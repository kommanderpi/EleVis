...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Un,depthTest:!1,depthWrite:!1})}function lc(){return new On({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:hl(),fragmentShader:`
		...
		`,blending:Un,depthTest:!1,depthWrite:!1})}function cc(){return new On({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:hl(),fragmentShader:`
		...
		`,blending:Un,depthTest:!1,depthWrite:!1})}function hl(){return`
	...
	`}function v_(n){let t=new WeakMap,e=null;function i(a){if(a&&a.isTexture){const c=a.mapping,l=c===ea||c===na,u=c===Gi||c===Wi;if(l||u){let h=t.get(a);const f=h!==void 0?h.texture.pmremVersion:0;if(a.isRenderTargetTexture&&a.pmremVersion!==f)return e===null&&(e=new oc(n)),h=l?e.fromEquirectangular(a,h):e.fromCubemap(a,h),h.texture.pmremVersion=a.pmremVersion,t.set(a,h),h.texture;if(h!==void 0)return h.texture;{const p=a.image;return l&&p&&p.height>0||u&&p&&r(p)?(e===null&&(e=new oc(n)),h=l?e.fromEquirectangular(a):e.fromCubemap(a),h.texture.pmremVersion=a.pmremVersion,t.set(a,h),a.addEventListener("dispose",s),h.texture):null}}}return a}function r(a){let c=0;const l=6;for(let u=0;u<l;u++)a[u]!==void 0&&c++;return c===l}function s(a){const c=a.target;c.removeEventListener("dispose",s);const l=t.get(c);l!==void 0&&(t.delete(c),l.dispose())}function o(){t=new WeakMap,e!==null&&(e.dispose(),e=null)}return{get:i,dispose:o}}function x_(n){const t={};function e(i){if(t[i]!==void 0)return t[i];let r;switch(i){case"WEBGL_depth_texture":r=n.getExtension("WEBGL_depth_texture")||n.getExtension("MOZ_WEBGL_depth_texture")||n.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":r=n.getExtension("EXT_texture_filter_anisotropic")||n.getExtension("MOZ_EXT_texture_filter_anisotropic")||n.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":r=n.getExtension("WEBGL_compressed_texture_s3tc")||n.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||n.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":r=n.getExtension("WEBGL_compressed_texture_pvrtc")||n.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:r=n.getExtension(i)}return t[i]=r,r}return{has:function(i){return e(i)!==null},init:function(){e("EXT_color_buffer_float"),e("WEBGL_clip_cull_distance"),e("OES_texture_float_linear"),e("EXT_color_buffer_half_float"),e("WEBGL_multisampled_render_to_texture"),e("WEBGL_render_shared_exponent")},get:function(i){const r=e(i);return r===null&&Oi("THREE.WebGLRenderer: "+i+" extension not supported."),r}}}function M_(n,t,e,i){const r={},s=new WeakMap;function o(h){const f=h.target;f.index!==null&&t.remove(f.index);for(const _ in f.attributes)t.remove(f.attributes[_]);f.removeEventListener("dispose",o),delete r[f.id];const p=s.get(f);p&&(t.remove(p),s.delete(f)),i.releaseStatesOfGeometry(f),f.isInstancedBufferGeometry===!0&&delete f._maxInstanceCount,e.memory.geometries--}function a(h,f){return r[f.id]===!0||(f.addEventListener("dispose",o),r[f.id]=!0,e.memory.geometries++),f}function c(h){const f=h.attributes;for(const p in f)t.update(f[p],n.ARRAY_BUFFER)}function l(h){const f=[],p=h.index,_=h.attributes.position;let v=0;if(p!==null){const T=p.array;v=p.version;for(let w=0,S=T.length;w<S;w+=3){const D=T[w+0],P=T[w+1],A=T[w+2];f.push(D,P,P,A,A,D)}}else if(_!==void 0){const T=_.array;v=_.version;for(let w=0,S=T.length/3-1;w<S;w+=3){const D=w+0,P=w+1,A=w+2;f.push(D,P,P,A,A,D)}}else return;const m=new(Lu(f)?Ou:Fu)(f,1);m.version=v;const d=s.get(h);d&&t.remove(d),s.set(h,m)}function u(h){const f=s.get(h);if(f){const p=h.index;p!==null&&f.version<p.version&&l(h)}else l(h);return s.get(h)}return{get:a,update:c,getWireframeAttribute:u}}function y_(n,t,e){let i;function r(f){i=f}let s,o;function a(f){s=f.type,o=f.bytesPerElement}function c(f,p){n.drawElements(i,p,s,f*o),e.update(p,i,1)}function l(f,p,_){_!==0&&(n.drawElementsInstanced(i,p,s,f*o,_),e.update(p,i,_))}function u(f,p,_){if(_===0)return;t.get("WEBGL_multi_draw").multiDrawElementsWEBGL(i,p,0,s,f,0,_);let m=0;for(let d=0;d<_;d++)m+=p[d];e.update(m,i,1)}function h(f,p,_,v){if(_===0)return;const m=t.get("WEBGL_multi_draw");if(m===null)for(let d=0;d<f.length;d++)l(f[d]/o,p[d],v[d]);else{m.multiDrawElementsInstancedWEBGL(i,p,0,s,f,0,v,0,_);let d=0;for(let T=0;T<_;T++)d+=p[T]*v[T];e.update(d,i,1)}}this.setMode=r,this.setIndex=a,this.render=c,this.renderInstances=l,this.renderMultiDraw=u,this.renderMultiDrawInstances=h}function S_(n){const t={geometries:0,textures:0},e={frame:0,calls:0,triangles:0,points:0,lines:0};function i(s,o,a){switch(e.calls++,o){case n.TRIANGLES:e.triangles+=a*(s/3);break;case n.LINES:e.lines+=a*(s/2);break;case n.LINE_STRIP:e.lines+=a*(s-1);break;case n.LINE_LOOP:e.lines+=a*s;break;case n.POINTS:e.points+=a*s;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",o);break}}function r(){e.calls=0,e.triangles=0,e.points=0,e.lines=0}return{memory:t,render:e,programs:null,autoReset:!0,reset:r,update:i}}function E_(n,t,e){const i=new WeakMap,r=new ce;function s(o,a,c){const l=o.morphTargetInfluences,u=a.morphAttributes.position||a.morphAttributes.normal||a.morphAttributes.color,h=u!==void 0?u.length:0;let f=i.get(a);if(f===void 0||f.count!==h){let x=function(){C.dispose(),i.delete(a),a.removeEventListener("dispose",x)};var p=x;f!==void 0&&f.texture.dispose();const _=a.morphAttributes.position!==void 0,v=a.morphAttributes.normal!==void 0,m=a.morphAttributes.color!==void 0,d=a.morphAttributes.position||[],T=a.morphAttributes.normal||[],w=a.morphAttributes.color||[];let S=0;_===!0&&(S=1),v===!0&&(S=2),m===!0&&(S=3);let D=a.attributes.position.count*S,P=1;D>t.maxTextureSize&&(P=Math.ceil(D/t.maxTextureSize),D=t.maxTextureSize);const A=new Float32Array(D*P*4*h),C=new Iu(A,D,P,h);C.type=Mn,C.needsUpdate=!0;const y=S*4;for(let b=0;b<h;b++){const z=d[b],O=T[b],$=w[b],j=D*P*4*b;for(let Z=0;Z<z.count;Z++){const et=Z*y;_===!0&&(r.fromBufferAttribute(z,Z),A[j+et+0]=r.x,A[j+et+1]=r.y,A[j+et+2]=r.z,A[j+et+3]=0),v===!0&&(r.fromBufferAttribute(O,Z),A[j+et+4]=r.x,A[j+et+5]=r.y,A[j+et+6]=r.z,A[j+et+7]=0),m===!0&&(r.fromBufferAttribute($,Z),A[j+et+8]=r.x,A[j+et+9]=r.y,A[j+et+10]=r.z,A[j+et+11]=$.itemSize===4?r.w:1)}}f={count:h,texture:C,size:new kt(D,P)},i.set(a,f),a.addEventListener("dispose",x)}if(o.isInstancedMesh===!0&&o.morphTexture!==null)c.getUniforms().setValue(n,"morphTexture",o.morphTexture,e);else{let _=0;for(let m=0;m<l.length;m++)_+=l[m];const v=a.morphTargetsRelative?1:1-_;c.getUniforms().setValue(n,"morphTargetBaseInfluence",v),c.getUniforms().setValue(n,"morphTargetInfluences",l)}c.getUniforms().setValue(n,"morphTargetsTexture",f.texture,e),c.getUniforms().setValue(n,"morphTargetsTextureSize",f.size)}return{update:s}}function T_(n,t,e,i){let r=new WeakMap;function s(c){const l=i.render.frame,u=c.geometry,h=t.get(c,u);if(r.get(h)!==l&&(t.update(h),r.set(h,l)),c.isInstancedMesh&&(c.hasEventListener("dispose",a)===!1&&c.addEventListener("dispose",a),r.get(c)!==l&&(e.update(c.instanceMatrix,n.ARRAY_BUFFER),c.instanceColor!==null&&e.update(c.instanceColor,n.ARRAY_BUFFER),r.set(c,l))),c.isSkinnedMesh){const f=c.skeleton;r.get(f)!==l&&(f.update(),r.set(f,l))}return h}function o(){r=new WeakMap}function a(c){const l=c.target;l.removeEventListener("dispose",a),e.remove(l.instanceMatrix),l.instanceColor!==null&&e.remove(l.instanceColor)}return{update:s,dispose:o}}const Xu=new Re,uc=new Vu(1,1),qu=new Iu,Yu=new Kf,$u=new ku,hc=[],fc=[],dc=new Float32Array(16),pc=new Float32Array(9),mc=new Float32Array(4);function er(n,t,e){const i=n[0];if(i<=0||i>0)return n;const r=t*e;let s=hc[r];if(s===void 0&&(s=new Float32Array(r),hc[r]=s),t!==0){i.toArray(s,0);for(let o=1,a=0;o!==t;++o)a+=e,n[o].toArray(s,a)}return s}function de(n,t){if(n.length!==t.length)return!1;for(let e=0,i=n.length;e<i;e++)if(n[e]!==t[e])return!1;return!0}function pe(n,t){for(let e=0,i=t.length;e<i;e++)n[e]=t[e]}function Js(n,t){let e=fc[t];e===void 0&&(e=new Int32Array(t),fc[t]=e);for(let i=0;i!==t;++i)e[i]=n.allocateTextureUnit();return e}function w_(n,t){const e=this.cache;e[0]!==t&&(n.uniform1f(this.addr,t),e[0]=t)}function b_(n,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(n.uniform2f(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(de(e,t))return;n.uniform2fv(this.addr,t),pe(e,t)}}function A_(n,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(n.uniform3f(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else if(t.r!==void 0)(e[0]!==t.r||e[1]!==t.g||e[2]!==t.b)&&(n.uniform3f(this.addr,t.r,t.g,t.b),e[0]=t.r,e[1]=t.g,e[2]=t.b);else{if(de(e,t))return;n.uniform3fv(this.addr,t),pe(e,t)}}function R_(n,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(n.uniform4f(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(de(e,t))return;n.uniform4fv(this.addr,t),pe(e,t)}}function C_(n,t){const e=this.cache,i=t.elements;if(i===void 0){if(de(e,t))return;n.uniformMatrix2fv(this.addr,!1,t),pe(e,t)}else{if(de(e,i))return;mc.set(i),n.uniformMatrix2fv(this.addr,!1,mc),pe(e,i)}}function P_(n,t){const e=this.cache,i=t.elements;if(i===void 0){if(de(e,t))return;n.uniformMatrix3fv(this.addr,!1,t),pe(e,t)}else{if(de(e,i))return;pc.set(i),n.uniformMatrix3fv(this.addr,!1,pc),pe(e,i)}}function D_(n,t){const e=this.cache,i=t.elements;if(i===void 0){if(de(e,t))return;n.uniformMatrix4fv(this.addr,!1,t),pe(e,t)}else{if(de(e,i))return;dc.set(i),n.uniformMatrix4fv(this.addr,!1,dc),pe(e,i)}}function L_(n,t){const e=this.cache;e[0]!==t&&(n.uniform1i(this.addr,t),e[0]=t)}function I_(n,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(n.uniform2i(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(de(e,t))return;n.uniform2iv(this.addr,t),pe(e,t)}}function U_(n,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(n.uniform3i(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else{if(de(e,t))return;n.uniform3iv(this.addr,t),pe(e,t)}}function N_(n,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(n.uniform4i(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(de(e,t))return;n.uniform4iv(this.addr,t),pe(e,t)}}function F_(n,t){const e=this.cache;e[0]!==t&&(n.uniform1ui(this.addr,t),e[0]=t)}function O_(n,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(n.uniform2ui(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(de(e,t))return;n.uniform2uiv(this.addr,t),pe(e,t)}}function B_(n,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(n.uniform3ui(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else{if(de(e,t))return;n.uniform3uiv(this.addr,t),pe(e,t)}}function z_(n,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(n.uniform4ui(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(de(e,t))return;n.uniform4uiv(this.addr,t),pe(e,t)}}function k_(n,t,e){const i=this.cache,r=e.allocateTextureUnit();i[0]!==r&&(n.uniform1i(this.addr,r),i[0]=r);let s;this.type===n.SAMPLER_2D_SHADOW?(uc.compareFunction=Du,s=uc):s=Xu,e.setTexture2D(t||s,r)}function H_(n,t,e){const i=this.cache,r=e.allocateTextureUnit();i[0]!==r&&(n.uniform1i(this.addr,r),i[0]=r),e.setTexture3D(t||Yu,r)}function V_(n,t,e){const i=this.cache,r=e.allocateTextureUnit();i[0]!==r&&(n.uniform1i(this.addr,r),i[0]=r),e.setTextureCube(t||$u,r)}function G_(n,t,e){const i=this.cache,r=e.allocateTextureUnit();i[0]!==r&&(n.uniform1i(this.addr,r),i[0]=r),e.setTexture2DArray(t||qu,r)}function W_(n){switch(n){case 5126:return w_;case 35664:return b_;case 35665:return A_;case 35666:return R_;case 35674:return C_;case 35675:return P_;case 35676:return D_;case 5124:case 35670:return L_;case 35667:case 35671:return I_;case 35668:case 35672:return U_;case 35669:case 35673:return N_;case 5125:return F_;case 36294:return O_;case 36295:return B_;case 36296:return z_;case 35678:case 36198:case 36298:case 36306:case 35682:return k_;case 35679:case 36299:case 36307:return H_;case 35680:case 36300:case 36308:case 36293:return V_;case 36289:case 36303:case 36311:case 36292:return G_}}function X_(n,t){n.uniform1fv(this.addr,t)}function q_(n,t){const e=er(t,this.size,2);n.uniform2fv(this.addr,e)}function Y_(n,t){const e=er(t,this.size,3);n.uniform3fv(this.addr,e)}function $_(n,t){const e=er(t,this.size,4);n.uniform4fv(this.addr,e)}function Z_(n,t){const e=er(t,this.size,4);n.uniformMatrix2fv(this.addr,!1,e)}function K_(n,t){const e=er(t,this.size,9);n.uniformMatrix3fv(this.addr,!1,e)}function j_(n,t){const e=er(t,this.size,16);n.uniformMatrix4fv(this.addr,!1,e)}function J_(n,t){n.uniform1iv(this.addr,t)}function Q_(n,t){n.uniform2iv(this.addr,t)}function tg(n,t){n.uniform3iv(this.addr,t)}function eg(n,t){n.uniform4iv(this.addr,t)}function ng(n,t){n.uniform1uiv(this.addr,t)}function ig(n,t){n.uniform2uiv(this.addr,t)}function rg(n,t){n.uniform3uiv(this.addr,t)}function sg(n,t){n.uniform4uiv(this.addr,t)}function og(n,t,e){const i=this.cache,r=t.length,s=Js(e,r);de(i,s)||(n.uniform1iv(this.addr,s),pe(i,s));for(let o=0;o!==r;++o)e.setTexture2D(t[o]||Xu,s[o])}function ag(n,t,e){const i=this.cache,r=t.length,s=Js(e,r);de(i,s)||(n.uniform1iv(this.addr,s),pe(i,s));for(let o=0;o!==r;++o)e.setTexture3D(t[o]||Yu,s[o])}function lg(n,t,e){const i=this.cache,r=t.length,s=Js(e,r);de(i,s)||(n.uniform1iv(this.addr,s),pe(i,s));for(let o=0;o!==r;++o)e.setTextureCube(t[o]||$u,s[o])}function cg(n,t,e){const i=this.cache,r=t.length,s=Js(e,r);de(i,s)||(n.uniform1iv(this.addr,s),pe(i,s));for(let o=0;o!==r;++o)e.setTexture2DArray(t[o]||qu,s[o])}function ug(n){switch(n){case 5126:return X_;case 35664:return q_;case 35665:return Y_;case 35666:return $_;case 35674:return Z_;case 35675:return K_;case 35676:return j_;case 5124:case 35670:return J_;case 35667:case 35671:return Q_;case 35668:case 35672:return tg;case 35669:case 35673:return eg;case 5125:return ng;case 36294:return ig;case 36295:return rg;case 36296:return sg;case 35678:case 36198:case 36298:case 36306:case 35682:return og;case 35679:case 36299:case 36307:return ag;case 35680:case 36300:case 36308:case 36293:return lg;case 36289:case 36303:case 36311:case 36292:return cg}}class hg{constructor(t,e,i){this.id=t,this.addr=i,this.cache=[],this.type=e.type,this.setValue=W_(e.type)}}class fg{constructor(t,e,i){this.id=t,this.addr=i,this.cache=[],this.type=e.type,this.size=e.size,this.setValue=ug(e.type)}}class dg{constructor(t){this.id=t,this.seq=[],this.map={}}setValue(t,e,i){const r=this.seq;for(let s=0,o=r.length;s!==o;++s){const a=r[s];a.setValue(t,e[a.id],i)}}}const No=/(\w+)(\])?(\[|\.)?/g;function _c(n,t){n.seq.push(t),n.map[t.id]=t}function pg(n,t,e){const i=n.name,r=i.length;for(No.lastIndex=0;;){const s=No.exec(i),o=No.lastIndex;let a=s[1];const c=s[2]==="]",l=s[3];if(c&&(a=a|0),l===void 0||l==="["&&o+2===r){_c(e,l===void 0?new hg(a,n,t):new fg(a,n,t));break}else{let h=e.map[a];h===void 0&&(h=new dg(a),_c(e,h)),e=h}}}class Ms{constructor(t,e){this.seq=[],this.map={};const i=t.getProgramParameter(e,t.ACTIVE_UNIFORMS);for(let r=0;r<i;++r){const s=t.getActiveUniform(e,r),o=t.getUniformLocation(e,s.name);pg(s,o,this)}}setValue(t,e,i,r){const s=this.map[e];s!==void 0&&s.setValue(t,i,r)}setOptional(t,e,i){const r=e[i];r!==void 0&&this.setValue(t,i,r)}static upload(t,e,i,r){for(let s=0,o=e.length;s!==o;++s){const a=e[s],c=i[a.id];c.needsUpdate!==!1&&a.setValue(t,c.value,r)}}static seqWithValue(t,e){const i=[];for(let r=0,s=t.length;r!==s;++r){const o=t[r];o.id in e&&i.push(o)}return i}}function gc(n,t,e){const i=n.createShader(t);return n.shaderSource(i,e),n.compileShader(i),i}const mg=37297;let _g=0;function gg(n,t){const e=n.split(`
`),i=[],r=Math.max(t-6,0),s=Math.min(t+6,e.length);for(let o=r;o<s;o++){const a=o+1;i.push(`${a===t?">":" "} ${a}: ${e[o]}`)}return i.join(`
`)}const vc=new Ht;function vg(n){jt._getMatrix(vc,jt.workingColorSpace,n);const t=`mat3( ${vc.elements.map(e=>e.toFixed(4))} )`;switch(jt.getTransfer(n)){case As:return[t,"LinearTransferOETF"];case te:return[t,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space: ",n),[t,"LinearTransferOETF"]}}function xc(n,t,e){const i=n.getShaderParameter(t,n.COMPILE_STATUS),r=n.getShaderInfoLog(t).trim();if(i&&r==="")return"";const s=/ERROR: 0:(\d+)/.exec(r);if(s){const o=parseInt(s[1]);return e.toUpperCase()+`

`+r+`

`+gg(n.getShaderSource(t),o)}else return r}function xg(n,t){const e=vg(t);return[`vec4 ${n}( vec4 value ) {`,`	return ${e[1]}( vec4( value.rgb * ${e[0]}, value.a ) );`,"}"].join(`
`)}function Mg(n,t){let e;switch(t){case yf:e="Linear";break;case Sf:e="Reinhard";break;case Ef:e="Cineon";break;case Tf:e="ACESFilmic";break;case bf:e="AgX";break;case Af:e="Neutral";break;case wf:e="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",t),e="Linear"}return"vec3 "+n+"( vec3 color ) { return "+e+"ToneMapping( color ); }"}const as=new F;function yg(){jt.getLuminanceCoefficients(as);const n=as.x.toFixed(4),t=as.y.toFixed(4),e=as.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${n}, ${t}, ${e} );`,"	return dot( weights, rgb );","}"].join(`
...
#define LOW_PRECISION`),t}function Pg(n){let t="SHADOWMAP_TYPE_BASIC";return n.shadowMapType===yu?t="SHADOWMAP_TYPE_PCF":n.shadowMapType===Qh?t="SHADOWMAP_TYPE_PCF_SOFT":n.shadowMapType===vn&&(t="SHADOWMAP_TYPE_VSM"),t}function Dg(n){let t="ENVMAP_TYPE_CUBE";if(n.envMap)switch(n.envMapMode){case Gi:case Wi:t="ENVMAP_TYPE_CUBE";break;case Zs:t="ENVMAP_TYPE_CUBE_UV";break}return t}function Lg(n){let t="ENVMAP_MODE_REFLECTION";if(n.envMap)switch(n.envMapMode){case Wi:t="ENVMAP_MODE_REFRACTION";break}return t}function Ig(n){let t="ENVMAP_BLENDING_NONE";if(n.envMap)switch(n.combine){case Qa:t="ENVMAP_BLENDING_MULTIPLY";break;case xf:t="ENVMAP_BLENDING_MIX";break;case Mf:t="ENVMAP_BLENDING_ADD";break}return t}function Ug(n){const t=n.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,i=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),7*16)),texelHeight:i,maxMip:e}}function Ng(n,t,e,i){const r=n.getContext(),s=e.defines;let o=e.vertexShader,a=e.fragmentShader;const c=Pg(e),l=Dg(e),u=Lg(e),h=Ig(e),f=Ug(e),p=Sg(e),_=Eg(s),v=r.createProgram();let m,d,T=e.glslVersion?"#version "+e.glslVersion+`
...
}`;class r0{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(t,e,i){if(this.texture===null){const r=new Re,s=t.properties.get(r);s.__webglTexture=e.texture,(e.depthNear!==i.depthNear||e.depthFar!==i.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=r}}getMesh(t){if(this.texture!==null&&this.mesh===null){const e=t.cameras[0].viewport,i=new On({vertexShader:n0,fragmentShader:i0,uniforms:{depthColor:{value:this.texture},depthWidth:{value:e.z},depthHeight:{value:e.w}}});this.mesh=new ke(new js(20,20),i)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class s0 extends ci{constructor(t,e){super();const i=this;let r=null,s=1,o=null,a="local-floor",c=1,l=null,u=null,h=null,f=null,p=null,_=null;const v=new r0,m=e.getContextAttributes();let d=null,T=null;const w=[],S=[],D=new kt;let P=null;const A=new qe;A.viewport=new ce;const C=new qe;C.viewport=new ce;const y=[A,C],x=new wd;let b=null,z=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(Y){let st=w[Y];return st===void 0&&(st=new Ao,w[Y]=st),st.getTargetRaySpace()},this.getControllerGrip=function(Y){let st=w[Y];return st===void 0&&(st=new Ao,w[Y]=st),st.getGripSpace()},this.getHand=function(Y){let st=w[Y];return st===void 0&&(st=new Ao,w[Y]=st),st.getHandSpace()};function O(Y){const st=S.indexOf(Y.inputSource);if(st===-1)return;const ut=w[st];ut!==void 0&&(ut.update(Y.inputSource,Y.frame,l||o),ut.dispatchEvent({type:Y.type,data:Y.inputSource}))}function $(){r.removeEventListener("select",O),r.removeEventListener("selectstart",O),r.removeEventListener("selectend",O),r.removeEventListener("squeeze",O),r.removeEventListener("squeezestart",O),r.removeEventListener("squeezeend",O),r.removeEventListener("end",$),r.removeEventListener("inputsourceschange",j);for(let Y=0;Y<w.length;Y++){const st=S[Y];st!==null&&(S[Y]=null,w[Y].disconnect(st))}b=null,z=null,v.reset(),t.setRenderTarget(d),p=null,f=null,h=null,r=null,T=null,Bt.stop(),i.isPresenting=!1,t.setPixelRatio(P),t.setSize(D.width,D.height,!1),i.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(Y){s=Y,i.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(Y){a=Y,i.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return l||o},this.setReferenceSpace=function(Y){l=Y},this.getBaseLayer=function(){return f!==null?f:p},this.getBinding=function(){return h},this.getFrame=function(){return _},this.getSession=function(){return r},this.setSession=async function(Y){if(r=Y,r!==null){if(d=t.getRenderTarget(),r.addEventListener("select",O),r.addEventListener("selectstart",O),r.addEventListener("selectend",O),r.addEventListener("squeeze",O),r.addEventListener("squeezestart",O),r.addEventListener("squeezeend",O),r.addEventListener("end",$),r.addEventListener("inputsourceschange",j),m.xrCompatible!==!0&&await e.makeXRCompatible(),P=t.getPixelRatio(),t.getSize(D),typeof XRWebGLBinding<"u"&&"createProjectionLayer"in XRWebGLBinding.prototype){let ut=null,at=null,dt=null;m.depth&&(dt=m.stencil?e.DEPTH24_STENCIL8:e.DEPTH_COMPONENT24,ut=m.stencil?Ar:br,at=m.stencil?wr:ii);const Rt={colorFormat:e.RGBA8,depthFormat:dt,scaleFactor:s};h=new XRWebGLBinding(r,e),f=h.createProjectionLayer(Rt),r.updateRenderState({layers:[f]}),t.setPixelRatio(1),t.setSize(f.textureWidth,f.textureHeight,!1),T=new si(f.textureWidth,f.textureHeight,{format:Ke,type:En,depthTexture:new Vu(f.textureWidth,f.textureHeight,at,void 0,void 0,void 0,void 0,void 0,void 0,ut),stencilBuffer:m.stencil,colorSpace:t.outputColorSpace,samples:m.antialias?4:0,resolveDepthBuffer:f.ignoreDepthValues===!1,resolveStencilBuffer:f.ignoreDepthValues===!1})}else{const ut={antialias:m.antialias,alpha:!0,depth:m.depth,stencil:m.stencil,framebufferScaleFactor:s};p=new XRWebGLLayer(r,e,ut),r.updateRenderState({baseLayer:p}),t.setPixelRatio(1),t.setSize(p.framebufferWidth,p.framebufferHeight,!1),T=new si(p.framebufferWidth,p.framebufferHeight,{format:Ke,type:En,colorSpace:t.outputColorSpace,stencilBuffer:m.stencil,resolveDepthBuffer:p.ignoreDepthValues===!1,resolveStencilBuffer:p.ignoreDepthValues===!1})}T.isXRRenderTarget=!0,this.setFoveation(c),l=null,o=await r.requestReferenceSpace(a),Bt.setContext(r),Bt.start(),i.isPresenting=!0,i.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(r!==null)return r.environmentBlendMode},this.getDepthTexture=function(){return v.getDepthTexture()};function j(Y){for(let st=0;st<Y.removed.length;st++){const ut=Y.removed[st],at=S.indexOf(ut);at>=0&&(S[at]=null,w[at].disconnect(ut))}for(let st=0;st<Y.added.length;st++){const ut=Y.added[st];let at=S.indexOf(ut);if(at===-1){for(let Rt=0;Rt<w.length;Rt++)if(Rt>=S.length){S.push(ut),at=Rt;break}else if(S[Rt]===null){S[Rt]=ut,at=Rt;break}if(at===-1)break}const dt=w[at];dt&&dt.connect(ut)}}const Z=new F,et=new F;function X(Y,st,ut){Z.setFromMatrixPosition(st.matrixWorld),et.setFromMatrixPosition(ut.matrixWorld);const at=Z.distanceTo(et),dt=st.projectionMatrix.elements,Rt=ut.projectionMatrix.elements,Et=dt[14]/(dt[10]-1),Zt=dt[14]/(dt[10]+1),qt=(dt[9]+1)/dt[5],zt=(dt[9]-1)/dt[5],R=(dt[8]-1)/dt[0],Gt=(Rt[8]+1)/Rt[0],It=Et*R,Wt=Et*Gt,Q=at/(-R+Gt),bt=Q*-R;if(st.matrixWorld.decompose(Y.position,Y.quaternion,Y.scale),Y.translateX(bt),Y.translateZ(Q),Y.matrixWorld.compose(Y.position,Y.quaternion,Y.scale),Y.matrixWorldInverse.copy(Y.matrixWorld).invert(),dt[10]===-1)Y.projectionMatrix.copy(st.projectionMatrix),Y.projectionMatrixInverse.copy(st.projectionMatrixInverse);else{const H=Et+Q,K=Zt+Q,vt=It-bt,E=Wt+(at-bt),g=qt*Zt/K*H,L=zt*Zt/K*H;Y.projectionMatrix.makePerspective(vt,E,g,L,H,K),Y.projectionMatrixInverse.copy(Y.projectionMatrix).invert()}}function W(Y,st){st===null?Y.matrixWorld.copy(Y.matrix):Y.matrixWorld.multiplyMatrices(st.matrixWorld,Y.matrix),Y.matrixWorldInverse.copy(Y.matrixWorld).invert()}this.updateCamera=function(Y){if(r===null)return;let st=Y.near,ut=Y.far;v.texture!==null&&(v.depthNear>0&&(st=v.depthNear),v.depthFar>0&&(ut=v.depthFar)),x.near=C.near=A.near=st,x.far=C.far=A.far=ut,(b!==x.near||z!==x.far)&&(r.updateRenderState({depthNear:x.near,depthFar:x.far}),b=x.near,z=x.far),A.layers.mask=Y.layers.mask|2,C.layers.mask=Y.layers.mask|4,x.layers.mask=A.layers.mask|C.layers.mask;const at=Y.parent,dt=x.cameras;W(x,at);for(let Rt=0;Rt<dt.length;Rt++)W(dt[Rt],at);dt.length===2?X(x,A,C):x.projectionMatrix.copy(A.projectionMatrix),nt(Y,x,at)};function nt(Y,st,ut){ut===null?Y.matrix.copy(st.matrixWorld):(Y.matrix.copy(ut.matrixWorld),Y.matrix.invert(),Y.matrix.multiply(st.matrixWorld)),Y.matrix.decompose(Y.position,Y.quaternion,Y.scale),Y.updateMatrixWorld(!0),Y.projectionMatrix.copy(st.projectionMatrix),Y.projectionMatrixInverse.copy(st.projectionMatrixInverse),Y.isPerspectiveCamera&&(Y.fov=Da*2*Math.atan(1/Y.projectionMatrix.elements[5]),Y.zoom=1)}this.getCamera=function(){return x},this.getFoveation=function(){if(!(f===null&&p===null))return c},this.setFoveation=function(Y){c=Y,f!==null&&(f.fixedFoveation=Y),p!==null&&p.fixedFoveation!==void 0&&(p.fixedFoveation=Y)},this.hasDepthSensing=function(){return v.texture!==null},this.getDepthSensingMesh=function(){return v.getMesh(x)};let ct=null;function gt(Y,st){if(u=st.getViewerPose(l||o),_=st,u!==null){const ut=u.views;p!==null&&(t.setRenderTargetFramebuffer(T,p.framebuffer),t.setRenderTarget(T));let at=!1;ut.length!==x.cameras.length&&(x.cameras.length=0,at=!0);for(let Et=0;Et<ut.length;Et++){const Zt=ut[Et];let qt=null;if(p!==null)qt=p.getViewport(Zt);else{const R=h.getViewSubImage(f,Zt);qt=R.viewport,Et===0&&(t.setRenderTargetTextures(T,R.colorTexture,R.depthStencilTexture),t.setRenderTarget(T))}let zt=y[Et];zt===void 0&&(zt=new qe,zt.layers.enable(Et),zt.viewport=new ce,y[Et]=zt),zt.matrix.fromArray(Zt.transform.matrix),zt.matrix.decompose(zt.position,zt.quaternion,zt.scale),zt.projectionMatrix.fromArray(Zt.projectionMatrix),zt.projectionMatrixInverse.copy(zt.projectionMatrix).invert(),zt.viewport.set(qt.x,qt.y,qt.width,qt.height),Et===0&&(x.matrix.copy(zt.matrix),x.matrix.decompose(x.position,x.quaternion,x.scale)),at===!0&&x.cameras.push(zt)}const dt=r.enabledFeatures;if(dt&&dt.includes("depth-sensing")&&r.depthUsage=="gpu-optimized"&&h){const Et=h.getDepthInformation(ut[0]);Et&&Et.isValid&&Et.texture&&v.init(t,Et,r.renderState)}}for(let ut=0;ut<w.length;ut++){const at=S[ut],dt=w[ut];at!==null&&dt!==void 0&&dt.update(at,st,l||o)}ct&&ct(Y,st),st.detectedPlanes&&i.dispatchEvent({type:"planesdetected",data:st}),_=null}const Bt=new Wu;Bt.setAnimationLoop(gt),this.setAnimationLoop=function(Y){ct=Y},this.dispose=function(){}}}const Xn=new tn,o0=new ue;function a0(n,t){function e(m,d){m.matrixAutoUpdate===!0&&m.updateMatrix(),d.value.copy(m.matrix)}function i(m,d){d.color.getRGB(m.fogColor.value,Bu(n)),d.isFog?(m.fogNear.value=d.near,m.fogFar.value=d.far):d.isFogExp2&&(m.fogDensity.value=d.density)}function r(m,d,T,w,S){d.isMeshBasicMaterial||d.isMeshLambertMaterial?s(m,d):d.isMeshToonMaterial?(s(m,d),h(m,d)):d.isMeshPhongMaterial?(s(m,d),u(m,d)):d.isMeshStandardMaterial?(s(m,d),f(m,d),d.isMeshPhysicalMaterial&&p(m,d,S)):d.isMeshMatcapMaterial?(s(m,d),_(m,d)):d.isMeshDepthMaterial?s(m,d):d.isMeshDistanceMaterial?(s(m,d),v(m,d)):d.isMeshNormalMaterial?s(m,d):d.isLineBasicMaterial?(o(m,d),d.isLineDashedMaterial&&a(m,d)):d.isPointsMaterial?c(m,d,T,w):d.isSpriteMaterial?l(m,d):d.isShadowMaterial?(m.color.value.copy(d.color),m.opacity.value=d.opacity):d.isShaderMaterial&&(d.uniformsNeedUpdate=!1)}function s(m,d){m.opacity.value=d.opacity,d.color&&m.diffuse.value.copy(d.color),d.emissive&&m.emissive.value.copy(d.emissive).multiplyScalar(d.emissiveIntensity),d.map&&(m.map.value=d.map,e(d.map,m.mapTransform)),d.alphaMap&&(m.alphaMap.value=d.alphaMap,e(d.alphaMap,m.alphaMapTransform)),d.bumpMap&&(m.bumpMap.value=d.bumpMap,e(d.bumpMap,m.bumpMapTransform),m.bumpScale.value=d.bumpScale,d.side===Ae&&(m.bumpScale.value*=-1)),d.normalMap&&(m.normalMap.value=d.normalMap,e(d.normalMap,m.normalMapTransform),m.normalScale.value.copy(d.normalScale),d.side===Ae&&m.normalScale.value.negate()),d.displacementMap&&(m.displacementMap.value=d.displacementMap,e(d.displacementMap,m.displacementMapTransform),m.displacementScale.value=d.displacementScale,m.displacementBias.value=d.displacementBias),d.emissiveMap&&(m.emissiveMap.value=d.emissiveMap,e(d.emissiveMap,m.emissiveMapTransform)),d.specularMap&&(m.specularMap.value=d.specularMap,e(d.specularMap,m.specularMapTransform)),d.alphaTest>0&&(m.alphaTest.value=d.alphaTest);const T=t.get(d),w=T.envMap,S=T.envMapRotation;w&&(m.envMap.value=w,Xn.copy(S),Xn.x*=-1,Xn.y*=-1,Xn.z*=-1,w.isCubeTexture&&w.isRenderTargetTexture===!1&&(Xn.y*=-1,Xn.z*=-1),m.envMapRotation.value.setFromMatrix4(o0.makeRotationFromEuler(Xn)),m.flipEnvMap.value=w.isCubeTexture&&w.isRenderTargetTexture===!1?-1:1,m.reflectivity.value=d.reflectivity,m.ior.value=d.ior,m.refractionRatio.value=d.refractionRatio),d.lightMap&&(m.lightMap.value=d.lightMap,m.lightMapIntensity.value=d.lightMapIntensity,e(d.lightMap,m.lightMapTransform)),d.aoMap&&(m.aoMap.value=d.aoMap,m.aoMapIntensity.value=d.aoMapIntensity,e(d.aoMap,m.aoMapTransform))}function o(m,d){m.diffuse.value.copy(d.color),m.opacity.value=d.opacity,d.map&&(m.map.value=d.map,e(d.map,m.mapTransform))}function a(m,d){m.dashSize.value=d.dashSize,m.totalSize.value=d.dashSize+d.gapSize,m.scale.value=d.scale}function c(m,d,T,w){m.diffuse.value.copy(d.color),m.opacity.value=d.opacity,m.size.value=d.size*T,m.scale.value=w*.5,d.map&&(m.map.value=d.map,e(d.map,m.uvTransform)),d.alphaMap&&(m.alphaMap.value=d.alphaMap,e(d.alphaMap,m.alphaMapTransform)),d.alphaTest>0&&(m.alphaTest.value=d.alphaTest)}function l(m,d){m.diffuse.value.copy(d.color),m.opacity.value=d.opacity,m.rotation.value=d.rotation,d.map&&(m.map.value=d.map,e(d.map,m.mapTransform)),d.alphaMap&&(m.alphaMap.value=d.alphaMap,e(d.alphaMap,m.alphaMapTransform)),d.alphaTest>0&&(m.alphaTest.value=d.alphaTest)}function u(m,d){m.specular.value.copy(d.specular),m.shininess.value=Math.max(d.shininess,1e-4)}function h(m,d){d.gradientMap&&(m.gradientMap.value=d.gradientMap)}function f(m,d){m.metalness.value=d.metalness,d.metalnessMap&&(m.metalnessMap.value=d.metalnessMap,e(d.metalnessMap,m.metalnessMapTransform)),m.roughness.value=d.roughness,d.roughnessMap&&(m.roughnessMap.value=d.roughnessMap,e(d.roughnessMap,m.roughnessMapTransform)),d.envMap&&(m.envMapIntensity.value=d.envMapIntensity)}function p(m,d,T){m.ior.value=d.ior,d.sheen>0&&(m.sheenColor.value.copy(d.sheenColor).multiplyScalar(d.sheen),m.sheenRoughness.value=d.sheenRoughness,d.sheenColorMap&&(m.sheenColorMap.value=d.sheenColorMap,e(d.sheenColorMap,m.sheenColorMapTransform)),d.sheenRoughnessMap&&(m.sheenRoughnessMap.value=d.sheenRoughnessMap,e(d.sheenRoughnessMap,m.sheenRoughnessMapTransform))),d.clearcoat>0&&(m.clearcoat.value=d.clearcoat,m.clearcoatRoughness.value=d.clearcoatRoughness,d.clearcoatMap&&(m.clearcoatMap.value=d.clearcoatMap,e(d.clearcoatMap,m.clearcoatMapTransform)),d.clearcoatRoughnessMap&&(m.clearcoatRoughnessMap.value=d.clearcoatRoughnessMap,e(d.clearcoatRoughnessMap,m.clearcoatRoughnessMapTransform)),d.clearcoatNormalMap&&(m.clearcoatNormalMap.value=d.clearcoatNormalMap,e(d.clearcoatNormalMap,m.clearcoatNormalMapTransform),m.clearcoatNormalScale.value.copy(d.clearcoatNormalScale),d.side===Ae&&m.clearcoatNormalScale.value.negate())),d.dispersion>0&&(m.dispersion.value=d.dispersion),d.iridescence>0&&(m.iridescence.value=d.iridescence,m.iridescenceIOR.value=d.iridescenceIOR,m.iridescenceThicknessMinimum.value=d.iridescenceThicknessRange[0],m.iridescenceThicknessMaximum.value=d.iridescenceThicknessRange[1],d.iridescenceMap&&(m.iridescenceMap.value=d.iridescenceMap,e(d.iridescenceMap,m.iridescenceMapTransform)),d.iridescenceThicknessMap&&(m.iridescenceThicknessMap.value=d.iridescenceThicknessMap,e(d.iridescenceThicknessMap,m.iridescenceThicknessMapTransform))),d.transmission>0&&(m.transmission.value=d.transmission,m.transmissionSamplerMap.value=T.texture,m.transmissionSamplerSize.value.set(T.width,T.height),d.transmissionMap&&(m.transmissionMap.value=d.transmissionMap,e(d.transmissionMap,m.transmissionMapTransform)),m.thickness.value=d.thickness,d.thicknessMap&&(m.thicknessMap.value=d.thicknessMap,e(d.thicknessMap,m.thicknessMapTransform)),m.attenuationDistance.value=d.attenuationDistance,m.attenuationColor.value.copy(d.attenuationColor)),d.anisotropy>0&&(m.anisotropyVector.value.set(d.anisotropy*Math.cos(d.anisotropyRotation),d.anisotropy*Math.sin(d.anisotropyRotation)),d.anisotropyMap&&(m.anisotropyMap.value=d.anisotropyMap,e(d.anisotropyMap,m.anisotropyMapTransform))),m.specularIntensity.value=d.specularIntensity,m.specularColor.value.copy(d.specularColor),d.specularColorMap&&(m.specularColorMap.value=d.specularColorMap,e(d.specularColorMap,m.specularColorMapTransform)),d.specularIntensityMap&&(m.specularIntensityMap.value=d.specularIntensityMap,e(d.specularIntensityMap,m.specularIntensityMapTransform))}function _(m,d){d.matcap&&(m.matcap.value=d.matcap)}function v(m,d){const T=t.get(d).light;m.referencePosition.value.setFromMatrixPosition(T.matrixWorld),m.nearDistance.value=T.shadow.camera.near,m.farDistance.value=T.shadow.camera.far}return{refreshFogUniforms:i,refreshMaterialUniforms:r}}function l0(n,t,e,i){let r={},s={},o=[];const a=n.getParameter(n.MAX_UNIFORM_BUFFER_BINDINGS);function c(T,w){const S=w.program;i.uniformBlockBinding(T,S)}function l(T,w){let S=r[T.id];S===void 0&&(_(T),S=u(T),r[T.id]=S,T.addEventListener("dispose",m));const D=w.program;i.updateUBOMapping(T,D);const P=t.render.frame;s[T.id]!==P&&(f(T),s[T.id]=P)}function u(T){const w=h();T.__bindingPointIndex=w;const S=n.createBuffer(),D=T.__size,P=T.usage;return n.bindBuffer(n.UNIFORM_BUFFER,S),n.bufferData(n.UNIFORM_BUFFER,D,P),n.bindBuffer(n.UNIFORM_BUFFER,null),n.bindBufferBase(n.UNIFORM_BUFFER,w,S),S}function h(){for(let T=0;T<a;T++)if(o.indexOf(T)===-1)return o.push(T),T;return console.error("THREE.WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function f(T){const w=r[T.id],S=T.uniforms,D=T.__cache;n.bindBuffer(n.UNIFORM_BUFFER,w);for(let P=0,A=S.length;P<A;P++){const C=Array.isArray(S[P])?S[P]:[S[P]];for(let y=0,x=C.length;y<x;y++){const b=C[y];if(p(b,P,y,D)===!0){const z=b.__offset,O=Array.isArray(b.value)?b.value:[b.value];let $=0;for(let j=0;j<O.length;j++){const Z=O[j],et=v(Z);typeof Z=="number"||typeof Z=="boolean"?(b.__data[0]=Z,n.bufferSubData(n.UNIFORM_BUFFER,z+$,b.__data)):Z.isMatrix3?(b.__data[0]=Z.elements[0],b.__data[1]=Z.elements[1],b.__data[2]=Z.elements[2],b.__data[3]=0,b.__data[4]=Z.elements[3],b.__data[5]=Z.elements[4],b.__data[6]=Z.elements[5],b.__data[7]=0,b.__data[8]=Z.elements[6],b.__data[9]=Z.elements[7],b.__data[10]=Z.elements[8],b.__data[11]=0):(Z.toArray(b.__data,$),$+=et.storage/Float32Array.BYTES_PER_ELEMENT)}n.bufferSubData(n.UNIFORM_BUFFER,z,b.__data)}}}n.bindBuffer(n.UNIFORM_BUFFER,null)}function p(T,w,S,D){const P=T.value,A=w+"_"+S;if(D[A]===void 0)return typeof P=="number"||typeof P=="boolean"?D[A]=P:D[A]=P.clone(),!0;{const C=D[A];if(typeof P=="number"||typeof P=="boolean"){if(C!==P)return D[A]=P,!0}else if(C.equals(P)===!1)return C.copy(P),!0}return!1}function _(T){const w=T.uniforms;let S=0;const D=16;for(let A=0,C=w.length;A<C;A++){const y=Array.isArray(w[A])?w[A]:[w[A]];for(let x=0,b=y.length;x<b;x++){const z=y[x],O=Array.isArray(z.value)?z.value:[z.value];for(let $=0,j=O.length;$<j;$++){const Z=O[$],et=v(Z),X=S%D,W=X%et.boundary,nt=X+W;S+=W,nt!==0&&D-nt<et.storage&&(S+=D-nt),z.__data=new Float32Array(et.storage/Float32Array.BYTES_PER_ELEMENT),z.__offset=S,S+=et.storage}}}const P=S%D;return P>0&&(S+=D-P),T.__size=S,T.__cache={},this}function v(T){const w={boundary:0,storage:0};return typeof T=="number"||typeof T=="boolean"?(w.boundary=4,w.storage=4):T.isVector2?(w.boundary=8,w.storage=8):T.isVector3||T.isColor?(w.boundary=16,w.storage=12):T.isVector4?(w.boundary=16,w.storage=16):T.isMatrix3?(w.boundary=48,w.storage=48):T.isMatrix4?(w.boundary=64,w.storage=64):T.isTexture?console.warn("THREE.WebGLRenderer: Texture samplers can not be part of an uniforms group."):console.warn("THREE.WebGLRenderer: Unsupported uniform value type.",T),w}function m(T){const w=T.target;w.removeEventListener("dispose",m);const S=o.indexOf(w.__bindingPointIndex);o.splice(S,1),n.deleteBuffer(r[w.id]),delete r[w.id],delete s[w.id]}function d(){for(const T in r)n.deleteBuffer(r[T]);o=[],r={},s={}}return{bind:c,update:l,dispose:d}}class c0{constructor(t={}){const{canvas:e=Hf(),context:i=null,depth:r=!0,stencil:s=!1,alpha:o=!1,antialias:a=!1,premultipliedAlpha:c=!0,preserveDrawingBuffer:l=!1,powerPreference:u="default",failIfMajorPerformanceCaveat:h=!1,reverseDepthBuffer:f=!1}=t;this.isWebGLRenderer=!0;let p;if(i!==null){if(typeof WebGLRenderingContext<"u"&&i instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");p=i.getContextAttributes().alpha}else p=o;const _=new Uint32Array(4),v=new Int32Array(4);let m=null,d=null;const T=[],w=[];this.domElement=e,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=Nn,this.toneMappingExposure=1,this.transmissionResolutionScale=1;const S=this;let D=!1;this._outputColorSpace=Be;let P=0,A=0,C=null,y=-1,x=null;const b=new ce,z=new ce;let O=null;const $=new $t(0);let j=0,Z=e.width,et=e.height,X=1,W=null,nt=null;const ct=new ce(0,0,Z,et),gt=new ce(0,0,Z,et);let Bt=!1;const Y=new Hu;let st=!1,ut=!1;const at=new ue,dt=new ue,Rt=new F,Et=new ce,Zt={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let qt=!1;function zt(){return C===null?X:1}let R=i;function Gt(M,U){return e.getContext(M,U)}try{const M={alpha:!0,depth:r,stencil:s,antialias:a,premultipliedAlpha:c,preserveDrawingBuffer:l,powerPreference:u,failIfMajorPerformanceCaveat:h};if("setAttribute"in e&&e.setAttribute("data-engine",`three.js r${Ja}`),e.addEventListener("webglcontextlost",St,!1),e.addEventListener("webglcontextrestored",ot,!1),e.addEventListener("webglcontextcreationerror",J,!1),R===null){const U="webgl2";if(R=Gt(U,M),R===null)throw Gt(U)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(M){throw console.error("THREE.WebGLRenderer: "+M.message),M}let It,Wt,Q,bt,H,K,vt,E,g,L,B,q,k,mt,ht,ft,xt,tt,yt,Dt,Ct,it,Ut,I;function _t(){It=new x_(R),It.init(),it=new e0(R,It),Wt=new f_(R,It,t,it),Q=new Qg(R,It),Wt.reverseDepthBuffer&&f&&Q.buffers.depth.setReversed(!0),bt=new S_(R),H=new kg,K=new t0(R,It,Q,H,Wt,it,bt),vt=new p_(S),E=new v_(S),g=new Rd(R),Ut=new u_(R,g),L=new M_(R,g,bt,Ut),B=new T_(R,L,g,bt),yt=new E_(R,Wt,K),ft=new d_(H),q=new zg(S,vt,E,It,Wt,Ut,ft),k=new a0(S,H),mt=new Vg,ht=new $g(It),tt=new c_(S,vt,E,Q,B,p,c),xt=new jg(S,B,Wt),I=new l0(R,bt,Wt,Q),Dt=new h_(R,It,bt),Ct=new y_(R,It,bt),bt.programs=q.programs,S.capabilities=Wt,S.extensions=It,S.properties=H,S.renderLists=mt,S.shadowMap=xt,S.state=Q,S.info=bt}_t();const rt=new s0(S,R);this.xr=rt,this.getContext=function(){return R},this.getContextAttributes=function(){return R.getContextAttributes()},this.forceContextLoss=function(){const M=It.get("WEBGL_lose_context");M&&M.loseContext()},this.forceContextRestore=function(){const M=It.get("WEBGL_lose_context");M&&M.restoreContext()},this.getPixelRatio=function(){return X},this.setPixelRatio=function(M){M!==void 0&&(X=M,this.setSize(Z,et,!1))},this.getSize=function(M){return M.set(Z,et)},this.setSize=function(M,U,V=!0){if(rt.isPresenting){console.warn("THREE.WebGLRenderer: Can't change size while VR device is presenting.");return}Z=M,et=U,e.width=Math.floor(M*X),e.height=Math.floor(U*X),V===!0&&(e.style.width=M+"px",e.style.height=U+"px"),this.setViewport(0,0,M,U)},this.getDrawingBufferSize=function(M){return M.set(Z*X,et*X).floor()},this.setDrawingBufferSize=function(M,U,V){Z=M,et=U,X=V,e.width=Math.floor(M*V),e.height=Math.floor(U*V),this.setViewport(0,0,M,U)},this.getCurrentViewport=function(M){return M.copy(b)},this.getViewport=function(M){return M.copy(ct)},this.setViewport=function(M,U,V,G){M.isVector4?ct.set(M.x,M.y,M.z,M.w):ct.set(M,U,V,G),Q.viewport(b.copy(ct).multiplyScalar(X).round())},this.getScissor=function(M){return M.copy(gt)},this.setScissor=function(M,U,V,G){M.isVector4?gt.set(M.x,M.y,M.z,M.w):gt.set(M,U,V,G),Q.scissor(z.copy(gt).multiplyScalar(X).round())},this.getScissorTest=function(){return Bt},this.setScissorTest=function(M){Q.setScissorTest(Bt=M)},this.setOpaqueSort=function(M){W=M},this.setTransparentSort=function(M){nt=M},this.getClearColor=function(M){return M.copy(tt.getClearColor())},this.setClearColor=function(){tt.setClearColor(...arguments)},this.getClearAlpha=function(){return tt.getClearAlpha()},this.setClearAlpha=function(){tt.setClearAlpha(...arguments)},this.clear=function(M=!0,U=!0,V=!0){let G=0;if(M){let N=!1;if(C!==null){const lt=C.texture.format;N=lt===sl||lt===rl||lt===il}if(N){const lt=C.texture.type,Mt=lt===En||lt===ii||lt===Tr||lt===wr||lt===el||lt===nl,At=tt.getClearColor(),Tt=tt.getClearAlpha(),Nt=At.r,Ot=At.g,Pt=At.b;Mt?(_[0]=Nt,_[1]=Ot,_[2]=Pt,_[3]=Tt,R.clearBufferuiv(R.COLOR,0,_)):(v[0]=Nt,v[1]=Ot,v[2]=Pt,v[3]=Tt,R.clearBufferiv(R.COLOR,0,v))}else G|=R.COLOR_BUFFER_BIT}U&&(G|=R.DEPTH_BUFFER_BIT),V&&(G|=R.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),R.clear(G)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){e.removeEventListener("webglcontextlost",St,!1),e.removeEventListener("webglcontextrestored",ot,!1),e.removeEventListener("webglcontextcreationerror",J,!1),tt.dispose(),mt.dispose(),ht.dispose(),H.dispose(),vt.dispose(),E.dispose(),B.dispose(),Ut.dispose(),I.dispose(),q.dispose(),rt.dispose(),rt.removeEventListener("sessionstart",Bn),rt.removeEventListener("sessionend",nr),nn.stop()};function St(M){M.preventDefault(),console.log("THREE.WebGLRenderer: Context Lost."),D=!0}function ot(){console.log("THREE.WebGLRenderer: Context Restored."),D=!1;const M=bt.autoReset,U=xt.enabled,V=xt.autoUpdate,G=xt.needsUpdate,N=xt.type;_t(),bt.autoReset=M,xt.enabled=U,xt.autoUpdate=V,xt.needsUpdate=G,xt.type=N}function J(M){console.error("THREE.WebGLRenderer: A WebGL context could not be created. Reason: ",M.statusMessage)}function wt(M){const U=M.target;U.removeEventListener("dispose",wt),Ft(U)}function Ft(M){ne(M),H.remove(M)}function ne(M){const U=H.get(M).programs;U!==void 0&&(U.forEach(function(V){q.releaseProgram(V)}),M.isShaderMaterial&&q.releaseShaderCache(M))}this.renderBufferDirect=function(M,U,V,G,N,lt){U===null&&(U=Zt);const Mt=N.isMesh&&N.matrixWorld.determinant()<0,At=Gh(M,U,V,G,N);Q.setMaterial(G,Mt);let Tt=V.index,Nt=1;if(G.wireframe===!0){if(Tt=L.getWireframeAttribute(V),Tt===void 0)return;Nt=2}const Ot=V.drawRange,Pt=V.attributes.position;let Yt=Ot.start*Nt,Qt=(Ot.start+Ot.count)*Nt;lt!==null&&(Yt=Math.max(Yt,lt.start*Nt),Qt=Math.min(Qt,(lt.start+lt.count)*Nt)),Tt!==null?(Yt=Math.max(Yt,0),Qt=Math.min(Qt,Tt.count)):Pt!=null&&(Yt=Math.max(Yt,0),Qt=Math.min(Qt,Pt.count));const ae=Qt-Yt;if(ae<0||ae===1/0)return;Ut.setup(N,G,At,V,Tt);let re,ie=Dt;if(Tt!==null&&(re=g.get(Tt),ie=Ct,ie.setIndex(re)),N.isMesh)G.wireframe===!0?(Q.setLineWidth(G.wireframeLinewidth*zt()),ie.setMode(R.LINES)):ie.setMode(R.TRIANGLES);else if(N.isLine){let Lt=G.linewidth;Lt===void 0&&(Lt=1),Q.setLineWidth(Lt*zt()),N.isLineSegments?ie.setMode(R.LINES):N.isLineLoop?ie.setMode(R.LINE_LOOP):ie.setMode(R.LINE_STRIP)}else N.isPoints?ie.setMode(R.POINTS):N.isSprite&&ie.setMode(R.TRIANGLES);if(N.isBatchedMesh)if(N._multiDrawInstances!==null)Oi("THREE.WebGLRenderer: renderMultiDrawInstances has been deprecated and will be removed in r184. Append to renderMultiDraw arguments and use indirection."),ie.renderMultiDrawInstances(N._multiDrawStarts,N._multiDrawCounts,N._multiDrawCount,N._multiDrawInstances);else if(It.get("WEBGL_multi_draw"))ie.renderMultiDraw(N._multiDrawStarts,N._multiDrawCounts,N._multiDrawCount);else{const Lt=N._multiDrawStarts,oe=N._multiDrawCounts,Kt=N._multiDrawCount,Pe=Tt?g.get(Tt).bytesPerElement:1,di=H.get(G).currentProgram.getUniforms();for(let De=0;De<Kt;De++)di.setValue(R,"_gl_DrawID",De),ie.render(Lt[De]/Pe,oe[De])}else if(N.isInstancedMesh)ie.renderInstances(Yt,ae,N.count);else if(V.isInstancedBufferGeometry){const Lt=V._maxInstanceCount!==void 0?V._maxInstanceCount:1/0,oe=Math.min(V.instanceCount,Lt);ie.renderInstances(Yt,ae,oe)}else ie.render(Yt,ae)};function Jt(M,U,V){M.transparent===!0&&M.side===sn&&M.forceSinglePass===!1?(M.side=Ae,M.needsUpdate=!0,Br(M,U,V),M.side=Fn,M.needsUpdate=!0,Br(M,U,V),M.side=sn):Br(M,U,V)}this.compile=function(M,U,V=null){V===null&&(V=M),d=ht.get(V),d.init(U),w.push(d),V.traverseVisible(function(N){N.isLight&&N.layers.test(U.layers)&&(d.pushLight(N),N.castShadow&&d.pushShadow(N))}),M!==V&&M.traverseVisible(function(N){N.isLight&&N.layers.test(U.layers)&&(d.pushLight(N),N.castShadow&&d.pushShadow(N))}),d.setupLights();const G=new Set;return M.traverse(function(N){if(!(N.isMesh||N.isPoints||N.isLine||N.isSprite))return;const lt=N.material;if(lt)if(Array.isArray(lt))for(let Mt=0;Mt<lt.length;Mt++){const At=lt[Mt];Jt(At,V,N),G.add(At)}else Jt(lt,V,N),G.add(lt)}),d=w.pop(),G},this.compileAsync=function(M,U,V=null){const G=this.compile(M,U,V);return new Promise(N=>{function lt(){if(G.forEach(function(Mt){H.get(Mt).currentProgram.isReady()&&G.delete(Mt)}),G.size===0){N(M);return}setTimeout(lt,10)}It.get("KHR_parallel_shader_compile")!==null?lt():setTimeout(lt,10)})};let le=null;function Ce(M){le&&le(M)}function Bn(){nn.stop()}function nr(){nn.start()}const nn=new Wu;nn.setAnimationLoop(Ce),typeof self<"u"&&nn.setContext(self),this.setAnimationLoop=function(M){le=M,rt.setAnimationLoop(M),M===null?nn.stop():nn.start()},rt.addEventListener("sessionstart",Bn),rt.addEventListener("sessionend",nr),this.render=function(M,U){if(U!==void 0&&U.isCamera!==!0){console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(D===!0)return;if(M.matrixWorldAutoUpdate===!0&&M.updateMatrixWorld(),U.parent===null&&U.matrixWorldAutoUpdate===!0&&U.updateMatrixWorld(),rt.enabled===!0&&rt.isPresenting===!0&&(rt.cameraAutoUpdate===!0&&rt.updateCamera(U),U=rt.getCamera()),M.isScene===!0&&M.onBeforeRender(S,M,U,C),d=ht.get(M,w.length),d.init(U),w.push(d),dt.multiplyMatrices(U.projectionMatrix,U.matrixWorldInverse),Y.setFromProjectionMatrix(dt),ut=this.localClippingEnabled,st=ft.init(this.clippingPlanes,ut),m=mt.get(M,T.length),m.init(),T.push(m),rt.enabled===!0&&rt.isPresenting===!0){const lt=S.xr.getDepthSensingMesh();lt!==null&&_e(lt,U,-1/0,S.sortObjects)}_e(M,U,0,S.sortObjects),m.finish(),S.sortObjects===!0&&m.sort(W,nt),qt=rt.enabled===!1||rt.isPresenting===!1||rt.hasDepthSensing()===!1,qt&&tt.addToRenderList(m,M),this.info.render.frame++,st===!0&&ft.beginShadows();const V=d.state.shadowsArray;xt.render(V,M,U),st===!0&&ft.endShadows(),this.info.autoReset===!0&&this.info.reset();const G=m.opaque,N=m.transmissive;if(d.setupLights(),U.isArrayCamera){const lt=U.cameras;if(N.length>0)for(let Mt=0,At=lt.length;Mt<At;Mt++){const Tt=lt[Mt];fi(G,N,M,Tt)}qt&&tt.render(M);for(let Mt=0,At=lt.length;Mt<At;Mt++){const Tt=lt[Mt];hi(m,M,Tt,Tt.viewport)}}else N.length>0&&fi(G,N,M,U),qt&&tt.render(M),hi(m,M,U);C!==null&&A===0&&(K.updateMultisampleRenderTarget(C),K.updateRenderTargetMipmap(C)),M.isScene===!0&&M.onAfterRender(S,M,U),Ut.resetDefaultState(),y=-1,x=null,w.pop(),w.length>0?(d=w[w.length-1],st===!0&&ft.setGlobalState(S.clippingPlanes,d.state.camera)):d=null,T.pop(),T.length>0?m=T[T.length-1]:m=null};function _e(M,U,V,G){if(M.visible===!1)return;if(M.layers.test(U.layers)){if(M.isGroup)V=M.renderOrder;else if(M.isLOD)M.autoUpdate===!0&&M.update(U);else if(M.isLight)d.pushLight(M),M.castShadow&&d.pushShadow(M);else if(M.isSprite){if(!M.frustumCulled||Y.intersectsSprite(M)){G&&Et.setFromMatrixPosition(M.matrixWorld).applyMatrix4(dt);const Mt=B.update(M),At=M.material;At.visible&&m.push(M,Mt,At,V,Et.z,null)}}else if((M.isMesh||M.isLine||M.isPoints)&&(!M.frustumCulled||Y.intersectsObject(M))){const Mt=B.update(M),At=M.material;if(G&&(M.boundingSphere!==void 0?(M.boundingSphere===null&&M.computeBoundingSphere(),Et.copy(M.boundingSphere.center)):(Mt.boundingSphere===null&&Mt.computeBoundingSphere(),Et.copy(Mt.boundingSphere.center)),Et.applyMatrix4(M.matrixWorld).applyMatrix4(dt)),Array.isArray(At)){const Tt=Mt.groups;for(let Nt=0,Ot=Tt.length;Nt<Ot;Nt++){const Pt=Tt[Nt],Yt=At[Pt.materialIndex];Yt&&Yt.visible&&m.push(M,Mt,Yt,V,Et.z,Pt)}}else At.visible&&m.push(M,Mt,At,V,Et.z,null)}}const lt=M.children;for(let Mt=0,At=lt.length;Mt<At;Mt++)_e(lt[Mt],U,V,G)}function hi(M,U,V,G){const N=M.opaque,lt=M.transmissive,Mt=M.transparent;d.setupLightsView(V),st===!0&&ft.setGlobalState(S.clippingPlanes,V),G&&Q.viewport(b.copy(G)),N.length>0&&Or(N,U,V),lt.length>0&&Or(lt,U,V),Mt.length>0&&Or(Mt,U,V),Q.buffers.depth.setTest(!0),Q.buffers.depth.setMask(!0),Q.buffers.color.setMask(!0),Q.setPolygonOffset(!1)}function fi(M,U,V,G){if((V.isScene===!0?V.overrideMaterial:null)!==null)return;d.state.transmissionRenderTarget[G.id]===void 0&&(d.state.transmissionRenderTarget[G.id]=new si(1,1,{generateMipmaps:!0,type:It.has("EXT_color_buffer_half_float")||It.has("EXT_color_buffer_float")?Ir:En,minFilter:Jn,samples:4,stencilBuffer:s,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:jt.workingColorSpace}));const lt=d.state.transmissionRenderTarget[G.id],Mt=G.viewport||b;lt.setSize(Mt.z*S.transmissionResolutionScale,Mt.w*S.transmissionResolutionScale);const At=S.getRenderTarget(),Tt=S.getActiveCubeFace(),Nt=S.getActiveMipmapLevel();S.setRenderTarget(lt),S.getClearColor($),j=S.getClearAlpha(),j<1&&S.setClearColor(16777215,.5),S.clear(),qt&&tt.render(V);const Ot=S.toneMapping;S.toneMapping=Nn;const Pt=G.viewport;if(G.viewport!==void 0&&(G.viewport=void 0),d.setupLightsView(G),st===!0&&ft.setGlobalState(S.clippingPlanes,G),Or(M,V,G),K.updateMultisampleRenderTarget(lt),K.updateRenderTargetMipmap(lt),It.has("WEBGL_multisampled_render_to_texture")===!1){let Yt=!1;for(let Qt=0,ae=U.length;Qt<ae;Qt++){const re=U[Qt],ie=re.object,Lt=re.geometry,oe=re.material,Kt=re.group;if(oe.side===sn&&ie.layers.test(G.layers)){const Pe=oe.side;oe.side=Ae,oe.needsUpdate=!0,Tl(ie,V,G,Lt,oe,Kt),oe.side=Pe,oe.needsUpdate=!0,Yt=!0}}Yt===!0&&(K.updateMultisampleRenderTarget(lt),K.updateRenderTargetMipmap(lt))}S.setRenderTarget(At,Tt,Nt),S.setClearColor($,j),Pt!==void 0&&(G.viewport=Pt),S.toneMapping=Ot}function Or(M,U,V){const G=U.isScene===!0?U.overrideMaterial:null;for(let N=0,lt=M.length;N<lt;N++){const Mt=M[N],At=Mt.object,Tt=Mt.geometry,Nt=Mt.group;let Ot=Mt.material;Ot.allowOverride===!0&&G!==null&&(Ot=G),At.layers.test(V.layers)&&Tl(At,U,V,Tt,Ot,Nt)}}function Tl(M,U,V,G,N,lt){M.onBeforeRender(S,U,V,G,N,lt),M.modelViewMatrix.multiplyMatrices(V.matrixWorldInverse,M.matrixWorld),M.normalMatrix.getNormalMatrix(M.modelViewMatrix),N.onBeforeRender(S,U,V,G,M,lt),N.transparent===!0&&N.side===sn&&N.forceSinglePass===!1?(N.side=Ae,N.needsUpdate=!0,S.renderBufferDirect(V,U,G,N,M,lt),N.side=Fn,N.needsUpdate=!0,S.renderBufferDirect(V,U,G,N,M,lt),N.side=sn):S.renderBufferDirect(V,U,G,N,M,lt),M.onAfterRender(S,U,V,G,N,lt)}function Br(M,U,V){U.isScene!==!0&&(U=Zt);const G=H.get(M),N=d.state.lights,lt=d.state.shadowsArray,Mt=N.state.version,At=q.getParameters(M,N.state,lt,U,V),Tt=q.getProgramCacheKey(At);let Nt=G.programs;G.environment=M.isMeshStandardMaterial?U.environment:null,G.fog=U.fog,G.envMap=(M.isMeshStandardMaterial?E:vt).get(M.envMap||G.environment),G.envMapRotation=G.environment!==null&&M.envMap===null?U.environmentRotation:M.envMapRotation,Nt===void 0&&(M.addEventListener("dispose",wt),Nt=new Map,G.programs=Nt);let Ot=Nt.get(Tt);if(Ot!==void 0){if(G.currentProgram===Ot&&G.lightsStateVersion===Mt)return bl(M,At),Ot}else At.uniforms=q.getUniforms(M),M.onBeforeCompile(At,S),Ot=q.acquireProgram(At,Tt),Nt.set(Tt,Ot),G.uniforms=At.uniforms;const Pt=G.uniforms;return(!M.isShaderMaterial&&!M.isRawShaderMaterial||M.clipping===!0)&&(Pt.clippingPlanes=ft.uniform),bl(M,At),G.needsLights=Xh(M),G.lightsStateVersion=Mt,G.needsLights&&(Pt.ambientLightColor.value=N.state.ambient,Pt.lightProbe.value=N.state.probe,Pt.directionalLights.value=N.state.directional,Pt.directionalLightShadows.value=N.state.directionalShadow,Pt.spotLights.value=N.state.spot,Pt.spotLightShadows.value=N.state.spotShadow,Pt.rectAreaLights.value=N.state.rectArea,Pt.ltc_1.value=N.state.rectAreaLTC1,Pt.ltc_2.value=N.state.rectAreaLTC2,Pt.pointLights.value=N.state.point,Pt.pointLightShadows.value=N.state.pointShadow,Pt.hemisphereLights.value=N.state.hemi,Pt.directionalShadowMap.value=N.state.directionalShadowMap,Pt.directionalShadowMatrix.value=N.state.directionalShadowMatrix,Pt.spotShadowMap.value=N.state.spotShadowMap,Pt.spotLightMatrix.value=N.state.spotLightMatrix,Pt.spotLightMap.value=N.state.spotLightMap,Pt.pointShadowMap.value=N.state.pointShadowMap,Pt.pointShadowMatrix.value=N.state.pointShadowMatrix),G.currentProgram=Ot,G.uniformsList=null,Ot}function wl(M){if(M.uniformsList===null){const U=M.currentProgram.getUniforms();M.uniformsList=Ms.seqWithValue(U.seq,M.uniforms)}return M.uniformsList}function bl(M,U){const V=H.get(M);V.outputColorSpace=U.outputColorSpace,V.batching=U.batching,V.batchingColor=U.batchingColor,V.instancing=U.instancing,V.instancingColor=U.instancingColor,V.instancingMorph=U.instancingMorph,V.skinning=U.skinning,V.morphTargets=U.morphTargets,V.morphNormals=U.morphNormals,V.morphColors=U.morphColors,V.morphTargetsCount=U.morphTargetsCount,V.numClippingPlanes=U.numClippingPlanes,V.numIntersection=U.numClipIntersection,V.vertexAlphas=U.vertexAlphas,V.vertexTangents=U.vertexTangents,V.toneMapping=U.toneMapping}function Gh(M,U,V,G,N){U.isScene!==!0&&(U=Zt),K.resetTextureUnits();const lt=U.fog,Mt=G.isMeshStandardMaterial?U.environment:null,At=C===null?S.outputColorSpace:C.isXRRenderTarget===!0?C.texture.colorSpace:Xi,Tt=(G.isMeshStandardMaterial?E:vt).get(G.envMap||Mt),Nt=G.vertexColors===!0&&!!V.attributes.color&&V.attributes.color.itemSize===4,Ot=!!V.attributes.tangent&&(!!G.normalMap||G.anisotropy>0),Pt=!!V.morphAttributes.position,Yt=!!V.morphAttributes.normal,Qt=!!V.morphAttributes.color;let ae=Nn;G.toneMapped&&(C===null||C.isXRRenderTarget===!0)&&(ae=S.toneMapping);const re=V.morphAttributes.position||V.morphAttributes.normal||V.morphAttributes.color,ie=re!==void 0?re.length:0,Lt=H.get(G),oe=d.state.lights;if(st===!0&&(ut===!0||M!==x)){const Me=M===x&&G.id===y;ft.setState(G,M,Me)}let Kt=!1;G.version===Lt.__version?(Lt.needsLights&&Lt.lightsStateVersion!==oe.state.version||Lt.outputColorSpace!==At||N.isBatchedMesh&&Lt.batching===!1||!N.isBatchedMesh&&Lt.batching===!0||N.isBatchedMesh&&Lt.batchingColor===!0&&N.colorTexture===null||N.isBatchedMesh&&Lt.batchingColor===!1&&N.colorTexture!==null||N.isInstancedMesh&&Lt.instancing===!1||!N.isInstancedMesh&&Lt.instancing===!0||N.isSkinnedMesh&&Lt.skinning===!1||!N.isSkinnedMesh&&Lt.skinning===!0||N.isInstancedMesh&&Lt.instancingColor===!0&&N.instanceColor===null||N.isInstancedMesh&&Lt.instancingColor===!1&&N.instanceColor!==null||N.isInstancedMesh&&Lt.instancingMorph===!0&&N.morphTexture===null||N.isInstancedMesh&&Lt.instancingMorph===!1&&N.morphTexture!==null||Lt.envMap!==Tt||G.fog===!0&&Lt.fog!==lt||Lt.numClippingPlanes!==void 0&&(Lt.numClippingPlanes!==ft.numPlanes||Lt.numIntersection!==ft.numIntersection)||Lt.vertexAlphas!==Nt||Lt.vertexTangents!==Ot||Lt.morphTargets!==Pt||Lt.morphNormals!==Yt||Lt.morphColors!==Qt||Lt.toneMapping!==ae||Lt.morphTargetsCount!==ie)&&(Kt=!0):(Kt=!0,Lt.__version=G.version);let Pe=Lt.currentProgram;Kt===!0&&(Pe=Br(G,U,N));let di=!1,De=!1,ir=!1;const se=Pe.getUniforms(),Ne=Lt.uniforms;if(Q.useProgram(Pe.program)&&(di=!0,De=!0,ir=!0),G.id!==y&&(y=G.id,De=!0),di||x!==M){Q.buffers.depth.getReversed()?(at.copy(M.projectionMatrix),Gf(at),Wf(at),se.setValue(R,"projectionMatrix",at)):se.setValue(R,"projectionMatrix",M.projectionMatrix),se.setValue(R,"viewMatrix",M.matrixWorldInverse);const Se=se.map.cameraPosition;Se!==void 0&&Se.setValue(R,Rt.setFromMatrixPosition(M.matrixWorld)),Wt.logarithmicDepthBuffer&&se.setValue(R,"logDepthBufFC",2/(Math.log(M.far+1)/Math.LN2)),(G.isMeshPhongMaterial||G.isMeshToonMaterial||G.isMeshLambertMaterial||G.isMeshBasicMaterial||G.isMeshStandardMaterial||G.isShaderMaterial)&&se.setValue(R,"isOrthographic",M.isOrthographicCamera===!0),x!==M&&(x=M,De=!0,ir=!0)}if(N.isSkinnedMesh){se.setOptional(R,N,"bindMatrix"),se.setOptional(R,N,"bindMatrixInverse");const Me=N.skeleton;Me&&(Me.boneTexture===null&&Me.computeBoneTexture(),se.setValue(R,"boneTexture",Me.boneTexture,K))}N.isBatchedMesh&&(se.setOptional(R,N,"batchingTexture"),se.setValue(R,"batchingTexture",N._matricesTexture,K),se.setOptional(R,N,"batchingIdTexture"),se.setValue(R,"batchingIdTexture",N._indirectTexture,K),se.setOptional(R,N,"batchingColorTexture"),N._colorsTexture!==null&&se.setValue(R,"batchingColorTexture",N._colorsTexture,K));const Fe=V.morphAttributes;if((Fe.position!==void 0||Fe.normal!==void 0||Fe.color!==void 0)&&yt.update(N,V,Pe),(De||Lt.receiveShadow!==N.receiveShadow)&&(Lt.receiveShadow=N.receiveShadow,se.setValue(R,"receiveShadow",N.receiveShadow)),G.isMeshGouraudMaterial&&G.envMap!==null&&(Ne.envMap.value=Tt,Ne.flipEnvMap.value=Tt.isCubeTexture&&Tt.isRenderTargetTexture===!1?-1:1),G.isMeshStandardMaterial&&G.envMap===null&&U.environment!==null&&(Ne.envMapIntensity.value=U.environmentIntensity),De&&(se.setValue(R,"toneMappingExposure",S.toneMappingExposure),Lt.needsLights&&Wh(Ne,ir),lt&&G.fog===!0&&k.refreshFogUniforms(Ne,lt),k.refreshMaterialUniforms(Ne,G,X,et,d.state.transmissionRenderTarget[M.id]),Ms.upload(R,wl(Lt),Ne,K)),G.isShaderMaterial&&G.uniformsNeedUpdate===!0&&(Ms.upload(R,wl(Lt),Ne,K),G.uniformsNeedUpdate=!1),G.isSpriteMaterial&&se.setValue(R,"center",N.center),se.setValue(R,"modelViewMatrix",N.modelViewMatrix),se.setValue(R,"normalMatrix",N.normalMatrix),se.setValue(R,"modelMatrix",N.matrixWorld),G.isShaderMaterial||G.isRawShaderMaterial){const Me=G.uniformsGroups;for(let Se=0,no=Me.length;Se<no;Se++){const zn=Me[Se];I.update(zn,Pe),I.bind(zn,Pe)}}return Pe}function Wh(M,U){M.ambientLightColor.needsUpdate=U,M.lightProbe.needsUpdate=U,M.directionalLights.needsUpdate=U,M.directionalLightShadows.needsUpdate=U,M.pointLights.needsUpdate=U,M.pointLightShadows.needsUpdate=U,M.spotLights.needsUpdate=U,M.spotLightShadows.needsUpdate=U,M.rectAreaLights.needsUpdate=U,M.hemisphereLights.needsUpdate=U}function Xh(M){return M.isMeshLambertMaterial||M.isMeshToonMaterial||M.isMeshPhongMaterial||M.isMeshStandardMaterial||M.isShadowMaterial||M.isShaderMaterial&&M.lights===!0}this.getActiveCubeFace=function(){return P},this.getActiveMipmapLevel=function(){return A},this.getRenderTarget=function(){return C},this.setRenderTargetTextures=function(M,U,V){const G=H.get(M);G.__autoAllocateDepthBuffer=M.resolveDepthBuffer===!1,G.__autoAllocateDepthBuffer===!1&&(G.__useRenderToTexture=!1),H.get(M.texture).__webglTexture=U,H.get(M.depthTexture).__webglTexture=G.__autoAllocateDepthBuffer?void 0:V,G.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(M,U){const V=H.get(M);V.__webglFramebuffer=U,V.__useDefaultFramebuffer=U===void 0};const qh=R.createFramebuffer();this.setRenderTarget=function(M,U=0,V=0){C=M,P=U,A=V;let G=!0,N=null,lt=!1,Mt=!1;if(M){const Tt=H.get(M);if(Tt.__useDefaultFramebuffer!==void 0)Q.bindFramebuffer(R.FRAMEBUFFER,null),G=!1;else if(Tt.__webglFramebuffer===void 0)K.setupRenderTarget(M);else if(Tt.__hasExternalTextures)K.rebindTextures(M,H.get(M.texture).__webglTexture,H.get(M.depthTexture).__webglTexture);else if(M.depthBuffer){const Pt=M.depthTexture;if(Tt.__boundDepthTexture!==Pt){if(Pt!==null&&H.has(Pt)&&(M.width!==Pt.image.width||M.height!==Pt.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");K.setupDepthRenderbuffer(M)}}const Nt=M.texture;(Nt.isData3DTexture||Nt.isDataArrayTexture||Nt.isCompressedArrayTexture)&&(Mt=!0);const Ot=H.get(M).__webglFramebuffer;M.isWebGLCubeRenderTarget?(Array.isArray(Ot[U])?N=Ot[U][V]:N=Ot[U],lt=!0):M.samples>0&&K.useMultisampledRTT(M)===!1?N=H.get(M).__webglMultisampledFramebuffer:Array.isArray(Ot)?N=Ot[V]:N=Ot,b.copy(M.viewport),z.copy(M.scissor),O=M.scissorTest}else b.copy(ct).multiplyScalar(X).floor(),z.copy(gt).multiplyScalar(X).floor(),O=Bt;if(V!==0&&(N=qh),Q.bindFramebuffer(R.FRAMEBUFFER,N)&&G&&Q.drawBuffers(M,N),Q.viewport(b),Q.scissor(z),Q.setScissorTest(O),lt){const Tt=H.get(M.texture);R.framebufferTexture2D(R.FRAMEBUFFER,R.COLOR_ATTACHMENT0,R.TEXTURE_CUBE_MAP_POSITIVE_X+U,Tt.__webglTexture,V)}else if(Mt){const Tt=H.get(M.texture),Nt=U;R.framebufferTextureLayer(R.FRAMEBUFFER,R.COLOR_ATTACHMENT0,Tt.__webglTexture,V,Nt)}else if(M!==null&&V!==0){const Tt=H.get(M.texture);R.framebufferTexture2D(R.FRAMEBUFFER,R.COLOR_ATTACHMENT0,R.TEXTURE_2D,Tt.__webglTexture,V)}y=-1},this.readRenderTargetPixels=function(M,U,V,G,N,lt,Mt,At=0){if(!(M&&M.isWebGLRenderTarget)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let Tt=H.get(M).__webglFramebuffer;if(M.isWebGLCubeRenderTarget&&Mt!==void 0&&(Tt=Tt[Mt]),Tt){Q.bindFramebuffer(R.FRAMEBUFFER,Tt);try{const Nt=M.textures[At],Ot=Nt.format,Pt=Nt.type;if(!Wt.textureFormatReadable(Ot)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!Wt.textureTypeReadable(Pt)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}U>=0&&U<=M.width-G&&V>=0&&V<=M.height-N&&(M.textures.length>1&&R.readBuffer(R.COLOR_ATTACHMENT0+At),R.readPixels(U,V,G,N,it.convert(Ot),it.convert(Pt),lt))}finally{const Nt=C!==null?H.get(C).__webglFramebuffer:null;Q.bindFramebuffer(R.FRAMEBUFFER,Nt)}}},this.readRenderTargetPixelsAsync=async function(M,U,V,G,N,lt,Mt,At=0){if(!(M&&M.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let Tt=H.get(M).__webglFramebuffer;if(M.isWebGLCubeRenderTarget&&Mt!==void 0&&(Tt=Tt[Mt]),Tt)if(U>=0&&U<=M.width-G&&V>=0&&V<=M.height-N){Q.bindFramebuffer(R.FRAMEBUFFER,Tt);const Nt=M.textures[At],Ot=Nt.format,Pt=Nt.type;if(!Wt.textureFormatReadable(Ot))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!Wt.textureTypeReadable(Pt))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");const Yt=R.createBuffer();R.bindBuffer(R.PIXEL_PACK_BUFFER,Yt),R.bufferData(R.PIXEL_PACK_BUFFER,lt.byteLength,R.STREAM_READ),M.textures.length>1&&R.readBuffer(R.COLOR_ATTACHMENT0+At),R.readPixels(U,V,G,N,it.convert(Ot),it.convert(Pt),0);const Qt=C!==null?H.get(C).__webglFramebuffer:null;Q.bindFramebuffer(R.FRAMEBUFFER,Qt);const ae=R.fenceSync(R.SYNC_GPU_COMMANDS_COMPLETE,0);return R.flush(),await Vf(R,ae,4),R.bindBuffer(R.PIXEL_PACK_BUFFER,Yt),R.getBufferSubData(R.PIXEL_PACK_BUFFER,0,lt),R.deleteBuffer(Yt),R.deleteSync(ae),lt}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(M,U=null,V=0){const G=Math.pow(2,-V),N=Math.floor(M.image.width*G),lt=Math.floor(M.image.height*G),Mt=U!==null?U.x:0,At=U!==null?U.y:0;K.setTexture2D(M,0),R.copyTexSubImage2D(R.TEXTURE_2D,V,0,0,Mt,At,N,lt),Q.unbindTexture()};const Yh=R.createFramebuffer(),$h=R.createFramebuffer();this.copyTextureToTexture=function(M,U,V=null,G=null,N=0,lt=null){lt===null&&(N!==0?(Oi("WebGLRenderer: copyTextureToTexture function signature has changed to support src and dst mipmap levels."),lt=N,N=0):lt=0);let Mt,At,Tt,Nt,Ot,Pt,Yt,Qt,ae;const re=M.isCompressedTexture?M.mipmaps[lt]:M.image;if(V!==null)Mt=V.max.x-V.min.x,At=V.max.y-V.min.y,Tt=V.isBox3?V.max.z-V.min.z:1,Nt=V.min.x,Ot=V.min.y,Pt=V.isBox3?V.min.z:0;else{const Fe=Math.pow(2,-N);Mt=Math.floor(re.width*Fe),At=Math.floor(re.height*Fe),M.isDataArrayTexture?Tt=re.depth:M.isData3DTexture?Tt=Math.floor(re.depth*Fe):Tt=1,Nt=0,Ot=0,Pt=0}G!==null?(Yt=G.x,Qt=G.y,ae=G.z):(Yt=0,Qt=0,ae=0);const ie=it.convert(U.format),Lt=it.convert(U.type);let oe;U.isData3DTexture?(K.setTexture3D(U,0),oe=R.TEXTURE_3D):U.isDataArrayTexture||U.isCompressedArrayTexture?(K.setTexture2DArray(U,0),oe=R.TEXTURE_2D_ARRAY):(K.setTexture2D(U,0),oe=R.TEXTURE_2D),R.pixelStorei(R.UNPACK_FLIP_Y_WEBGL,U.flipY),R.pixelStorei(R.UNPACK_PREMULTIPLY_ALPHA_WEBGL,U.premultiplyAlpha),R.pixelStorei(R.UNPACK_ALIGNMENT,U.unpackAlignment);const Kt=R.getParameter(R.UNPACK_ROW_LENGTH),Pe=R.getParameter(R.UNPACK_IMAGE_HEIGHT),di=R.getParameter(R.UNPACK_SKIP_PIXELS),De=R.getParameter(R.UNPACK_SKIP_ROWS),ir=R.getParameter(R.UNPACK_SKIP_IMAGES);R.pixelStorei(R.UNPACK_ROW_LENGTH,re.width),R.pixelStorei(R.UNPACK_IMAGE_HEIGHT,re.height),R.pixelStorei(R.UNPACK_SKIP_PIXELS,Nt),R.pixelStorei(R.UNPACK_SKIP_ROWS,Ot),R.pixelStorei(R.UNPACK_SKIP_IMAGES,Pt);const se=M.isDataArrayTexture||M.isData3DTexture,Ne=U.isDataArrayTexture||U.isData3DTexture;if(M.isDepthTexture){const Fe=H.get(M),Me=H.get(U),Se=H.get(Fe.__renderTarget),no=H.get(Me.__renderTarget);Q.bindFramebuffer(R.READ_FRAMEBUFFER,Se.__webglFramebuffer),Q.bindFramebuffer(R.DRAW_FRAMEBUFFER,no.__webglFramebuffer);for(let zn=0;zn<Tt;zn++)se&&(R.framebufferTextureLayer(R.READ_FRAMEBUFFER,R.COLOR_ATTACHMENT0,H.get(M).__webglTexture,N,Pt+zn),R.framebufferTextureLayer(R.DRAW_FRAMEBUFFER,R.COLOR_ATTACHMENT0,H.get(U).__webglTexture,lt,ae+zn)),R.blitFramebuffer(Nt,Ot,Mt,At,Yt,Qt,Mt,At,R.DEPTH_BUFFER_BIT,R.NEAREST);Q.bindFramebuffer(R.READ_FRAMEBUFFER,null),Q.bindFramebuffer(R.DRAW_FRAMEBUFFER,null)}else if(N!==0||M.isRenderTargetTexture||H.has(M)){const Fe=H.get(M),Me=H.get(U);Q.bindFramebuffer(R.READ_FRAMEBUFFER,Yh),Q.bindFramebuffer(R.DRAW_FRAMEBUFFER,$h);for(let Se=0;Se<Tt;Se++)se?R.framebufferTextureLayer(R.READ_FRAMEBUFFER,R.COLOR_ATTACHMENT0,Fe.__webglTexture,N,Pt+Se):R.framebufferTexture2D(R.READ_FRAMEBUFFER,R.COLOR_ATTACHMENT0,R.TEXTURE_2D,Fe.__webglTexture,N),Ne?R.framebufferTextureLayer(R.DRAW_FRAMEBUFFER,R.COLOR_ATTACHMENT0,Me.__webglTexture,lt,ae+Se):R.framebufferTexture2D(R.DRAW_FRAMEBUFFER,R.COLOR_ATTACHMENT0,R.TEXTURE_2D,Me.__webglTexture,lt),N!==0?R.blitFramebuffer(Nt,Ot,Mt,At,Yt,Qt,Mt,At,R.COLOR_BUFFER_BIT,R.NEAREST):Ne?R.copyTexSubImage3D(oe,lt,Yt,Qt,ae+Se,Nt,Ot,Mt,At):R.copyTexSubImage2D(oe,lt,Yt,Qt,Nt,Ot,Mt,At);Q.bindFramebuffer(R.READ_FRAMEBUFFER,null),Q.bindFramebuffer(R.DRAW_FRAMEBUFFER,null)}else Ne?M.isDataTexture||M.isData3DTexture?R.texSubImage3D(oe,lt,Yt,Qt,ae,Mt,At,Tt,ie,Lt,re.data):U.isCompressedArrayTexture?R.compressedTexSubImage3D(oe,lt,Yt,Qt,ae,Mt,At,Tt,ie,re.data):R.texSubImage3D(oe,lt,Yt,Qt,ae,Mt,At,Tt,ie,Lt,re):M.isDataTexture?R.texSubImage2D(R.TEXTURE_2D,lt,Yt,Qt,Mt,At,ie,Lt,re.data):M.isCompressedTexture?R.compressedTexSubImage2D(R.TEXTURE_2D,lt,Yt,Qt,re.width,re.height,ie,re.data):R.texSubImage2D(R.TEXTURE_2D,lt,Yt,Qt,Mt,At,ie,Lt,re);R.pixelStorei(R.UNPACK_ROW_LENGTH,Kt),R.pixelStorei(R.UNPACK_IMAGE_HEIGHT,Pe),R.pixelStorei(R.UNPACK_SKIP_PIXELS,di),R.pixelStorei(R.UNPACK_SKIP_ROWS,De),R.pixelStorei(R.UNPACK_SKIP_IMAGES,ir),lt===0&&U.generateMipmaps&&R.generateMipmap(oe),Q.unbindTexture()},this.copyTextureToTexture3D=function(M,U,V=null,G=null,N=0){return Oi('WebGLRenderer: copyTextureToTexture3D function has been deprecated. Use "copyTextureToTexture" instead.'),this.copyTextureToTexture(M,U,V,G,N)},this.initRenderTarget=function(M){H.get(M).__webglFramebuffer===void 0&&K.setupRenderTarget(M)},this.initTexture=function(M){M.isCubeTexture?K.setTextureCube(M,0):M.isData3DTexture?K.setTexture3D(M,0):M.isDataArrayTexture||M.isCompressedArrayTexture?K.setTexture2DArray(M,0):K.setTexture2D(M,0),Q.unbindTexture()},this.resetState=function(){P=0,A=0,C=null,Q.reset(),Ut.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return yn}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(t){this._outputColorSpace=t;const e=this.getContext();e.drawingBufferColorSpace=jt._getDrawingBufferColorSpace(t),e.unpackColorSpace=jt._getUnpackColorSpace()}}const Ac={type:"change"},fl={type:"start"},Zu={type:"end"},ls=new ll,Rc=new Dn,u0=Math.cos(70*kf.DEG2RAD),fe=new F,Te=2*Math.PI,ee={NONE:-1,ROTATE:0,DOLLY:1,PAN:2,TOUCH_ROTATE:3,TOUCH_PAN:4,TOUCH_DOLLY_PAN:5,TOUCH_DOLLY_ROTATE:6},Fo=1e-6;class h0 extends bd{constructor(t,e=null){super(t,e),this.state=ee.NONE,this.target=new F,this.cursor=new F,this.minDistance=0,this.maxDistance=1/0,this.minZoom=0,this.maxZoom=1/0,this.minTargetRadius=0,this.maxTargetRadius=1/0,this.minPolarAngle=0,this.maxPolarAngle=Math.PI,this.minAzimuthAngle=-1/0,this.maxAzimuthAngle=1/0,this.enableDamping=!1,this.dampingFactor=.05,this.enableZoom=!0,this.zoomSpeed=1,this.enableRotate=!0,this.rotateSpeed=1,this.keyRotateSpeed=1,this.enablePan=!0,this.panSpeed=1,this.screenSpacePanning=!0,this.keyPanSpeed=7,this.zoomToCursor=!1,this.autoRotate=!1,this.autoRotateSpeed=2,this.keys={LEFT:"ArrowLeft",UP:"ArrowUp",RIGHT:"ArrowRight",BOTTOM:"ArrowDown"},this.mouseButtons={LEFT:Ni.ROTATE,MIDDLE:Ni.DOLLY,RIGHT:Ni.PAN},this.touches={ONE:Di.ROTATE,TWO:Di.DOLLY_PAN},this.target0=this.target.clone(),this.position0=this.object.position.clone(),this.zoom0=this.object.zoom,this._domElementKeyEvents=null,this._lastPosition=new F,this._lastQuaternion=new ri,this._lastTargetPosition=new F,this._quat=new ri().setFromUnitVectors(t.up,new F(0,1,0)),this._quatInverse=this._quat.clone().invert(),this._spherical=new ec,this._sphericalDelta=new ec,this._scale=1,this._panOffset=new F,this._rotateStart=new kt,this._rotateEnd=new kt,this._rotateDelta=new kt,this._panStart=new kt,this._panEnd=new kt,this._panDelta=new kt,this._dollyStart=new kt,this._dollyEnd=new kt,this._dollyDelta=new kt,this._dollyDirection=new F,this._mouse=new kt,this._performCursorZoom=!1,this._pointers=[],this._pointerPositions={},this._controlActive=!1,this._onPointerMove=d0.bind(this),this._onPointerDown=f0.bind(this),this._onPointerUp=p0.bind(this),this._onContextMenu=y0.bind(this),this._onMouseWheel=g0.bind(this),this._onKeyDown=v0.bind(this),this._onTouchStart=x0.bind(this),this._onTouchMove=M0.bind(this),this._onMouseDown=m0.bind(this),this._onMouseMove=_0.bind(this),this._interceptControlDown=S0.bind(this),this._interceptControlUp=E0.bind(this),this.domElement!==null&&this.connect(this.domElement),this.update()}connect(t){super.connect(t),this.domElement.addEventListener("pointerdown",this._onPointerDown),this.domElement.addEventListener("pointercancel",this._onPointerUp),this.domElement.addEventListener("contextmenu",this._onContextMenu),this.domElement.addEventListener("wheel",this._onMouseWheel,{passive:!1}),this.domElement.getRootNode().addEventListener("keydown",this._interceptControlDown,{passive:!0,capture:!0}),this.domElement.style.touchAction="none"}disconnect(){this.domElement.removeEventListener("pointerdown",this._onPointerDown),this.domElement.removeEventListener("pointermove",this._onPointerMove),this.domElement.removeEventListener("pointerup",this._onPointerUp),this.domElement.removeEventListener("pointercancel",this._onPointerUp),this.domElement.removeEventListener("wheel",this._onMouseWheel),this.domElement.removeEventListener("contextmenu",this._onContextMenu),this.stopListenToKeyEvents(),this.domElement.getRootNode().removeEventListener("keydown",this._interceptControlDown,{capture:!0}),this.domElement.style.touchAction="auto"}dispose(){this.disconnect()}getPolarAngle(){return this._spherical.phi}getAzimuthalAngle(){return this._spherical.theta}getDistance(){return this.object.position.distanceTo(this.target)}listenToKeyEvents(t){t.addEventListener("keydown",this._onKeyDown),this._domElementKeyEvents=t}stopListenToKeyEvents(){this._domElementKeyEvents!==null&&(this._domElementKeyEvents.removeEventListener("keydown",this._onKeyDown),this._domElementKeyEvents=null)}saveState(){this.target0.copy(this.target),this.position0.copy(this.object.position),this.zoom0=this.object.zoom}reset(){this.target.copy(this.target0),this.object.position.copy(this.position0),this.object.zoom=this.zoom0,this.object.updateProjectionMatrix(),this.dispatchEvent(Ac),this.update(),this.state=ee.NONE}update(t=null){const e=this.object.position;fe.copy(e).sub(this.target),fe.applyQuaternion(this._quat),this._spherical.setFromVector3(fe),this.autoRotate&&this.state===ee.NONE&&this._rotateLeft(this._getAutoRotationAngle(t)),this.enableDamping?(this._spherical.theta+=this._sphericalDelta.theta*this.dampingFactor,this._spherical.phi+=this._sphericalDelta.phi*this.dampingFactor):(this._spherical.theta+=this._sphericalDelta.theta,this._spherical.phi+=this._sphericalDelta.phi);let i=this.minAzimuthAngle,r=this.maxAzimuthAngle;isFinite(i)&&isFinite(r)&&(i<-Math.PI?i+=Te:i>Math.PI&&(i-=Te),r<-Math.PI?r+=Te:r>Math.PI&&(r-=Te),i<=r?this._spherical.theta=Math.max(i,Math.min(r,this._spherical.theta)):this._spherical.theta=this._spherical.theta>(i+r)/2?Math.max(i,this._spherical.theta):Math.min(r,this._spherical.theta)),this._spherical.phi=Math.max(this.minPolarAngle,Math.min(this.maxPolarAngle,this._spherical.phi)),this._spherical.makeSafe(),this.enableDamping===!0?this.target.addScaledVector(this._panOffset,this.dampingFactor):this.target.add(this._panOffset),this.target.sub(this.cursor),this.target.clampLength(this.minTargetRadius,this.maxTargetRadius),this.target.add(this.cursor);let s=!1;if(this.zoomToCursor&&this._performCursorZoom||this.object.isOrthographicCamera)this._spherical.radius=this._clampDistance(this._spherical.radius);else{const o=this._spherical.radius;this._spherical.radius=this._clampDistance(this._spherical.radius*this._scale),s=o!=this._spherical.radius}if(fe.setFromSpherical(this._spherical),fe.applyQuaternion(this._quatInverse),e.copy(this.target).add(fe),this.object.lookAt(this.target),this.enableDamping===!0?(this._sphericalDelta.theta*=1-this.dampingFactor,this._sphericalDelta.phi*=1-this.dampingFactor,this._panOffset.multiplyScalar(1-this.dampingFactor)):(this._sphericalDelta.set(0,0,0),this._panOffset.set(0,0,0)),this.zoomToCursor&&this._performCursorZoom){let o=null;if(this.object.isPerspectiveCamera){const a=fe.length();o=this._clampDistance(a*this._scale);const c=a-o;this.object.position.addScaledVector(this._dollyDirection,c),this.object.updateMatrixWorld(),s=!!c}else if(this.object.isOrthographicCamera){const a=new F(this._mouse.x,this._mouse.y,0);a.unproject(this.object);const c=this.object.zoom;this.object.zoom=Math.max(this.minZoom,Math.min(this.maxZoom,this.object.zoom/this._scale)),this.object.updateProjectionMatrix(),s=c!==this.object.zoom;const l=new F(this._mouse.x,this._mouse.y,0);l.unproject(this.object),this.object.position.sub(l).add(a),this.object.updateMatrixWorld(),o=fe.length()}else console.warn("WARNING: OrbitControls.js encountered an unknown camera type - zoom to cursor disabled."),this.zoomToCursor=!1;o!==null&&(this.screenSpacePanning?this.target.set(0,0,-1).transformDirection(this.object.matrix).multiplyScalar(o).add(this.object.position):(ls.origin.copy(this.object.position),ls.direction.set(0,0,-1).transformDirection(this.object.matrix),Math.abs(this.object.up.dot(ls.direction))<u0?this.object.lookAt(this.target):(Rc.setFromNormalAndCoplanarPoint(this.object.up,this.target),ls.intersectPlane(Rc,this.target))))}else if(this.object.isOrthographicCamera){const o=this.object.zoom;this.object.zoom=Math.max(this.minZoom,Math.min(this.maxZoom,this.object.zoom/this._scale)),o!==this.object.zoom&&(this.object.updateProjectionMatrix(),s=!0)}return this._scale=1,this._performCursorZoom=!1,s||this._lastPosition.distanceToSquared(this.object.position)>Fo||8*(1-this._lastQuaternion.dot(this.object.quaternion))>Fo||this._lastTargetPosition.distanceToSquared(this.target)>Fo?(this.dispatchEvent(Ac),this._lastPosition.copy(this.object.position),this._lastQuaternion.copy(this.object.quaternion),this._lastTargetPosition.copy(this.target),!0):!1}_getAutoRotationAngle(t){return t!==null?Te/60*this.autoRotateSpeed*t:Te/60/60*this.autoRotateSpeed}_getZoomScale(t){const e=Math.abs(t*.01);return Math.pow(.95,this.zoomSpeed*e)}_rotateLeft(t){this._sphericalDelta.theta-=t}_rotateUp(t){this._sphericalDelta.phi-=t}_panLeft(t,e){fe.setFromMatrixColumn(e,0),fe.multiplyScalar(-t),this._panOffset.add(fe)}_panUp(t,e){this.screenSpacePanning===!0?fe.setFromMatrixColumn(e,1):(fe.setFromMatrixColumn(e,0),fe.crossVectors(this.object.up,fe)),fe.multiplyScalar(t),this._panOffset.add(fe)}_pan(t,e){const i=this.domElement;if(this.object.isPerspectiveCamera){const r=this.object.position;fe.copy(r).sub(this.target);let s=fe.length();s*=Math.tan(this.object.fov/2*Math.PI/180),this._panLeft(2*t*s/i.clientHeight,this.object.matrix),this._panUp(2*e*s/i.clientHeight,this.object.matrix)}else this.object.isOrthographicCamera?(this._panLeft(t*(this.object.right-this.object.left)/this.object.zoom/i.clientWidth,this.object.matrix),this._panUp(e*(this.object.top-this.object.bottom)/this.object.zoom/i.clientHeight,this.object.matrix)):(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - pan disabled."),this.enablePan=!1)}_dollyOut(t){this.object.isPerspectiveCamera||this.object.isOrthographicCamera?this._scale/=t:(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled."),this.enableZoom=!1)}_dollyIn(t){this.object.isPerspectiveCamera||this.object.isOrthographicCamera?this._scale*=t:(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled."),this.enableZoom=!1)}_updateZoomParameters(t,e){if(!this.zoomToCursor)return;this._performCursorZoom=!0;const i=this.domElement.getBoundingClientRect(),r=t-i.left,s=e-i.top,o=i.width,a=i.height;this._mouse.x=r/o*2-1,this._mouse.y=-(s/a)*2+1,this._dollyDirection.set(this._mouse.x,this._mouse.y,1).unproject(this.object).sub(this.object.position).normalize()}_clampDistance(t){return Math.max(this.minDistance,Math.min(this.maxDistance,t))}_handleMouseDownRotate(t){this._rotateStart.set(t.clientX,t.clientY)}_handleMouseDownDolly(t){this._updateZoomParameters(t.clientX,t.clientX),this._dollyStart.set(t.clientX,t.clientY)}_handleMouseDownPan(t){this._panStart.set(t.clientX,t.clientY)}_handleMouseMoveRotate(t){this._rotateEnd.set(t.clientX,t.clientY),this._rotateDelta.subVectors(this._rotateEnd,this._rotateStart).multiplyScalar(this.rotateSpeed);const e=this.domElement;this._rotateLeft(Te*this._rotateDelta.x/e.clientHeight),this._rotateUp(Te*this._rotateDelta.y/e.clientHeight),this._rotateStart.copy(this._rotateEnd),this.update()}_handleMouseMoveDolly(t){this._dollyEnd.set(t.clientX,t.clientY),this._dollyDelta.subVectors(this._dollyEnd,this._dollyStart),this._dollyDelta.y>0?this._dollyOut(this._getZoomScale(this._dollyDelta.y)):this._dollyDelta.y<0&&this._dollyIn(this._getZoomScale(this._dollyDelta.y)),this._dollyStart.copy(this._dollyEnd),this.update()}_handleMouseMovePan(t){this._panEnd.set(t.clientX,t.clientY),this._panDelta.subVectors(this._panEnd,this._panStart).multiplyScalar(this.panSpeed),this._pan(this._panDelta.x,this._panDelta.y),this._panStart.copy(this._panEnd),this.update()}_handleMouseWheel(t){this._updateZoomParameters(t.clientX,t.clientY),t.deltaY<0?this._dollyIn(this._getZoomScale(t.deltaY)):t.deltaY>0&&this._dollyOut(this._getZoomScale(t.deltaY)),this.update()}_handleKeyDown(t){let e=!1;switch(t.code){case this.keys.UP:t.ctrlKey||t.metaKey||t.shiftKey?this.enableRotate&&this._rotateUp(Te*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(0,this.keyPanSpeed),e=!0;break;case this.keys.BOTTOM:t.ctrlKey||t.metaKey||t.shiftKey?this.enableRotate&&this._rotateUp(-Te*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(0,-this.keyPanSpeed),e=!0;break;case this.keys.LEFT:t.ctrlKey||t.metaKey||t.shiftKey?this.enableRotate&&this._rotateLeft(Te*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(this.keyPanSpeed,0),e=!0;break;case this.keys.RIGHT:t.ctrlKey||t.metaKey||t.shiftKey?this.enableRotate&&this._rotateLeft(-Te*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(-this.keyPanSpeed,0),e=!0;break}e&&(t.preventDefault(),this.update())}_handleTouchStartRotate(t){if(this._pointers.length===1)this._rotateStart.set(t.pageX,t.pageY);else{const e=this._getSecondPointerPosition(t),i=.5*(t.pageX+e.x),r=.5*(t.pageY+e.y);this._rotateStart.set(i,r)}}_handleTouchStartPan(t){if(this._pointers.length===1)this._panStart.set(t.pageX,t.pageY);else{const e=this._getSecondPointerPosition(t),i=.5*(t.pageX+e.x),r=.5*(t.pageY+e.y);this._panStart.set(i,r)}}_handleTouchStartDolly(t){const e=this._getSecondPointerPosition(t),i=t.pageX-e.x,r=t.pageY-e.y,s=Math.sqrt(i*i+r*r);this._dollyStart.set(0,s)}_handleTouchStartDollyPan(t){this.enableZoom&&this._handleTouchStartDolly(t),this.enablePan&&this._handleTouchStartPan(t)}_handleTouchStartDollyRotate(t){this.enableZoom&&this._handleTouchStartDolly(t),this.enableRotate&&this._handleTouchStartRotate(t)}_handleTouchMoveRotate(t){if(this._pointers.length==1)this._rotateEnd.set(t.pageX,t.pageY);else{const i=this._getSecondPointerPosition(t),r=.5*(t.pageX+i.x),s=.5*(t.pageY+i.y);this._rotateEnd.set(r,s)}this._rotateDelta.subVectors(this._rotateEnd,this._rotateStart).multiplyScalar(this.rotateSpeed);const e=this.domElement;this._rotateLeft(Te*this._rotateDelta.x/e.clientHeight),this._rotateUp(Te*this._rotateDelta.y/e.clientHeight),this._rotateStart.copy(this._rotateEnd)}_handleTouchMovePan(t){if(this._pointers.length===1)this._panEnd.set(t.pageX,t.pageY);else{const e=this._getSecondPointerPosition(t),i=.5*(t.pageX+e.x),r=.5*(t.pageY+e.y);this._panEnd.set(i,r)}this._panDelta.subVectors(this._panEnd,this._panStart).multiplyScalar(this.panSpeed),this._pan(this._panDelta.x,this._panDelta.y),this._panStart.copy(this._panEnd)}_handleTouchMoveDolly(t){const e=this._getSecondPointerPosition(t),i=t.pageX-e.x,r=t.pageY-e.y,s=Math.sqrt(i*i+r*r);this._dollyEnd.set(0,s),this._dollyDelta.set(0,Math.pow(this._dollyEnd.y/this._dollyStart.y,this.zoomSpeed)),this._dollyOut(this._dollyDelta.y),this._dollyStart.copy(this._dollyEnd);const o=(t.pageX+e.x)*.5,a=(t.pageY+e.y)*.5;this._updateZoomParameters(o,a)}_handleTouchMoveDollyPan(t){this.enableZoom&&this._handleTouchMoveDolly(t),this.enablePan&&this._handleTouchMovePan(t)}_handleTouchMoveDollyRotate(t){this.enableZoom&&this._handleTouchMoveDolly(t),this.enableRotate&&this._handleTouchMoveRotate(t)}_addPointer(t){this._pointers.push(t.pointerId)}_removePointer(t){delete this._pointerPositions[t.pointerId];for(let e=0;e<this._pointers.length;e++)if(this._pointers[e]==t.pointerId){this._pointers.splice(e,1);return}}_isTrackingPointer(t){for(let e=0;e<this._pointers.length;e++)if(this._pointers[e]==t.pointerId)return!0;return!1}_trackPointer(t){let e=this._pointerPositions[t.pointerId];e===void 0&&(e=new kt,this._pointerPositions[t.pointerId]=e),e.set(t.pageX,t.pageY)}_getSecondPointerPosition(t){const e=t.pointerId===this._pointers[0]?this._pointers[1]:this._pointers[0];return this._pointerPositions[e]}_customWheelEvent(t){const e=t.deltaMode,i={clientX:t.clientX,clientY:t.clientY,deltaY:t.deltaY};switch(e){case 1:i.deltaY*=16;break;case 2:i.deltaY*=100;break}return t.ctrlKey&&!this._controlActive&&(i.deltaY*=10),i}}function f0(n){this.enabled!==!1&&(this._pointers.length===0&&(this.domElement.setPointerCapture(n.pointerId),this.domElement.addEventListener("pointermove",this._onPointerMove),this.domElement.addEventListener("pointerup",this._onPointerUp)),!this._isTrackingPointer(n)&&(this._addPointer(n),n.pointerType==="touch"?this._onTouchStart(n):this._onMouseDown(n)))}function d0(n){this.enabled!==!1&&(n.pointerType==="touch"?this._onTouchMove(n):this._onMouseMove(n))}function p0(n){switch(this._removePointer(n),this._pointers.length){case 0:this.domElement.releasePointerCapture(n.pointerId),this.domElement.removeEventListener("pointermove",this._onPointerMove),this.domElement.removeEventListener("pointerup",this._onPointerUp),this.dispatchEvent(Zu),this.state=ee.NONE;break;case 1:const t=this._pointers[0],e=this._pointerPositions[t];this._onTouchStart({pointerId:t,pageX:e.x,pageY:e.y});break}}function m0(n){let t;switch(n.button){case 0:t=this.mouseButtons.LEFT;break;case 1:t=this.mouseButtons.MIDDLE;break;case 2:t=this.mouseButtons.RIGHT;break;default:t=-1}switch(t){case Ni.DOLLY:if(this.enableZoom===!1)return;this._handleMouseDownDolly(n),this.state=ee.DOLLY;break;case Ni.ROTATE:if(n.ctrlKey||n.metaKey||n.shiftKey){if(this.enablePan===!1)return;this._handleMouseDownPan(n),this.state=ee.PAN}else{if(this.enableRotate===!1)return;this._handleMouseDownRotate(n),this.state=ee.ROTATE}break;case Ni.PAN:if(n.ctrlKey||n.metaKey||n.shiftKey){if(this.enableRotate===!1)return;this._handleMouseDownRotate(n),this.state=ee.ROTATE}else{if(this.enablePan===!1)return;this._handleMouseDownPan(n),this.state=ee.PAN}break;default:this.state=ee.NONE}this.state!==ee.NONE&&this.dispatchEvent(fl)}function _0(n){switch(this.state){case ee.ROTATE:if(this.enableRotate===!1)return;this._handleMouseMoveRotate(n);break;case ee.DOLLY:if(this.enableZoom===!1)return;this._handleMouseMoveDolly(n);break;case ee.PAN:if(this.enablePan===!1)return;this._handleMouseMovePan(n);break}}function g0(n){this.enabled===!1||this.enableZoom===!1||this.state!==ee.NONE||(n.preventDefault(),this.dispatchEvent(fl),this._handleMouseWheel(this._customWheelEvent(n)),this.dispatchEvent(Zu))}function v0(n){this.enabled!==!1&&this._handleKeyDown(n)}function x0(n){switch(this._trackPointer(n),this._pointers.length){case 1:switch(this.touches.ONE){case Di.ROTATE:if(this.enableRotate===!1)return;this._handleTouchStartRotate(n),this.state=ee.TOUCH_ROTATE;break;case Di.PAN:if(this.enablePan===!1)return;this._handleTouchStartPan(n),this.state=ee.TOUCH_PAN;break;default:this.state=ee.NONE}break;case 2:switch(this.touches.TWO){case Di.DOLLY_PAN:if(this.enableZoom===!1&&this.enablePan===!1)return;this._handleTouchStartDollyPan(n),this.state=ee.TOUCH_DOLLY_PAN;break;case Di.DOLLY_ROTATE:if(this.enableZoom===!1&&this.enableRotate===!1)return;this._handleTouchStartDollyRotate(n),this.state=ee.TOUCH_DOLLY_ROTATE;break;default:this.state=ee.NONE}break;default:this.state=ee.NONE}this.state!==ee.NONE&&this.dispatchEvent(fl)}function M0(n){switch(this._trackPointer(n),this.state){case ee.TOUCH_ROTATE:if(this.enableRotate===!1)return;this._handleTouchMoveRotate(n),this.update();break;case ee.TOUCH_PAN:if(this.enablePan===!1)return;this._handleTouchMovePan(n),this.update();break;case ee.TOUCH_DOLLY_PAN:if(this.enableZoom===!1&&this.enablePan===!1)return;this._handleTouchMoveDollyPan(n),this.update();break;case ee.TOUCH_DOLLY_ROTATE:if(this.enableZoom===!1&&this.enableRotate===!1)return;this._handleTouchMoveDollyRotate(n),this.update();break;default:this.state=ee.NONE}}function y0(n){this.enabled!==!1&&n.preventDefault()}function S0(n){n.key==="Control"&&(this._controlActive=!0,this.domElement.getRootNode().addEventListener("keyup",this._interceptControlUp,{passive:!0,capture:!0}))}function E0(n){n.key==="Control"&&(this._controlActive=!1,this.domElement.getRootNode().removeEventListener("keyup",this._interceptControlUp,{passive:!0,capture:!0}))}function ys(n,t){return n==null||t==null?NaN:n<t?-1:n>t?1:n>=t?0:NaN}function T0(n,t){return n==null||t==null?NaN:t<n?-1:t>n?1:t>=n?0:NaN}function Ku(n){let t,e,i;n.length!==2?(t=ys,e=(a,c)=>ys(n(a),c),i=(a,c)=>n(a)-c):(t=n===ys||n===T0?n:w0,e=n,i=n);function r(a,c,l=0,u=a.length){if(l<u){if(t(c,c)!==0)return u;do{const h=l+u>>>1;e(a[h],c)<0?l=h+1:u=h}while(l<u)}return l}function s(a,c,l=0,u=a.length){if(l<u){if(t(c,c)!==0)return u;do{const h=l+u>>>1;e(a[h],c)<=0?l=h+1:u=h}while(l<u)}return l}function o(a,c,l=0,u=a.length){const h=r(a,c,l,u-1);return h>l&&i(a[h-1],c)>-i(a[h],c)?h-1:h}return{left:r,center:o,right:s}}function w0(){return 0}function b0(n){return n===null?NaN:+n}const A0=Ku(ys),R0=A0.right;Ku(b0).center;const C0=P0(D0);function P0(n){return function(t,e,i=e){if(!((e=+e)>=0))throw new RangeError("invalid rx");if(!((i=+i)>=0))throw new RangeError("invalid ry");let{data:r,width:s,height:o}=t;if(!((s=Math.floor(s))>=0))throw new RangeError("invalid width");if(!((o=Math.floor(o!==void 0?o:r.length/s))>=0))throw new RangeError("invalid height");if(!s||!o||!e&&!i)return t;const a=e&&n(e),c=i&&n(i),l=r.slice();return a&&c?(Ri(a,l,r,s,o),Ri(a,r,l,s,o),Ri(a,l,r,s,o),Ci(c,r,l,s,o),Ci(c,l,r,s,o),Ci(c,r,l,s,o)):a?(Ri(a,r,l,s,o),Ri(a,l,r,s,o),Ri(a,r,l,s,o)):c&&(Ci(c,r,l,s,o),Ci(c,l,r,s,o),Ci(c,r,l,s,o)),t}}function Ri(n,t,e,i,r){for(let s=0,o=i*r;s<o;)n(t,e,s,s+=i,1)}function Ci(n,t,e,i,r){for(let s=0,o=i*r;s<i;++s)n(t,e,s,s+o,i)}function D0(n){const t=Math.floor(n);if(t===n)return L0(n);const e=n-t,i=2*n+1;return(r,s,o,a,c)=>{if(!((a-=c)>=o))return;let l=t*s[o];const u=c*t,h=u+c;for(let f=o,p=o+u;f<p;f+=c)l+=s[Math.min(a,f)];for(let f=o,p=a;f<=p;f+=c)l+=s[Math.min(a,f+u)],r[f]=(l+e*(s[Math.max(o,f-h)]+s[Math.min(a,f+h)]))/i,l-=s[Math.max(o,f-u)]}}function L0(n){const t=2*n+1;return(e,i,r,s,o)=>{if(!((s-=o)>=r))return;let a=n*i[r];const c=o*n;for(let l=r,u=r+c;l<u;l+=o)a+=i[Math.min(s,l)];for(let l=r,u=s;l<=u;l+=o)a+=i[Math.min(s,l+c)],e[l]=a/t,a-=i[Math.max(r,l-c)]}}function I0(n,t){let e=0;for(let i of n)i!=null&&(i=+i)>=i&&++e;return e}function U0(n,t){let e,i;if(t===void 0)for(const r of n)r!=null&&(e===void 0?r>=r&&(e=i=r):(e>r&&(e=r),i<r&&(i=r)));else{let r=-1;for(let s of n)(s=t(s,++r,n))!=null&&(e===void 0?s>=s&&(e=i=s):(e>s&&(e=s),i<s&&(i=s)))}return[e,i]}class Yi{constructor(){this._partials=new Float64Array(32),this._n=0}add(t){const e=this._partials;let i=0;for(let r=0;r<this._n&&r<32;r++){const s=e[r],o=t+s,a=Math.abs(t)<Math.abs(s)?t-(o-s):s-(o-t);a&&(e[i++]=a),t=o}return e[i]=t,this._n=i+1,this}valueOf(){const t=this._partials;let e=this._n,i,r,s,o=0;if(e>0){for(o=t[--e];e>0&&(i=o,r=t[--e],o=i+r,s=r-(o-i),!s););e>0&&(s<0&&t[e-1]<0||s>0&&t[e-1]>0)&&(r=s*2,i=o+r,r==i-o&&(o=i))}return o}}class N0 extends Map{constructor(t,e=B0){if(super(),Object.defineProperties(this,{_intern:{value:new Map},_key:{value:e}}),t!=null)for(const[i,r]of t)this.set(i,r)}get(t){return super.get(Cc(this,t))}has(t){return super.has(Cc(this,t))}set(t,e){return super.set(F0(this,t),e)}delete(t){return super.delete(O0(this,t))}}function Cc({_intern:n,_key:t},e){const i=t(e);return n.has(i)?n.get(i):e}function F0({_intern:n,_key:t},e){const i=t(e);return n.has(i)?n.get(i):(n.set(i,e),e)}function O0({_intern:n,_key:t},e){const i=t(e);return n.has(i)&&(e=n.get(i),n.delete(i)),e}function B0(n){return n!==null&&typeof n=="object"?n.valueOf():n}function Pc(n){return n}function Dc(n,...t){return z0(n,Pc,Pc,t)}function z0(n,t,e,i){return function r(s,o){if(o>=i.length)return e(s);const a=new N0,c=i[o++];let l=-1;for(const u of s){const h=c(u,++l,s),f=a.get(h);f?f.push(u):a.set(h,[u])}for(const[u,h]of a)a.set(u,r(h,o));return t(a)}(n,0)}const k0=Math.sqrt(50),H0=Math.sqrt(10),V0=Math.sqrt(2);function Ls(n,t,e){const i=(t-n)/Math.max(0,e),r=Math.floor(Math.log10(i)),s=i/Math.pow(10,r),o=s>=k0?10:s>=H0?5:s>=V0?2:1;let a,c,l;return r<0?(l=Math.pow(10,-r)/o,a=Math.round(n*l),c=Math.round(t*l),a/l<n&&++a,c/l>t&&--c,l=-l):(l=Math.pow(10,r)*o,a=Math.round(n/l),c=Math.round(t/l),a*l<n&&++a,c*l>t&&--c),c<a&&.5<=e&&e<2?Ls(n,t,e*2):[a,c,l]}function dl(n,t,e){if(t=+t,n=+n,e=+e,!(e>0))return[];if(n===t)return[n];const i=t<n,[r,s,o]=i?Ls(t,n,e):Ls(n,t,e);if(!(s>=r))return[];const a=s-r+1,c=new Array(a);if(i)if(o<0)for(let l=0;l<a;++l)c[l]=(s-l)/-o;else for(let l=0;l<a;++l)c[l]=(s-l)*o;else if(o<0)for(let l=0;l<a;++l)c[l]=(r+l)/-o;else for(let l=0;l<a;++l)c[l]=(r+l)*o;return c}function Is(n,t,e){return t=+t,n=+n,e=+e,Ls(n,t,e)[2]}function G0(n,t,e){t=+t,n=+n,e=+e;const i=t<n,r=i?Is(t,n,e):Is(n,t,e);return(i?-1:1)*(r<0?1/-r:r)}function W0(n,t,e){let i;for(;;){const r=Is(n,t,e);if(r===i||r===0||!isFinite(r))return[n,t];r>0?(n=Math.floor(n/r)*r,t=Math.ceil(t/r)*r):r<0&&(n=Math.ceil(n*r)/r,t=Math.floor(t*r)/r),i=r}}function X0(n){return Math.max(1,Math.ceil(Math.log(I0(n))/Math.LN2)+1)}function ei(n,t){let e;if(t===void 0)for(const i of n)i!=null&&(e<i||e===void 0&&i>=i)&&(e=i);else{let i=-1;for(let r of n)(r=t(r,++i,n))!=null&&(e<r||e===void 0&&r>=r)&&(e=r)}return e}function Lc(n,t){let e;for(const i of n)i!=null&&(e>i||e===void 0&&i>=i)&&(e=i);return e}function Ic(n,t){let e=0,i=0;if(t===void 0)for(let r of n)r!=null&&(r=+r)>=r&&(++e,i+=r);else{let r=-1;for(let s of n)(s=t(s,++r,n))!=null&&(s=+s)>=s&&(++e,i+=s)}if(e)return i/e}var q0={value:()=>{}};function ju(){for(var n=0,t=arguments.length,e={},i;n<t;++n){if(!(i=arguments[n]+"")||i in e||/[\s.]/.test(i))throw new Error("illegal type: "+i);e[i]=[]}return new Ss(e)}function Ss(n){this._=n}function Y0(n,t){return n.trim().split(/^|\s+/).map(function(e){var i="",r=e.indexOf(".");if(r>=0&&(i=e.slice(r+1),e=e.slice(0,r)),e&&!t.hasOwnProperty(e))throw new Error("unknown type: "+e);return{type:e,name:i}})}Ss.prototype=ju.prototype={constructor:Ss,on:function(n,t){var e=this._,i=Y0(n+"",e),r,s=-1,o=i.length;if(arguments.length<2){for(;++s<o;)if((r=(n=i[s]).type)&&(r=$0(e[r],n.name)))return r;return}if(t!=null&&typeof t!="function")throw new Error("invalid callback: "+t);for(;++s<o;)if(r=(n=i[s]).type)e[r]=Uc(e[r],n.name,t);else if(t==null)for(r in e)e[r]=Uc(e[r],n.name,null);return this},copy:function(){var n={},t=this._;for(var e in t)n[e]=t[e].slice();return new Ss(n)},call:function(n,t){if((r=arguments.length-2)>0)for(var e=new Array(r),i=0,r,s;i<r;++i)e[i]=arguments[i+2];if(!this._.hasOwnProperty(n))throw new Error("unknown type: "+n);for(s=this._[n],i=0,r=s.length;i<r;++i)s[i].value.apply(t,e)},apply:function(n,t,e){if(!this._.hasOwnProperty(n))throw new Error("unknown type: "+n);for(var i=this._[n],r=0,s=i.length;r<s;++r)i[r].value.apply(t,e)}};function $0(n,t){for(var e=0,i=n.length,r;e<i;++e)if((r=n[e]).name===t)return r.value}function Uc(n,t,e){for(var i=0,r=n.length;i<r;++i)if(n[i].name===t){n[i]=q0,n=n.slice(0,i).concat(n.slice(i+1));break}return e!=null&&n.push({name:t,value:e}),n}var Ua="http://www.w3.org/1999/xhtml";const Nc={svg:"http://www.w3.org/2000/svg",xhtml:Ua,xlink:"http://www.w3.org/1999/xlink",xml:"http://www.w3.org/XML/1998/namespace",xmlns:"http://www.w3.org/2000/xmlns/"};function Qs(n){var t=n+="",e=t.indexOf(":");return e>=0&&(t=n.slice(0,e))!=="xmlns"&&(n=n.slice(e+1)),Nc.hasOwnProperty(t)?{space:Nc[t],local:n}:n}function Z0(n){return function(){var t=this.ownerDocument,e=this.namespaceURI;return e===Ua&&t.documentElement.namespaceURI===Ua?t.createElement(n):t.createElementNS(e,n)}}function K0(n){return function(){return this.ownerDocument.createElementNS(n.space,n.local)}}function Ju(n){var t=Qs(n);return(t.local?K0:Z0)(t)}function j0(){}function pl(n){return n==null?j0:function(){return this.querySelector(n)}}function J0(n){typeof n!="function"&&(n=pl(n));for(var t=this._groups,e=t.length,i=new Array(e),r=0;r<e;++r)for(var s=t[r],o=s.length,a=i[r]=new Array(o),c,l,u=0;u<o;++u)(c=s[u])&&(l=n.call(c,c.__data__,u,s))&&("__data__"in c&&(l.__data__=c.__data__),a[u]=l);return new Ue(i,this._parents)}function Q0(n){return n==null?[]:Array.isArray(n)?n:Array.from(n)}function tv(){return[]}function Qu(n){return n==null?tv:function(){return this.querySelectorAll(n)}}function ev(n){return function(){return Q0(n.apply(this,arguments))}}function nv(n){typeof n=="function"?n=ev(n):n=Qu(n);for(var t=this._groups,e=t.length,i=[],r=[],s=0;s<e;++s)for(var o=t[s],a=o.length,c,l=0;l<a;++l)(c=o[l])&&(i.push(n.call(c,c.__data__,l,o)),r.push(c));return new Ue(i,r)}function th(n){return function(){return this.matches(n)}}function eh(n){return function(t){return t.matches(n)}}var iv=Array.prototype.find;function rv(n){return function(){return iv.call(this.children,n)}}function sv(){return this.firstElementChild}function ov(n){return this.select(n==null?sv:rv(typeof n=="function"?n:eh(n)))}var av=Array.prototype.filter;function lv(){return Array.from(this.children)}function cv(n){return function(){return av.call(this.children,n)}}function uv(n){return this.selectAll(n==null?lv:cv(typeof n=="function"?n:eh(n)))}function hv(n){typeof n!="function"&&(n=th(n));for(var t=this._groups,e=t.length,i=new Array(e),r=0;r<e;++r)for(var s=t[r],o=s.length,a=i[r]=[],c,l=0;l<o;++l)(c=s[l])&&n.call(c,c.__data__,l,s)&&a.push(c);return new Ue(i,this._parents)}function nh(n){return new Array(n.length)}function fv(){return new Ue(this._enter||this._groups.map(nh),this._parents)}function Us(n,t){this.ownerDocument=n.ownerDocument,this.namespaceURI=n.namespaceURI,this._next=null,this._parent=n,this.__data__=t}Us.prototype={constructor:Us,appendChild:function(n){return this._parent.insertBefore(n,this._next)},insertBefore:function(n,t){return this._parent.insertBefore(n,t)},querySelector:function(n){return this._parent.querySelector(n)},querySelectorAll:function(n){return this._parent.querySelectorAll(n)}};function dv(n){return function(){return n}}function pv(n,t,e,i,r,s){for(var o=0,a,c=t.length,l=s.length;o<l;++o)(a=t[o])?(a.__data__=s[o],i[o]=a):e[o]=new Us(n,s[o]);for(;o<c;++o)(a=t[o])&&(r[o]=a)}function mv(n,t,e,i,r,s,o){var a,c,l=new Map,u=t.length,h=s.length,f=new Array(u),p;for(a=0;a<u;++a)(c=t[a])&&(f[a]=p=o.call(c,c.__data__,a,t)+"",l.has(p)?r[a]=c:l.set(p,c));for(a=0;a<h;++a)p=o.call(n,s[a],a,s)+"",(c=l.get(p))?(i[a]=c,c.__data__=s[a],l.delete(p)):e[a]=new Us(n,s[a]);for(a=0;a<u;++a)(c=t[a])&&l.get(f[a])===c&&(r[a]=c)}function _v(n){return n.__data__}function gv(n,t){if(!arguments.length)return Array.from(this,_v);var e=t?mv:pv,i=this._parents,r=this._groups;typeof n!="function"&&(n=dv(n));for(var s=r.length,o=new Array(s),a=new Array(s),c=new Array(s),l=0;l<s;++l){var u=i[l],h=r[l],f=h.length,p=vv(n.call(u,u&&u.__data__,l,i)),_=p.length,v=a[l]=new Array(_),m=o[l]=new Array(_),d=c[l]=new Array(f);e(u,h,v,m,d,p,t);for(var T=0,w=0,S,D;T<_;++T)if(S=v[T]){for(T>=w&&(w=T+1);!(D=m[w])&&++w<_;);S._next=D||null}}return o=new Ue(o,i),o._enter=a,o._exit=c,o}function vv(n){return typeof n=="object"&&"length"in n?n:Array.from(n)}function xv(){return new Ue(this._exit||this._groups.map(nh),this._parents)}function Mv(n,t,e){var i=this.enter(),r=this,s=this.exit();return typeof n=="function"?(i=n(i),i&&(i=i.selection())):i=i.append(n+""),t!=null&&(r=t(r),r&&(r=r.selection())),e==null?s.remove():e(s),i&&r?i.merge(r).order():r}function yv(n){for(var t=n.selection?n.selection():n,e=this._groups,i=t._groups,r=e.length,s=i.length,o=Math.min(r,s),a=new Array(r),c=0;c<o;++c)for(var l=e[c],u=i[c],h=l.length,f=a[c]=new Array(h),p,_=0;_<h;++_)(p=l[_]||u[_])&&(f[_]=p);for(;c<r;++c)a[c]=e[c];return new Ue(a,this._parents)}function Sv(){for(var n=this._groups,t=-1,e=n.length;++t<e;)for(var i=n[t],r=i.length-1,s=i[r],o;--r>=0;)(o=i[r])&&(s&&o.compareDocumentPosition(s)^4&&s.parentNode.insertBefore(o,s),s=o);return this}function Ev(n){n||(n=Tv);function t(h,f){return h&&f?n(h.__data__,f.__data__):!h-!f}for(var e=this._groups,i=e.length,r=new Array(i),s=0;s<i;++s){for(var o=e[s],a=o.length,c=r[s]=new Array(a),l,u=0;u<a;++u)(l=o[u])&&(c[u]=l);c.sort(t)}return new Ue(r,this._parents).order()}function Tv(n,t){return n<t?-1:n>t?1:n>=t?0:NaN}function wv(){var n=arguments[0];return arguments[0]=this,n.apply(null,arguments),this}function bv(){return Array.from(this)}function Av(){for(var n=this._groups,t=0,e=n.length;t<e;++t)for(var i=n[t],r=0,s=i.length;r<s;++r){var o=i[r];if(o)return o}return null}function Rv(){let n=0;for(const t of this)++n;return n}function Cv(){return!this.node()}function Pv(n){for(var t=this._groups,e=0,i=t.length;e<i;++e)for(var r=t[e],s=0,o=r.length,a;s<o;++s)(a=r[s])&&n.call(a,a.__data__,s,r);return this}function Dv(n){return function(){this.removeAttribute(n)}}function Lv(n){return function(){this.removeAttributeNS(n.space,n.local)}}function Iv(n,t){return function(){this.setAttribute(n,t)}}function Uv(n,t){return function(){this.setAttributeNS(n.space,n.local,t)}}function Nv(n,t){return function(){var e=t.apply(this,arguments);e==null?this.removeAttribute(n):this.setAttribute(n,e)}}function Fv(n,t){return function(){var e=t.apply(this,arguments);e==null?this.removeAttributeNS(n.space,n.local):this.setAttributeNS(n.space,n.local,e)}}function Ov(n,t){var e=Qs(n);if(arguments.length<2){var i=this.node();return e.local?i.getAttributeNS(e.space,e.local):i.getAttribute(e)}return this.each((t==null?e.local?Lv:Dv:typeof t=="function"?e.local?Fv:Nv:e.local?Uv:Iv)(e,t))}function ih(n){return n.ownerDocument&&n.ownerDocument.defaultView||n.document&&n||n.defaultView}function Bv(n){return function(){this.style.removeProperty(n)}}function zv(n,t,e){return function(){this.style.setProperty(n,t,e)}}function kv(n,t,e){return function(){var i=t.apply(this,arguments);i==null?this.style.removeProperty(n):this.style.setProperty(n,i,e)}}function Hv(n,t,e){return arguments.length>1?this.each((t==null?Bv:typeof t=="function"?kv:zv)(n,t,e??"")):$i(this.node(),n)}function $i(n,t){return n.style.getPropertyValue(t)||ih(n).getComputedStyle(n,null).getPropertyValue(t)}function Vv(n){return function(){delete this[n]}}function Gv(n,t){return function(){this[n]=t}}function Wv(n,t){return function(){var e=t.apply(this,arguments);e==null?delete this[n]:this[n]=e}}function Xv(n,t){return arguments.length>1?this.each((t==null?Vv:typeof t=="function"?Wv:Gv)(n,t)):this.node()[n]}function rh(n){return n.trim().split(/^|\s+/)}function ml(n){return n.classList||new sh(n)}function sh(n){this._node=n,this._names=rh(n.getAttribute("class")||"")}sh.prototype={add:function(n){var t=this._names.indexOf(n);t<0&&(this._names.push(n),this._node.setAttribute("class",this._names.join(" ")))},remove:function(n){var t=this._names.indexOf(n);t>=0&&(this._names.splice(t,1),this._node.setAttribute("class",this._names.join(" ")))},contains:function(n){return this._names.indexOf(n)>=0}};function oh(n,t){for(var e=ml(n),i=-1,r=t.length;++i<r;)e.add(t[i])}function ah(n,t){for(var e=ml(n),i=-1,r=t.length;++i<r;)e.remove(t[i])}function qv(n){return function(){oh(this,n)}}function Yv(n){return function(){ah(this,n)}}function $v(n,t){return function(){(t.apply(this,arguments)?oh:ah)(this,n)}}function Zv(n,t){var e=rh(n+"");if(arguments.length<2){for(var i=ml(this.node()),r=-1,s=e.length;++r<s;)if(!i.contains(e[r]))return!1;return!0}return this.each((typeof t=="function"?$v:t?qv:Yv)(e,t))}function Kv(){this.textContent=""}function jv(n){return function(){this.textContent=n}}function Jv(n){return function(){var t=n.apply(this,arguments);this.textContent=t??""}}function Qv(n){return arguments.length?this.each(n==null?Kv:(typeof n=="function"?Jv:jv)(n)):this.node().textContent}function tx(){this.innerHTML=""}function ex(n){return function(){this.innerHTML=n}}function nx(n){return function(){var t=n.apply(this,arguments);this.innerHTML=t??""}}function ix(n){return arguments.length?this.each(n==null?tx:(typeof n=="function"?nx:ex)(n)):this.node().innerHTML}function rx(){this.nextSibling&&this.parentNode.appendChild(this)}function sx(){return this.each(rx)}function ox(){this.previousSibling&&this.parentNode.insertBefore(this,this.parentNode.firstChild)}function ax(){return this.each(ox)}function lx(n){var t=typeof n=="function"?n:Ju(n);return this.select(function(){return this.appendChild(t.apply(this,arguments))})}function cx(){return null}function ux(n,t){var e=typeof n=="function"?n:Ju(n),i=t==null?cx:typeof t=="function"?t:pl(t);return this.select(function(){return this.insertBefore(e.apply(this,arguments),i.apply(this,arguments)||null)})}function hx(){var n=this.parentNode;n&&n.removeChild(this)}function fx(){return this.each(hx)}function dx(){var n=this.cloneNode(!1),t=this.parentNode;return t?t.insertBefore(n,this.nextSibling):n}function px(){var n=this.cloneNode(!0),t=this.parentNode;return t?t.insertBefore(n,this.nextSibling):n}function mx(n){return this.select(n?px:dx)}function _x(n){return arguments.length?this.property("__data__",n):this.node().__data__}function gx(n){return function(t){n.call(this,t,this.__data__)}}function vx(n){return n.trim().split(/^|\s+/).map(function(t){var e="",i=t.indexOf(".");return i>=0&&(e=t.slice(i+1),t=t.slice(0,i)),{type:t,name:e}})}function xx(n){return function(){var t=this.__on;if(t){for(var e=0,i=-1,r=t.length,s;e<r;++e)s=t[e],(!n.type||s.type===n.type)&&s.name===n.name?this.removeEventListener(s.type,s.listener,s.options):t[++i]=s;++i?t.length=i:delete this.__on}}}function Mx(n,t,e){return function(){var i=this.__on,r,s=gx(t);if(i){for(var o=0,a=i.length;o<a;++o)if((r=i[o]).type===n.type&&r.name===n.name){this.removeEventListener(r.type,r.listener,r.options),this.addEventListener(r.type,r.listener=s,r.options=e),r.value=t;return}}this.addEventListener(n.type,s,e),r={type:n.type,name:n.name,value:t,listener:s,options:e},i?i.push(r):this.__on=[r]}}function yx(n,t,e){var i=vx(n+""),r,s=i.length,o;if(arguments.length<2){var a=this.node().__on;if(a){for(var c=0,l=a.length,u;c<l;++c)for(r=0,u=a[c];r<s;++r)if((o=i[r]).type===u.type&&o.name===u.name)return u.value}return}for(a=t?Mx:xx,r=0;r<s;++r)this.each(a(i[r],t,e));return this}function lh(n,t,e){var i=ih(n),r=i.CustomEvent;typeof r=="function"?r=new r(t,e):(r=i.document.createEvent("Event"),e?(r.initEvent(t,e.bubbles,e.cancelable),r.detail=e.detail):r.initEvent(t,!1,!1)),n.dispatchEvent(r)}function Sx(n,t){return function(){return lh(this,n,t)}}function Ex(n,t){return function(){return lh(this,n,t.apply(this,arguments))}}function Tx(n,t){return this.each((typeof t=="function"?Ex:Sx)(n,t))}function*wx(){for(var n=this._groups,t=0,e=n.length;t<e;++t)for(var i=n[t],r=0,s=i.length,o;r<s;++r)(o=i[r])&&(yield o)}var ch=[null];function Ue(n,t){this._groups=n,this._parents=t}function Nr(){return new Ue([[document.documentElement]],ch)}function bx(){return this}Ue.prototype=Nr.prototype={constructor:Ue,select:J0,selectAll:nv,selectChild:ov,selectChildren:uv,filter:hv,data:gv,enter:fv,exit:xv,join:Mv,merge:yv,selection:bx,order:Sv,sort:Ev,call:wv,nodes:bv,node:Av,size:Rv,empty:Cv,each:Pv,attr:Ov,style:Hv,property:Xv,classed:Zv,text:Qv,html:ix,raise:sx,lower:ax,append:lx,insert:ux,remove:fx,clone:mx,datum:_x,on:yx,dispatch:Tx,[Symbol.iterator]:wx};function zi(n){return typeof n=="string"?new Ue([[document.querySelector(n)]],[document.documentElement]):new Ue([[n]],ch)}function _l(n,t,e){n.prototype=t.prototype=e,e.constructor=n}function uh(n,t){var e=Object.create(n.prototype);for(var i in t)e[i]=t[i];return e}function Fr(){}var Rr=.7,Ns=1/Rr,ki="\\s*([+-]?\\d+)\\s*",Cr="\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)\\s*",cn="\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)%\\s*",Ax=/^#([0-9a-f]{3,8})$/,Rx=new RegExp(`^rgb\\(${ki},${ki},${ki}\\)$`),Cx=new RegExp(`^rgb\\(${cn},${cn},${cn}\\)$`),Px=new RegExp(`^rgba\\(${ki},${ki},${ki},${Cr}\\)$`),Dx=new RegExp(`^rgba\\(${cn},${cn},${cn},${Cr}\\)$`),Lx=new RegExp(`^hsl\\(${Cr},${cn},${cn}\\)$`),Ix=new RegExp(`^hsla\\(${Cr},${cn},${cn},${Cr}\\)$`),Fc={aliceblue:15792383,antiquewhite:16444375,aqua:65535,aquamarine:8388564,azure:15794175,beige:16119260,bisque:16770244,black:0,blanchedalmond:16772045,blue:255,blueviolet:9055202,brown:10824234,burlywood:14596231,cadetblue:6266528,chartreuse:8388352,chocolate:13789470,coral:16744272,cornflowerblue:6591981,cornsilk:16775388,crimson:14423100,cyan:65535,darkblue:139,darkcyan:35723,darkgoldenrod:12092939,darkgray:11119017,darkgreen:25600,darkgrey:11119017,darkkhaki:12433259,darkmagenta:9109643,darkolivegreen:5597999,darkorange:16747520,darkorchid:10040012,darkred:9109504,darksalmon:15308410,darkseagreen:9419919,darkslateblue:4734347,darkslategray:3100495,darkslategrey:3100495,darkturquoise:52945,darkviolet:9699539,deeppink:16716947,deepskyblue:49151,dimgray:6908265,dimgrey:6908265,dodgerblue:2003199,firebrick:11674146,floralwhite:16775920,forestgreen:2263842,fuchsia:16711935,gainsboro:14474460,ghostwhite:16316671,gold:16766720,goldenrod:14329120,gray:8421504,green:32768,greenyellow:11403055,grey:8421504,honeydew:15794160,hotpink:16738740,indianred:13458524,indigo:4915330,ivory:16777200,khaki:15787660,lavender:15132410,lavenderblush:16773365,lawngreen:8190976,lemonchiffon:16775885,lightblue:11393254,lightcoral:15761536,lightcyan:14745599,lightgoldenrodyellow:16448210,lightgray:13882323,lightgreen:9498256,lightgrey:13882323,lightpink:16758465,lightsalmon:16752762,lightseagreen:2142890,lightskyblue:8900346,lightslategray:7833753,lightslategrey:7833753,lightsteelblue:11584734,lightyellow:16777184,lime:65280,limegreen:3329330,linen:16445670,magenta:16711935,maroon:8388608,mediumaquamarine:6737322,mediumblue:205,mediumorchid:12211667,mediumpurple:9662683,mediumseagreen:3978097,mediumslateblue:8087790,mediumspringgreen:64154,mediumturquoise:4772300,mediumvioletred:13047173,midnightblue:1644912,mintcream:16121850,mistyrose:16770273,moccasin:16770229,navajowhite:16768685,navy:128,oldlace:16643558,olive:8421376,olivedrab:7048739,orange:16753920,orangered:16729344,orchid:14315734,palegoldenrod:15657130,palegreen:10025880,paleturquoise:11529966,palevioletred:14381203,papayawhip:16773077,peachpuff:16767673,peru:13468991,pink:16761035,plum:14524637,powderblue:11591910,purple:8388736,rebeccapurple:6697881,red:16711680,rosybrown:12357519,royalblue:4286945,saddlebrown:9127187,salmon:16416882,sandybrown:16032864,seagreen:3050327,seashell:16774638,sienna:10506797,silver:12632256,skyblue:8900331,slateblue:6970061,slategray:7372944,slategrey:7372944,snow:16775930,springgreen:65407,steelblue:4620980,tan:13808780,teal:32896,thistle:14204888,tomato:16737095,turquoise:4251856,violet:15631086,wheat:16113331,white:16777215,whitesmoke:16119285,yellow:16776960,yellowgreen:10145074};_l(Fr,oi,{copy(n){return Object.assign(new this.constructor,this,n)},displayable(){return this.rgb().displayable()},hex:Oc,formatHex:Oc,formatHex8:Ux,formatHsl:Nx,formatRgb:Bc,toString:Bc});function Oc(){return this.rgb().formatHex()}function Ux(){return this.rgb().formatHex8()}function Nx(){return hh(this).formatHsl()}function Bc(){return this.rgb().formatRgb()}function oi(n){var t,e;return n=(n+"").trim().toLowerCase(),(t=Ax.exec(n))?(e=t[1].length,t=parseInt(t[1],16),e===6?zc(t):e===3?new be(t>>8&15|t>>4&240,t>>4&15|t&240,(t&15)<<4|t&15,1):e===8?cs(t>>24&255,t>>16&255,t>>8&255,(t&255)/255):e===4?cs(t>>12&15|t>>8&240,t>>8&15|t>>4&240,t>>4&15|t&240,((t&15)<<4|t&15)/255):null):(t=Rx.exec(n))?new be(t[1],t[2],t[3],1):(t=Cx.exec(n))?new be(t[1]*255/100,t[2]*255/100,t[3]*255/100,1):(t=Px.exec(n))?cs(t[1],t[2],t[3],t[4]):(t=Dx.exec(n))?cs(t[1]*255/100,t[2]*255/100,t[3]*255/100,t[4]):(t=Lx.exec(n))?Vc(t[1],t[2]/100,t[3]/100,1):(t=Ix.exec(n))?Vc(t[1],t[2]/100,t[3]/100,t[4]):Fc.hasOwnProperty(n)?zc(Fc[n]):n==="transparent"?new be(NaN,NaN,NaN,0):null}function zc(n){return new be(n>>16&255,n>>8&255,n&255,1)}function cs(n,t,e,i){return i<=0&&(n=t=e=NaN),new be(n,t,e,i)}function Fx(n){return n instanceof Fr||(n=oi(n)),n?(n=n.rgb(),new be(n.r,n.g,n.b,n.opacity)):new be}function Na(n,t,e,i){return arguments.length===1?Fx(n):new be(n,t,e,i??1)}function be(n,t,e,i){this.r=+n,this.g=+t,this.b=+e,this.opacity=+i}_l(be,Na,uh(Fr,{brighter(n){return n=n==null?Ns:Math.pow(Ns,n),new be(this.r*n,this.g*n,this.b*n,this.opacity)},darker(n){return n=n==null?Rr:Math.pow(Rr,n),new be(this.r*n,this.g*n,this.b*n,this.opacity)},rgb(){return this},clamp(){return new be(ni(this.r),ni(this.g),ni(this.b),Fs(this.opacity))},displayable(){return-.5<=this.r&&this.r<255.5&&-.5<=this.g&&this.g<255.5&&-.5<=this.b&&this.b<255.5&&0<=this.opacity&&this.opacity<=1},hex:kc,formatHex:kc,formatHex8:Ox,formatRgb:Hc,toString:Hc}));function kc(){return`#${Qn(this.r)}${Qn(this.g)}${Qn(this.b)}`}function Ox(){return`#${Qn(this.r)}${Qn(this.g)}${Qn(this.b)}${Qn((isNaN(this.opacity)?1:this.opacity)*255)}`}function Hc(){const n=Fs(this.opacity);return`${n===1?"rgb(":"rgba("}${ni(this.r)}, ${ni(this.g)}, ${ni(this.b)}${n===1?")":`, ${n})`}`}function Fs(n){return isNaN(n)?1:Math.max(0,Math.min(1,n))}function ni(n){return Math.max(0,Math.min(255,Math.round(n)||0))}function Qn(n){return n=ni(n),(n<16?"0":"")+n.toString(16)}function Vc(n,t,e,i){return i<=0?n=t=e=NaN:e<=0||e>=1?n=t=NaN:t<=0&&(n=NaN),new Ze(n,t,e,i)}function hh(n){if(n instanceof Ze)return new Ze(n.h,n.s,n.l,n.opacity);if(n instanceof Fr||(n=oi(n)),!n)return new Ze;if(n instanceof Ze)return n;n=n.rgb();var t=n.r/255,e=n.g/255,i=n.b/255,r=Math.min(t,e,i),s=Math.max(t,e,i),o=NaN,a=s-r,c=(s+r)/2;return a?(t===s?o=(e-i)/a+(e<i)*6:e===s?o=(i-t)/a+2:o=(t-e)/a+4,a/=c<.5?s+r:2-s-r,o*=60):a=c>0&&c<1?0:o,new Ze(o,a,c,n.opacity)}function Bx(n,t,e,i){return arguments.length===1?hh(n):new Ze(n,t,e,i??1)}function Ze(n,t,e,i){this.h=+n,this.s=+t,this.l=+e,this.opacity=+i}_l(Ze,Bx,uh(Fr,{brighter(n){return n=n==null?Ns:Math.pow(Ns,n),new Ze(this.h,this.s,this.l*n,this.opacity)},darker(n){return n=n==null?Rr:Math.pow(Rr,n),new Ze(this.h,this.s,this.l*n,this.opacity)},rgb(){var n=this.h%360+(this.h<0)*360,t=isNaN(n)||isNaN(this.s)?0:this.s,e=this.l,i=e+(e<.5?e:1-e)*t,r=2*e-i;return new be(Oo(n>=240?n-240:n+120,r,i),Oo(n,r,i),Oo(n<120?n+240:n-120,r,i),this.opacity)},clamp(){return new Ze(Gc(this.h),us(this.s),us(this.l),Fs(this.opacity))},displayable(){return(0<=this.s&&this.s<=1||isNaN(this.s))&&0<=this.l&&this.l<=1&&0<=this.opacity&&this.opacity<=1},formatHsl(){const n=Fs(this.opacity);return`${n===1?"hsl(":"hsla("}${Gc(this.h)}, ${us(this.s)*100}%, ${us(this.l)*100}%${n===1?")":`, ${n})`}`}}));function Gc(n){return n=(n||0)%360,n<0?n+360:n}function us(n){return Math.max(0,Math.min(1,n||0))}function Oo(n,t,e){return(n<60?t+(e-t)*n/60:n<180?e:n<240?t+(e-t)*(240-n)/60:t)*255}const gl=n=>()=>n;function zx(n,t){return function(e){return n+e*t}}function kx(n,t,e){return n=Math.pow(n,e),t=Math.pow(t,e)-n,e=1/e,function(i){return Math.pow(n+i*t,e)}}function Hx(n){return(n=+n)==1?fh:function(t,e){return e-t?kx(t,e,n):gl(isNaN(t)?e:t)}}function fh(n,t){var e=t-n;return e?zx(n,e):gl(isNaN(n)?t:n)}const Os=function n(t){var e=Hx(t);function i(r,s){var o=e((r=Na(r)).r,(s=Na(s)).r),a=e(r.g,s.g),c=e(r.b,s.b),l=fh(r.opacity,s.opacity);return function(u){return r.r=o(u),r.g=a(u),r.b=c(u),r.opacity=l(u),r+""}}return i.gamma=n,i}(1);function Vx(n,t){t||(t=[]);var e=n?Math.min(t.length,n.length):0,i=t.slice(),r;return function(s){for(r=0;r<e;++r)i[r]=n[r]*(1-s)+t[r]*s;return i}}function Gx(n){return ArrayBuffer.isView(n)&&!(n instanceof DataView)}function Wx(n,t){var e=t?t.length:0,i=n?Math.min(e,n.length):0,r=new Array(i),s=new Array(e),o;for(o=0;o<i;++o)r[o]=vl(n[o],t[o]);for(;o<e;++o)s[o]=t[o];return function(a){for(o=0;o<i;++o)s[o]=r[o](a);return s}}function Xx(n,t){var e=new Date;return n=+n,t=+t,function(i){return e.setTime(n*(1-i)+t*i),e}}function Ye(n,t){return n=+n,t=+t,function(e){return n*(1-e)+t*e}}function qx(n,t){var e={},i={},r;(n===null||typeof n!="object")&&(n={}),(t===null||typeof t!="object")&&(t={});for(r in t)r in n?e[r]=vl(n[r],t[r]):i[r]=t[r];return function(s){for(r in e)i[r]=e[r](s);return i}}var Fa=/[-+]?(?:\d+\.?\d*|\.?\d+)(?:[eE][-+]?\d+)?/g,Bo=new RegExp(Fa.source,"g");function Yx(n){return function(){return n}}function $x(n){return function(t){return n(t)+""}}function dh(n,t){var e=Fa.lastIndex=Bo.lastIndex=0,i,r,s,o=-1,a=[],c=[];for(n=n+"",t=t+"";(i=Fa.exec(n))&&(r=Bo.exec(t));)(s=r.index)>e&&(s=t.slice(e,s),a[o]?a[o]+=s:a[++o]=s),(i=i[0])===(r=r[0])?a[o]?a[o]+=r:a[++o]=r:(a[++o]=null,c.push({i:o,x:Ye(i,r)})),e=Bo.lastIndex;return e<t.length&&(s=t.slice(e),a[o]?a[o]+=s:a[++o]=s),a.length<2?c[0]?$x(c[0].x):Yx(t):(t=c.length,function(l){for(var u=0,h;u<t;++u)a[(h=c[u]).i]=h.x(l);return a.join("")})}function vl(n,t){var e=typeof t,i;return t==null||e==="boolean"?gl(t):(e==="number"?Ye:e==="string"?(i=oi(t))?(t=i,Os):dh:t instanceof oi?Os:t instanceof Date?Xx:Gx(t)?Vx:Array.isArray(t)?Wx:typeof t.valueOf!="function"&&typeof t.toString!="function"||isNaN(t)?qx:Ye)(n,t)}function Zx(n,t){return n=+n,t=+t,function(e){return Math.round(n*(1-e)+t*e)}}var Wc=180/Math.PI,Oa={translateX:0,translateY:0,rotate:0,skewX:0,scaleX:1,scaleY:1};function ph(n,t,e,i,r,s){var o,a,c;return(o=Math.sqrt(n*n+t*t))&&(n/=o,t/=o),(c=n*e+t*i)&&(e-=n*c,i-=t*c),(a=Math.sqrt(e*e+i*i))&&(e/=a,i/=a,c/=a),n*i<t*e&&(n=-n,t=-t,c=-c,o=-o),{translateX:r,translateY:s,rotate:Math.atan2(t,n)*Wc,skewX:Math.atan(c)*Wc,scaleX:o,scaleY:a}}var hs;function Kx(n){const t=new(typeof DOMMatrix=="function"?DOMMatrix:WebKitCSSMatrix)(n+"");return t.isIdentity?Oa:ph(t.a,t.b,t.c,t.d,t.e,t.f)}function jx(n){return n==null||(hs||(hs=document.createElementNS("http://www.w3.org/2000/svg","g")),hs.setAttribute("transform",n),!(n=hs.transform.baseVal.consolidate()))?Oa:(n=n.matrix,ph(n.a,n.b,n.c,n.d,n.e,n.f))}function mh(n,t,e,i){function r(l){return l.length?l.pop()+" ":""}function s(l,u,h,f,p,_){if(l!==h||u!==f){var v=p.push("translate(",null,t,null,e);_.push({i:v-4,x:Ye(l,h)},{i:v-2,x:Ye(u,f)})}else(h||f)&&p.push("translate("+h+t+f+e)}function o(l,u,h,f){l!==u?(l-u>180?u+=360:u-l>180&&(l+=360),f.push({i:h.push(r(h)+"rotate(",null,i)-2,x:Ye(l,u)})):u&&h.push(r(h)+"rotate("+u+i)}function a(l,u,h,f){l!==u?f.push({i:h.push(r(h)+"skewX(",null,i)-2,x:Ye(l,u)}):u&&h.push(r(h)+"skewX("+u+i)}function c(l,u,h,f,p,_){if(l!==h||u!==f){var v=p.push(r(p)+"scale(",null,",",null,")");_.push({i:v-4,x:Ye(l,h)},{i:v-2,x:Ye(u,f)})}else(h!==1||f!==1)&&p.push(r(p)+"scale("+h+","+f+")")}return function(l,u){var h=[],f=[];return l=n(l),u=n(u),s(l.translateX,l.translateY,u.translateX,u.translateY,h,f),o(l.rotate,u.rotate,h,f),a(l.skewX,u.skewX,h,f),c(l.scaleX,l.scaleY,u.scaleX,u.scaleY,h,f),l=u=null,function(p){for(var _=-1,v=f.length,m;++_<v;)h[(m=f[_]).i]=m.x(p);return h.join("")}}}var Jx=mh(Kx,"px, ","px)","deg)"),Qx=mh(jx,", ",")",")"),Zi=0,_r=0,ur=0,_h=1e3,Bs,gr,zs=0,ai=0,to=0,Pr=typeof performance=="object"&&performance.now?performance:Date,gh=typeof window=="object"&&window.requestAnimationFrame?window.requestAnimationFrame.bind(window):function(n){setTimeout(n,17)};function xl(){return ai||(gh(tM),ai=Pr.now()+to)}function tM(){ai=0}function ks(){this._call=this._time=this._next=null}ks.prototype=vh.prototype={constructor:ks,restart:function(n,t,e){if(typeof n!="function")throw new TypeError("callback is not a function");e=(e==null?xl():+e)+(t==null?0:+t),!this._next&&gr!==this&&(gr?gr._next=this:Bs=this,gr=this),this._call=n,this._time=e,Ba()},stop:function(){this._call&&(this._call=null,this._time=1/0,Ba())}};function vh(n,t,e){var i=new ks;return i.restart(n,t,e),i}function eM(){xl(),++Zi;for(var n=Bs,t;n;)(t=ai-n._time)>=0&&n._call.call(void 0,t),n=n._next;--Zi}function Xc(){ai=(zs=Pr.now())+to,Zi=_r=0;try{eM()}finally{Zi=0,iM(),ai=0}}function nM(){var n=Pr.now(),t=n-zs;t>_h&&(to-=t,zs=n)}function iM(){for(var n,t=Bs,e,i=1/0;t;)t._call?(i>t._time&&(i=t._time),n=t,t=t._next):(e=t._next,t._next=null,t=n?n._next=e:Bs=e);gr=n,Ba(i)}function Ba(n){if(!Zi){_r&&(_r=clearTimeout(_r));var t=n-ai;t>24?(n<1/0&&(_r=setTimeout(Xc,n-Pr.now()-to)),ur&&(ur=clearInterval(ur))):(ur||(zs=Pr.now(),ur=setInterval(nM,_h)),Zi=1,gh(Xc))}}function qc(n,t,e){var i=new ks;return t=t==null?0:+t,i.restart(r=>{i.stop(),n(r+t)},t,e),i}var rM=ju("start","end","cancel","interrupt"),sM=[],xh=0,Yc=1,za=2,Es=3,$c=4,ka=5,Ts=6;function eo(n,t,e,i,r,s){var o=n.__transition;if(!o)n.__transition={};else if(e in o)return;oM(n,e,{name:t,index:i,group:r,on:rM,tween:sM,time:s.time,delay:s.delay,duration:s.duration,ease:s.ease,timer:null,state:xh})}function Ml(n,t){var e=en(n,t);if(e.state>xh)throw new Error("too late; already scheduled");return e}function un(n,t){var e=en(n,t);if(e.state>Es)throw new Error("too late; already running");return e}function en(n,t){var e=n.__transition;if(!e||!(e=e[t]))throw new Error("transition not found");return e}function oM(n,t,e){var i=n.__transition,r;i[t]=e,e.timer=vh(s,0,e.time);function s(l){e.state=Yc,e.timer.restart(o,e.delay,e.time),e.delay<=l&&o(l-e.delay)}function o(l){var u,h,f,p;if(e.state!==Yc)return c();for(u in i)if(p=i[u],p.name===e.name){if(p.state===Es)return qc(o);p.state===$c?(p.state=Ts,p.timer.stop(),p.on.call("interrupt",n,n.__data__,p.index,p.group),delete i[u]):+u<t&&(p.state=Ts,p.timer.stop(),p.on.call("cancel",n,n.__data__,p.index,p.group),delete i[u])}if(qc(function(){e.state===Es&&(e.state=$c,e.timer.restart(a,e.delay,e.time),a(l))}),e.state=za,e.on.call("start",n,n.__data__,e.index,e.group),e.state===za){for(e.state=Es,r=new Array(f=e.tween.length),u=0,h=-1;u<f;++u)(p=e.tween[u].value.call(n,n.__data__,e.index,e.group))&&(r[++h]=p);r.length=h+1}}function a(l){for(var u=l<e.duration?e.ease.call(null,l/e.duration):(e.timer.restart(c),e.state=ka,1),h=-1,f=r.length;++h<f;)r[h].call(n,u);e.state===ka&&(e.on.call("end",n,n.__data__,e.index,e.group),c())}function c(){e.state=Ts,e.timer.stop(),delete i[t];for(var l in i)return;delete n.__transition}}function aM(n,t){var e=n.__transition,i,r,s=!0,o;if(e){t=t==null?null:t+"";for(o in e){if((i=e[o]).name!==t){s=!1;continue}r=i.state>za&&i.state<ka,i.state=Ts,i.timer.stop(),i.on.call(r?"interrupt":"cancel",n,n.__data__,i.index,i.group),delete e[o]}s&&delete n.__transition}}function lM(n){return this.each(function(){aM(this,n)})}function cM(n,t){var e,i;return function(){var r=un(this,n),s=r.tween;if(s!==e){i=e=s;for(var o=0,a=i.length;o<a;++o)if(i[o].name===t){i=i.slice(),i.splice(o,1);break}}r.tween=i}}function uM(n,t,e){var i,r;if(typeof e!="function")throw new Error;return function(){var s=un(this,n),o=s.tween;if(o!==i){r=(i=o).slice();for(var a={name:t,value:e},c=0,l=r.length;c<l;++c)if(r[c].name===t){r[c]=a;break}c===l&&r.push(a)}s.tween=r}}function hM(n,t){var e=this._id;if(n+="",arguments.length<2){for(var i=en(this.node(),e).tween,r=0,s=i.length,o;r<s;++r)if((o=i[r]).name===n)return o.value;return null}return this.each((t==null?cM:uM)(e,n,t))}function yl(n,t,e){var i=n._id;return n.each(function(){var r=un(this,i);(r.value||(r.value={}))[t]=e.apply(this,arguments)}),function(r){return en(r,i).value[t]}}function Mh(n,t){var e;return(typeof t=="number"?Ye:t instanceof oi?Os:(e=oi(t))?(t=e,Os):dh)(n,t)}function fM(n){return function(){this.removeAttribute(n)}}function dM(n){return function(){this.removeAttributeNS(n.space,n.local)}}function pM(n,t,e){var i,r=e+"",s;return function(){var o=this.getAttribute(n);return o===r?null:o===i?s:s=t(i=o,e)}}function mM(n,t,e){var i,r=e+"",s;return function(){var o=this.getAttributeNS(n.space,n.local);return o===r?null:o===i?s:s=t(i=o,e)}}function _M(n,t,e){var i,r,s;return function(){var o,a=e(this),c;return a==null?void this.removeAttribute(n):(o=this.getAttribute(n),c=a+"",o===c?null:o===i&&c===r?s:(r=c,s=t(i=o,a)))}}function gM(n,t,e){var i,r,s;return function(){var o,a=e(this),c;return a==null?void this.removeAttributeNS(n.space,n.local):(o=this.getAttributeNS(n.space,n.local),c=a+"",o===c?null:o===i&&c===r?s:(r=c,s=t(i=o,a)))}}function vM(n,t){var e=Qs(n),i=e==="transform"?Qx:Mh;return this.attrTween(n,typeof t=="function"?(e.local?gM:_M)(e,i,yl(this,"attr."+n,t)):t==null?(e.local?dM:fM)(e):(e.local?mM:pM)(e,i,t))}function xM(n,t){return function(e){this.setAttribute(n,t.call(this,e))}}function MM(n,t){return function(e){this.setAttributeNS(n.space,n.local,t.call(this,e))}}function yM(n,t){var e,i;function r(){var s=t.apply(this,arguments);return s!==i&&(e=(i=s)&&MM(n,s)),e}return r._value=t,r}function SM(n,t){var e,i;function r(){var s=t.apply(this,arguments);return s!==i&&(e=(i=s)&&xM(n,s)),e}return r._value=t,r}function EM(n,t){var e="attr."+n;if(arguments.length<2)return(e=this.tween(e))&&e._value;if(t==null)return this.tween(e,null);if(typeof t!="function")throw new Error;var i=Qs(n);return this.tween(e,(i.local?yM:SM)(i,t))}function TM(n,t){return function(){Ml(this,n).delay=+t.apply(this,arguments)}}function wM(n,t){return t=+t,function(){Ml(this,n).delay=t}}function bM(n){var t=this._id;return arguments.length?this.each((typeof n=="function"?TM:wM)(t,n)):en(this.node(),t).delay}function AM(n,t){return function(){un(this,n).duration=+t.apply(this,arguments)}}function RM(n,t){return t=+t,function(){un(this,n).duration=t}}function CM(n){var t=this._id;return arguments.length?this.each((typeof n=="function"?AM:RM)(t,n)):en(this.node(),t).duration}function PM(n,t){if(typeof t!="function")throw new Error;return function(){un(this,n).ease=t}}function DM(n){var t=this._id;return arguments.length?this.each(PM(t,n)):en(this.node(),t).ease}function LM(n,t){return function(){var e=t.apply(this,arguments);if(typeof e!="function")throw new Error;un(this,n).ease=e}}function IM(n){if(typeof n!="function")throw new Error;return this.each(LM(this._id,n))}function UM(n){typeof n!="function"&&(n=th(n));for(var t=this._groups,e=t.length,i=new Array(e),r=0;r<e;++r)for(var s=t[r],o=s.length,a=i[r]=[],c,l=0;l<o;++l)(c=s[l])&&n.call(c,c.__data__,l,s)&&a.push(c);return new Tn(i,this._parents,this._name,this._id)}function NM(n){if(n._id!==this._id)throw new Error;for(var t=this._groups,e=n._groups,i=t.length,r=e.length,s=Math.min(i,r),o=new Array(i),a=0;a<s;++a)for(var c=t[a],l=e[a],u=c.length,h=o[a]=new Array(u),f,p=0;p<u;++p)(f=c[p]||l[p])&&(h[p]=f);for(;a<i;++a)o[a]=t[a];return new Tn(o,this._parents,this._name,this._id)}function FM(n){return(n+"").trim().split(/^|\s+/).every(function(t){var e=t.indexOf(".");return e>=0&&(t=t.slice(0,e)),!t||t==="start"})}function OM(n,t,e){var i,r,s=FM(t)?Ml:un;return function(){var o=s(this,n),a=o.on;a!==i&&(r=(i=a).copy()).on(t,e),o.on=r}}function BM(n,t){var e=this._id;return arguments.length<2?en(this.node(),e).on.on(n):this.each(OM(e,n,t))}function zM(n){return function(){var t=this.parentNode;for(var e in this.__transition)if(+e!==n)return;t&&t.removeChild(this)}}function kM(){return this.on("end.remove",zM(this._id))}function HM(n){var t=this._name,e=this._id;typeof n!="function"&&(n=pl(n));for(var i=this._groups,r=i.length,s=new Array(r),o=0;o<r;++o)for(var a=i[o],c=a.length,l=s[o]=new Array(c),u,h,f=0;f<c;++f)(u=a[f])&&(h=n.call(u,u.__data__,f,a))&&("__data__"in u&&(h.__data__=u.__data__),l[f]=h,eo(l[f],t,e,f,l,en(u,e)));return new Tn(s,this._parents,t,e)}function VM(n){var t=this._name,e=this._id;typeof n!="function"&&(n=Qu(n));for(var i=this._groups,r=i.length,s=[],o=[],a=0;a<r;++a)for(var c=i[a],l=c.length,u,h=0;h<l;++h)if(u=c[h]){for(var f=n.call(u,u.__data__,h,c),p,_=en(u,e),v=0,m=f.length;v<m;++v)(p=f[v])&&eo(p,t,e,v,f,_);s.push(f),o.push(u)}return new Tn(s,o,t,e)}var GM=Nr.prototype.constructor;function WM(){return new GM(this._groups,this._parents)}function XM(n,t){var e,i,r;return function(){var s=$i(this,n),o=(this.style.removeProperty(n),$i(this,n));return s===o?null:s===e&&o===i?r:r=t(e=s,i=o)}}function yh(n){return function(){this.style.removeProperty(n)}}function qM(n,t,e){var i,r=e+"",s;return function(){var o=$i(this,n);return o===r?null:o===i?s:s=t(i=o,e)}}function YM(n,t,e){var i,r,s;return function(){var o=$i(this,n),a=e(this),c=a+"";return a==null&&(c=a=(this.style.removeProperty(n),$i(this,n))),o===c?null:o===i&&c===r?s:(r=c,s=t(i=o,a))}}function $M(n,t){var e,i,r,s="style."+t,o="end."+s,a;return function(){var c=un(this,n),l=c.on,u=c.value[s]==null?a||(a=yh(t)):void 0;(l!==e||r!==u)&&(i=(e=l).copy()).on(o,r=u),c.on=i}}function ZM(n,t,e){var i=(n+="")=="transform"?Jx:Mh;return t==null?this.styleTween(n,XM(n,i)).on("end.style."+n,yh(n)):typeof t=="function"?this.styleTween(n,YM(n,i,yl(this,"style."+n,t))).each($M(this._id,n)):this.styleTween(n,qM(n,i,t),e).on("end.style."+n,null)}function KM(n,t,e){return function(i){this.style.setProperty(n,t.call(this,i),e)}}function jM(n,t,e){var i,r;function s(){var o=t.apply(this,arguments);return o!==r&&(i=(r=o)&&KM(n,o,e)),i}return s._value=t,s}function JM(n,t,e){var i="style."+(n+="");if(arguments.length<2)return(i=this.tween(i))&&i._value;if(t==null)return this.tween(i,null);if(typeof t!="function")throw new Error;return this.tween(i,jM(n,t,e??""))}function QM(n){return function(){this.textContent=n}}function ty(n){return function(){var t=n(this);this.textContent=t??""}}function ey(n){return this.tween("text",typeof n=="function"?ty(yl(this,"text",n)):QM(n==null?"":n+""))}function ny(n){return function(t){this.textContent=n.call(this,t)}}function iy(n){var t,e;function i(){var r=n.apply(this,arguments);return r!==e&&(t=(e=r)&&ny(r)),t}return i._value=n,i}function ry(n){var t="text";if(arguments.length<1)return(t=this.tween(t))&&t._value;if(n==null)return this.tween(t,null);if(typeof n!="function")throw new Error;return this.tween(t,iy(n))}function sy(){for(var n=this._name,t=this._id,e=Sh(),i=this._groups,r=i.length,s=0;s<r;++s)for(var o=i[s],a=o.length,c,l=0;l<a;++l)if(c=o[l]){var u=en(c,t);eo(c,n,e,l,o,{time:u.time+u.delay+u.duration,delay:0,duration:u.duration,ease:u.ease})}return new Tn(i,this._parents,n,e)}function oy(){var n,t,e=this,i=e._id,r=e.size();return new Promise(function(s,o){var a={value:o},c={value:function(){--r===0&&s()}};e.each(function(){var l=un(this,i),u=l.on;u!==n&&(t=(n=u).copy(),t._.cancel.push(a),t._.interrupt.push(a),t._.end.push(c)),l.on=t}),r===0&&s()})}var ay=0;function Tn(n,t,e,i){this._groups=n,this._parents=t,this._name=e,this._id=i}function Sh(){return++ay}var _n=Nr.prototype;Tn.prototype={constructor:Tn,select:HM,selectAll:VM,selectChild:_n.selectChild,selectChildren:_n.selectChildren,filter:UM,merge:NM,selection:WM,transition:sy,call:_n.call,nodes:_n.nodes,node:_n.node,size:_n.size,empty:_n.empty,each:_n.each,on:BM,attr:vM,attrTween:EM,style:ZM,styleTween:JM,text:ey,textTween:ry,remove:kM,tween:hM,delay:bM,duration:CM,ease:DM,easeVarying:IM,end:oy,[Symbol.iterator]:_n[Symbol.iterator]};function ly(n){return((n*=2)<=1?n*n*n:(n-=2)*n*n+2)/2}var cy=Math.PI;function uy(n){return(1-Math.cos(cy*n))/2}var hy={time:null,delay:0,duration:250,ease:ly};function fy(n,t){for(var e;!(e=n.__transition)||!(e=e[t]);)if(!(n=n.parentNode))throw new Error(`transition ${t} not found`);return e}function dy(n){var t,e;n instanceof Tn?(t=n._id,n=n._name):(t=Sh(),(e=hy).time=xl(),n=n==null?null:n+"");for(var i=this._groups,r=i.length,s=0;s<r;++s)for(var o=i[s],a=o.length,c,l=0;l<a;++l)(c=o[l])&&eo(c,n,t,l,o,e||fy(c,t));return new Tn(i,this._parents,n,t)}Nr.prototype.interrupt=lM;Nr.prototype.transition=dy;var py=Array.prototype,Eh=py.slice;function my(n,t){return n-t}function _y(n){for(var t=0,e=n.length,i=n[e-1][1]*n[0][0]-n[e-1][0]*n[0][1];++t<e;)i+=n[t-1][1]*n[t][0]-n[t-1][0]*n[t][1];return i}const Ln=n=>()=>n;function gy(n,t){for(var e=-1,i=t.length,r;++e<i;)if(r=vy(n,t[e]))return r;return 0}function vy(n,t){for(var e=t[0],i=t[1],r=-1,s=0,o=n.length,a=o-1;s<o;a=s++){var c=n[s],l=c[0],u=c[1],h=n[a],f=h[0],p=h[1];if(xy(c,h,t))return 0;u>i!=p>i&&e<(f-l)*(i-u)/(p-u)+l&&(r=-r)}return r}function xy(n,t,e){var i;return My(n,t,e)&&yy(n[i=+(n[0]===t[0])],e[i],t[i])}function My(n,t,e){return(t[0]-n[0])*(e[1]-n[1])===(e[0]-n[0])*(t[1]-n[1])}function yy(n,t,e){return n<=t&&t<=e||e<=t&&t<=n}function Sy(){}var gn=[[],[[[1,1.5],[.5,1]]],[[[1.5,1],[1,1.5]]],[[[1.5,1],[.5,1]]],[[[1,.5],[1.5,1]]],[[[1,1.5],[.5,1]],[[1,.5],[1.5,1]]],[[[1,.5],[1,1.5]]],[[[1,.5],[.5,1]]],[[[.5,1],[1,.5]]],[[[1,1.5],[1,.5]]],[[[.5,1],[1,.5]],[[1.5,1],[1,1.5]]],[[[1.5,1],[1,.5]]],[[[.5,1],[1.5,1]]],[[[1,1.5],[1.5,1]]],[[[.5,1],[1,1.5]]],[]];function Zc(){var n=1,t=1,e=X0,i=c;function r(l){var u=e(l);if(Array.isArray(u))u=u.slice().sort(my);else{const h=U0(l,Ey);for(u=dl(...W0(h[0],h[1],u),u);u[u.length-1]>=h[1];)u.pop();for(;u[1]<h[0];)u.shift()}return u.map(h=>s(l,h))}function s(l,u){const h=u==null?NaN:+u;if(isNaN(h))throw new Error(`invalid value: ${u}`);var f=[],p=[];return o(l,h,function(_){i(_,l,h),_y(_)>0?f.push([_]):p.push(_)}),p.forEach(function(_){for(var v=0,m=f.length,d;v<m;++v)if(gy((d=f[v])[0],_)!==-1){d.push(_);return}}),{type:"MultiPolygon",value:u,coordinates:f}}function o(l,u,h){var f=new Array,p=new Array,_,v,m,d,T,w;for(_=v=-1,d=qn(l[0],u),gn[d<<1].forEach(S);++_<n-1;)m=d,d=qn(l[_+1],u),gn[m|d<<1].forEach(S);for(gn[d<<0].forEach(S);++v<t-1;){for(_=-1,d=qn(l[v*n+n],u),T=qn(l[v*n],u),gn[d<<1|T<<2].forEach(S);++_<n-1;)m=d,d=qn(l[v*n+n+_+1],u),w=T,T=qn(l[v*n+_+1],u),gn[m|d<<1|T<<2|w<<3].forEach(S);gn[d|T<<3].forEach(S)}for(_=-1,T=l[v*n]>=u,gn[T<<2].forEach(S);++_<n-1;)w=T,T=qn(l[v*n+_+1],u),gn[T<<2|w<<3].forEach(S);gn[T<<3].forEach(S);function S(D){var P=[D[0][0]+_,D[0][1]+v],A=[D[1][0]+_,D[1][1]+v],C=a(P),y=a(A),x,b;(x=p[C])?(b=f[y])?(delete p[x.end],delete f[b.start],x===b?(x.ring.push(A),h(x.ring)):f[x.start]=p[b.end]={start:x.start,end:b.end,ring:x.ring.concat(b.ring)}):(delete p[x.end],x.ring.push(A),p[x.end=y]=x):(x=f[y])?(b=p[C])?(delete f[x.start],delete p[b.end],x===b?(x.ring.push(A),h(x.ring)):f[b.start]=p[x.end]={start:b.start,end:x.end,ring:b.ring.concat(x.ring)}):(delete f[x.start],x.ring.unshift(P),f[x.start=C]=x):f[C]=p[y]={start:C,end:y,ring:[P,A]}}}function a(l){return l[0]*2+l[1]*(n+1)*4}function c(l,u,h){l.forEach(function(f){var p=f[0],_=f[1],v=p|0,m=_|0,d=zo(u[m*n+v]);p>0&&p<n&&v===p&&(f[0]=Kc(p,zo(u[m*n+v-1]),d,h)),_>0&&_<t&&m===_&&(f[1]=Kc(_,zo(u[(m-1)*n+v]),d,h))})}return r.contour=s,r.size=function(l){if(!arguments.length)return[n,t];var u=Math.floor(l[0]),h=Math.floor(l[1]);if(!(u>=0&&h>=0))throw new Error("invalid size");return n=u,t=h,r},r.thresholds=function(l){return arguments.length?(e=typeof l=="function"?l:Array.isArray(l)?Ln(Eh.call(l)):Ln(l),r):e},r.smooth=function(l){return arguments.length?(i=l?c:Sy,r):i===c},r}function Ey(n){return isFinite(n)?n:NaN}function qn(n,t){return n==null?!1:+n>=t}function zo(n){return n==null||isNaN(n=+n)?-1/0:n}function Kc(n,t,e,i){const r=i-t,s=e-t,o=isFinite(r)||isFinite(s)?r/s:Math.sign(r)/Math.sign(s);return isNaN(o)?n:n+o-.5}function Ty(n){return n[0]}function wy(n){return n[1]}function by(){return 1}function Th(){var n=Ty,t=wy,e=by,i=960,r=500,s=20,o=2,a=s*3,c=i+a*2>>o,l=r+a*2>>o,u=Ln(20);function h(T){var w=new Float32Array(c*l),S=Math.pow(2,-o),D=-1;for(const O of T){var P=(n(O,++D,T)+a)*S,A=(t(O,D,T)+a)*S,C=+e(O,D,T);if(C&&P>=0&&P<c&&A>=0&&A<l){var y=Math.floor(P),x=Math.floor(A),b=P-y-.5,z=A-x-.5;w[y+x*c]+=(1-b)*(1-z)*C,w[y+1+x*c]+=b*(1-z)*C,w[y+1+(x+1)*c]+=b*z*C,w[y+(x+1)*c]+=(1-b)*z*C}}return C0({data:w,width:c,height:l},s*S),w}function f(T){var w=h(T),S=u(w),D=Math.pow(2,2*o);return Array.isArray(S)||(S=dl(Number.MIN_VALUE,ei(w)/D,S)),Zc().size([c,l]).thresholds(S.map(P=>P*D))(w).map((P,A)=>(P.value=+S[A],p(P)))}f.contours=function(T){var w=h(T),S=Zc().size([c,l]),D=Math.pow(2,2*o),P=A=>{A=+A;var C=p(S.contour(w,A*D));return C.value=A,C};return Object.defineProperty(P,"max",{get:()=>ei(w)/D}),P};function p(T){return T.coordinates.forEach(_),T}function _(T){T.forEach(v)}function v(T){T.forEach(m)}function m(T){T[0]=T[0]*Math.pow(2,o)-a,T[1]=T[1]*Math.pow(2,o)-a}function d(){return a=s*3,c=i+a*2>>o,l=r+a*2>>o,f}return f.x=function(T){return arguments.length?(n=typeof T=="function"?T:Ln(+T),f):n},f.y=function(T){return arguments.length?(t=typeof T=="function"?T:Ln(+T),f):t},f.weight=function(T){return arguments.length?(e=typeof T=="function"?T:Ln(+T),f):e},f.size=function(T){if(!arguments.length)return[i,r];var w=+T[0],S=+T[1];if(!(w>=0&&S>=0))throw new Error("invalid size");return i=w,r=S,d()},f.cellSize=function(T){if(!arguments.length)return 1<<o;if(!((T=+T)>=1))throw new Error("invalid cell size");return o=Math.floor(Math.log(T)/Math.LN2),d()},f.thresholds=function(T){return arguments.length?(u=typeof T=="function"?T:Array.isArray(T)?Ln(Eh.call(T)):Ln(T),f):u},f.bandwidth=function(T){if(!arguments.length)return Math.sqrt(s*(s+1));if(!((T=+T)>=0))throw new Error("invalid bandwidth");return s=(Math.sqrt(4*T*T+1)-1)/2,d()},f}var jc={},ko={},Ho=34,hr=10,Vo=13;function wh(n){return new Function("d","return {"+n.map(function(t,e){return JSON.stringify(t)+": d["+e+'] || ""'}).join(",")+"}")}function Ay(n,t){var e=wh(n);return function(i,r){return t(e(i),r,n)}}function Jc(n){var t=Object.create(null),e=[];return n.forEach(function(i){for(var r in i)r in t||e.push(t[r]=r)}),e}function we(n,t){var e=n+"",i=e.length;return i<t?new Array(t-i+1).join(0)+e:e}function Ry(n){return n<0?"-"+we(-n,6):n>9999?"+"+we(n,6):we(n,4)}function Cy(n){var t=n.getUTCHours(),e=n.getUTCMinutes(),i=n.getUTCSeconds(),r=n.getUTCMilliseconds();return isNaN(n)?"Invalid Date":Ry(n.getUTCFullYear())+"-"+we(n.getUTCMonth()+1,2)+"-"+we(n.getUTCDate(),2)+(r?"T"+we(t,2)+":"+we(e,2)+":"+we(i,2)+"."+we(r,3)+"Z":i?"T"+we(t,2)+":"+we(e,2)+":"+we(i,2)+"Z":e||t?"T"+we(t,2)+":"+we(e,2)+"Z":"")}function Py(n){var t=new RegExp('["'+n+`
\r]`),e=n.charCodeAt(0);function i(h,f){var p,_,v=r(h,function(m,d){if(p)return p(m,d-1);_=m,p=f?Ay(m,f):wh(m)});return v.columns=_||[],v}function r(h,f){var p=[],_=h.length,v=0,m=0,d,T=_<=0,w=!1;h.charCodeAt(_-1)===hr&&--_,h.charCodeAt(_-1)===Vo&&--_;function S(){if(T)return ko;if(w)return w=!1,jc;var P,A=v,C;if(h.charCodeAt(A)===Ho){for(;v++<_&&h.charCodeAt(v)!==Ho||h.charCodeAt(++v)===Ho;);return(P=v)>=_?T=!0:(C=h.charCodeAt(v++))===hr?w=!0:C===Vo&&(w=!0,h.charCodeAt(v)===hr&&++v),h.slice(A+1,P-1).replace(/""/g,'"')}for(;v<_;){if((C=h.charCodeAt(P=v++))===hr)w=!0;else if(C===Vo)w=!0,h.charCodeAt(v)===hr&&++v;else if(C!==e)continue;return h.slice(A,P)}return T=!0,h.slice(A,_)}for(;(d=S())!==ko;){for(var D=[];d!==jc&&d!==ko;)D.push(d),d=S();f&&(D=f(D,m++))==null||p.push(D)}return p}function s(h,f){return h.map(function(p){return f.map(function(_){return u(p[_])}).join(n)})}function o(h,f){return f==null&&(f=Jc(h)),[f.map(u).join(n)].concat(s(h,f)).join(`
`)}function a(h,f){return f==null&&(f=Jc(h)),s(h,f).join(`
`)}function c(h){return h.map(l).join(`
`)}function l(h){return h.map(u).join(n)}function u(h){return h==null?"":h instanceof Date?Cy(h):t.test(h+="")?'"'+h.replace(/"/g,'""')+'"':h}return{parse:i,parseRows:r,format:o,formatBody:a,formatRows:c,formatRow:l,formatValue:u}}var Dy=Py(","),Ly=Dy.parse;function Iy(n){if(!n.ok)throw new Error(n.status+" "+n.statusText);return n.text()}function Uy(n,t){return fetch(n,t).then(Iy)}function Ny(n){return function(t,e,i){return arguments.length===2&&typeof e=="function"&&(i=e,e=void 0),Uy(t,e).then(function(r){return n(r,i)})}}var fs=Ny(Ly);function Fy(n){if(!n.ok)throw new Error(n.status+" "+n.statusText);if(!(n.status===204||n.status===205))return n.json()}function Oy(n,t){return fetch(n,t).then(Fy)}function By(n){return Math.abs(n=Math.round(n))>=1e21?n.toLocaleString("en").replace(/,/g,""):n.toString(10)}function Hs(n,t){if((e=(n=t?n.toExponential(t-1):n.toExponential()).indexOf("e"))<0)return null;var e,i=n.slice(0,e);return[i.length>1?i[0]+i.slice(2):i,+n.slice(e+1)]}function Ki(n){return n=Hs(Math.abs(n)),n?n[1]:NaN}function zy(n,t){return function(e,i){for(var r=e.length,s=[],o=0,a=n[0],c=0;r>0&&a>0&&(c+a+1>i&&(a=Math.max(1,i-c)),s.push(e.substring(r-=a,r+a)),!((c+=a+1)>i));)a=n[o=(o+1)%n.length];return s.reverse().join(t)}}function ky(n){return function(t){return t.replace(/[0-9]/g,function(e){return n[+e]})}}var Hy=/^(?:(.)?([<>=^]))?([+\-( ])?([$#])?(0)?(\d+)?(,)?(\.\d+)?(~)?([a-z%])?$/i;function Vs(n){if(!(t=Hy.exec(n)))throw new Error("invalid format: "+n);var t;return new Sl({fill:t[1],align:t[2],sign:t[3],symbol:t[4],zero:t[5],width:t[6],comma:t[7],precision:t[8]&&t[8].slice(1),trim:t[9],type:t[10]})}Vs.prototype=Sl.prototype;function Sl(n){this.fill=n.fill===void 0?" ":n.fill+"",this.align=n.align===void 0?">":n.align+"",this.sign=n.sign===void 0?"-":n.sign+"",this.symbol=n.symbol===void 0?"":n.symbol+"",this.zero=!!n.zero,this.width=n.width===void 0?void 0:+n.width,this.comma=!!n.comma,this.precision=n.precision===void 0?void 0:+n.precision,this.trim=!!n.trim,this.type=n.type===void 0?"":n.type+""}Sl.prototype.toString=function(){return this.fill+this.align+this.sign+this.symbol+(this.zero?"0":"")+(this.width===void 0?"":Math.max(1,this.width|0))+(this.comma?",":"")+(this.precision===void 0?"":"."+Math.max(0,this.precision|0))+(this.trim?"~":"")+this.type};function Vy(n){t:for(var t=n.length,e=1,i=-1,r;e<t;++e)switch(n[e]){case".":i=r=e;break;case"0":i===0&&(i=e),r=e;break;default:if(!+n[e])break t;i>0&&(i=0);break}return i>0?n.slice(0,i)+n.slice(r+1):n}var bh;function Gy(n,t){var e=Hs(n,t);if(!e)return n+"";var i=e[0],r=e[1],s=r-(bh=Math.max(-8,Math.min(8,Math.floor(r/3)))*3)+1,o=i.length;return s===o?i:s>o?i+new Array(s-o+1).join("0"):s>0?i.slice(0,s)+"."+i.slice(s):"0."+new Array(1-s).join("0")+Hs(n,Math.max(0,t+s-1))[0]}function Qc(n,t){var e=Hs(n,t);if(!e)return n+"";var i=e[0],r=e[1];return r<0?"0."+new Array(-r).join("0")+i:i.length>r+1?i.slice(0,r+1)+"."+i.slice(r+1):i+new Array(r-i.length+2).join("0")}const tu={"%":(n,t)=>(n*100).toFixed(t),b:n=>Math.round(n).toString(2),c:n=>n+"",d:By,e:(n,t)=>n.toExponential(t),f:(n,t)=>n.toFixed(t),g:(n,t)=>n.toPrecision(t),o:n=>Math.round(n).toString(8),p:(n,t)=>Qc(n*100,t),r:Qc,s:Gy,X:n=>Math.round(n).toString(16).toUpperCase(),x:n=>Math.round(n).toString(16)};function eu(n){return n}var nu=Array.prototype.map,iu=["y","z","a","f","p","n","µ","m","","k","M","G","T","P","E","Z","Y"];function Wy(n){var t=n.grouping===void 0||n.thousands===void 0?eu:zy(nu.call(n.grouping,Number),n.thousands+""),e=n.currency===void 0?"":n.currency[0]+"",i=n.currency===void 0?"":n.currency[1]+"",r=n.decimal===void 0?".":n.decimal+"",s=n.numerals===void 0?eu:ky(nu.call(n.numerals,String)),o=n.percent===void 0?"%":n.percent+"",a=n.minus===void 0?"−":n.minus+"",c=n.nan===void 0?"NaN":n.nan+"";function l(h){h=Vs(h);var f=h.fill,p=h.align,_=h.sign,v=h.symbol,m=h.zero,d=h.width,T=h.comma,w=h.precision,S=h.trim,D=h.type;D==="n"?(T=!0,D="g"):tu[D]||(w===void 0&&(w=12),S=!0,D="g"),(m||f==="0"&&p==="=")&&(m=!0,f="0",p="=");var P=v==="$"?e:v==="#"&&/[boxX]/.test(D)?"0"+D.toLowerCase():"",A=v==="$"?i:/[%p]/.test(D)?o:"",C=tu[D],y=/[defgprs%]/.test(D);w=w===void 0?6:/[gprs]/.test(D)?Math.max(1,Math.min(21,w)):Math.max(0,Math.min(20,w));function x(b){var z=P,O=A,$,j,Z;if(D==="c")O=C(b)+O,b="";else{b=+b;var et=b<0||1/b<0;if(b=isNaN(b)?c:C(Math.abs(b),w),S&&(b=Vy(b)),et&&+b==0&&_!=="+"&&(et=!1),z=(et?_==="("?_:a:_==="-"||_==="("?"":_)+z,O=(D==="s"?iu[8+bh/3]:"")+O+(et&&_==="("?")":""),y){for($=-1,j=b.length;++$<j;)if(Z=b.charCodeAt($),48>Z||Z>57){O=(Z===46?r+b.slice($+1):b.slice($))+O,b=b.slice(0,$);break}}}T&&!m&&(b=t(b,1/0));var X=z.length+b.length+O.length,W=X<d?new Array(d-X+1).join(f):"";switch(T&&m&&(b=t(W+b,W.length?d-O.length:1/0),W=""),p){case"<":b=z+b+O+W;break;case"=":b=z+W+b+O;break;case"^":b=W.slice(0,X=W.length>>1)+z+b+O+W.slice(X);break;default:b=W+z+b+O;break}return s(b)}return x.toString=function(){return h+""},x}function u(h,f){var p=l((h=Vs(h),h.type="f",h)),_=Math.max(-8,Math.min(8,Math.floor(Ki(f)/3)))*3,v=Math.pow(10,-_),m=iu[8+_/3];return function(d){return p(v*d)+m}}return{format:l,formatPrefix:u}}var ds,Ah,Rh;Xy({thousands:",",grouping:[3],currency:["$",""]});function Xy(n){return ds=Wy(n),Ah=ds.format,Rh=ds.formatPrefix,ds}function qy(n){return Math.max(0,-Ki(Math.abs(n)))}function Yy(n,t){return Math.max(0,Math.max(-8,Math.min(8,Math.floor(Ki(t)/3)))*3-Ki(Math.abs(n)))}function $y(n,t){return n=Math.abs(n),t=Math.abs(t)-n,Math.max(0,Ki(t)-Ki(n))+1}var Zy=Math.PI,Ky=Zy*2,jy=Math.abs,El=Math.sqrt;function je(){}function Gs(n,t){n&&su.hasOwnProperty(n.type)&&su[n.type](n,t)}var ru={Feature:function(n,t){Gs(n.geometry,t)},FeatureCollection:function(n,t){for(var e=n.features,i=-1,r=e.length;++i<r;)Gs(e[i].geometry,t)}},su={Sphere:function(n,t){t.sphere()},Point:function(n,t){n=n.coordinates,t.point(n[0],n[1],n[2])},MultiPoint:function(n,t){for(var e=n.coordinates,i=-1,r=e.length;++i<r;)n=e[i],t.point(n[0],n[1],n[2])},LineString:function(n,t){Ha(n.coordinates,t,0)},MultiLineString:function(n,t){for(var e=n.coordinates,i=-1,r=e.length;++i<r;)Ha(e[i],t,0)},Polygon:function(n,t){ou(n.coordinates,t)},MultiPolygon:function(n,t){for(var e=n.coordinates,i=-1,r=e.length;++i<r;)ou(e[i],t)},GeometryCollection:function(n,t){for(var e=n.geometries,i=-1,r=e.length;++i<r;)Gs(e[i],t)}};function Ha(n,t,e){var i=-1,r=n.length-e,s;for(t.lineStart();++i<r;)s=n[i],t.point(s[0],s[1],s[2]);t.lineEnd()}function ou(n,t){var e=-1,i=n.length;for(t.polygonStart();++e<i;)Ha(n[e],t,1);t.polygonEnd()}function fr(n,t){n&&ru.hasOwnProperty(n.type)?ru[n.type](n,t):Gs(n,t)}const Jy=n=>n;var Go=new Yi,Va=new Yi,Ch,Ph,Ga,Wa,xn={point:je,lineStart:je,lineEnd:je,polygonStart:function(){xn.lineStart=Qy,xn.lineEnd=eS},polygonEnd:function(){xn.lineStart=xn.lineEnd=xn.point=je,Go.add(jy(Va)),Va=new Yi},result:function(){var n=Go/2;return Go=new Yi,n}};function Qy(){xn.point=tS}function tS(n,t){xn.point=Dh,Ch=Ga=n,Ph=Wa=t}function Dh(n,t){Va.add(Wa*n-Ga*t),Ga=n,Wa=t}function eS(){Dh(Ch,Ph)}var ji=1/0,Ws=ji,Dr=-ji,Xs=Dr,au={point:nS,lineStart:je,lineEnd:je,polygonStart:je,polygonEnd:je,result:function(){var n=[[ji,Ws],[Dr,Xs]];return Dr=Xs=-(Ws=ji=1/0),n}};function nS(n,t){n<ji&&(ji=n),n>Dr&&(Dr=n),t<Ws&&(Ws=t),t>Xs&&(Xs=t)}var Xa=0,qa=0,vr=0,qs=0,Ys=0,Ii=0,Ya=0,$a=0,xr=0,Lh,Ih,on,an,ze={point:li,lineStart:lu,lineEnd:cu,polygonStart:function(){ze.lineStart=sS,ze.lineEnd=oS},polygonEnd:function(){ze.point=li,ze.lineStart=lu,ze.lineEnd=cu},result:function(){var n=xr?[Ya/xr,$a/xr]:Ii?[qs/Ii,Ys/Ii]:vr?[Xa/vr,qa/vr]:[NaN,NaN];return Xa=qa=vr=qs=Ys=Ii=Ya=$a=xr=0,n}};function li(n,t){Xa+=n,qa+=t,++vr}function lu(){ze.point=iS}function iS(n,t){ze.point=rS,li(on=n,an=t)}function rS(n,t){var e=n-on,i=t-an,r=El(e*e+i*i);qs+=r*(on+n)/2,Ys+=r*(an+t)/2,Ii+=r,li(on=n,an=t)}function cu(){ze.point=li}function sS(){ze.point=aS}function oS(){Uh(Lh,Ih)}function aS(n,t){ze.point=Uh,li(Lh=on=n,Ih=an=t)}function Uh(n,t){var e=n-on,i=t-an,r=El(e*e+i*i);qs+=r*(on+n)/2,Ys+=r*(an+t)/2,Ii+=r,r=an*n-on*t,Ya+=r*(on+n),$a+=r*(an+t),xr+=r*3,li(on=n,an=t)}function Nh(n){this._context=n}Nh.prototype={_radius:4.5,pointRadius:function(n){return this._radius=n,this},polygonStart:function(){this._line=0},polygonEnd:function(){this._line=NaN},lineStart:function(){this._point=0},lineEnd:function(){this._line===0&&this._context.closePath(),this._point=NaN},point:function(n,t){switch(this._point){case 0:{this._context.moveTo(n,t),this._point=1;break}case 1:{this._context.lineTo(n,t);break}default:{this._context.moveTo(n+this._radius,t),this._context.arc(n,t,this._radius,0,Ky);break}}},result:je};var Za=new Yi,Wo,Fh,Oh,Mr,yr,Lr={point:je,lineStart:function(){Lr.point=lS},lineEnd:function(){Wo&&Bh(Fh,Oh),Lr.point=je},polygonStart:function(){Wo=!0},polygonEnd:function(){Wo=null},result:function(){var n=+Za;return Za=new Yi,n}};function lS(n,t){Lr.point=Bh,Fh=Mr=n,Oh=yr=t}function Bh(n,t){Mr-=n,yr-=t,Za.add(El(Mr*Mr+yr*yr)),Mr=n,yr=t}let uu,$s,hu,fu;class du{constructor(t){this._append=t==null?zh:cS(t),this._radius=4.5,this._=""}pointRadius(t){return this._radius=+t,this}polygonStart(){this._line=0}polygonEnd(){this._line=NaN}lineStart(){this._point=0}lineEnd(){this._line===0&&(this._+="Z"),this._point=NaN}point(t,e){switch(this._point){case 0:{this._append`M${t},${e}`,this._point=1;break}case 1:{this._append`L${t},${e}`;break}default:{if(this._append`M${t},${e}`,this._radius!==hu||this._append!==$s){const i=this._radius,r=this._;this._="",this._append`m0,${i}a${i},${i} 0 1,1 0,${-2*i}a${i},${i} 0 1,1 0,${2*i}z`,hu=i,$s=this._append,fu=this._,this._=r}this._+=fu;break}}}result(){const t=this._;return this._="",t.length?t:null}}function zh(n){let t=1;this._+=n[0];for(const e=n.length;t<e;++t)this._+=arguments[t]+n[t]}function cS(n){const t=Math.floor(n);if(!(t>=0))throw new RangeError(`invalid digits: ${n}`);if(t>15)return zh;if(t!==uu){const e=10**t;uu=t,$s=function(r){let s=1;this._+=r[0];for(const o=r.length;s<o;++s)this._+=Math.round(arguments[s]*e)/e+r[s]}}return $s}function kh(n,t){let e=3,i=4.5,r,s;function o(a){return a&&(typeof i=="function"&&s.pointRadius(+i.apply(this,arguments)),fr(a,r(s))),s.result()}return o.area=function(a){return fr(a,r(xn)),xn.result()},o.measure=function(a){return fr(a,r(Lr)),Lr.result()},o.bounds=function(a){return fr(a,r(au)),au.result()},o.centroid=function(a){return fr(a,r(ze)),ze.result()},o.projection=function(a){return arguments.length?(r=a==null?(n=null,Jy):(n=a).stream,o):n},o.context=function(a){return arguments.length?(s=a==null?(t=null,new du(e)):new Nh(t=a),typeof i!="function"&&s.pointRadius(i),o):t},o.pointRadius=function(a){return arguments.length?(i=typeof a=="function"?a:(s.pointRadius(+a),+a),o):i},o.digits=function(a){if(!arguments.length)return e;if(a==null)e=null;else{const c=Math.floor(a);if(!(c>=0))throw new RangeError(`invalid digits: ${a}`);e=c}return t===null&&(s=new du(e)),o},o.projection(n).digits(e).context(t)}function uS(n,t,e){return(t[0]-n[0])*(e[1]-n[1])-(t[1]-n[1])*(e[0]-n[0])}function hS(n,t){return n[0]-t[0]||n[1]-t[1]}function pu(n){const t=n.length,e=[0,1];let i=2,r;for(r=2;r<t;++r){for(;i>1&&uS(n[e[i-2]],n[e[i-1]],n[r])<=0;)--i;e[i++]=r}return e.slice(0,i)}function mu(n){if((e=n.length)<3)return null;var t,e,i=new Array(e),r=new Array(e);for(t=0;t<e;++t)i[t]=[+n[t][0],+n[t][1],t];for(i.sort(hS),t=0;t<e;++t)r[t]=[i[t][0],-i[t][1]];var s=pu(i),o=pu(r),a=o[0]===s[0],c=o[o.length-1]===s[s.length-1],l=[];for(t=s.length-1;t>=0;--t)l.push(n[i[s[t]][2]]);for(t=+a;t<o.length-c;++t)l.push(n[i[o[t]][2]]);return l}function fS(n,t){switch(arguments.length){case 0:break;case 1:this.range(n);break;default:this.range(t).domain(n);break}return this}function dS(n){return function(){return n}}function pS(n){return+n}var _u=[0,1];function Ui(n){return n}function Ka(n,t){return(t-=n=+n)?function(e){return(e-n)/t}:dS(isNaN(t)?NaN:.5)}function mS(n,t){var e;return n>t&&(e=n,n=t,t=e),function(i){return Math.max(n,Math.min(t,i))}}function _S(n,t,e){var i=n[0],r=n[1],s=t[0],o=t[1];return r<i?(i=Ka(r,i),s=e(o,s)):(i=Ka(i,r),s=e(s,o)),function(a){return s(i(a))}}function gS(n,t,e){var i=Math.min(n.length,t.length)-1,r=new Array(i),s=new Array(i),o=-1;for(n[i]<n[0]&&(n=n.slice().reverse(),t=t.slice().reverse());++o<i;)r[o]=Ka(n[o],n[o+1]),s[o]=e(t[o],t[o+1]);return function(a){var c=R0(n,a,1,i)-1;return s[c](r[c](a))}}function vS(n,t){return t.domain(n.domain()).range(n.range()).interpolate(n.interpolate()).clamp(n.clamp()).unknown(n.unknown())}function xS(){var n=_u,t=_u,e=vl,i,r,s,o=Ui,a,c,l;function u(){var f=Math.min(n.length,t.length);return o!==Ui&&(o=mS(n[0],n[f-1])),a=f>2?gS:_S,c=l=null,h}function h(f){return f==null||isNaN(f=+f)?s:(c||(c=a(n.map(i),t,e)))(i(o(f)))}return h.invert=function(f){return o(r((l||(l=a(t,n.map(i),Ye)))(f)))},h.domain=function(f){return arguments.length?(n=Array.from(f,pS),u()):n.slice()},h.range=function(f){return arguments.length?(t=Array.from(f),u()):t.slice()},h.rangeRound=function(f){return t=Array.from(f),e=Zx,u()},h.clamp=function(f){return arguments.length?(o=f?!0:Ui,u()):o!==Ui},h.interpolate=function(f){return arguments.length?(e=f,u()):e},h.unknown=function(f){return arguments.length?(s=f,h):s},function(f,p){return i=f,r=p,u()}}function MS(){return xS()(Ui,Ui)}function yS(n,t,e,i){var r=G0(n,t,e),s;switch(i=Vs(i??",f"),i.type){case"s":{var o=Math.max(Math.abs(n),Math.abs(t));return i.precision==null&&!isNaN(s=Yy(r,o))&&(i.precision=s),Rh(i,o)}case"":case"e":case"g":case"p":case"r":{i.precision==null&&!isNaN(s=$y(r,Math.max(Math.abs(n),Math.abs(t))))&&(i.precision=s-(i.type==="e"));break}case"f":case"%":{i.precision==null&&!isNaN(s=qy(r))&&(i.precision=s-(i.type==="%")*2);break}}return Ah(i)}function SS(n){var t=n.domain;return n.ticks=function(e){var i=t();return dl(i[0],i[i.length-1],e??10)},n.tickFormat=function(e,i){var r=t();return yS(r[0],r[r.length-1],e??10,i)},n.nice=function(e){e==null&&(e=10);var i=t(),r=0,s=i.length-1,o=i[r],a=i[s],c,l,u=10;for(a<o&&(l=o,o=a,a=l,l=r,r=s,s=l);u-- >0;){if(l=Is(o,a,e),l===c)return i[r]=o,i[s]=a,t(i);if(l>0)o=Math.floor(o/l)*l,a=Math.ceil(a/l)*l;else if(l<0)o=Math.ceil(o*l)/l,a=Math.floor(a*l)/l;else break;c=l}return n},n}function ja(){var n=MS();return n.copy=function(){return vS(n,ja())},fS.apply(n,arguments),SS(n)}function Sr(n,t,e){this.k=n,this.x=t,this.y=e}Sr.prototype={constructor:Sr,scale:function(n){return n===1?this:new Sr(this.k*n,this.x,this.y)},translate:function(n,t){return n===0&t===0?this:new Sr(this.k,this.x+this.k*n,this.y+this.k*t)},apply:function(n){return[n[0]*this.k+this.x,n[1]*this.k+this.y]},applyX:function(n){return n*this.k+this.x},applyY:function(n){return n*this.k+this.y},invert:function(n){return[(n[0]-this.x)/this.k,(n[1]-this.y)/this.k]},invertX:function(n){return(n-this.x)/this.k},invertY:function(n){return(n-this.y)/this.k},rescaleX:function(n){return n.copy().domain(n.range().map(this.invertX,this).map(n.invert,n))},rescaleY:function(n){return n.copy().domain(n.range().map(this.invertY,this).map(n.invert,n))},toString:function(){return"translate("+this.x+","+this.y+") scale("+this.k+")"}};Sr.prototype;const Kn="/EleVis/",gu="mesh_frames_",ws=.034,ES=5,dr=[["elephant_Trunk4_bone","elephant_Snout_bone"],["elephant_Trunk2_bone","elephant_Trunk4_bone"],["elephant_Snout_bone","elephant_Head_bone"],["elephant_Head_bone","elephant_Neck_bone"],["elephant_Neck_bone","elephant_Spine3_bone"],["elephant_Spine3_bone","elephant_Spine2_bone"],["elephant_Spine2_bone","elephant_Pelvis_bone"],["elephant_Pelvis_bone","elephant_Tail2_bone"],["elephant_Head_bone","elephant_r_Ear1_bone"],["elephant_r_Ear1_bone","elephant_r_Ear4_bone"],["elephant_Head_bone","elephant_l_Ear1_bone"],["elephant_l_Ear1_bone","elephant_l_Ear4_bone"],["elephant_Neck_bone","elephant_r_Humerus_bone"],["elephant_Neck_bone","elephant_l_Humerus_bone"],["elephant_Pelvis_bone","elephant_r_Femur_bone"],["elephant_Pelvis_bone","elephant_l_Femur_bone"]];let ti=null,vu=0,Hi=10,Ji=()=>{},Er=null,bs=[],Hh=null,Pi=!1;window.globalTrackCSV=Er;window.globalCollCSV=Hh;window.dwellThreshold=Hi;window.computeDwellZones=Vh;function TS(){if(document.getElementById("dashboard"))return;const n=document.createElement("div");n.id="dashboard",n.style.cssText=`
    display:flex; gap:16px; align-items:flex-start;
    flex-wrap:nowrap; overflow-x:auto;
  `;const t=document.getElementById("viz")||(()=>{const o=document.createElementNS("http://www.w3.org/2000/svg","svg");return o.id="viz",o.setAttribute("width",1e3),o.setAttribute("height",1e3),o})(),e=document.createElement("div");e.style.cssText=`
  ...
  `;const r=document.createElement("div");r.id="viewer3DContainer",r.style.cssText=`
    width:1000px; height:1000px; background:#222; border-radius:8px;
    position:relative; overflow:hidden;
  `,i.appendChild(r);const s=document.body;n.appendChild(e),n.appendChild(i),s.appendChild(n)}function wS(n,t,e,i,r,s){const o=r-e,a=s-i;if(o===0&&a===0)return Math.hypot(n-e,t-i);const c=((n-e)*o+(t-i)*a)/(o*o+a*a),l=Math.max(0,Math.min(1,c)),u=e+l*o,h=i+l*a;return Math.hypot(n-u,t-h)}function Vh(n,t=.03,e=1){const i=new Map;return n.forEach(s=>{const o=+s.centroidA_x,a=+s.centroidA_z;if(!isFinite(o)||!isFinite(a))return;const c=`${o/t|0},${a/t|0}`;i.has(c)||i.set(c,[]),i.get(c).push({cx:o,cz:a})}),Array.from(i.values()).filter(s=>s.length>=e).map(s=>{const o=s.reduce((a,c)=>({cx:a.cx+c.cx,cz:a.cz+c.cz}),{cx:0,cz:0});return{cx:o.cx/s.length,cz:o.cz/s.length}})}function bS(n,t,e,i,r=1e3,s=1e3){const o=zi("#viz").selectAll("g#layer-heatmap").data([null]).join("g").attr("id","layer-heatmap").lower();o.selectAll("*").remove();const a=n.map(u=>({x:+u.contact_x,z:+u.contact_z||+u.contact_y})).filter(u=>isFinite(u.x)&&isFinite(u.z));if(!a.length){console.warn("No collision coords");return}const c=Th().x(u=>e(u.x)).y(u=>i(u.z)).size([r,s]).bandwidth(30)(a),l=ei(c,u=>u.value);o.selectAll("path").data(c).enter().append("path").attr("d",kh()).attr("fill","red").attr("fill-opacity",u=>u.value/l).attr("stroke","none")}function Xo(n,t,e,i=1e3,r=1e3){const s=zi("#viz").selectAll("g#layer-dwell-heatmap").data([null]).join("g").attr("id","layer-dwell-heatmap").lower();if(s.selectAll("*").remove(),!n?.length){console.warn("No dwell zones provided.");return}const o=n.map(({cx:l,cz:u})=>({x:+l,z:+u})).filter(l=>isFinite(l.x)&&isFinite(l.z));if(!o.length)return;const a=Th().x(l=>t(l.x)).y(l=>e(l.z)).size([i,r]).bandwidth(30)(o),c=ei(a,l=>l.value);s.selectAll("path").data(a).enter().append("path").attr("d",kh()).attr("fill","purple").attr("fill-opacity",l=>l.value/c).attr("stroke","none")}document.addEventListener("DOMContentLoaded",()=>{TS();let n=document.getElementById("overlay-line-layer");n||(n=document.createElementNS("http://www.w3.org/2000/svg","svg"),n.id="overlay-line-layer",n.setAttribute("width","100%"),n.setAttribute("height","100%"),Object.assign(n.style,{position:"absolute",inset:0,pointerEvents:"none",overflow:"visible",background:"transparent",zIndex:9998}),document.body.appendChild(n));const t=Object.assign({"/public/skeleton_tracking_20250626_094312.csv":()=>io(()=>import("./skeleton_tracking_20250626_094312-mk7Ol7QD.js"),[]).then(u=>u.default),"/public/skeleton_tracking_20250701_113425.csv":()=>io(()=>import("./skeleton_tracking_20250701_113425-CZfE7OGE.js"),[]).then(u=>u.default),"/public/skeleton_tracking_20250703_165735.csv":()=>io(()=>import("./skeleton_tracking_20250703_165735-C45-Qlt3.js"),[]).then(u=>u.default)}),e=Object.keys(t).map(u=>{const h=u.match(/skeleton_tracking_(\d{8}_\d{6})\.csv$/);return h?h[1]:null}).filter(Boolean).sort().reverse();e.length||(alert("No datasets found in /public"),console.warn("datasetUrls",t));const i=document.createElement("select");i.id="datasetSelect",i.style="margin:10px 0;padding:6px;font-size:14px;",e.forEach(u=>{const h=document.createElement("option");h.value=u,h.textContent=u,i.appendChild(h)}),document.body.insertBefore(i,document.getElementById("dashboard")),i.addEventListener("change",()=>xu(i.value)),e.length&&xu(e[0]);const s=1/.1,o=document.createElement("label");o.innerHTML='Dwell Threshold (s): <span id="dwellValue">1.0</span>',o.style="margin-left:20px;margin-right:5px;font-size:14px;",i.after(o);const a=document.createElement("input");a.type="range",a.min=.5,a.max=10,a.value=3.5,a.step=.1,a.style="vertical-align:middle",a.disabled=!0,o.appendChild(a),a.oninput=()=>{const u=+a.value;if(document.getElementById("dwellValue").textContent=u.toFixed(1),Hi=Math.round(u*s),typeof Ji=="function"){const h=+document.getElementById("stepSlider").value||0,f=+document.getElementById("skeletonSlider").value||1;Ji(h,f)}typeof window.refreshSliderTicks=="function"&&window.refreshSliderTicks()},a.oninput();const c=document.createElement("button");c.textContent="Toggle Interaction Heat-map",c.style="margin-left:8px;padding:6px 12px",c.disabled=!0,c.id="toggleHeatmap",i.after(c);const l=document.createElement("button");l.id="toggleDwellHeatmap",l.textContent="Toggle Dwell Heat-map",l.style="margin-left:8px;padding:6px 12px",l.disabled=!0,c.after(l)});function xu(n){ti=null,zi("#viz").selectAll("*").remove(),document.getElementById("viewer3DContainer").innerHTML="",Promise.all([fs(`${Kn}skeleton_tracking_${n}.csv`),fs(`${Kn}centroid_data_${n}_tracking.csv`),fs(`${Kn}centroid_data_${n}_collisions.csv`),Oy(`${Kn}skeleton_hierarchy_${n}.json`),fs(`${Kn}behaviours.csv`)]).then(([t,e,i,r,s])=>{Er=e,Hh=i,window.globalTrackCSV=e,window.globalCollCSV=i,window.dwellThreshold=Hi,bs=s.map(l=>({name:l[Object.keys(l)[1]],description:l[Object.keys(l)[2]]})),AS(t,e,i,r,n),typeof dwellSlider<"u"&&dwellSlider.oninput&&dwellSlider.oninput();const o=Vh(e,ws,ES);window._dwellZones=o,Pi&&window._dwellZones.length&&typeof window._scaleX=="function"&&typeof window._scaleZ=="function"&&Xo(window._dwellZones,window._scaleX,window._scaleZ),Pi&&o.length&&typeof window._scaleX=="function"&&typeof window._scaleZ=="function"&&Xo(o,window._scaleX,window._scaleZ);const a=document.getElementById("toggleHeatmap");if(a){a.disabled=!1;let l=!1;a.onclick=()=>{l=!l,a.textContent="Toggle Interaction Heat-map",l?bS(i,window._rects3D,window._scaleX,window._scaleZ):zi("#layer-heatmap").remove()}}const c=document.getElementById("toggleDwellHeatmap");if(c&&(c.disabled=!1,c.onclick=()=>{Pi=!Pi,c.textContent="Toggle Dwell Heat-map",Pi?Xo(window._dwellZones,window._scaleX,window._scaleZ):zi("#layer-dwell-heatmap").remove()}),typeof dwellSlider<"u"&&dwellSlider.oninput&&dwellSlider.oninput(),typeof window.refreshSliderTicks=="function"&&window.refreshSliderTicks(),typeof Ji=="function"){const l=+document.getElementById("stepSlider")?.value||0,u=+document.getElementById("skeletonSlider")?.value||1;Ji(l,u)}}).catch(t=>{alert("Failed to load data (see console)"),console.error(t)})}function Mu(){if(ti)return ti;const n=document.getElementById("viewer3DContainer");if(!n){console.warn("viewer3DContainer missing");return}const t=new md,e=new c0({antialias:!0});e.setSize(n.clientWidth,n.clientHeight),n.appendChild(e.domElement),t.background=new $t(16777215);const i=new Gu,r=new h0(i,e.domElement);r.enablePan=!0,r.enableZoom=!0,r.enableRotate=!0,t.add(new Td(16777215,3355443,1));const s=new pr;return t.add(s),ti={scene:t,group:s,cam:i,renderer:e,controls:r,dwellAnims:[]},function o(){requestAnimationFrame(o),r.update(),e.render(t,i)}(),ti}function AS(n,t,e,i,r){document.querySelector("input[type=range][disabled]")?.removeAttribute("disabled");const s=document.getElementById("stepSlider"),o=document.getElementById("skeletonSlider");document.getElementById("stepValue"),document.getElementById("skeletonValue");function a(W,nt){window.refreshSliderTicks=()=>{const st=(()=>{const ut=new Set,at=Er.map(Rt=>({x:+Rt.centroidA_x,z:+Rt.centroidA_z,t:Rt.time})).filter(Rt=>isFinite(Rt.x)&&isFinite(Rt.z)),dt=new Set;for(let Rt=0;Rt<at.length;Rt++){const{x:Et,z:Zt,t:qt}=at[Rt];if(dt.has(qt))continue;const zt=at.filter(R=>Math.hypot(R.x-Et,R.z-Zt)<=ws&&!dt.has(R.t));zt.length<Hi||zt.forEach(R=>{ut.add(R.t),dt.add(R.t)})}return ut})();document.querySelectorAll("#collisionTicks, #dwellTicks").forEach(ut=>ut.remove()),a(W,st)};const ct=document.createElement("div");ct.id="hullSliderWrapper",ct.style.cssText=`
      position:relative;
      width:1000px;
      height:60px;
      margin-top:6px;

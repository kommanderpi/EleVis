...
#define LOW_PRECISION`),t}function a_(n){let t="SHADOWMAP_TYPE_BASIC";return n.shadowMapType===hc?t="SHADOWMAP_TYPE_PCF":n.shadowMapType===Ru?t="SHADOWMAP_TYPE_PCF_SOFT":n.shadowMapType===hn&&(t="SHADOWMAP_TYPE_VSM"),t}function o_(n){let t="ENVMAP_TYPE_CUBE";if(n.envMap)switch(n.envMapMode){case Ei:case Ti:t="ENVMAP_TYPE_CUBE";break;case us:t="ENVMAP_TYPE_CUBE_UV";break}return t}function l_(n){let t="ENVMAP_MODE_REFLECTION";if(n.envMap)switch(n.envMapMode){case Ti:t="ENVMAP_MODE_REFRACTION";break}return t}function c_(n){let t="ENVMAP_BLENDING_NONE";if(n.envMap)switch(n.combine){case eo:t="ENVMAP_BLENDING_MULTIPLY";break;case Yu:t="ENVMAP_BLENDING_MIX";break;case $u:t="ENVMAP_BLENDING_ADD";break}return t}function u_(n){const t=n.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,i=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),7*16)),texelHeight:i,maxMip:e}}function h_(n,t,e,i){const r=n.getContext(),s=e.defines;let a=e.vertexShader,o=e.fragmentShader;const l=a_(e),c=o_(e),u=l_(e),h=c_(e),f=u_(e),p=Jm(e),g=Qm(s),x=r.createProgram();let m,d,w=e.glslVersion?"#version "+e.glslVersion+`
...
`)+`
`+d);const b=w+m+a,y=w+d+o,D=Sl(r,r.VERTEX_SHADER,b),C=Sl(r,r.FRAGMENT_SHADER,y);r.attachShader(x,D),r.attachShader(x,C),e.index0AttributeName!==void 0?r.bindAttribLocation(x,0,e.index0AttributeName):e.morphTargets===!0&&r.bindAttribLocation(x,0,"position"),r.linkProgram(x);function R(E){if(n.debug.checkShaderErrors){const O=r.getProgramInfoLog(x).trim(),I=r.getShaderInfoLog(D).trim(),H=r.getShaderInfoLog(C).trim();let q=!0,W=!0;if(r.getProgramParameter(x,r.LINK_STATUS)===!1)if(q=!1,typeof n.debug.onShaderError=="function")n.debug.onShaderError(r,x,D,C);else{const j=El(r,D,"vertex"),z=El(r,C,"fragment");console.error("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(x,r.VALIDATE_STATUS)+`
...
Program Info Log: `+O+`
`+j+`
`+z)}else O!==""?console.warn("THREE.WebGLProgram: Program Info Log:",O):(I===""||H==="")&&(W=!1);W&&(E.diagnostics={runnable:q,programLog:O,vertexShader:{log:I,prefix:m},fragmentShader:{log:H,prefix:d}})}r.deleteShader(D),r.deleteShader(C),L=new Vr(r,x),S=t_(r,x)}let L;this.getUniforms=function(){return L===void 0&&R(this),L};let S;this.getAttributes=function(){return S===void 0&&R(this),S};let v=e.rendererExtensionParallelShaderCompile===!1;return this.isReady=function(){return v===!1&&(v=r.getProgramParameter(x,Xm)),v},this.destroy=function(){i.releaseStatesOfProgram(this),r.deleteProgram(x),this.program=void 0},this.type=e.shaderType,this.name=e.shaderName,this.id=qm++,this.cacheKey=t,this.usedTimes=1,this.program=x,this.vertexShader=D,this.fragmentShader=C,this}let f_=0;class d_{constructor(){this.shaderCache=new Map,this.materialCache=new Map}update(t){const e=t.vertexShader,i=t.fragmentShader,r=this._getShaderStage(e),s=this._getShaderStage(i),a=this._getShaderCacheForMaterial(t);return a.has(r)===!1&&(a.add(r),r.usedTimes++),a.has(s)===!1&&(a.add(s),s.usedTimes++),this}remove(t){const e=this.materialCache.get(t);for(const i of e)i.usedTimes--,i.usedTimes===0&&this.shaderCache.delete(i.code);return this.materialCache.delete(t),this}getVertexShaderID(t){return this._getShaderStage(t.vertexShader).id}getFragmentShaderID(t){return this._getShaderStage(t.fragmentShader).id}dispose(){this.shaderCache.clear(),this.materialCache.clear()}_getShaderCacheForMaterial(t){const e=this.materialCache;let i=e.get(t);return i===void 0&&(i=new Set,e.set(t,i)),i}_getShaderStage(t){const e=this.shaderCache;let i=e.get(t);return i===void 0&&(i=new p_(t),e.set(t,i)),i}}class p_{constructor(t){this.id=f_++,this.code=t,this.usedTimes=0}}function m_(n,t,e,i,r,s,a){const o=new Tc,l=new d_,c=new Set,u=[],h=r.logarithmicDepthBuffer,f=r.vertexTextures;let p=r.precision;const g={MeshDepthMaterial:"depth",MeshDistanceMaterial:"distanceRGBA",MeshNormalMaterial:"normal",MeshBasicMaterial:"basic",MeshLambertMaterial:"lambert",MeshPhongMaterial:"phong",MeshToonMaterial:"toon",MeshStandardMaterial:"physical",MeshPhysicalMaterial:"physical",MeshMatcapMaterial:"matcap",LineBasicMaterial:"basic",LineDashedMaterial:"dashed",PointsMaterial:"points",ShadowMaterial:"shadow",SpriteMaterial:"sprite"};function x(S){return c.add(S),S===0?"uv":`uv${S}`}function m(S,v,E,O,I){const H=O.fog,q=I.geometry,W=S.isMeshStandardMaterial?O.environment:null,j=(S.isMeshStandardMaterial?e:t).get(S.envMap||W),z=j&&j.mapping===us?j.image.height:null,nt=g[S.type];S.precision!==null&&(p=r.getMaxPrecision(S.precision),p!==S.precision&&console.warn("THREE.WebGLProgram.getParameters:",S.precision,"not supported, using",p,"instead."));const ht=q.morphAttributes.position||q.morphAttributes.normal||q.morphAttributes.color,yt=ht!==void 0?ht.length:0;let Ct=0;q.morphAttributes.position!==void 0&&(Ct=1),q.morphAttributes.normal!==void 0&&(Ct=2),q.morphAttributes.color!==void 0&&(Ct=3);let kt,X,tt,$;if(nt){const Zt=Qe[nt];kt=Zt.vertexShader,X=Zt.fragmentShader}else kt=S.vertexShader,X=S.fragmentShader,l.update(S),tt=l.getVertexShaderID(S),$=l.getFragmentShaderID(S);const Y=n.getRenderTarget(),G=n.state.buffers.depth.getReversed(),Q=I.isInstancedMesh===!0,it=I.isBatchedMesh===!0,lt=!!S.map,vt=!!S.matcap,ct=!!j,A=!!S.aoMap,Yt=!!S.lightMap,Bt=!!S.bumpMap,It=!!S.normalMap,pt=!!S.displacementMap,gt=!!S.emissiveMap,Et=!!S.metalnessMap,Pt=!!S.roughnessMap,Jt=S.anisotropy>0,T=S.clearcoat>0,_=S.dispersion>0,B=S.iridescence>0,Z=S.sheen>0,et=S.transmission>0,K=Jt&&!!S.anisotropyMap,xt=T&&!!S.clearcoatMap,ut=T&&!!S.clearcoatNormalMap,bt=T&&!!S.clearcoatRoughnessMap,Rt=B&&!!S.iridescenceMap,rt=B&&!!S.iridescenceThicknessMap,Mt=Z&&!!S.sheenColorMap,Nt=Z&&!!S.sheenRoughnessMap,Ut=!!S.specularMap,ft=!!S.specularColorMap,zt=!!S.specularIntensityMap,P=et&&!!S.transmissionMap,mt=et&&!!S.thicknessMap,st=!!S.gradientMap,Tt=!!S.alphaMap,at=S.alphaTest>0,J=!!S.alphaHash,At=!!S.extensions;let Ht=Rn;S.toneMapped&&(Y===null||Y.isXRRenderTarget===!0)&&(Ht=n.toneMapping);const ie={shaderID:nt,shaderType:S.type,shaderName:S.name,vertexShader:kt,fragmentShader:X,defines:S.defines,customVertexShaderID:tt,customFragmentShaderID:$,isRawShaderMaterial:S.isRawShaderMaterial===!0,glslVersion:S.glslVersion,precision:p,batching:it,batchingColor:it&&I._colorsTexture!==null,instancing:Q,instancingColor:Q&&I.instanceColor!==null,instancingMorph:Q&&I.morphTexture!==null,supportsVertexTextures:f,outputColorSpace:Y===null?n.outputColorSpace:Y.isXRRenderTarget===!0?Y.texture.colorSpace:bi,alphaToCoverage:!!S.alphaToCoverage,map:lt,matcap:vt,envMap:ct,envMapMode:ct&&j.mapping,envMapCubeUVHeight:z,aoMap:A,lightMap:Yt,bumpMap:Bt,normalMap:It,displacementMap:f&&pt,emissiveMap:gt,normalMapObjectSpace:It&&S.normalMapType===sh,normalMapTangentSpace:It&&S.normalMapType===lo,metalnessMap:Et,roughnessMap:Pt,anisotropy:Jt,anisotropyMap:K,clearcoat:T,clearcoatMap:xt,clearcoatNormalMap:ut,clearcoatRoughnessMap:bt,dispersion:_,iridescence:B,iridescenceMap:Rt,iridescenceThicknessMap:rt,sheen:Z,sheenColorMap:Mt,sheenRoughnessMap:Nt,specularMap:Ut,specularColorMap:ft,specularIntensityMap:zt,transmission:et,transmissionMap:P,thicknessMap:mt,gradientMap:st,opaque:S.transparent===!1&&S.blending===vi&&S.alphaToCoverage===!1,alphaMap:Tt,alphaTest:at,alphaHash:J,combine:S.combine,mapUv:lt&&x(S.map.channel),aoMapUv:A&&x(S.aoMap.channel),lightMapUv:Yt&&x(S.lightMap.channel),bumpMapUv:Bt&&x(S.bumpMap.channel),normalMapUv:It&&x(S.normalMap.channel),displacementMapUv:pt&&x(S.displacementMap.channel),emissiveMapUv:gt&&x(S.emissiveMap.channel),metalnessMapUv:Et&&x(S.metalnessMap.channel),roughnessMapUv:Pt&&x(S.roughnessMap.channel),anisotropyMapUv:K&&x(S.anisotropyMap.channel),clearcoatMapUv:xt&&x(S.clearcoatMap.channel),clearcoatNormalMapUv:ut&&x(S.clearcoatNormalMap.channel),clearcoatRoughnessMapUv:bt&&x(S.clearcoatRoughnessMap.channel),iridescenceMapUv:Rt&&x(S.iridescenceMap.channel),iridescenceThicknessMapUv:rt&&x(S.iridescenceThicknessMap.channel),sheenColorMapUv:Mt&&x(S.sheenColorMap.channel),sheenRoughnessMapUv:Nt&&x(S.sheenRoughnessMap.channel),specularMapUv:Ut&&x(S.specularMap.channel),specularColorMapUv:ft&&x(S.specularColorMap.channel),specularIntensityMapUv:zt&&x(S.specularIntensityMap.channel),transmissionMapUv:P&&x(S.transmissionMap.channel),thicknessMapUv:mt&&x(S.thicknessMap.channel),alphaMapUv:Tt&&x(S.alphaMap.channel),vertexTangents:!!q.attributes.tangent&&(It||Jt),vertexColors:S.vertexColors,vertexAlphas:S.vertexColors===!0&&!!q.attributes.color&&q.attributes.color.itemSize===4,pointsUvs:I.isPoints===!0&&!!q.attributes.uv&&(lt||Tt),fog:!!H,useFog:S.fog===!0,fogExp2:!!H&&H.isFogExp2,flatShading:S.flatShading===!0&&S.wireframe===!1,sizeAttenuation:S.sizeAttenuation===!0,logarithmicDepthBuffer:h,reverseDepthBuffer:G,skinning:I.isSkinnedMesh===!0,morphTargets:q.morphAttributes.position!==void 0,morphNormals:q.morphAttributes.normal!==void 0,morphColors:q.morphAttributes.color!==void 0,morphTargetsCount:yt,morphTextureStride:Ct,numDirLights:v.directional.length,numPointLights:v.point.length,numSpotLights:v.spot.length,numSpotLightMaps:v.spotLightMap.length,numRectAreaLights:v.rectArea.length,numHemiLights:v.hemi.length,numDirLightShadows:v.directionalShadowMap.length,numPointLightShadows:v.pointShadowMap.length,numSpotLightShadows:v.spotShadowMap.length,numSpotLightShadowsWithMaps:v.numSpotLightShadowsWithMaps,numLightProbes:v.numLightProbes,numClippingPlanes:a.numPlanes,numClipIntersection:a.numIntersection,dithering:S.dithering,shadowMapEnabled:n.shadowMap.enabled&&E.length>0,shadowMapType:n.shadowMap.type,toneMapping:Ht,decodeVideoTexture:lt&&S.map.isVideoTexture===!0&&jt.getTransfer(S.map.colorSpace)===te,decodeVideoTextureEmissive:gt&&S.emissiveMap.isVideoTexture===!0&&jt.getTransfer(S.emissiveMap.colorSpace)===te,premultipliedAlpha:S.premultipliedAlpha,doubleSided:S.side===fn,flipSided:S.side===Ae,useDepthPacking:S.depthPacking>=0,depthPacking:S.depthPacking||0,index0AttributeName:S.index0AttributeName,extensionClipCullDistance:At&&S.extensions.clipCullDistance===!0&&i.has("WEBGL_clip_cull_distance"),extensionMultiDraw:(At&&S.extensions.multiDraw===!0||it)&&i.has("WEBGL_multi_draw"),rendererExtensionParallelShaderCompile:i.has("KHR_parallel_shader_compile"),customProgramCacheKey:S.customProgramCacheKey()};return ie.vertexUv1s=c.has(1),ie.vertexUv2s=c.has(2),ie.vertexUv3s=c.has(3),c.clear(),ie}function d(S){const v=[];if(S.shaderID?v.push(S.shaderID):(v.push(S.customVertexShaderID),v.push(S.customFragmentShaderID)),S.defines!==void 0)for(const E in S.defines)v.push(E),v.push(S.defines[E]);return S.isRawShaderMaterial===!1&&(w(v,S),b(v,S),v.push(n.outputColorSpace)),v.push(S.customProgramCacheKey),v.join()}function w(S,v){S.push(v.precision),S.push(v.outputColorSpace),S.push(v.envMapMode),S.push(v.envMapCubeUVHeight),S.push(v.mapUv),S.push(v.alphaMapUv),S.push(v.lightMapUv),S.push(v.aoMapUv),S.push(v.bumpMapUv),S.push(v.normalMapUv),S.push(v.displacementMapUv),S.push(v.emissiveMapUv),S.push(v.metalnessMapUv),S.push(v.roughnessMapUv),S.push(v.anisotropyMapUv),S.push(v.clearcoatMapUv),S.push(v.clearcoatNormalMapUv),S.push(v.clearcoatRoughnessMapUv),S.push(v.iridescenceMapUv),S.push(v.iridescenceThicknessMapUv),S.push(v.sheenColorMapUv),S.push(v.sheenRoughnessMapUv),S.push(v.specularMapUv),S.push(v.specularColorMapUv),S.push(v.specularIntensityMapUv),S.push(v.transmissionMapUv),S.push(v.thicknessMapUv),S.push(v.combine),S.push(v.fogExp2),S.push(v.sizeAttenuation),S.push(v.morphTargetsCount),S.push(v.morphAttributeCount),S.push(v.numDirLights),S.push(v.numPointLights),S.push(v.numSpotLights),S.push(v.numSpotLightMaps),S.push(v.numHemiLights),S.push(v.numRectAreaLights),S.push(v.numDirLightShadows),S.push(v.numPointLightShadows),S.push(v.numSpotLightShadows),S.push(v.numSpotLightShadowsWithMaps),S.push(v.numLightProbes),S.push(v.shadowMapType),S.push(v.toneMapping),S.push(v.numClippingPlanes),S.push(v.numClipIntersection),S.push(v.depthPacking)}function b(S,v){o.disableAll(),v.supportsVertexTextures&&o.enable(0),v.instancing&&o.enable(1),v.instancingColor&&o.enable(2),v.instancingMorph&&o.enable(3),v.matcap&&o.enable(4),v.envMap&&o.enable(5),v.normalMapObjectSpace&&o.enable(6),v.normalMapTangentSpace&&o.enable(7),v.clearcoat&&o.enable(8),v.iridescence&&o.enable(9),v.alphaTest&&o.enable(10),v.vertexColors&&o.enable(11),v.vertexAlphas&&o.enable(12),v.vertexUv1s&&o.enable(13),v.vertexUv2s&&o.enable(14),v.vertexUv3s&&o.enable(15),v.vertexTangents&&o.enable(16),v.anisotropy&&o.enable(17),v.alphaHash&&o.enable(18),v.batching&&o.enable(19),v.dispersion&&o.enable(20),v.batchingColor&&o.enable(21),v.gradientMap&&o.enable(22),S.push(o.mask),o.disableAll(),v.fog&&o.enable(0),v.useFog&&o.enable(1),v.flatShading&&o.enable(2),v.logarithmicDepthBuffer&&o.enable(3),v.reverseDepthBuffer&&o.enable(4),v.skinning&&o.enable(5),v.morphTargets&&o.enable(6),v.morphNormals&&o.enable(7),v.morphColors&&o.enable(8),v.premultipliedAlpha&&o.enable(9),v.shadowMapEnabled&&o.enable(10),v.doubleSided&&o.enable(11),v.flipSided&&o.enable(12),v.useDepthPacking&&o.enable(13),v.dithering&&o.enable(14),v.transmission&&o.enable(15),v.sheen&&o.enable(16),v.opaque&&o.enable(17),v.pointsUvs&&o.enable(18),v.decodeVideoTexture&&o.enable(19),v.decodeVideoTextureEmissive&&o.enable(20),v.alphaToCoverage&&o.enable(21),S.push(o.mask)}function y(S){const v=g[S.type];let E;if(v){const O=Qe[v];E=Oh.clone(O.uniforms)}else E=S.uniforms;return E}function D(S,v){let E;for(let O=0,I=u.length;O<I;O++){const H=u[O];if(H.cacheKey===v){E=H,++E.usedTimes;break}}return E===void 0&&(E=new h_(n,v,S,s),u.push(E)),E}function C(S){if(--S.usedTimes===0){const v=u.indexOf(S);u[v]=u[u.length-1],u.pop(),S.destroy()}}function R(S){l.remove(S)}function L(){l.dispose()}return{getParameters:m,getProgramCacheKey:d,getUniforms:y,acquireProgram:D,releaseProgram:C,releaseShaderCache:R,programs:u,dispose:L}}function __(){let n=new WeakMap;function t(a){return n.has(a)}function e(a){let o=n.get(a);return o===void 0&&(o={},n.set(a,o)),o}function i(a){n.delete(a)}function r(a,o,l){n.get(a)[o]=l}function s(){n=new WeakMap}return{has:t,get:e,remove:i,update:r,dispose:s}}function g_(n,t){return n.groupOrder!==t.groupOrder?n.groupOrder-t.groupOrder:n.renderOrder!==t.renderOrder?n.renderOrder-t.renderOrder:n.material.id!==t.material.id?n.material.id-t.material.id:n.z!==t.z?n.z-t.z:n.id-t.id}function Rl(n,t){return n.groupOrder!==t.groupOrder?n.groupOrder-t.groupOrder:n.renderOrder!==t.renderOrder?n.renderOrder-t.renderOrder:n.z!==t.z?t.z-n.z:n.id-t.id}function Cl(){const n=[];let t=0;const e=[],i=[],r=[];function s(){t=0,e.length=0,i.length=0,r.length=0}function a(h,f,p,g,x,m){let d=n[t];return d===void 0?(d={id:h.id,object:h,geometry:f,material:p,groupOrder:g,renderOrder:h.renderOrder,z:x,group:m},n[t]=d):(d.id=h.id,d.object=h,d.geometry=f,d.material=p,d.groupOrder=g,d.renderOrder=h.renderOrder,d.z=x,d.group=m),t++,d}function o(h,f,p,g,x,m){const d=a(h,f,p,g,x,m);p.transmission>0?i.push(d):p.transparent===!0?r.push(d):e.push(d)}function l(h,f,p,g,x,m){const d=a(h,f,p,g,x,m);p.transmission>0?i.unshift(d):p.transparent===!0?r.unshift(d):e.unshift(d)}function c(h,f){e.length>1&&e.sort(h||g_),i.length>1&&i.sort(f||Rl),r.length>1&&r.sort(f||Rl)}function u(){for(let h=t,f=n.length;h<f;h++){const p=n[h];if(p.id===null)break;p.id=null,p.object=null,p.geometry=null,p.material=null,p.group=null}}return{opaque:e,transmissive:i,transparent:r,init:s,push:o,unshift:l,finish:u,sort:c}}function v_(){let n=new WeakMap;function t(i,r){const s=n.get(i);let a;return s===void 0?(a=new Cl,n.set(i,[a])):r>=s.length?(a=new Cl,s.push(a)):a=s[r],a}function e(){n=new WeakMap}return{get:t,dispose:e}}function x_(){const n={};return{get:function(t){if(n[t.id]!==void 0)return n[t.id];let e;switch(t.type){case"DirectionalLight":e={direction:new F,color:new $t};break;case"SpotLight":e={position:new F,direction:new F,color:new $t,distance:0,coneCos:0,penumbraCos:0,decay:0};break;case"PointLight":e={position:new F,color:new $t,distance:0,decay:0};break;case"HemisphereLight":e={direction:new F,skyColor:new $t,groundColor:new $t};break;case"RectAreaLight":e={color:new $t,position:new F,halfWidth:new F,halfHeight:new F};break}return n[t.id]=e,e}}}function M_(){const n={};return{get:function(t){if(n[t.id]!==void 0)return n[t.id];let e;switch(t.type){case"DirectionalLight":e={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Vt};break;case"SpotLight":e={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Vt};break;case"PointLight":e={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Vt,shadowCameraNear:1,shadowCameraFar:1e3};break}return n[t.id]=e,e}}}let S_=0;function y_(n,t){return(t.castShadow?2:0)-(n.castShadow?2:0)+(t.map?1:0)-(n.map?1:0)}function E_(n){const t=new x_,e=M_(),i={version:0,hash:{directionalLength:-1,pointLength:-1,spotLength:-1,rectAreaLength:-1,hemiLength:-1,numDirectionalShadows:-1,numPointShadows:-1,numSpotShadows:-1,numSpotMaps:-1,numLightProbes:-1},ambient:[0,0,0],probe:[],directional:[],directionalShadow:[],directionalShadowMap:[],directionalShadowMatrix:[],spot:[],spotLightMap:[],spotShadow:[],spotShadowMap:[],spotLightMatrix:[],rectArea:[],rectAreaLTC1:null,rectAreaLTC2:null,point:[],pointShadow:[],pointShadowMap:[],pointShadowMatrix:[],hemi:[],numSpotLightShadowsWithMaps:0,numLightProbes:0};for(let c=0;c<9;c++)i.probe.push(new F);const r=new F,s=new ce,a=new ce;function o(c){let u=0,h=0,f=0;for(let S=0;S<9;S++)i.probe[S].set(0,0,0);let p=0,g=0,x=0,m=0,d=0,w=0,b=0,y=0,D=0,C=0,R=0;c.sort(y_);for(let S=0,v=c.length;S<v;S++){const E=c[S],O=E.color,I=E.intensity,H=E.distance,q=E.shadow&&E.shadow.map?E.shadow.map.texture:null;if(E.isAmbientLight)u+=O.r*I,h+=O.g*I,f+=O.b*I;else if(E.isLightProbe){for(let W=0;W<9;W++)i.probe[W].addScaledVector(E.sh.coefficients[W],I);R++}else if(E.isDirectionalLight){const W=t.get(E);if(W.color.copy(E.color).multiplyScalar(E.intensity),E.castShadow){const j=E.shadow,z=e.get(E);z.shadowIntensity=j.intensity,z.shadowBias=j.bias,z.shadowNormalBias=j.normalBias,z.shadowRadius=j.radius,z.shadowMapSize=j.mapSize,i.directionalShadow[p]=z,i.directionalShadowMap[p]=q,i.directionalShadowMatrix[p]=E.shadow.matrix,w++}i.directional[p]=W,p++}else if(E.isSpotLight){const W=t.get(E);W.position.setFromMatrixPosition(E.matrixWorld),W.color.copy(O).multiplyScalar(I),W.distance=H,W.coneCos=Math.cos(E.angle),W.penumbraCos=Math.cos(E.angle*(1-E.penumbra)),W.decay=E.decay,i.spot[x]=W;const j=E.shadow;if(E.map&&(i.spotLightMap[D]=E.map,D++,j.updateMatrices(E),E.castShadow&&C++),i.spotLightMatrix[x]=j.matrix,E.castShadow){const z=e.get(E);z.shadowIntensity=j.intensity,z.shadowBias=j.bias,z.shadowNormalBias=j.normalBias,z.shadowRadius=j.radius,z.shadowMapSize=j.mapSize,i.spotShadow[x]=z,i.spotShadowMap[x]=q,y++}x++}else if(E.isRectAreaLight){const W=t.get(E);W.color.copy(O).multiplyScalar(I),W.halfWidth.set(E.width*.5,0,0),W.halfHeight.set(0,E.height*.5,0),i.rectArea[m]=W,m++}else if(E.isPointLight){const W=t.get(E);if(W.color.copy(E.color).multiplyScalar(E.intensity),W.distance=E.distance,W.decay=E.decay,E.castShadow){const j=E.shadow,z=e.get(E);z.shadowIntensity=j.intensity,z.shadowBias=j.bias,z.shadowNormalBias=j.normalBias,z.shadowRadius=j.radius,z.shadowMapSize=j.mapSize,z.shadowCameraNear=j.camera.near,z.shadowCameraFar=j.camera.far,i.pointShadow[g]=z,i.pointShadowMap[g]=q,i.pointShadowMatrix[g]=E.shadow.matrix,b++}i.point[g]=W,g++}else if(E.isHemisphereLight){const W=t.get(E);W.skyColor.copy(E.color).multiplyScalar(I),W.groundColor.copy(E.groundColor).multiplyScalar(I),i.hemi[d]=W,d++}}m>0&&(n.has("OES_texture_float_linear")===!0?(i.rectAreaLTC1=dt.LTC_FLOAT_1,i.rectAreaLTC2=dt.LTC_FLOAT_2):(i.rectAreaLTC1=dt.LTC_HALF_1,i.rectAreaLTC2=dt.LTC_HALF_2)),i.ambient[0]=u,i.ambient[1]=h,i.ambient[2]=f;const L=i.hash;(L.directionalLength!==p||L.pointLength!==g||L.spotLength!==x||L.rectAreaLength!==m||L.hemiLength!==d||L.numDirectionalShadows!==w||L.numPointShadows!==b||L.numSpotShadows!==y||L.numSpotMaps!==D||L.numLightProbes!==R)&&(i.directional.length=p,i.spot.length=x,i.rectArea.length=m,i.point.length=g,i.hemi.length=d,i.directionalShadow.length=w,i.directionalShadowMap.length=w,i.pointShadow.length=b,i.pointShadowMap.length=b,i.spotShadow.length=y,i.spotShadowMap.length=y,i.directionalShadowMatrix.length=w,i.pointShadowMatrix.length=b,i.spotLightMatrix.length=y+D-C,i.spotLightMap.length=D,i.numSpotLightShadowsWithMaps=C,i.numLightProbes=R,L.directionalLength=p,L.pointLength=g,L.spotLength=x,L.rectAreaLength=m,L.hemiLength=d,L.numDirectionalShadows=w,L.numPointShadows=b,L.numSpotShadows=y,L.numSpotMaps=D,L.numLightProbes=R,i.version=S_++)}function l(c,u){let h=0,f=0,p=0,g=0,x=0;const m=u.matrixWorldInverse;for(let d=0,w=c.length;d<w;d++){const b=c[d];if(b.isDirectionalLight){const y=i.directional[h];y.direction.setFromMatrixPosition(b.matrixWorld),r.setFromMatrixPosition(b.target.matrixWorld),y.direction.sub(r),y.direction.transformDirection(m),h++}else if(b.isSpotLight){const y=i.spot[p];y.position.setFromMatrixPosition(b.matrixWorld),y.position.applyMatrix4(m),y.direction.setFromMatrixPosition(b.matrixWorld),r.setFromMatrixPosition(b.target.matrixWorld),y.direction.sub(r),y.direction.transformDirection(m),p++}else if(b.isRectAreaLight){const y=i.rectArea[g];y.position.setFromMatrixPosition(b.matrixWorld),y.position.applyMatrix4(m),a.identity(),s.copy(b.matrixWorld),s.premultiply(m),a.extractRotation(s),y.halfWidth.set(b.width*.5,0,0),y.halfHeight.set(0,b.height*.5,0),y.halfWidth.applyMatrix4(a),y.halfHeight.applyMatrix4(a),g++}else if(b.isPointLight){const y=i.point[f];y.position.setFromMatrixPosition(b.matrixWorld),y.position.applyMatrix4(m),f++}else if(b.isHemisphereLight){const y=i.hemi[x];y.direction.setFromMatrixPosition(b.matrixWorld),y.direction.transformDirection(m),x++}}}return{setup:o,setupView:l,state:i}}function Pl(n){const t=new E_(n),e=[],i=[];function r(u){c.camera=u,e.length=0,i.length=0}function s(u){e.push(u)}function a(u){i.push(u)}function o(){t.setup(e)}function l(u){t.setupView(e,u)}const c={lightsArray:e,shadowsArray:i,camera:null,lights:t,transmissionRenderTarget:{}};return{init:r,state:c,setupLights:o,setupLightsView:l,pushLight:s,pushShadow:a}}function T_(n){let t=new WeakMap;function e(r,s=0){const a=t.get(r);let o;return a===void 0?(o=new Pl(n),t.set(r,[o])):s>=a.length?(o=new Pl(n),a.push(o)):o=a[s],o}function i(){t=new WeakMap}return{get:e,dispose:i}}const b_=`void main() {
	gl_Position = vec4( position, 1.0 );
...
}`;function w_(n,t,e){let i=new Dc;const r=new Vt,s=new Vt,a=new le,o=new Kh({depthPacking:rh}),l=new jh,c={},u=e.maxTextureSize,h={[Cn]:Ae,[Ae]:Cn,[fn]:fn},f=new Pn({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Vt},radius:{value:4}},vertexShader:b_,fragmentShader:A_}),p=f.clone();p.defines.HORIZONTAL_PASS=1;const g=new ze;g.setAttribute("position",new Le(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const x=new Be(g,f),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=hc;let d=this.type;this.render=function(C,R,L){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||C.length===0)return;const S=n.getRenderTarget(),v=n.getActiveCubeFace(),E=n.getActiveMipmapLevel(),O=n.state;O.setBlending(wn),O.buffers.color.setClear(1,1,1,1),O.buffers.depth.setTest(!0),O.setScissorTest(!1);const I=d!==hn&&this.type===hn,H=d===hn&&this.type!==hn;for(let q=0,W=C.length;q<W;q++){const j=C[q],z=j.shadow;if(z===void 0){console.warn("THREE.WebGLShadowMap:",j,"has no shadow.");continue}if(z.autoUpdate===!1&&z.needsUpdate===!1)continue;r.copy(z.mapSize);const nt=z.getFrameExtents();if(r.multiply(nt),s.copy(z.mapSize),(r.x>u||r.y>u)&&(r.x>u&&(s.x=Math.floor(u/nt.x),r.x=s.x*nt.x,z.mapSize.x=s.x),r.y>u&&(s.y=Math.floor(u/nt.y),r.y=s.y*nt.y,z.mapSize.y=s.y)),z.map===null||I===!0||H===!0){const yt=this.type!==hn?{minFilter:Ke,magFilter:Ke}:{};z.map!==null&&z.map.dispose(),z.map=new Kn(r.x,r.y,yt),z.map.texture.name=j.name+".shadowMap",z.camera.updateProjectionMatrix()}n.setRenderTarget(z.map),n.clear();const ht=z.getViewportCount();for(let yt=0;yt<ht;yt++){const Ct=z.getViewport(yt);a.set(s.x*Ct.x,s.y*Ct.y,s.x*Ct.z,s.y*Ct.w),O.viewport(a),z.updateMatrices(j,yt),i=z.getFrustum(),y(R,L,z.camera,j,this.type)}z.isPointLightShadow!==!0&&this.type===hn&&w(z,L),z.needsUpdate=!1}d=this.type,m.needsUpdate=!1,n.setRenderTarget(S,v,E)};function w(C,R){const L=t.update(x);f.defines.VSM_SAMPLES!==C.blurSamples&&(f.defines.VSM_SAMPLES=C.blurSamples,p.defines.VSM_SAMPLES=C.blurSamples,f.needsUpdate=!0,p.needsUpdate=!0),C.mapPass===null&&(C.mapPass=new Kn(r.x,r.y)),f.uniforms.shadow_pass.value=C.map.texture,f.uniforms.resolution.value=C.mapSize,f.uniforms.radius.value=C.radius,n.setRenderTarget(C.mapPass),n.clear(),n.renderBufferDirect(R,null,L,f,x,null),p.uniforms.shadow_pass.value=C.mapPass.texture,p.uniforms.resolution.value=C.mapSize,p.uniforms.radius.value=C.radius,n.setRenderTarget(C.map),n.clear(),n.renderBufferDirect(R,null,L,p,x,null)}function b(C,R,L,S){let v=null;const E=L.isPointLight===!0?C.customDistanceMaterial:C.customDepthMaterial;if(E!==void 0)v=E;else if(v=L.isPointLight===!0?l:o,n.localClippingEnabled&&R.clipShadows===!0&&Array.isArray(R.clippingPlanes)&&R.clippingPlanes.length!==0||R.displacementMap&&R.displacementScale!==0||R.alphaMap&&R.alphaTest>0||R.map&&R.alphaTest>0||R.alphaToCoverage===!0){const O=v.uuid,I=R.uuid;let H=c[O];H===void 0&&(H={},c[O]=H);let q=H[I];q===void 0&&(q=v.clone(),H[I]=q,R.addEventListener("dispose",D)),v=q}if(v.visible=R.visible,v.wireframe=R.wireframe,S===hn?v.side=R.shadowSide!==null?R.shadowSide:R.side:v.side=R.shadowSide!==null?R.shadowSide:h[R.side],v.alphaMap=R.alphaMap,v.alphaTest=R.alphaToCoverage===!0?.5:R.alphaTest,v.map=R.map,v.clipShadows=R.clipShadows,v.clippingPlanes=R.clippingPlanes,v.clipIntersection=R.clipIntersection,v.displacementMap=R.displacementMap,v.displacementScale=R.displacementScale,v.displacementBias=R.displacementBias,v.wireframeLinewidth=R.wireframeLinewidth,v.linewidth=R.linewidth,L.isPointLight===!0&&v.isMeshDistanceMaterial===!0){const O=n.properties.get(v);O.light=L}return v}function y(C,R,L,S,v){if(C.visible===!1)return;if(C.layers.test(R.layers)&&(C.isMesh||C.isLine||C.isPoints)&&(C.castShadow||C.receiveShadow&&v===hn)&&(!C.frustumCulled||i.intersectsObject(C))){C.modelViewMatrix.multiplyMatrices(L.matrixWorldInverse,C.matrixWorld);const I=t.update(C),H=C.material;if(Array.isArray(H)){const q=I.groups;for(let W=0,j=q.length;W<j;W++){const z=q[W],nt=H[z.materialIndex];if(nt&&nt.visible){const ht=b(C,nt,S,v);C.onBeforeShadow(n,C,R,L,I,ht,z),n.renderBufferDirect(L,null,I,ht,C,z),C.onAfterShadow(n,C,R,L,I,ht,z)}}}else if(H.visible){const q=b(C,H,S,v);C.onBeforeShadow(n,C,R,L,I,q,null),n.renderBufferDirect(L,null,I,q,C,null),C.onAfterShadow(n,C,R,L,I,q,null)}}const O=C.children;for(let I=0,H=O.length;I<H;I++)y(O[I],R,L,S,v)}function D(C){C.target.removeEventListener("dispose",D);for(const L in c){const S=c[L],v=C.target.uuid;v in S&&(S[v].dispose(),delete S[v])}}}const R_={[ra]:sa,[aa]:ca,[oa]:ua,[yi]:la,[sa]:ra,[ca]:aa,[ua]:oa,[la]:yi};function C_(n,t){function e(){let P=!1;const mt=new le;let st=null;const Tt=new le(0,0,0,0);return{setMask:function(at){st!==at&&!P&&(n.colorMask(at,at,at,at),st=at)},setLocked:function(at){P=at},setClear:function(at,J,At,Ht,ie){ie===!0&&(at*=Ht,J*=Ht,At*=Ht),mt.set(at,J,At,Ht),Tt.equals(mt)===!1&&(n.clearColor(at,J,At,Ht),Tt.copy(mt))},reset:function(){P=!1,st=null,Tt.set(-1,0,0,0)}}}function i(){let P=!1,mt=!1,st=null,Tt=null,at=null;return{setReversed:function(J){if(mt!==J){const At=t.get("EXT_clip_control");J?At.clipControlEXT(At.LOWER_LEFT_EXT,At.ZERO_TO_ONE_EXT):At.clipControlEXT(At.LOWER_LEFT_EXT,At.NEGATIVE_ONE_TO_ONE_EXT),mt=J;const Ht=at;at=null,this.setClear(Ht)}},getReversed:function(){return mt},setTest:function(J){J?Y(n.DEPTH_TEST):G(n.DEPTH_TEST)},setMask:function(J){st!==J&&!P&&(n.depthMask(J),st=J)},setFunc:function(J){if(mt&&(J=R_[J]),Tt!==J){switch(J){case ra:n.depthFunc(n.NEVER);break;case sa:n.depthFunc(n.ALWAYS);break;case aa:n.depthFunc(n.LESS);break;case yi:n.depthFunc(n.LEQUAL);break;case oa:n.depthFunc(n.EQUAL);break;case la:n.depthFunc(n.GEQUAL);break;case ca:n.depthFunc(n.GREATER);break;case ua:n.depthFunc(n.NOTEQUAL);break;default:n.depthFunc(n.LEQUAL)}Tt=J}},setLocked:function(J){P=J},setClear:function(J){at!==J&&(mt&&(J=1-J),n.clearDepth(J),at=J)},reset:function(){P=!1,st=null,Tt=null,at=null,mt=!1}}}function r(){let P=!1,mt=null,st=null,Tt=null,at=null,J=null,At=null,Ht=null,ie=null;return{setTest:function(Zt){P||(Zt?Y(n.STENCIL_TEST):G(n.STENCIL_TEST))},setMask:function(Zt){mt!==Zt&&!P&&(n.stencilMask(Zt),mt=Zt)},setFunc:function(Zt,ke,rn){(st!==Zt||Tt!==ke||at!==rn)&&(n.stencilFunc(Zt,ke,rn),st=Zt,Tt=ke,at=rn)},setOp:function(Zt,ke,rn){(J!==Zt||At!==ke||Ht!==rn)&&(n.stencilOp(Zt,ke,rn),J=Zt,At=ke,Ht=rn)},setLocked:function(Zt){P=Zt},setClear:function(Zt){ie!==Zt&&(n.clearStencil(Zt),ie=Zt)},reset:function(){P=!1,mt=null,st=null,Tt=null,at=null,J=null,At=null,Ht=null,ie=null}}}const s=new e,a=new i,o=new r,l=new WeakMap,c=new WeakMap;let u={},h={},f=new WeakMap,p=[],g=null,x=!1,m=null,d=null,w=null,b=null,y=null,D=null,C=null,R=new $t(0,0,0),L=0,S=!1,v=null,E=null,O=null,I=null,H=null;const q=n.getParameter(n.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let W=!1,j=0;const z=n.getParameter(n.VERSION);z.indexOf("WebGL")!==-1?(j=parseFloat(/^WebGL (\d)/.exec(z)[1]),W=j>=1):z.indexOf("OpenGL ES")!==-1&&(j=parseFloat(/^OpenGL ES (\d)/.exec(z)[1]),W=j>=2);let nt=null,ht={};const yt=n.getParameter(n.SCISSOR_BOX),Ct=n.getParameter(n.VIEWPORT),kt=new le().fromArray(yt),X=new le().fromArray(Ct);function tt(P,mt,st,Tt){const at=new Uint8Array(4),J=n.createTexture();n.bindTexture(P,J),n.texParameteri(P,n.TEXTURE_MIN_FILTER,n.NEAREST),n.texParameteri(P,n.TEXTURE_MAG_FILTER,n.NEAREST);for(let At=0;At<st;At++)P===n.TEXTURE_3D||P===n.TEXTURE_2D_ARRAY?n.texImage3D(mt,0,n.RGBA,1,1,Tt,0,n.RGBA,n.UNSIGNED_BYTE,at):n.texImage2D(mt+At,0,n.RGBA,1,1,0,n.RGBA,n.UNSIGNED_BYTE,at);return J}const $={};$[n.TEXTURE_2D]=tt(n.TEXTURE_2D,n.TEXTURE_2D,1),$[n.TEXTURE_CUBE_MAP]=tt(n.TEXTURE_CUBE_MAP,n.TEXTURE_CUBE_MAP_POSITIVE_X,6),$[n.TEXTURE_2D_ARRAY]=tt(n.TEXTURE_2D_ARRAY,n.TEXTURE_2D_ARRAY,1,1),$[n.TEXTURE_3D]=tt(n.TEXTURE_3D,n.TEXTURE_3D,1,1),s.setClear(0,0,0,1),a.setClear(1),o.setClear(0),Y(n.DEPTH_TEST),a.setFunc(yi),Bt(!1),It(Lo),Y(n.CULL_FACE),A(wn);function Y(P){u[P]!==!0&&(n.enable(P),u[P]=!0)}function G(P){u[P]!==!1&&(n.disable(P),u[P]=!1)}function Q(P,mt){return h[P]!==mt?(n.bindFramebuffer(P,mt),h[P]=mt,P===n.DRAW_FRAMEBUFFER&&(h[n.FRAMEBUFFER]=mt),P===n.FRAMEBUFFER&&(h[n.DRAW_FRAMEBUFFER]=mt),!0):!1}function it(P,mt){let st=p,Tt=!1;if(P){st=f.get(mt),st===void 0&&(st=[],f.set(mt,st));const at=P.textures;if(st.length!==at.length||st[0]!==n.COLOR_ATTACHMENT0){for(let J=0,At=at.length;J<At;J++)st[J]=n.COLOR_ATTACHMENT0+J;st.length=at.length,Tt=!0}}else st[0]!==n.BACK&&(st[0]=n.BACK,Tt=!0);Tt&&n.drawBuffers(st)}function lt(P){return g!==P?(n.useProgram(P),g=P,!0):!1}const vt={[kn]:n.FUNC_ADD,[Pu]:n.FUNC_SUBTRACT,[Du]:n.FUNC_REVERSE_SUBTRACT};vt[Lu]=n.MIN,vt[Iu]=n.MAX;const ct={[Uu]:n.ZERO,[Nu]:n.ONE,[Fu]:n.SRC_COLOR,[na]:n.SRC_ALPHA,[Vu]:n.SRC_ALPHA_SATURATE,[ku]:n.DST_COLOR,[Bu]:n.DST_ALPHA,[Ou]:n.ONE_MINUS_SRC_COLOR,[ia]:n.ONE_MINUS_SRC_ALPHA,[Hu]:n.ONE_MINUS_DST_COLOR,[zu]:n.ONE_MINUS_DST_ALPHA,[Gu]:n.CONSTANT_COLOR,[Wu]:n.ONE_MINUS_CONSTANT_COLOR,[Xu]:n.CONSTANT_ALPHA,[qu]:n.ONE_MINUS_CONSTANT_ALPHA};function A(P,mt,st,Tt,at,J,At,Ht,ie,Zt){if(P===wn){x===!0&&(G(n.BLEND),x=!1);return}if(x===!1&&(Y(n.BLEND),x=!0),P!==Cu){if(P!==m||Zt!==S){if((d!==kn||y!==kn)&&(n.blendEquation(n.FUNC_ADD),d=kn,y=kn),Zt)switch(P){case vi:n.blendFuncSeparate(n.ONE,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case Io:n.blendFunc(n.ONE,n.ONE);break;case Uo:n.blendFuncSeparate(n.ZERO,n.ONE_MINUS_SRC_COLOR,n.ZERO,n.ONE);break;case No:n.blendFuncSeparate(n.DST_COLOR,n.ONE_MINUS_SRC_ALPHA,n.ZERO,n.ONE);break;default:console.error("THREE.WebGLState: Invalid blending: ",P);break}else switch(P){case vi:n.blendFuncSeparate(n.SRC_ALPHA,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case Io:n.blendFuncSeparate(n.SRC_ALPHA,n.ONE,n.ONE,n.ONE);break;case Uo:console.error("THREE.WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case No:console.error("THREE.WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:console.error("THREE.WebGLState: Invalid blending: ",P);break}w=null,b=null,D=null,C=null,R.set(0,0,0),L=0,m=P,S=Zt}return}at=at||mt,J=J||st,At=At||Tt,(mt!==d||at!==y)&&(n.blendEquationSeparate(vt[mt],vt[at]),d=mt,y=at),(st!==w||Tt!==b||J!==D||At!==C)&&(n.blendFuncSeparate(ct[st],ct[Tt],ct[J],ct[At]),w=st,b=Tt,D=J,C=At),(Ht.equals(R)===!1||ie!==L)&&(n.blendColor(Ht.r,Ht.g,Ht.b,ie),R.copy(Ht),L=ie),m=P,S=!1}function Yt(P,mt){P.side===fn?G(n.CULL_FACE):Y(n.CULL_FACE);let st=P.side===Ae;mt&&(st=!st),Bt(st),P.blending===vi&&P.transparent===!1?A(wn):A(P.blending,P.blendEquation,P.blendSrc,P.blendDst,P.blendEquationAlpha,P.blendSrcAlpha,P.blendDstAlpha,P.blendColor,P.blendAlpha,P.premultipliedAlpha),a.setFunc(P.depthFunc),a.setTest(P.depthTest),a.setMask(P.depthWrite),s.setMask(P.colorWrite);const Tt=P.stencilWrite;o.setTest(Tt),Tt&&(o.setMask(P.stencilWriteMask),o.setFunc(P.stencilFunc,P.stencilRef,P.stencilFuncMask),o.setOp(P.stencilFail,P.stencilZFail,P.stencilZPass)),gt(P.polygonOffset,P.polygonOffsetFactor,P.polygonOffsetUnits),P.alphaToCoverage===!0?Y(n.SAMPLE_ALPHA_TO_COVERAGE):G(n.SAMPLE_ALPHA_TO_COVERAGE)}function Bt(P){v!==P&&(P?n.frontFace(n.CW):n.frontFace(n.CCW),v=P)}function It(P){P!==Au?(Y(n.CULL_FACE),P!==E&&(P===Lo?n.cullFace(n.BACK):P===wu?n.cullFace(n.FRONT):n.cullFace(n.FRONT_AND_BACK))):G(n.CULL_FACE),E=P}function pt(P){P!==O&&(W&&n.lineWidth(P),O=P)}function gt(P,mt,st){P?(Y(n.POLYGON_OFFSET_FILL),(I!==mt||H!==st)&&(n.polygonOffset(mt,st),I=mt,H=st)):G(n.POLYGON_OFFSET_FILL)}function Et(P){P?Y(n.SCISSOR_TEST):G(n.SCISSOR_TEST)}function Pt(P){P===void 0&&(P=n.TEXTURE0+q-1),nt!==P&&(n.activeTexture(P),nt=P)}function Jt(P,mt,st){st===void 0&&(nt===null?st=n.TEXTURE0+q-1:st=nt);let Tt=ht[st];Tt===void 0&&(Tt={type:void 0,texture:void 0},ht[st]=Tt),(Tt.type!==P||Tt.texture!==mt)&&(nt!==st&&(n.activeTexture(st),nt=st),n.bindTexture(P,mt||$[P]),Tt.type=P,Tt.texture=mt)}function T(){const P=ht[nt];P!==void 0&&P.type!==void 0&&(n.bindTexture(P.type,null),P.type=void 0,P.texture=void 0)}function _(){try{n.compressedTexImage2D(...arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function B(){try{n.compressedTexImage3D(...arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function Z(){try{n.texSubImage2D(...arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function et(){try{n.texSubImage3D(...arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function K(){try{n.compressedTexSubImage2D(...arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function xt(){try{n.compressedTexSubImage3D(...arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function ut(){try{n.texStorage2D(...arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function bt(){try{n.texStorage3D(...arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function Rt(){try{n.texImage2D(...arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function rt(){try{n.texImage3D(...arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function Mt(P){kt.equals(P)===!1&&(n.scissor(P.x,P.y,P.z,P.w),kt.copy(P))}function Nt(P){X.equals(P)===!1&&(n.viewport(P.x,P.y,P.z,P.w),X.copy(P))}function Ut(P,mt){let st=c.get(mt);st===void 0&&(st=new WeakMap,c.set(mt,st));let Tt=st.get(P);Tt===void 0&&(Tt=n.getUniformBlockIndex(mt,P.name),st.set(P,Tt))}function ft(P,mt){const Tt=c.get(mt).get(P);l.get(mt)!==Tt&&(n.uniformBlockBinding(mt,Tt,P.__bindingPointIndex),l.set(mt,Tt))}function zt(){n.disable(n.BLEND),n.disable(n.CULL_FACE),n.disable(n.DEPTH_TEST),n.disable(n.POLYGON_OFFSET_FILL),n.disable(n.SCISSOR_TEST),n.disable(n.STENCIL_TEST),n.disable(n.SAMPLE_ALPHA_TO_COVERAGE),n.blendEquation(n.FUNC_ADD),n.blendFunc(n.ONE,n.ZERO),n.blendFuncSeparate(n.ONE,n.ZERO,n.ONE,n.ZERO),n.blendColor(0,0,0,0),n.colorMask(!0,!0,!0,!0),n.clearColor(0,0,0,0),n.depthMask(!0),n.depthFunc(n.LESS),a.setReversed(!1),n.clearDepth(1),n.stencilMask(4294967295),n.stencilFunc(n.ALWAYS,0,4294967295),n.stencilOp(n.KEEP,n.KEEP,n.KEEP),n.clearStencil(0),n.cullFace(n.BACK),n.frontFace(n.CCW),n.polygonOffset(0,0),n.activeTexture(n.TEXTURE0),n.bindFramebuffer(n.FRAMEBUFFER,null),n.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),n.bindFramebuffer(n.READ_FRAMEBUFFER,null),n.useProgram(null),n.lineWidth(1),n.scissor(0,0,n.canvas.width,n.canvas.height),n.viewport(0,0,n.canvas.width,n.canvas.height),u={},nt=null,ht={},h={},f=new WeakMap,p=[],g=null,x=!1,m=null,d=null,w=null,b=null,y=null,D=null,C=null,R=new $t(0,0,0),L=0,S=!1,v=null,E=null,O=null,I=null,H=null,kt.set(0,0,n.canvas.width,n.canvas.height),X.set(0,0,n.canvas.width,n.canvas.height),s.reset(),a.reset(),o.reset()}return{buffers:{color:s,depth:a,stencil:o},enable:Y,disable:G,bindFramebuffer:Q,drawBuffers:it,useProgram:lt,setBlending:A,setMaterial:Yt,setFlipSided:Bt,setCullFace:It,setLineWidth:pt,setPolygonOffset:gt,setScissorTest:Et,activeTexture:Pt,bindTexture:Jt,unbindTexture:T,compressedTexImage2D:_,compressedTexImage3D:B,texImage2D:Rt,texImage3D:rt,updateUBOMapping:Ut,uniformBlockBinding:ft,texStorage2D:ut,texStorage3D:bt,texSubImage2D:Z,texSubImage3D:et,compressedTexSubImage2D:K,compressedTexSubImage3D:xt,scissor:Mt,viewport:Nt,reset:zt}}function P_(n,t,e,i,r,s,a){const o=t.has("WEBGL_multisampled_render_to_texture")?t.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new Vt,u=new WeakMap;let h;const f=new WeakMap;let p=!1;try{p=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function g(T,_){return p?new OffscreenCanvas(T,_):jr("canvas")}function x(T,_,B){let Z=1;const et=Jt(T);if((et.width>B||et.height>B)&&(Z=B/Math.max(et.width,et.height)),Z<1)if(typeof HTMLImageElement<"u"&&T instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&T instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&T instanceof ImageBitmap||typeof VideoFrame<"u"&&T instanceof VideoFrame){const K=Math.floor(Z*et.width),xt=Math.floor(Z*et.height);h===void 0&&(h=g(K,xt));const ut=_?g(K,xt):h;return ut.width=K,ut.height=xt,ut.getContext("2d").drawImage(T,0,0,K,xt),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+et.width+"x"+et.height+") to ("+K+"x"+xt+")."),ut}else return"data"in T&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+et.width+"x"+et.height+")."),T;return T}function m(T){return T.generateMipmaps}function d(T){n.generateMipmap(T)}function w(T){return T.isWebGLCubeRenderTarget?n.TEXTURE_CUBE_MAP:T.isWebGL3DRenderTarget?n.TEXTURE_3D:T.isWebGLArrayRenderTarget||T.isCompressedArrayTexture?n.TEXTURE_2D_ARRAY:n.TEXTURE_2D}function b(T,_,B,Z,et=!1){if(T!==null){if(n[T]!==void 0)return n[T];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+T+"'")}let K=_;if(_===n.RED&&(B===n.FLOAT&&(K=n.R32F),B===n.HALF_FLOAT&&(K=n.R16F),B===n.UNSIGNED_BYTE&&(K=n.R8)),_===n.RED_INTEGER&&(B===n.UNSIGNED_BYTE&&(K=n.R8UI),B===n.UNSIGNED_SHORT&&(K=n.R16UI),B===n.UNSIGNED_INT&&(K=n.R32UI),B===n.BYTE&&(K=n.R8I),B===n.SHORT&&(K=n.R16I),B===n.INT&&(K=n.R32I)),_===n.RG&&(B===n.FLOAT&&(K=n.RG32F),B===n.HALF_FLOAT&&(K=n.RG16F),B===n.UNSIGNED_BYTE&&(K=n.RG8)),_===n.RG_INTEGER&&(B===n.UNSIGNED_BYTE&&(K=n.RG8UI),B===n.UNSIGNED_SHORT&&(K=n.RG16UI),B===n.UNSIGNED_INT&&(K=n.RG32UI),B===n.BYTE&&(K=n.RG8I),B===n.SHORT&&(K=n.RG16I),B===n.INT&&(K=n.RG32I)),_===n.RGB_INTEGER&&(B===n.UNSIGNED_BYTE&&(K=n.RGB8UI),B===n.UNSIGNED_SHORT&&(K=n.RGB16UI),B===n.UNSIGNED_INT&&(K=n.RGB32UI),B===n.BYTE&&(K=n.RGB8I),B===n.SHORT&&(K=n.RGB16I),B===n.INT&&(K=n.RGB32I)),_===n.RGBA_INTEGER&&(B===n.UNSIGNED_BYTE&&(K=n.RGBA8UI),B===n.UNSIGNED_SHORT&&(K=n.RGBA16UI),B===n.UNSIGNED_INT&&(K=n.RGBA32UI),B===n.BYTE&&(K=n.RGBA8I),B===n.SHORT&&(K=n.RGBA16I),B===n.INT&&(K=n.RGBA32I)),_===n.RGB&&B===n.UNSIGNED_INT_5_9_9_9_REV&&(K=n.RGB9_E5),_===n.RGBA){const xt=et?$r:jt.getTransfer(Z);B===n.FLOAT&&(K=n.RGBA32F),B===n.HALF_FLOAT&&(K=n.RGBA16F),B===n.UNSIGNED_BYTE&&(K=xt===te?n.SRGB8_ALPHA8:n.RGBA8),B===n.UNSIGNED_SHORT_4_4_4_4&&(K=n.RGBA4),B===n.UNSIGNED_SHORT_5_5_5_1&&(K=n.RGB5_A1)}return(K===n.R16F||K===n.R32F||K===n.RG16F||K===n.RG32F||K===n.RGBA16F||K===n.RGBA32F)&&t.get("EXT_color_buffer_float"),K}function y(T,_){let B;return T?_===null||_===Yn||_===$i?B=n.DEPTH24_STENCIL8:_===dn?B=n.DEPTH32F_STENCIL8:_===Yi&&(B=n.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):_===null||_===Yn||_===$i?B=n.DEPTH_COMPONENT24:_===dn?B=n.DEPTH_COMPONENT32F:_===Yi&&(B=n.DEPTH_COMPONENT16),B}function D(T,_){return m(T)===!0||T.isFramebufferTexture&&T.minFilter!==Ke&&T.minFilter!==tn?Math.log2(Math.max(_.width,_.height))+1:T.mipmaps!==void 0&&T.mipmaps.length>0?T.mipmaps.length:T.isCompressedTexture&&Array.isArray(T.image)?_.mipmaps.length:1}function C(T){const _=T.target;_.removeEventListener("dispose",C),L(_),_.isVideoTexture&&u.delete(_)}function R(T){const _=T.target;_.removeEventListener("dispose",R),v(_)}function L(T){const _=i.get(T);if(_.__webglInit===void 0)return;const B=T.source,Z=f.get(B);if(Z){const et=Z[_.__cacheKey];et.usedTimes--,et.usedTimes===0&&S(T),Object.keys(Z).length===0&&f.delete(B)}i.remove(T)}function S(T){const _=i.get(T);n.deleteTexture(_.__webglTexture);const B=T.source,Z=f.get(B);delete Z[_.__cacheKey],a.memory.textures--}function v(T){const _=i.get(T);if(T.depthTexture&&(T.depthTexture.dispose(),i.remove(T.depthTexture)),T.isWebGLCubeRenderTarget)for(let Z=0;Z<6;Z++){if(Array.isArray(_.__webglFramebuffer[Z]))for(let et=0;et<_.__webglFramebuffer[Z].length;et++)n.deleteFramebuffer(_.__webglFramebuffer[Z][et]);else n.deleteFramebuffer(_.__webglFramebuffer[Z]);_.__webglDepthbuffer&&n.deleteRenderbuffer(_.__webglDepthbuffer[Z])}else{if(Array.isArray(_.__webglFramebuffer))for(let Z=0;Z<_.__webglFramebuffer.length;Z++)n.deleteFramebuffer(_.__webglFramebuffer[Z]);else n.deleteFramebuffer(_.__webglFramebuffer);if(_.__webglDepthbuffer&&n.deleteRenderbuffer(_.__webglDepthbuffer),_.__webglMultisampledFramebuffer&&n.deleteFramebuffer(_.__webglMultisampledFramebuffer),_.__webglColorRenderbuffer)for(let Z=0;Z<_.__webglColorRenderbuffer.length;Z++)_.__webglColorRenderbuffer[Z]&&n.deleteRenderbuffer(_.__webglColorRenderbuffer[Z]);_.__webglDepthRenderbuffer&&n.deleteRenderbuffer(_.__webglDepthRenderbuffer)}const B=T.textures;for(let Z=0,et=B.length;Z<et;Z++){const K=i.get(B[Z]);K.__webglTexture&&(n.deleteTexture(K.__webglTexture),a.memory.textures--),i.remove(B[Z])}i.remove(T)}let E=0;function O(){E=0}function I(){const T=E;return T>=r.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+T+" texture units while this GPU supports only "+r.maxTextures),E+=1,T}function H(T){const _=[];return _.push(T.wrapS),_.push(T.wrapT),_.push(T.wrapR||0),_.push(T.magFilter),_.push(T.minFilter),_.push(T.anisotropy),_.push(T.internalFormat),_.push(T.format),_.push(T.type),_.push(T.generateMipmaps),_.push(T.premultiplyAlpha),_.push(T.flipY),_.push(T.unpackAlignment),_.push(T.colorSpace),_.join()}function q(T,_){const B=i.get(T);if(T.isVideoTexture&&Et(T),T.isRenderTargetTexture===!1&&T.version>0&&B.__version!==T.version){const Z=T.image;if(Z===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(Z.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{$(B,T,_);return}}e.bindTexture(n.TEXTURE_2D,B.__webglTexture,n.TEXTURE0+_)}function W(T,_){const B=i.get(T);if(T.version>0&&B.__version!==T.version){$(B,T,_);return}e.bindTexture(n.TEXTURE_2D_ARRAY,B.__webglTexture,n.TEXTURE0+_)}function j(T,_){const B=i.get(T);if(T.version>0&&B.__version!==T.version){$(B,T,_);return}e.bindTexture(n.TEXTURE_3D,B.__webglTexture,n.TEXTURE0+_)}function z(T,_){const B=i.get(T);if(T.version>0&&B.__version!==T.version){Y(B,T,_);return}e.bindTexture(n.TEXTURE_CUBE_MAP,B.__webglTexture,n.TEXTURE0+_)}const nt={[da]:n.REPEAT,[Gn]:n.CLAMP_TO_EDGE,[pa]:n.MIRRORED_REPEAT},ht={[Ke]:n.NEAREST,[nh]:n.NEAREST_MIPMAP_NEAREST,[ar]:n.NEAREST_MIPMAP_LINEAR,[tn]:n.LINEAR,[xs]:n.LINEAR_MIPMAP_NEAREST,[Wn]:n.LINEAR_MIPMAP_LINEAR},yt={[ah]:n.NEVER,[fh]:n.ALWAYS,[oh]:n.LESS,[Sc]:n.LEQUAL,[lh]:n.EQUAL,[hh]:n.GEQUAL,[ch]:n.GREATER,[uh]:n.NOTEQUAL};function Ct(T,_){if(_.type===dn&&t.has("OES_texture_float_linear")===!1&&(_.magFilter===tn||_.magFilter===xs||_.magFilter===ar||_.magFilter===Wn||_.minFilter===tn||_.minFilter===xs||_.minFilter===ar||_.minFilter===Wn)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),n.texParameteri(T,n.TEXTURE_WRAP_S,nt[_.wrapS]),n.texParameteri(T,n.TEXTURE_WRAP_T,nt[_.wrapT]),(T===n.TEXTURE_3D||T===n.TEXTURE_2D_ARRAY)&&n.texParameteri(T,n.TEXTURE_WRAP_R,nt[_.wrapR]),n.texParameteri(T,n.TEXTURE_MAG_FILTER,ht[_.magFilter]),n.texParameteri(T,n.TEXTURE_MIN_FILTER,ht[_.minFilter]),_.compareFunction&&(n.texParameteri(T,n.TEXTURE_COMPARE_MODE,n.COMPARE_REF_TO_TEXTURE),n.texParameteri(T,n.TEXTURE_COMPARE_FUNC,yt[_.compareFunction])),t.has("EXT_texture_filter_anisotropic")===!0){if(_.magFilter===Ke||_.minFilter!==ar&&_.minFilter!==Wn||_.type===dn&&t.has("OES_texture_float_linear")===!1)return;if(_.anisotropy>1||i.get(_).__currentAnisotropy){const B=t.get("EXT_texture_filter_anisotropic");n.texParameterf(T,B.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(_.anisotropy,r.getMaxAnisotropy())),i.get(_).__currentAnisotropy=_.anisotropy}}}function kt(T,_){let B=!1;T.__webglInit===void 0&&(T.__webglInit=!0,_.addEventListener("dispose",C));const Z=_.source;let et=f.get(Z);et===void 0&&(et={},f.set(Z,et));const K=H(_);if(K!==T.__cacheKey){et[K]===void 0&&(et[K]={texture:n.createTexture(),usedTimes:0},a.memory.textures++,B=!0),et[K].usedTimes++;const xt=et[T.__cacheKey];xt!==void 0&&(et[T.__cacheKey].usedTimes--,xt.usedTimes===0&&S(_)),T.__cacheKey=K,T.__webglTexture=et[K].texture}return B}function X(T,_,B){return Math.floor(Math.floor(T/B)/_)}function tt(T,_,B,Z){const K=T.updateRanges;if(K.length===0)e.texSubImage2D(n.TEXTURE_2D,0,0,0,_.width,_.height,B,Z,_.data);else{K.sort((rt,Mt)=>rt.start-Mt.start);let xt=0;for(let rt=1;rt<K.length;rt++){const Mt=K[xt],Nt=K[rt],Ut=Mt.start+Mt.count,ft=X(Nt.start,_.width,4),zt=X(Mt.start,_.width,4);Nt.start<=Ut+1&&ft===zt&&X(Nt.start+Nt.count-1,_.width,4)===ft?Mt.count=Math.max(Mt.count,Nt.start+Nt.count-Mt.start):(++xt,K[xt]=Nt)}K.length=xt+1;const ut=n.getParameter(n.UNPACK_ROW_LENGTH),bt=n.getParameter(n.UNPACK_SKIP_PIXELS),Rt=n.getParameter(n.UNPACK_SKIP_ROWS);n.pixelStorei(n.UNPACK_ROW_LENGTH,_.width);for(let rt=0,Mt=K.length;rt<Mt;rt++){const Nt=K[rt],Ut=Math.floor(Nt.start/4),ft=Math.ceil(Nt.count/4),zt=Ut%_.width,P=Math.floor(Ut/_.width),mt=ft,st=1;n.pixelStorei(n.UNPACK_SKIP_PIXELS,zt),n.pixelStorei(n.UNPACK_SKIP_ROWS,P),e.texSubImage2D(n.TEXTURE_2D,0,zt,P,mt,st,B,Z,_.data)}T.clearUpdateRanges(),n.pixelStorei(n.UNPACK_ROW_LENGTH,ut),n.pixelStorei(n.UNPACK_SKIP_PIXELS,bt),n.pixelStorei(n.UNPACK_SKIP_ROWS,Rt)}}function $(T,_,B){let Z=n.TEXTURE_2D;(_.isDataArrayTexture||_.isCompressedArrayTexture)&&(Z=n.TEXTURE_2D_ARRAY),_.isData3DTexture&&(Z=n.TEXTURE_3D);const et=kt(T,_),K=_.source;e.bindTexture(Z,T.__webglTexture,n.TEXTURE0+B);const xt=i.get(K);if(K.version!==xt.__version||et===!0){e.activeTexture(n.TEXTURE0+B);const ut=jt.getPrimaries(jt.workingColorSpace),bt=_.colorSpace===An?null:jt.getPrimaries(_.colorSpace),Rt=_.colorSpace===An||ut===bt?n.NONE:n.BROWSER_DEFAULT_WEBGL;n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,_.flipY),n.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,_.premultiplyAlpha),n.pixelStorei(n.UNPACK_ALIGNMENT,_.unpackAlignment),n.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,Rt);let rt=x(_.image,!1,r.maxTextureSize);rt=Pt(_,rt);const Mt=s.convert(_.format,_.colorSpace),Nt=s.convert(_.type);let Ut=b(_.internalFormat,Mt,Nt,_.colorSpace,_.isVideoTexture);Ct(Z,_);let ft;const zt=_.mipmaps,P=_.isVideoTexture!==!0,mt=xt.__version===void 0||et===!0,st=K.dataReady,Tt=D(_,rt);if(_.isDepthTexture)Ut=y(_.format===ji,_.type),mt&&(P?e.texStorage2D(n.TEXTURE_2D,1,Ut,rt.width,rt.height):e.texImage2D(n.TEXTURE_2D,0,Ut,rt.width,rt.height,0,Mt,Nt,null));else if(_.isDataTexture)if(zt.length>0){P&&mt&&e.texStorage2D(n.TEXTURE_2D,Tt,Ut,zt[0].width,zt[0].height);for(let at=0,J=zt.length;at<J;at++)ft=zt[at],P?st&&e.texSubImage2D(n.TEXTURE_2D,at,0,0,ft.width,ft.height,Mt,Nt,ft.data):e.texImage2D(n.TEXTURE_2D,at,Ut,ft.width,ft.height,0,Mt,Nt,ft.data);_.generateMipmaps=!1}else P?(mt&&e.texStorage2D(n.TEXTURE_2D,Tt,Ut,rt.width,rt.height),st&&tt(_,rt,Mt,Nt)):e.texImage2D(n.TEXTURE_2D,0,Ut,rt.width,rt.height,0,Mt,Nt,rt.data);else if(_.isCompressedTexture)if(_.isCompressedArrayTexture){P&&mt&&e.texStorage3D(n.TEXTURE_2D_ARRAY,Tt,Ut,zt[0].width,zt[0].height,rt.depth);for(let at=0,J=zt.length;at<J;at++)if(ft=zt[at],_.format!==$e)if(Mt!==null)if(P){if(st)if(_.layerUpdates.size>0){const At=al(ft.width,ft.height,_.format,_.type);for(const Ht of _.layerUpdates){const ie=ft.data.subarray(Ht*At/ft.data.BYTES_PER_ELEMENT,(Ht+1)*At/ft.data.BYTES_PER_ELEMENT);e.compressedTexSubImage3D(n.TEXTURE_2D_ARRAY,at,0,0,Ht,ft.width,ft.height,1,Mt,ie)}_.clearLayerUpdates()}else e.compressedTexSubImage3D(n.TEXTURE_2D_ARRAY,at,0,0,0,ft.width,ft.height,rt.depth,Mt,ft.data)}else e.compressedTexImage3D(n.TEXTURE_2D_ARRAY,at,Ut,ft.width,ft.height,rt.depth,0,ft.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else P?st&&e.texSubImage3D(n.TEXTURE_2D_ARRAY,at,0,0,0,ft.width,ft.height,rt.depth,Mt,Nt,ft.data):e.texImage3D(n.TEXTURE_2D_ARRAY,at,Ut,ft.width,ft.height,rt.depth,0,Mt,Nt,ft.data)}else{P&&mt&&e.texStorage2D(n.TEXTURE_2D,Tt,Ut,zt[0].width,zt[0].height);for(let at=0,J=zt.length;at<J;at++)ft=zt[at],_.format!==$e?Mt!==null?P?st&&e.compressedTexSubImage2D(n.TEXTURE_2D,at,0,0,ft.width,ft.height,Mt,ft.data):e.compressedTexImage2D(n.TEXTURE_2D,at,Ut,ft.width,ft.height,0,ft.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):P?st&&e.texSubImage2D(n.TEXTURE_2D,at,0,0,ft.width,ft.height,Mt,Nt,ft.data):e.texImage2D(n.TEXTURE_2D,at,Ut,ft.width,ft.height,0,Mt,Nt,ft.data)}else if(_.isDataArrayTexture)if(P){if(mt&&e.texStorage3D(n.TEXTURE_2D_ARRAY,Tt,Ut,rt.width,rt.height,rt.depth),st)if(_.layerUpdates.size>0){const at=al(rt.width,rt.height,_.format,_.type);for(const J of _.layerUpdates){const At=rt.data.subarray(J*at/rt.data.BYTES_PER_ELEMENT,(J+1)*at/rt.data.BYTES_PER_ELEMENT);e.texSubImage3D(n.TEXTURE_2D_ARRAY,0,0,0,J,rt.width,rt.height,1,Mt,Nt,At)}_.clearLayerUpdates()}else e.texSubImage3D(n.TEXTURE_2D_ARRAY,0,0,0,0,rt.width,rt.height,rt.depth,Mt,Nt,rt.data)}else e.texImage3D(n.TEXTURE_2D_ARRAY,0,Ut,rt.width,rt.height,rt.depth,0,Mt,Nt,rt.data);else if(_.isData3DTexture)P?(mt&&e.texStorage3D(n.TEXTURE_3D,Tt,Ut,rt.width,rt.height,rt.depth),st&&e.texSubImage3D(n.TEXTURE_3D,0,0,0,0,rt.width,rt.height,rt.depth,Mt,Nt,rt.data)):e.texImage3D(n.TEXTURE_3D,0,Ut,rt.width,rt.height,rt.depth,0,Mt,Nt,rt.data);else if(_.isFramebufferTexture){if(mt)if(P)e.texStorage2D(n.TEXTURE_2D,Tt,Ut,rt.width,rt.height);else{let at=rt.width,J=rt.height;for(let At=0;At<Tt;At++)e.texImage2D(n.TEXTURE_2D,At,Ut,at,J,0,Mt,Nt,null),at>>=1,J>>=1}}else if(zt.length>0){if(P&&mt){const at=Jt(zt[0]);e.texStorage2D(n.TEXTURE_2D,Tt,Ut,at.width,at.height)}for(let at=0,J=zt.length;at<J;at++)ft=zt[at],P?st&&e.texSubImage2D(n.TEXTURE_2D,at,0,0,Mt,Nt,ft):e.texImage2D(n.TEXTURE_2D,at,Ut,Mt,Nt,ft);_.generateMipmaps=!1}else if(P){if(mt){const at=Jt(rt);e.texStorage2D(n.TEXTURE_2D,Tt,Ut,at.width,at.height)}st&&e.texSubImage2D(n.TEXTURE_2D,0,0,0,Mt,Nt,rt)}else e.texImage2D(n.TEXTURE_2D,0,Ut,Mt,Nt,rt);m(_)&&d(Z),xt.__version=K.version,_.onUpdate&&_.onUpdate(_)}T.__version=_.version}function Y(T,_,B){if(_.image.length!==6)return;const Z=kt(T,_),et=_.source;e.bindTexture(n.TEXTURE_CUBE_MAP,T.__webglTexture,n.TEXTURE0+B);const K=i.get(et);if(et.version!==K.__version||Z===!0){e.activeTexture(n.TEXTURE0+B);const xt=jt.getPrimaries(jt.workingColorSpace),ut=_.colorSpace===An?null:jt.getPrimaries(_.colorSpace),bt=_.colorSpace===An||xt===ut?n.NONE:n.BROWSER_DEFAULT_WEBGL;n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,_.flipY),n.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,_.premultiplyAlpha),n.pixelStorei(n.UNPACK_ALIGNMENT,_.unpackAlignment),n.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,bt);const Rt=_.isCompressedTexture||_.image[0].isCompressedTexture,rt=_.image[0]&&_.image[0].isDataTexture,Mt=[];for(let J=0;J<6;J++)!Rt&&!rt?Mt[J]=x(_.image[J],!0,r.maxCubemapSize):Mt[J]=rt?_.image[J].image:_.image[J],Mt[J]=Pt(_,Mt[J]);const Nt=Mt[0],Ut=s.convert(_.format,_.colorSpace),ft=s.convert(_.type),zt=b(_.internalFormat,Ut,ft,_.colorSpace),P=_.isVideoTexture!==!0,mt=K.__version===void 0||Z===!0,st=et.dataReady;let Tt=D(_,Nt);Ct(n.TEXTURE_CUBE_MAP,_);let at;if(Rt){P&&mt&&e.texStorage2D(n.TEXTURE_CUBE_MAP,Tt,zt,Nt.width,Nt.height);for(let J=0;J<6;J++){at=Mt[J].mipmaps;for(let At=0;At<at.length;At++){const Ht=at[At];_.format!==$e?Ut!==null?P?st&&e.compressedTexSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+J,At,0,0,Ht.width,Ht.height,Ut,Ht.data):e.compressedTexImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+J,At,zt,Ht.width,Ht.height,0,Ht.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):P?st&&e.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+J,At,0,0,Ht.width,Ht.height,Ut,ft,Ht.data):e.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+J,At,zt,Ht.width,Ht.height,0,Ut,ft,Ht.data)}}}else{if(at=_.mipmaps,P&&mt){at.length>0&&Tt++;const J=Jt(Mt[0]);e.texStorage2D(n.TEXTURE_CUBE_MAP,Tt,zt,J.width,J.height)}for(let J=0;J<6;J++)if(rt){P?st&&e.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+J,0,0,0,Mt[J].width,Mt[J].height,Ut,ft,Mt[J].data):e.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+J,0,zt,Mt[J].width,Mt[J].height,0,Ut,ft,Mt[J].data);for(let At=0;At<at.length;At++){const ie=at[At].image[J].image;P?st&&e.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+J,At+1,0,0,ie.width,ie.height,Ut,ft,ie.data):e.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+J,At+1,zt,ie.width,ie.height,0,Ut,ft,ie.data)}}else{P?st&&e.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+J,0,0,0,Ut,ft,Mt[J]):e.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+J,0,zt,Ut,ft,Mt[J]);for(let At=0;At<at.length;At++){const Ht=at[At];P?st&&e.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+J,At+1,0,0,Ut,ft,Ht.image[J]):e.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+J,At+1,zt,Ut,ft,Ht.image[J])}}}m(_)&&d(n.TEXTURE_CUBE_MAP),K.__version=et.version,_.onUpdate&&_.onUpdate(_)}T.__version=_.version}function G(T,_,B,Z,et,K){const xt=s.convert(B.format,B.colorSpace),ut=s.convert(B.type),bt=b(B.internalFormat,xt,ut,B.colorSpace),Rt=i.get(_),rt=i.get(B);if(rt.__renderTarget=_,!Rt.__hasExternalTextures){const Mt=Math.max(1,_.width>>K),Nt=Math.max(1,_.height>>K);et===n.TEXTURE_3D||et===n.TEXTURE_2D_ARRAY?e.texImage3D(et,K,bt,Mt,Nt,_.depth,0,xt,ut,null):e.texImage2D(et,K,bt,Mt,Nt,0,xt,ut,null)}e.bindFramebuffer(n.FRAMEBUFFER,T),gt(_)?o.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,Z,et,rt.__webglTexture,0,pt(_)):(et===n.TEXTURE_2D||et>=n.TEXTURE_CUBE_MAP_POSITIVE_X&&et<=n.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&n.framebufferTexture2D(n.FRAMEBUFFER,Z,et,rt.__webglTexture,K),e.bindFramebuffer(n.FRAMEBUFFER,null)}function Q(T,_,B){if(n.bindRenderbuffer(n.RENDERBUFFER,T),_.depthBuffer){const Z=_.depthTexture,et=Z&&Z.isDepthTexture?Z.type:null,K=y(_.stencilBuffer,et),xt=_.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,ut=pt(_);gt(_)?o.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,ut,K,_.width,_.height):B?n.renderbufferStorageMultisample(n.RENDERBUFFER,ut,K,_.width,_.height):n.renderbufferStorage(n.RENDERBUFFER,K,_.width,_.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,xt,n.RENDERBUFFER,T)}else{const Z=_.textures;for(let et=0;et<Z.length;et++){const K=Z[et],xt=s.convert(K.format,K.colorSpace),ut=s.convert(K.type),bt=b(K.internalFormat,xt,ut,K.colorSpace),Rt=pt(_);B&&gt(_)===!1?n.renderbufferStorageMultisample(n.RENDERBUFFER,Rt,bt,_.width,_.height):gt(_)?o.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,Rt,bt,_.width,_.height):n.renderbufferStorage(n.RENDERBUFFER,bt,_.width,_.height)}}n.bindRenderbuffer(n.RENDERBUFFER,null)}function it(T,_){if(_&&_.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(e.bindFramebuffer(n.FRAMEBUFFER,T),!(_.depthTexture&&_.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const Z=i.get(_.depthTexture);Z.__renderTarget=_,(!Z.__webglTexture||_.depthTexture.image.width!==_.width||_.depthTexture.image.height!==_.height)&&(_.depthTexture.image.width=_.width,_.depthTexture.image.height=_.height,_.depthTexture.needsUpdate=!0),q(_.depthTexture,0);const et=Z.__webglTexture,K=pt(_);if(_.depthTexture.format===Ki)gt(_)?o.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,n.DEPTH_ATTACHMENT,n.TEXTURE_2D,et,0,K):n.framebufferTexture2D(n.FRAMEBUFFER,n.DEPTH_ATTACHMENT,n.TEXTURE_2D,et,0);else if(_.depthTexture.format===ji)gt(_)?o.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,n.DEPTH_STENCIL_ATTACHMENT,n.TEXTURE_2D,et,0,K):n.framebufferTexture2D(n.FRAMEBUFFER,n.DEPTH_STENCIL_ATTACHMENT,n.TEXTURE_2D,et,0);else throw new Error("Unknown depthTexture format")}function lt(T){const _=i.get(T),B=T.isWebGLCubeRenderTarget===!0;if(_.__boundDepthTexture!==T.depthTexture){const Z=T.depthTexture;if(_.__depthDisposeCallback&&_.__depthDisposeCallback(),Z){const et=()=>{delete _.__boundDepthTexture,delete _.__depthDisposeCallback,Z.removeEventListener("dispose",et)};Z.addEventListener("dispose",et),_.__depthDisposeCallback=et}_.__boundDepthTexture=Z}if(T.depthTexture&&!_.__autoAllocateDepthBuffer){if(B)throw new Error("target.depthTexture not supported in Cube render targets");const Z=T.texture.mipmaps;Z&&Z.length>0?it(_.__webglFramebuffer[0],T):it(_.__webglFramebuffer,T)}else if(B){_.__webglDepthbuffer=[];for(let Z=0;Z<6;Z++)if(e.bindFramebuffer(n.FRAMEBUFFER,_.__webglFramebuffer[Z]),_.__webglDepthbuffer[Z]===void 0)_.__webglDepthbuffer[Z]=n.createRenderbuffer(),Q(_.__webglDepthbuffer[Z],T,!1);else{const et=T.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,K=_.__webglDepthbuffer[Z];n.bindRenderbuffer(n.RENDERBUFFER,K),n.framebufferRenderbuffer(n.FRAMEBUFFER,et,n.RENDERBUFFER,K)}}else{const Z=T.texture.mipmaps;if(Z&&Z.length>0?e.bindFramebuffer(n.FRAMEBUFFER,_.__webglFramebuffer[0]):e.bindFramebuffer(n.FRAMEBUFFER,_.__webglFramebuffer),_.__webglDepthbuffer===void 0)_.__webglDepthbuffer=n.createRenderbuffer(),Q(_.__webglDepthbuffer,T,!1);else{const et=T.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,K=_.__webglDepthbuffer;n.bindRenderbuffer(n.RENDERBUFFER,K),n.framebufferRenderbuffer(n.FRAMEBUFFER,et,n.RENDERBUFFER,K)}}e.bindFramebuffer(n.FRAMEBUFFER,null)}function vt(T,_,B){const Z=i.get(T);_!==void 0&&G(Z.__webglFramebuffer,T,T.texture,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,0),B!==void 0&&lt(T)}function ct(T){const _=T.texture,B=i.get(T),Z=i.get(_);T.addEventListener("dispose",R);const et=T.textures,K=T.isWebGLCubeRenderTarget===!0,xt=et.length>1;if(xt||(Z.__webglTexture===void 0&&(Z.__webglTexture=n.createTexture()),Z.__version=_.version,a.memory.textures++),K){B.__webglFramebuffer=[];for(let ut=0;ut<6;ut++)if(_.mipmaps&&_.mipmaps.length>0){B.__webglFramebuffer[ut]=[];for(let bt=0;bt<_.mipmaps.length;bt++)B.__webglFramebuffer[ut][bt]=n.createFramebuffer()}else B.__webglFramebuffer[ut]=n.createFramebuffer()}else{if(_.mipmaps&&_.mipmaps.length>0){B.__webglFramebuffer=[];for(let ut=0;ut<_.mipmaps.length;ut++)B.__webglFramebuffer[ut]=n.createFramebuffer()}else B.__webglFramebuffer=n.createFramebuffer();if(xt)for(let ut=0,bt=et.length;ut<bt;ut++){const Rt=i.get(et[ut]);Rt.__webglTexture===void 0&&(Rt.__webglTexture=n.createTexture(),a.memory.textures++)}if(T.samples>0&&gt(T)===!1){B.__webglMultisampledFramebuffer=n.createFramebuffer(),B.__webglColorRenderbuffer=[],e.bindFramebuffer(n.FRAMEBUFFER,B.__webglMultisampledFramebuffer);for(let ut=0;ut<et.length;ut++){const bt=et[ut];B.__webglColorRenderbuffer[ut]=n.createRenderbuffer(),n.bindRenderbuffer(n.RENDERBUFFER,B.__webglColorRenderbuffer[ut]);const Rt=s.convert(bt.format,bt.colorSpace),rt=s.convert(bt.type),Mt=b(bt.internalFormat,Rt,rt,bt.colorSpace,T.isXRRenderTarget===!0),Nt=pt(T);n.renderbufferStorageMultisample(n.RENDERBUFFER,Nt,Mt,T.width,T.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+ut,n.RENDERBUFFER,B.__webglColorRenderbuffer[ut])}n.bindRenderbuffer(n.RENDERBUFFER,null),T.depthBuffer&&(B.__webglDepthRenderbuffer=n.createRenderbuffer(),Q(B.__webglDepthRenderbuffer,T,!0)),e.bindFramebuffer(n.FRAMEBUFFER,null)}}if(K){e.bindTexture(n.TEXTURE_CUBE_MAP,Z.__webglTexture),Ct(n.TEXTURE_CUBE_MAP,_);for(let ut=0;ut<6;ut++)if(_.mipmaps&&_.mipmaps.length>0)for(let bt=0;bt<_.mipmaps.length;bt++)G(B.__webglFramebuffer[ut][bt],T,_,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+ut,bt);else G(B.__webglFramebuffer[ut],T,_,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+ut,0);m(_)&&d(n.TEXTURE_CUBE_MAP),e.unbindTexture()}else if(xt){for(let ut=0,bt=et.length;ut<bt;ut++){const Rt=et[ut],rt=i.get(Rt);e.bindTexture(n.TEXTURE_2D,rt.__webglTexture),Ct(n.TEXTURE_2D,Rt),G(B.__webglFramebuffer,T,Rt,n.COLOR_ATTACHMENT0+ut,n.TEXTURE_2D,0),m(Rt)&&d(n.TEXTURE_2D)}e.unbindTexture()}else{let ut=n.TEXTURE_2D;if((T.isWebGL3DRenderTarget||T.isWebGLArrayRenderTarget)&&(ut=T.isWebGL3DRenderTarget?n.TEXTURE_3D:n.TEXTURE_2D_ARRAY),e.bindTexture(ut,Z.__webglTexture),Ct(ut,_),_.mipmaps&&_.mipmaps.length>0)for(let bt=0;bt<_.mipmaps.length;bt++)G(B.__webglFramebuffer[bt],T,_,n.COLOR_ATTACHMENT0,ut,bt);else G(B.__webglFramebuffer,T,_,n.COLOR_ATTACHMENT0,ut,0);m(_)&&d(ut),e.unbindTexture()}T.depthBuffer&&lt(T)}function A(T){const _=T.textures;for(let B=0,Z=_.length;B<Z;B++){const et=_[B];if(m(et)){const K=w(T),xt=i.get(et).__webglTexture;e.bindTexture(K,xt),d(K),e.unbindTexture()}}}const Yt=[],Bt=[];function It(T){if(T.samples>0){if(gt(T)===!1){const _=T.textures,B=T.width,Z=T.height;let et=n.COLOR_BUFFER_BIT;const K=T.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,xt=i.get(T),ut=_.length>1;if(ut)for(let Rt=0;Rt<_.length;Rt++)e.bindFramebuffer(n.FRAMEBUFFER,xt.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+Rt,n.RENDERBUFFER,null),e.bindFramebuffer(n.FRAMEBUFFER,xt.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+Rt,n.TEXTURE_2D,null,0);e.bindFramebuffer(n.READ_FRAMEBUFFER,xt.__webglMultisampledFramebuffer);const bt=T.texture.mipmaps;bt&&bt.length>0?e.bindFramebuffer(n.DRAW_FRAMEBUFFER,xt.__webglFramebuffer[0]):e.bindFramebuffer(n.DRAW_FRAMEBUFFER,xt.__webglFramebuffer);for(let Rt=0;Rt<_.length;Rt++){if(T.resolveDepthBuffer&&(T.depthBuffer&&(et|=n.DEPTH_BUFFER_BIT),T.stencilBuffer&&T.resolveStencilBuffer&&(et|=n.STENCIL_BUFFER_BIT)),ut){n.framebufferRenderbuffer(n.READ_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.RENDERBUFFER,xt.__webglColorRenderbuffer[Rt]);const rt=i.get(_[Rt]).__webglTexture;n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,rt,0)}n.blitFramebuffer(0,0,B,Z,0,0,B,Z,et,n.NEAREST),l===!0&&(Yt.length=0,Bt.length=0,Yt.push(n.COLOR_ATTACHMENT0+Rt),T.depthBuffer&&T.resolveDepthBuffer===!1&&(Yt.push(K),Bt.push(K),n.invalidateFramebuffer(n.DRAW_FRAMEBUFFER,Bt)),n.invalidateFramebuffer(n.READ_FRAMEBUFFER,Yt))}if(e.bindFramebuffer(n.READ_FRAMEBUFFER,null),e.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),ut)for(let Rt=0;Rt<_.length;Rt++){e.bindFramebuffer(n.FRAMEBUFFER,xt.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+Rt,n.RENDERBUFFER,xt.__webglColorRenderbuffer[Rt]);const rt=i.get(_[Rt]).__webglTexture;e.bindFramebuffer(n.FRAMEBUFFER,xt.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+Rt,n.TEXTURE_2D,rt,0)}e.bindFramebuffer(n.DRAW_FRAMEBUFFER,xt.__webglMultisampledFramebuffer)}else if(T.depthBuffer&&T.resolveDepthBuffer===!1&&l){const _=T.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT;n.invalidateFramebuffer(n.DRAW_FRAMEBUFFER,[_])}}}function pt(T){return Math.min(r.maxSamples,T.samples)}function gt(T){const _=i.get(T);return T.samples>0&&t.has("WEBGL_multisampled_render_to_texture")===!0&&_.__useRenderToTexture!==!1}function Et(T){const _=a.render.frame;u.get(T)!==_&&(u.set(T,_),T.update())}function Pt(T,_){const B=T.colorSpace,Z=T.format,et=T.type;return T.isCompressedTexture===!0||T.isVideoTexture===!0||B!==bi&&B!==An&&(jt.getTransfer(B)===te?(Z!==$e||et!==gn)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",B)),_}function Jt(T){return typeof HTMLImageElement<"u"&&T instanceof HTMLImageElement?(c.width=T.naturalWidth||T.width,c.height=T.naturalHeight||T.height):typeof VideoFrame<"u"&&T instanceof VideoFrame?(c.width=T.displayWidth,c.height=T.displayHeight):(c.width=T.width,c.height=T.height),c}this.allocateTextureUnit=I,this.resetTextureUnits=O,this.setTexture2D=q,this.setTexture2DArray=W,this.setTexture3D=j,this.setTextureCube=z,this.rebindTextures=vt,this.setupRenderTarget=ct,this.updateRenderTargetMipmap=A,this.updateMultisampleRenderTarget=It,this.setupDepthRenderbuffer=lt,this.setupFrameBufferTexture=G,this.useMultisampledRTT=gt}function D_(n,t){function e(i,r=An){let s;const a=jt.getTransfer(r);if(i===gn)return n.UNSIGNED_BYTE;if(i===io)return n.UNSIGNED_SHORT_4_4_4_4;if(i===ro)return n.UNSIGNED_SHORT_5_5_5_1;if(i===mc)return n.UNSIGNED_INT_5_9_9_9_REV;if(i===dc)return n.BYTE;if(i===pc)return n.SHORT;if(i===Yi)return n.UNSIGNED_SHORT;if(i===no)return n.INT;if(i===Yn)return n.UNSIGNED_INT;if(i===dn)return n.FLOAT;if(i===tr)return n.HALF_FLOAT;if(i===_c)return n.ALPHA;if(i===gc)return n.RGB;if(i===$e)return n.RGBA;if(i===Ki)return n.DEPTH_COMPONENT;if(i===ji)return n.DEPTH_STENCIL;if(i===vc)return n.RED;if(i===so)return n.RED_INTEGER;if(i===xc)return n.RG;if(i===ao)return n.RG_INTEGER;if(i===oo)return n.RGBA_INTEGER;if(i===Fr||i===Or||i===Br||i===zr)if(a===te)if(s=t.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(i===Fr)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(i===Or)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(i===Br)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(i===zr)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=t.get("WEBGL_compressed_texture_s3tc"),s!==null){if(i===Fr)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(i===Or)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(i===Br)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(i===zr)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(i===ma||i===_a||i===ga||i===va)if(s=t.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(i===ma)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(i===_a)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(i===ga)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(i===va)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(i===xa||i===Ma||i===Sa)if(s=t.get("WEBGL_compressed_texture_etc"),s!==null){if(i===xa||i===Ma)return a===te?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(i===Sa)return a===te?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(i===ya||i===Ea||i===Ta||i===ba||i===Aa||i===wa||i===Ra||i===Ca||i===Pa||i===Da||i===La||i===Ia||i===Ua||i===Na)if(s=t.get("WEBGL_compressed_texture_astc"),s!==null){if(i===ya)return a===te?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(i===Ea)return a===te?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(i===Ta)return a===te?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(i===ba)return a===te?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(i===Aa)return a===te?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(i===wa)return a===te?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(i===Ra)return a===te?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(i===Ca)return a===te?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(i===Pa)return a===te?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(i===Da)return a===te?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(i===La)return a===te?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(i===Ia)return a===te?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(i===Ua)return a===te?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(i===Na)return a===te?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(i===kr||i===Fa||i===Oa)if(s=t.get("EXT_texture_compression_bptc"),s!==null){if(i===kr)return a===te?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(i===Fa)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(i===Oa)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(i===Mc||i===Ba||i===za||i===ka)if(s=t.get("EXT_texture_compression_rgtc"),s!==null){if(i===kr)return s.COMPRESSED_RED_RGTC1_EXT;if(i===Ba)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(i===za)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(i===ka)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return i===$i?n.UNSIGNED_INT_24_8:n[i]!==void 0?n[i]:null}return{convert:e}}const L_=`
void main() {
...
}`;class U_{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(t,e,i){if(this.texture===null){const r=new we,s=t.properties.get(r);s.__webglTexture=e.texture,(e.depthNear!==i.depthNear||e.depthFar!==i.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=r}}getMesh(t){if(this.texture!==null&&this.mesh===null){const e=t.cameras[0].viewport,i=new Pn({vertexShader:L_,fragmentShader:I_,uniforms:{depthColor:{value:this.texture},depthWidth:{value:e.z},depthHeight:{value:e.w}}});this.mesh=new Be(new fs(20,20),i)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class N_ extends Jn{constructor(t,e){super();const i=this;let r=null,s=1,a=null,o="local-floor",l=1,c=null,u=null,h=null,f=null,p=null,g=null;const x=new U_,m=e.getContextAttributes();let d=null,w=null;const b=[],y=[],D=new Vt;let C=null;const R=new We;R.viewport=new le;const L=new We;L.viewport=new le;const S=[R,L],v=new Qh;let E=null,O=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(X){let tt=b[X];return tt===void 0&&(tt=new Hs,b[X]=tt),tt.getTargetRaySpace()},this.getControllerGrip=function(X){let tt=b[X];return tt===void 0&&(tt=new Hs,b[X]=tt),tt.getGripSpace()},this.getHand=function(X){let tt=b[X];return tt===void 0&&(tt=new Hs,b[X]=tt),tt.getHandSpace()};function I(X){const tt=y.indexOf(X.inputSource);if(tt===-1)return;const $=b[tt];$!==void 0&&($.update(X.inputSource,X.frame,c||a),$.dispatchEvent({type:X.type,data:X.inputSource}))}function H(){r.removeEventListener("select",I),r.removeEventListener("selectstart",I),r.removeEventListener("selectend",I),r.removeEventListener("squeeze",I),r.removeEventListener("squeezestart",I),r.removeEventListener("squeezeend",I),r.removeEventListener("end",H),r.removeEventListener("inputsourceschange",q);for(let X=0;X<b.length;X++){const tt=y[X];tt!==null&&(y[X]=null,b[X].disconnect(tt))}E=null,O=null,x.reset(),t.setRenderTarget(d),p=null,f=null,h=null,r=null,w=null,kt.stop(),i.isPresenting=!1,t.setPixelRatio(C),t.setSize(D.width,D.height,!1),i.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(X){s=X,i.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(X){o=X,i.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return c||a},this.setReferenceSpace=function(X){c=X},this.getBaseLayer=function(){return f!==null?f:p},this.getBinding=function(){return h},this.getFrame=function(){return g},this.getSession=function(){return r},this.setSession=async function(X){if(r=X,r!==null){if(d=t.getRenderTarget(),r.addEventListener("select",I),r.addEventListener("selectstart",I),r.addEventListener("selectend",I),r.addEventListener("squeeze",I),r.addEventListener("squeezestart",I),r.addEventListener("squeezeend",I),r.addEventListener("end",H),r.addEventListener("inputsourceschange",q),m.xrCompatible!==!0&&await e.makeXRCompatible(),C=t.getPixelRatio(),t.getSize(D),typeof XRWebGLBinding<"u"&&"createProjectionLayer"in XRWebGLBinding.prototype){let $=null,Y=null,G=null;m.depth&&(G=m.stencil?e.DEPTH24_STENCIL8:e.DEPTH_COMPONENT24,$=m.stencil?ji:Ki,Y=m.stencil?$i:Yn);const Q={colorFormat:e.RGBA8,depthFormat:G,scaleFactor:s};h=new XRWebGLBinding(r,e),f=h.createProjectionLayer(Q),r.updateRenderState({layers:[f]}),t.setPixelRatio(1),t.setSize(f.textureWidth,f.textureHeight,!1),w=new Kn(f.textureWidth,f.textureHeight,{format:$e,type:gn,depthTexture:new Lc(f.textureWidth,f.textureHeight,Y,void 0,void 0,void 0,void 0,void 0,void 0,$),stencilBuffer:m.stencil,colorSpace:t.outputColorSpace,samples:m.antialias?4:0,resolveDepthBuffer:f.ignoreDepthValues===!1,resolveStencilBuffer:f.ignoreDepthValues===!1})}else{const $={antialias:m.antialias,alpha:!0,depth:m.depth,stencil:m.stencil,framebufferScaleFactor:s};p=new XRWebGLLayer(r,e,$),r.updateRenderState({baseLayer:p}),t.setPixelRatio(1),t.setSize(p.framebufferWidth,p.framebufferHeight,!1),w=new Kn(p.framebufferWidth,p.framebufferHeight,{format:$e,type:gn,colorSpace:t.outputColorSpace,stencilBuffer:m.stencil,resolveDepthBuffer:p.ignoreDepthValues===!1,resolveStencilBuffer:p.ignoreDepthValues===!1})}w.isXRRenderTarget=!0,this.setFoveation(l),c=null,a=await r.requestReferenceSpace(o),kt.setContext(r),kt.start(),i.isPresenting=!0,i.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(r!==null)return r.environmentBlendMode},this.getDepthTexture=function(){return x.getDepthTexture()};function q(X){for(let tt=0;tt<X.removed.length;tt++){const $=X.removed[tt],Y=y.indexOf($);Y>=0&&(y[Y]=null,b[Y].disconnect($))}for(let tt=0;tt<X.added.length;tt++){const $=X.added[tt];let Y=y.indexOf($);if(Y===-1){for(let Q=0;Q<b.length;Q++)if(Q>=y.length){y.push($),Y=Q;break}else if(y[Q]===null){y[Q]=$,Y=Q;break}if(Y===-1)break}const G=b[Y];G&&G.connect($)}}const W=new F,j=new F;function z(X,tt,$){W.setFromMatrixPosition(tt.matrixWorld),j.setFromMatrixPosition($.matrixWorld);const Y=W.distanceTo(j),G=tt.projectionMatrix.elements,Q=$.projectionMatrix.elements,it=G[14]/(G[10]-1),lt=G[14]/(G[10]+1),vt=(G[9]+1)/G[5],ct=(G[9]-1)/G[5],A=(G[8]-1)/G[0],Yt=(Q[8]+1)/Q[0],Bt=it*A,It=it*Yt,pt=Y/(-A+Yt),gt=pt*-A;if(tt.matrixWorld.decompose(X.position,X.quaternion,X.scale),X.translateX(gt),X.translateZ(pt),X.matrixWorld.compose(X.position,X.quaternion,X.scale),X.matrixWorldInverse.copy(X.matrixWorld).invert(),G[10]===-1)X.projectionMatrix.copy(tt.projectionMatrix),X.projectionMatrixInverse.copy(tt.projectionMatrixInverse);else{const Et=it+pt,Pt=lt+pt,Jt=Bt-gt,T=It+(Y-gt),_=vt*lt/Pt*Et,B=ct*lt/Pt*Et;X.projectionMatrix.makePerspective(Jt,T,_,B,Et,Pt),X.projectionMatrixInverse.copy(X.projectionMatrix).invert()}}function nt(X,tt){tt===null?X.matrixWorld.copy(X.matrix):X.matrixWorld.multiplyMatrices(tt.matrixWorld,X.matrix),X.matrixWorldInverse.copy(X.matrixWorld).invert()}this.updateCamera=function(X){if(r===null)return;let tt=X.near,$=X.far;x.texture!==null&&(x.depthNear>0&&(tt=x.depthNear),x.depthFar>0&&($=x.depthFar)),v.near=L.near=R.near=tt,v.far=L.far=R.far=$,(E!==v.near||O!==v.far)&&(r.updateRenderState({depthNear:v.near,depthFar:v.far}),E=v.near,O=v.far),R.layers.mask=X.layers.mask|2,L.layers.mask=X.layers.mask|4,v.layers.mask=R.layers.mask|L.layers.mask;const Y=X.parent,G=v.cameras;nt(v,Y);for(let Q=0;Q<G.length;Q++)nt(G[Q],Y);G.length===2?z(v,R,L):v.projectionMatrix.copy(R.projectionMatrix),ht(X,v,Y)};function ht(X,tt,$){$===null?X.matrix.copy(tt.matrixWorld):(X.matrix.copy($.matrixWorld),X.matrix.invert(),X.matrix.multiply(tt.matrixWorld)),X.matrix.decompose(X.position,X.quaternion,X.scale),X.updateMatrixWorld(!0),X.projectionMatrix.copy(tt.projectionMatrix),X.projectionMatrixInverse.copy(tt.projectionMatrixInverse),X.isPerspectiveCamera&&(X.fov=Ha*2*Math.atan(1/X.projectionMatrix.elements[5]),X.zoom=1)}this.getCamera=function(){return v},this.getFoveation=function(){if(!(f===null&&p===null))return l},this.setFoveation=function(X){l=X,f!==null&&(f.fixedFoveation=X),p!==null&&p.fixedFoveation!==void 0&&(p.fixedFoveation=X)},this.hasDepthSensing=function(){return x.texture!==null},this.getDepthSensingMesh=function(){return x.getMesh(v)};let yt=null;function Ct(X,tt){if(u=tt.getViewerPose(c||a),g=tt,u!==null){const $=u.views;p!==null&&(t.setRenderTargetFramebuffer(w,p.framebuffer),t.setRenderTarget(w));let Y=!1;$.length!==v.cameras.length&&(v.cameras.length=0,Y=!0);for(let it=0;it<$.length;it++){const lt=$[it];let vt=null;if(p!==null)vt=p.getViewport(lt);else{const A=h.getViewSubImage(f,lt);vt=A.viewport,it===0&&(t.setRenderTargetTextures(w,A.colorTexture,A.depthStencilTexture),t.setRenderTarget(w))}let ct=S[it];ct===void 0&&(ct=new We,ct.layers.enable(it),ct.viewport=new le,S[it]=ct),ct.matrix.fromArray(lt.transform.matrix),ct.matrix.decompose(ct.position,ct.quaternion,ct.scale),ct.projectionMatrix.fromArray(lt.projectionMatrix),ct.projectionMatrixInverse.copy(ct.projectionMatrix).invert(),ct.viewport.set(vt.x,vt.y,vt.width,vt.height),it===0&&(v.matrix.copy(ct.matrix),v.matrix.decompose(v.position,v.quaternion,v.scale)),Y===!0&&v.cameras.push(ct)}const G=r.enabledFeatures;if(G&&G.includes("depth-sensing")&&r.depthUsage=="gpu-optimized"&&h){const it=h.getDepthInformation($[0]);it&&it.isValid&&it.texture&&x.init(t,it,r.renderState)}}for(let $=0;$<b.length;$++){const Y=y[$],G=b[$];Y!==null&&G!==void 0&&G.update(Y,tt,c||a)}yt&&yt(X,tt),tt.detectedPlanes&&i.dispatchEvent({type:"planesdetected",data:tt}),g=null}const kt=new Uc;kt.setAnimationLoop(Ct),this.setAnimationLoop=function(X){yt=X},this.dispose=function(){}}}const Bn=new Ze,F_=new ce;function O_(n,t){function e(m,d){m.matrixAutoUpdate===!0&&m.updateMatrix(),d.value.copy(m.matrix)}function i(m,d){d.color.getRGB(m.fogColor.value,Rc(n)),d.isFog?(m.fogNear.value=d.near,m.fogFar.value=d.far):d.isFogExp2&&(m.fogDensity.value=d.density)}function r(m,d,w,b,y){d.isMeshBasicMaterial||d.isMeshLambertMaterial?s(m,d):d.isMeshToonMaterial?(s(m,d),h(m,d)):d.isMeshPhongMaterial?(s(m,d),u(m,d)):d.isMeshStandardMaterial?(s(m,d),f(m,d),d.isMeshPhysicalMaterial&&p(m,d,y)):d.isMeshMatcapMaterial?(s(m,d),g(m,d)):d.isMeshDepthMaterial?s(m,d):d.isMeshDistanceMaterial?(s(m,d),x(m,d)):d.isMeshNormalMaterial?s(m,d):d.isLineBasicMaterial?(a(m,d),d.isLineDashedMaterial&&o(m,d)):d.isPointsMaterial?l(m,d,w,b):d.isSpriteMaterial?c(m,d):d.isShadowMaterial?(m.color.value.copy(d.color),m.opacity.value=d.opacity):d.isShaderMaterial&&(d.uniformsNeedUpdate=!1)}function s(m,d){m.opacity.value=d.opacity,d.color&&m.diffuse.value.copy(d.color),d.emissive&&m.emissive.value.copy(d.emissive).multiplyScalar(d.emissiveIntensity),d.map&&(m.map.value=d.map,e(d.map,m.mapTransform)),d.alphaMap&&(m.alphaMap.value=d.alphaMap,e(d.alphaMap,m.alphaMapTransform)),d.bumpMap&&(m.bumpMap.value=d.bumpMap,e(d.bumpMap,m.bumpMapTransform),m.bumpScale.value=d.bumpScale,d.side===Ae&&(m.bumpScale.value*=-1)),d.normalMap&&(m.normalMap.value=d.normalMap,e(d.normalMap,m.normalMapTransform),m.normalScale.value.copy(d.normalScale),d.side===Ae&&m.normalScale.value.negate()),d.displacementMap&&(m.displacementMap.value=d.displacementMap,e(d.displacementMap,m.displacementMapTransform),m.displacementScale.value=d.displacementScale,m.displacementBias.value=d.displacementBias),d.emissiveMap&&(m.emissiveMap.value=d.emissiveMap,e(d.emissiveMap,m.emissiveMapTransform)),d.specularMap&&(m.specularMap.value=d.specularMap,e(d.specularMap,m.specularMapTransform)),d.alphaTest>0&&(m.alphaTest.value=d.alphaTest);const w=t.get(d),b=w.envMap,y=w.envMapRotation;b&&(m.envMap.value=b,Bn.copy(y),Bn.x*=-1,Bn.y*=-1,Bn.z*=-1,b.isCubeTexture&&b.isRenderTargetTexture===!1&&(Bn.y*=-1,Bn.z*=-1),m.envMapRotation.value.setFromMatrix4(F_.makeRotationFromEuler(Bn)),m.flipEnvMap.value=b.isCubeTexture&&b.isRenderTargetTexture===!1?-1:1,m.reflectivity.value=d.reflectivity,m.ior.value=d.ior,m.refractionRatio.value=d.refractionRatio),d.lightMap&&(m.lightMap.value=d.lightMap,m.lightMapIntensity.value=d.lightMapIntensity,e(d.lightMap,m.lightMapTransform)),d.aoMap&&(m.aoMap.value=d.aoMap,m.aoMapIntensity.value=d.aoMapIntensity,e(d.aoMap,m.aoMapTransform))}function a(m,d){m.diffuse.value.copy(d.color),m.opacity.value=d.opacity,d.map&&(m.map.value=d.map,e(d.map,m.mapTransform))}function o(m,d){m.dashSize.value=d.dashSize,m.totalSize.value=d.dashSize+d.gapSize,m.scale.value=d.scale}function l(m,d,w,b){m.diffuse.value.copy(d.color),m.opacity.value=d.opacity,m.size.value=d.size*w,m.scale.value=b*.5,d.map&&(m.map.value=d.map,e(d.map,m.uvTransform)),d.alphaMap&&(m.alphaMap.value=d.alphaMap,e(d.alphaMap,m.alphaMapTransform)),d.alphaTest>0&&(m.alphaTest.value=d.alphaTest)}function c(m,d){m.diffuse.value.copy(d.color),m.opacity.value=d.opacity,m.rotation.value=d.rotation,d.map&&(m.map.value=d.map,e(d.map,m.mapTransform)),d.alphaMap&&(m.alphaMap.value=d.alphaMap,e(d.alphaMap,m.alphaMapTransform)),d.alphaTest>0&&(m.alphaTest.value=d.alphaTest)}function u(m,d){m.specular.value.copy(d.specular),m.shininess.value=Math.max(d.shininess,1e-4)}function h(m,d){d.gradientMap&&(m.gradientMap.value=d.gradientMap)}function f(m,d){m.metalness.value=d.metalness,d.metalnessMap&&(m.metalnessMap.value=d.metalnessMap,e(d.metalnessMap,m.metalnessMapTransform)),m.roughness.value=d.roughness,d.roughnessMap&&(m.roughnessMap.value=d.roughnessMap,e(d.roughnessMap,m.roughnessMapTransform)),d.envMap&&(m.envMapIntensity.value=d.envMapIntensity)}function p(m,d,w){m.ior.value=d.ior,d.sheen>0&&(m.sheenColor.value.copy(d.sheenColor).multiplyScalar(d.sheen),m.sheenRoughness.value=d.sheenRoughness,d.sheenColorMap&&(m.sheenColorMap.value=d.sheenColorMap,e(d.sheenColorMap,m.sheenColorMapTransform)),d.sheenRoughnessMap&&(m.sheenRoughnessMap.value=d.sheenRoughnessMap,e(d.sheenRoughnessMap,m.sheenRoughnessMapTransform))),d.clearcoat>0&&(m.clearcoat.value=d.clearcoat,m.clearcoatRoughness.value=d.clearcoatRoughness,d.clearcoatMap&&(m.clearcoatMap.value=d.clearcoatMap,e(d.clearcoatMap,m.clearcoatMapTransform)),d.clearcoatRoughnessMap&&(m.clearcoatRoughnessMap.value=d.clearcoatRoughnessMap,e(d.clearcoatRoughnessMap,m.clearcoatRoughnessMapTransform)),d.clearcoatNormalMap&&(m.clearcoatNormalMap.value=d.clearcoatNormalMap,e(d.clearcoatNormalMap,m.clearcoatNormalMapTransform),m.clearcoatNormalScale.value.copy(d.clearcoatNormalScale),d.side===Ae&&m.clearcoatNormalScale.value.negate())),d.dispersion>0&&(m.dispersion.value=d.dispersion),d.iridescence>0&&(m.iridescence.value=d.iridescence,m.iridescenceIOR.value=d.iridescenceIOR,m.iridescenceThicknessMinimum.value=d.iridescenceThicknessRange[0],m.iridescenceThicknessMaximum.value=d.iridescenceThicknessRange[1],d.iridescenceMap&&(m.iridescenceMap.value=d.iridescenceMap,e(d.iridescenceMap,m.iridescenceMapTransform)),d.iridescenceThicknessMap&&(m.iridescenceThicknessMap.value=d.iridescenceThicknessMap,e(d.iridescenceThicknessMap,m.iridescenceThicknessMapTransform))),d.transmission>0&&(m.transmission.value=d.transmission,m.transmissionSamplerMap.value=w.texture,m.transmissionSamplerSize.value.set(w.width,w.height),d.transmissionMap&&(m.transmissionMap.value=d.transmissionMap,e(d.transmissionMap,m.transmissionMapTransform)),m.thickness.value=d.thickness,d.thicknessMap&&(m.thicknessMap.value=d.thicknessMap,e(d.thicknessMap,m.thicknessMapTransform)),m.attenuationDistance.value=d.attenuationDistance,m.attenuationColor.value.copy(d.attenuationColor)),d.anisotropy>0&&(m.anisotropyVector.value.set(d.anisotropy*Math.cos(d.anisotropyRotation),d.anisotropy*Math.sin(d.anisotropyRotation)),d.anisotropyMap&&(m.anisotropyMap.value=d.anisotropyMap,e(d.anisotropyMap,m.anisotropyMapTransform))),m.specularIntensity.value=d.specularIntensity,m.specularColor.value.copy(d.specularColor),d.specularColorMap&&(m.specularColorMap.value=d.specularColorMap,e(d.specularColorMap,m.specularColorMapTransform)),d.specularIntensityMap&&(m.specularIntensityMap.value=d.specularIntensityMap,e(d.specularIntensityMap,m.specularIntensityMapTransform))}function g(m,d){d.matcap&&(m.matcap.value=d.matcap)}function x(m,d){const w=t.get(d).light;m.referencePosition.value.setFromMatrixPosition(w.matrixWorld),m.nearDistance.value=w.shadow.camera.near,m.farDistance.value=w.shadow.camera.far}return{refreshFogUniforms:i,refreshMaterialUniforms:r}}function B_(n,t,e,i){let r={},s={},a=[];const o=n.getParameter(n.MAX_UNIFORM_BUFFER_BINDINGS);function l(w,b){const y=b.program;i.uniformBlockBinding(w,y)}function c(w,b){let y=r[w.id];y===void 0&&(g(w),y=u(w),r[w.id]=y,w.addEventListener("dispose",m));const D=b.program;i.updateUBOMapping(w,D);const C=t.render.frame;s[w.id]!==C&&(f(w),s[w.id]=C)}function u(w){const b=h();w.__bindingPointIndex=b;const y=n.createBuffer(),D=w.__size,C=w.usage;return n.bindBuffer(n.UNIFORM_BUFFER,y),n.bufferData(n.UNIFORM_BUFFER,D,C),n.bindBuffer(n.UNIFORM_BUFFER,null),n.bindBufferBase(n.UNIFORM_BUFFER,b,y),y}function h(){for(let w=0;w<o;w++)if(a.indexOf(w)===-1)return a.push(w),w;return console.error("THREE.WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function f(w){const b=r[w.id],y=w.uniforms,D=w.__cache;n.bindBuffer(n.UNIFORM_BUFFER,b);for(let C=0,R=y.length;C<R;C++){const L=Array.isArray(y[C])?y[C]:[y[C]];for(let S=0,v=L.length;S<v;S++){const E=L[S];if(p(E,C,S,D)===!0){const O=E.__offset,I=Array.isArray(E.value)?E.value:[E.value];let H=0;for(let q=0;q<I.length;q++){const W=I[q],j=x(W);typeof W=="number"||typeof W=="boolean"?(E.__data[0]=W,n.bufferSubData(n.UNIFORM_BUFFER,O+H,E.__data)):W.isMatrix3?(E.__data[0]=W.elements[0],E.__data[1]=W.elements[1],E.__data[2]=W.elements[2],E.__data[3]=0,E.__data[4]=W.elements[3],E.__data[5]=W.elements[4],E.__data[6]=W.elements[5],E.__data[7]=0,E.__data[8]=W.elements[6],E.__data[9]=W.elements[7],E.__data[10]=W.elements[8],E.__data[11]=0):(W.toArray(E.__data,H),H+=j.storage/Float32Array.BYTES_PER_ELEMENT)}n.bufferSubData(n.UNIFORM_BUFFER,O,E.__data)}}}n.bindBuffer(n.UNIFORM_BUFFER,null)}function p(w,b,y,D){const C=w.value,R=b+"_"+y;if(D[R]===void 0)return typeof C=="number"||typeof C=="boolean"?D[R]=C:D[R]=C.clone(),!0;{const L=D[R];if(typeof C=="number"||typeof C=="boolean"){if(L!==C)return D[R]=C,!0}else if(L.equals(C)===!1)return L.copy(C),!0}return!1}function g(w){const b=w.uniforms;let y=0;const D=16;for(let R=0,L=b.length;R<L;R++){const S=Array.isArray(b[R])?b[R]:[b[R]];for(let v=0,E=S.length;v<E;v++){const O=S[v],I=Array.isArray(O.value)?O.value:[O.value];for(let H=0,q=I.length;H<q;H++){const W=I[H],j=x(W),z=y%D,nt=z%j.boundary,ht=z+nt;y+=nt,ht!==0&&D-ht<j.storage&&(y+=D-ht),O.__data=new Float32Array(j.storage/Float32Array.BYTES_PER_ELEMENT),O.__offset=y,y+=j.storage}}}const C=y%D;return C>0&&(y+=D-C),w.__size=y,w.__cache={},this}function x(w){const b={boundary:0,storage:0};return typeof w=="number"||typeof w=="boolean"?(b.boundary=4,b.storage=4):w.isVector2?(b.boundary=8,b.storage=8):w.isVector3||w.isColor?(b.boundary=16,b.storage=12):w.isVector4?(b.boundary=16,b.storage=16):w.isMatrix3?(b.boundary=48,b.storage=48):w.isMatrix4?(b.boundary=64,b.storage=64):w.isTexture?console.warn("THREE.WebGLRenderer: Texture samplers can not be part of an uniforms group."):console.warn("THREE.WebGLRenderer: Unsupported uniform value type.",w),b}function m(w){const b=w.target;b.removeEventListener("dispose",m);const y=a.indexOf(b.__bindingPointIndex);a.splice(y,1),n.deleteBuffer(r[b.id]),delete r[b.id],delete s[b.id]}function d(){for(const w in r)n.deleteBuffer(r[w]);a=[],r={},s={}}return{bind:l,update:c,dispose:d}}class z_{constructor(t={}){const{canvas:e=mh(),context:i=null,depth:r=!0,stencil:s=!1,alpha:a=!1,antialias:o=!1,premultipliedAlpha:l=!0,preserveDrawingBuffer:c=!1,powerPreference:u="default",failIfMajorPerformanceCaveat:h=!1,reverseDepthBuffer:f=!1}=t;this.isWebGLRenderer=!0;let p;if(i!==null){if(typeof WebGLRenderingContext<"u"&&i instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");p=i.getContextAttributes().alpha}else p=a;const g=new Uint32Array(4),x=new Int32Array(4);let m=null,d=null;const w=[],b=[];this.domElement=e,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=Rn,this.toneMappingExposure=1,this.transmissionResolutionScale=1;const y=this;let D=!1;this._outputColorSpace=Oe;let C=0,R=0,L=null,S=-1,v=null;const E=new le,O=new le;let I=null;const H=new $t(0);let q=0,W=e.width,j=e.height,z=1,nt=null,ht=null;const yt=new le(0,0,W,j),Ct=new le(0,0,W,j);let kt=!1;const X=new Dc;let tt=!1,$=!1;const Y=new ce,G=new ce,Q=new F,it=new le,lt={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let vt=!1;function ct(){return L===null?z:1}let A=i;function Yt(M,U){return e.getContext(M,U)}try{const M={alpha:!0,depth:r,stencil:s,antialias:o,premultipliedAlpha:l,preserveDrawingBuffer:c,powerPreference:u,failIfMajorPerformanceCaveat:h};if("setAttribute"in e&&e.setAttribute("data-engine",`three.js r${to}`),e.addEventListener("webglcontextlost",Tt,!1),e.addEventListener("webglcontextrestored",at,!1),e.addEventListener("webglcontextcreationerror",J,!1),A===null){const U="webgl2";if(A=Yt(U,M),A===null)throw Yt(U)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(M){throw console.error("THREE.WebGLRenderer: "+M.message),M}let Bt,It,pt,gt,Et,Pt,Jt,T,_,B,Z,et,K,xt,ut,bt,Rt,rt,Mt,Nt,Ut,ft,zt,P;function mt(){Bt=new Kp(A),Bt.init(),ft=new D_(A,Bt),It=new Vp(A,Bt,t,ft),pt=new C_(A,Bt),It.reverseDepthBuffer&&f&&pt.buffers.depth.setReversed(!0),gt=new Jp(A),Et=new __,Pt=new P_(A,Bt,pt,Et,It,ft,gt),Jt=new Wp(y),T=new $p(y),_=new rf(A),zt=new kp(A,_),B=new jp(A,_,gt,zt),Z=new tm(A,B,_,gt),Mt=new Qp(A,It,Pt),bt=new Gp(Et),et=new m_(y,Jt,T,Bt,It,zt,bt),K=new O_(y,Et),xt=new v_,ut=new T_(Bt),rt=new zp(y,Jt,T,pt,Z,p,l),Rt=new w_(y,Z,It),P=new B_(A,gt,It,pt),Nt=new Hp(A,Bt,gt),Ut=new Zp(A,Bt,gt),gt.programs=et.programs,y.capabilities=It,y.extensions=Bt,y.properties=Et,y.renderLists=xt,y.shadowMap=Rt,y.state=pt,y.info=gt}mt();const st=new N_(y,A);this.xr=st,this.getContext=function(){return A},this.getContextAttributes=function(){return A.getContextAttributes()},this.forceContextLoss=function(){const M=Bt.get("WEBGL_lose_context");M&&M.loseContext()},this.forceContextRestore=function(){const M=Bt.get("WEBGL_lose_context");M&&M.restoreContext()},this.getPixelRatio=function(){return z},this.setPixelRatio=function(M){M!==void 0&&(z=M,this.setSize(W,j,!1))},this.getSize=function(M){return M.set(W,j)},this.setSize=function(M,U,k=!0){if(st.isPresenting){console.warn("THREE.WebGLRenderer: Can't change size while VR device is presenting.");return}W=M,j=U,e.width=Math.floor(M*z),e.height=Math.floor(U*z),k===!0&&(e.style.width=M+"px",e.style.height=U+"px"),this.setViewport(0,0,M,U)},this.getDrawingBufferSize=function(M){return M.set(W*z,j*z).floor()},this.setDrawingBufferSize=function(M,U,k){W=M,j=U,z=k,e.width=Math.floor(M*k),e.height=Math.floor(U*k),this.setViewport(0,0,M,U)},this.getCurrentViewport=function(M){return M.copy(E)},this.getViewport=function(M){return M.copy(yt)},this.setViewport=function(M,U,k,V){M.isVector4?yt.set(M.x,M.y,M.z,M.w):yt.set(M,U,k,V),pt.viewport(E.copy(yt).multiplyScalar(z).round())},this.getScissor=function(M){return M.copy(Ct)},this.setScissor=function(M,U,k,V){M.isVector4?Ct.set(M.x,M.y,M.z,M.w):Ct.set(M,U,k,V),pt.scissor(O.copy(Ct).multiplyScalar(z).round())},this.getScissorTest=function(){return kt},this.setScissorTest=function(M){pt.setScissorTest(kt=M)},this.setOpaqueSort=function(M){nt=M},this.setTransparentSort=function(M){ht=M},this.getClearColor=function(M){return M.copy(rt.getClearColor())},this.setClearColor=function(){rt.setClearColor(...arguments)},this.getClearAlpha=function(){return rt.getClearAlpha()},this.setClearAlpha=function(){rt.setClearAlpha(...arguments)},this.clear=function(M=!0,U=!0,k=!0){let V=0;if(M){let N=!1;if(L!==null){const ot=L.texture.format;N=ot===oo||ot===ao||ot===so}if(N){const ot=L.texture.type,_t=ot===gn||ot===Yn||ot===Yi||ot===$i||ot===io||ot===ro,wt=rt.getClearColor(),St=rt.getClearAlpha(),Ft=wt.r,Ot=wt.g,Dt=wt.b;_t?(g[0]=Ft,g[1]=Ot,g[2]=Dt,g[3]=St,A.clearBufferuiv(A.COLOR,0,g)):(x[0]=Ft,x[1]=Ot,x[2]=Dt,x[3]=St,A.clearBufferiv(A.COLOR,0,x))}else V|=A.COLOR_BUFFER_BIT}U&&(V|=A.DEPTH_BUFFER_BIT),k&&(V|=A.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),A.clear(V)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){e.removeEventListener("webglcontextlost",Tt,!1),e.removeEventListener("webglcontextrestored",at,!1),e.removeEventListener("webglcontextcreationerror",J,!1),rt.dispose(),xt.dispose(),ut.dispose(),Et.dispose(),Jt.dispose(),T.dispose(),Z.dispose(),zt.dispose(),P.dispose(),et.dispose(),st.dispose(),st.removeEventListener("sessionstart",bo),st.removeEventListener("sessionend",Ao),Dn.stop()};function Tt(M){M.preventDefault(),console.log("THREE.WebGLRenderer: Context Lost."),D=!0}function at(){console.log("THREE.WebGLRenderer: Context Restored."),D=!1;const M=gt.autoReset,U=Rt.enabled,k=Rt.autoUpdate,V=Rt.needsUpdate,N=Rt.type;mt(),gt.autoReset=M,Rt.enabled=U,Rt.autoUpdate=k,Rt.needsUpdate=V,Rt.type=N}function J(M){console.error("THREE.WebGLRenderer: A WebGL context could not be created. Reason: ",M.statusMessage)}function At(M){const U=M.target;U.removeEventListener("dispose",At),Ht(U)}function Ht(M){ie(M),Et.remove(M)}function ie(M){const U=Et.get(M).programs;U!==void 0&&(U.forEach(function(k){et.releaseProgram(k)}),M.isShaderMaterial&&et.releaseShaderCache(M))}this.renderBufferDirect=function(M,U,k,V,N,ot){U===null&&(U=lt);const _t=N.isMesh&&N.matrixWorld.determinant()<0,wt=Mu(M,U,k,V,N);pt.setMaterial(V,_t);let St=k.index,Ft=1;if(V.wireframe===!0){if(St=B.getWireframeAttribute(k),St===void 0)return;Ft=2}const Ot=k.drawRange,Dt=k.attributes.position;let qt=Ot.start*Ft,Qt=(Ot.start+Ot.count)*Ft;ot!==null&&(qt=Math.max(qt,ot.start*Ft),Qt=Math.min(Qt,(ot.start+ot.count)*Ft)),St!==null?(qt=Math.max(qt,0),Qt=Math.min(Qt,St.count)):Dt!=null&&(qt=Math.max(qt,0),Qt=Math.min(Qt,Dt.count));const oe=Qt-qt;if(oe<0||oe===1/0)return;zt.setup(N,V,wt,k,St);let re,ne=Nt;if(St!==null&&(re=_.get(St),ne=Ut,ne.setIndex(re)),N.isMesh)V.wireframe===!0?(pt.setLineWidth(V.wireframeLinewidth*ct()),ne.setMode(A.LINES)):ne.setMode(A.TRIANGLES);else if(N.isLine){let Lt=V.linewidth;Lt===void 0&&(Lt=1),pt.setLineWidth(Lt*ct()),N.isLineSegments?ne.setMode(A.LINES):N.isLineLoop?ne.setMode(A.LINE_LOOP):ne.setMode(A.LINE_STRIP)}else N.isPoints?ne.setMode(A.POINTS):N.isSprite&&ne.setMode(A.TRIANGLES);if(N.isBatchedMesh)if(N._multiDrawInstances!==null)xi("THREE.WebGLRenderer: renderMultiDrawInstances has been deprecated and will be removed in r184. Append to renderMultiDraw arguments and use indirection."),ne.renderMultiDrawInstances(N._multiDrawStarts,N._multiDrawCounts,N._multiDrawCount,N._multiDrawInstances);else if(Bt.get("WEBGL_multi_draw"))ne.renderMultiDraw(N._multiDrawStarts,N._multiDrawCounts,N._multiDrawCount);else{const Lt=N._multiDrawStarts,ae=N._multiDrawCounts,Kt=N._multiDrawCount,Re=St?_.get(St).bytesPerElement:1,ti=Et.get(V).currentProgram.getUniforms();for(let Ce=0;Ce<Kt;Ce++)ti.setValue(A,"_gl_DrawID",Ce),ne.render(Lt[Ce]/Re,ae[Ce])}else if(N.isInstancedMesh)ne.renderInstances(qt,oe,N.count);else if(k.isInstancedBufferGeometry){const Lt=k._maxInstanceCount!==void 0?k._maxInstanceCount:1/0,ae=Math.min(k.instanceCount,Lt);ne.renderInstances(qt,oe,ae)}else ne.render(qt,oe)};function Zt(M,U,k){M.transparent===!0&&M.side===fn&&M.forceSinglePass===!1?(M.side=Ae,M.needsUpdate=!0,sr(M,U,k),M.side=Cn,M.needsUpdate=!0,sr(M,U,k),M.side=fn):sr(M,U,k)}this.compile=function(M,U,k=null){k===null&&(k=M),d=ut.get(k),d.init(U),b.push(d),k.traverseVisible(function(N){N.isLight&&N.layers.test(U.layers)&&(d.pushLight(N),N.castShadow&&d.pushShadow(N))}),M!==k&&M.traverseVisible(function(N){N.isLight&&N.layers.test(U.layers)&&(d.pushLight(N),N.castShadow&&d.pushShadow(N))}),d.setupLights();const V=new Set;return M.traverse(function(N){if(!(N.isMesh||N.isPoints||N.isLine||N.isSprite))return;const ot=N.material;if(ot)if(Array.isArray(ot))for(let _t=0;_t<ot.length;_t++){const wt=ot[_t];Zt(wt,k,N),V.add(wt)}else Zt(ot,k,N),V.add(ot)}),d=b.pop(),V},this.compileAsync=function(M,U,k=null){const V=this.compile(M,U,k);return new Promise(N=>{function ot(){if(V.forEach(function(_t){Et.get(_t).currentProgram.isReady()&&V.delete(_t)}),V.size===0){N(M);return}setTimeout(ot,10)}Bt.get("KHR_parallel_shader_compile")!==null?ot():setTimeout(ot,10)})};let ke=null;function rn(M){ke&&ke(M)}function bo(){Dn.stop()}function Ao(){Dn.start()}const Dn=new Uc;Dn.setAnimationLoop(rn),typeof self<"u"&&Dn.setContext(self),this.setAnimationLoop=function(M){ke=M,st.setAnimationLoop(M),M===null?Dn.stop():Dn.start()},st.addEventListener("sessionstart",bo),st.addEventListener("sessionend",Ao),this.render=function(M,U){if(U!==void 0&&U.isCamera!==!0){console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(D===!0)return;if(M.matrixWorldAutoUpdate===!0&&M.updateMatrixWorld(),U.parent===null&&U.matrixWorldAutoUpdate===!0&&U.updateMatrixWorld(),st.enabled===!0&&st.isPresenting===!0&&(st.cameraAutoUpdate===!0&&st.updateCamera(U),U=st.getCamera()),M.isScene===!0&&M.onBeforeRender(y,M,U,L),d=ut.get(M,b.length),d.init(U),b.push(d),G.multiplyMatrices(U.projectionMatrix,U.matrixWorldInverse),X.setFromProjectionMatrix(G),$=this.localClippingEnabled,tt=bt.init(this.clippingPlanes,$),m=xt.get(M,w.length),m.init(),w.push(m),st.enabled===!0&&st.isPresenting===!0){const ot=y.xr.getDepthSensingMesh();ot!==null&&gs(ot,U,-1/0,y.sortObjects)}gs(M,U,0,y.sortObjects),m.finish(),y.sortObjects===!0&&m.sort(nt,ht),vt=st.enabled===!1||st.isPresenting===!1||st.hasDepthSensing()===!1,vt&&rt.addToRenderList(m,M),this.info.render.frame++,tt===!0&&bt.beginShadows();const k=d.state.shadowsArray;Rt.render(k,M,U),tt===!0&&bt.endShadows(),this.info.autoReset===!0&&this.info.reset();const V=m.opaque,N=m.transmissive;if(d.setupLights(),U.isArrayCamera){const ot=U.cameras;if(N.length>0)for(let _t=0,wt=ot.length;_t<wt;_t++){const St=ot[_t];Ro(V,N,M,St)}vt&&rt.render(M);for(let _t=0,wt=ot.length;_t<wt;_t++){const St=ot[_t];wo(m,M,St,St.viewport)}}else N.length>0&&Ro(V,N,M,U),vt&&rt.render(M),wo(m,M,U);L!==null&&R===0&&(Pt.updateMultisampleRenderTarget(L),Pt.updateRenderTargetMipmap(L)),M.isScene===!0&&M.onAfterRender(y,M,U),zt.resetDefaultState(),S=-1,v=null,b.pop(),b.length>0?(d=b[b.length-1],tt===!0&&bt.setGlobalState(y.clippingPlanes,d.state.camera)):d=null,w.pop(),w.length>0?m=w[w.length-1]:m=null};function gs(M,U,k,V){if(M.visible===!1)return;if(M.layers.test(U.layers)){if(M.isGroup)k=M.renderOrder;else if(M.isLOD)M.autoUpdate===!0&&M.update(U);else if(M.isLight)d.pushLight(M),M.castShadow&&d.pushShadow(M);else if(M.isSprite){if(!M.frustumCulled||X.intersectsSprite(M)){V&&it.setFromMatrixPosition(M.matrixWorld).applyMatrix4(G);const _t=Z.update(M),wt=M.material;wt.visible&&m.push(M,_t,wt,k,it.z,null)}}else if((M.isMesh||M.isLine||M.isPoints)&&(!M.frustumCulled||X.intersectsObject(M))){const _t=Z.update(M),wt=M.material;if(V&&(M.boundingSphere!==void 0?(M.boundingSphere===null&&M.computeBoundingSphere(),it.copy(M.boundingSphere.center)):(_t.boundingSphere===null&&_t.computeBoundingSphere(),it.copy(_t.boundingSphere.center)),it.applyMatrix4(M.matrixWorld).applyMatrix4(G)),Array.isArray(wt)){const St=_t.groups;for(let Ft=0,Ot=St.length;Ft<Ot;Ft++){const Dt=St[Ft],qt=wt[Dt.materialIndex];qt&&qt.visible&&m.push(M,_t,qt,k,it.z,Dt)}}else wt.visible&&m.push(M,_t,wt,k,it.z,null)}}const ot=M.children;for(let _t=0,wt=ot.length;_t<wt;_t++)gs(ot[_t],U,k,V)}function wo(M,U,k,V){const N=M.opaque,ot=M.transmissive,_t=M.transparent;d.setupLightsView(k),tt===!0&&bt.setGlobalState(y.clippingPlanes,k),V&&pt.viewport(E.copy(V)),N.length>0&&rr(N,U,k),ot.length>0&&rr(ot,U,k),_t.length>0&&rr(_t,U,k),pt.buffers.depth.setTest(!0),pt.buffers.depth.setMask(!0),pt.buffers.color.setMask(!0),pt.setPolygonOffset(!1)}function Ro(M,U,k,V){if((k.isScene===!0?k.overrideMaterial:null)!==null)return;d.state.transmissionRenderTarget[V.id]===void 0&&(d.state.transmissionRenderTarget[V.id]=new Kn(1,1,{generateMipmaps:!0,type:Bt.has("EXT_color_buffer_half_float")||Bt.has("EXT_color_buffer_float")?tr:gn,minFilter:Wn,samples:4,stencilBuffer:s,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:jt.workingColorSpace}));const ot=d.state.transmissionRenderTarget[V.id],_t=V.viewport||E;ot.setSize(_t.z*y.transmissionResolutionScale,_t.w*y.transmissionResolutionScale);const wt=y.getRenderTarget(),St=y.getActiveCubeFace(),Ft=y.getActiveMipmapLevel();y.setRenderTarget(ot),y.getClearColor(H),q=y.getClearAlpha(),q<1&&y.setClearColor(16777215,.5),y.clear(),vt&&rt.render(k);const Ot=y.toneMapping;y.toneMapping=Rn;const Dt=V.viewport;if(V.viewport!==void 0&&(V.viewport=void 0),d.setupLightsView(V),tt===!0&&bt.setGlobalState(y.clippingPlanes,V),rr(M,k,V),Pt.updateMultisampleRenderTarget(ot),Pt.updateRenderTargetMipmap(ot),Bt.has("WEBGL_multisampled_render_to_texture")===!1){let qt=!1;for(let Qt=0,oe=U.length;Qt<oe;Qt++){const re=U[Qt],ne=re.object,Lt=re.geometry,ae=re.material,Kt=re.group;if(ae.side===fn&&ne.layers.test(V.layers)){const Re=ae.side;ae.side=Ae,ae.needsUpdate=!0,Co(ne,k,V,Lt,ae,Kt),ae.side=Re,ae.needsUpdate=!0,qt=!0}}qt===!0&&(Pt.updateMultisampleRenderTarget(ot),Pt.updateRenderTargetMipmap(ot))}y.setRenderTarget(wt,St,Ft),y.setClearColor(H,q),Dt!==void 0&&(V.viewport=Dt),y.toneMapping=Ot}function rr(M,U,k){const V=U.isScene===!0?U.overrideMaterial:null;for(let N=0,ot=M.length;N<ot;N++){const _t=M[N],wt=_t.object,St=_t.geometry,Ft=_t.group;let Ot=_t.material;Ot.allowOverride===!0&&V!==null&&(Ot=V),wt.layers.test(k.layers)&&Co(wt,U,k,St,Ot,Ft)}}function Co(M,U,k,V,N,ot){M.onBeforeRender(y,U,k,V,N,ot),M.modelViewMatrix.multiplyMatrices(k.matrixWorldInverse,M.matrixWorld),M.normalMatrix.getNormalMatrix(M.modelViewMatrix),N.onBeforeRender(y,U,k,V,M,ot),N.transparent===!0&&N.side===fn&&N.forceSinglePass===!1?(N.side=Ae,N.needsUpdate=!0,y.renderBufferDirect(k,U,V,N,M,ot),N.side=Cn,N.needsUpdate=!0,y.renderBufferDirect(k,U,V,N,M,ot),N.side=fn):y.renderBufferDirect(k,U,V,N,M,ot),M.onAfterRender(y,U,k,V,N,ot)}function sr(M,U,k){U.isScene!==!0&&(U=lt);const V=Et.get(M),N=d.state.lights,ot=d.state.shadowsArray,_t=N.state.version,wt=et.getParameters(M,N.state,ot,U,k),St=et.getProgramCacheKey(wt);let Ft=V.programs;V.environment=M.isMeshStandardMaterial?U.environment:null,V.fog=U.fog,V.envMap=(M.isMeshStandardMaterial?T:Jt).get(M.envMap||V.environment),V.envMapRotation=V.environment!==null&&M.envMap===null?U.environmentRotation:M.envMapRotation,Ft===void 0&&(M.addEventListener("dispose",At),Ft=new Map,V.programs=Ft);let Ot=Ft.get(St);if(Ot!==void 0){if(V.currentProgram===Ot&&V.lightsStateVersion===_t)return Do(M,wt),Ot}else wt.uniforms=et.getUniforms(M),M.onBeforeCompile(wt,y),Ot=et.acquireProgram(wt,St),Ft.set(St,Ot),V.uniforms=wt.uniforms;const Dt=V.uniforms;return(!M.isShaderMaterial&&!M.isRawShaderMaterial||M.clipping===!0)&&(Dt.clippingPlanes=bt.uniform),Do(M,wt),V.needsLights=yu(M),V.lightsStateVersion=_t,V.needsLights&&(Dt.ambientLightColor.value=N.state.ambient,Dt.lightProbe.value=N.state.probe,Dt.directionalLights.value=N.state.directional,Dt.directionalLightShadows.value=N.state.directionalShadow,Dt.spotLights.value=N.state.spot,Dt.spotLightShadows.value=N.state.spotShadow,Dt.rectAreaLights.value=N.state.rectArea,Dt.ltc_1.value=N.state.rectAreaLTC1,Dt.ltc_2.value=N.state.rectAreaLTC2,Dt.pointLights.value=N.state.point,Dt.pointLightShadows.value=N.state.pointShadow,Dt.hemisphereLights.value=N.state.hemi,Dt.directionalShadowMap.value=N.state.directionalShadowMap,Dt.directionalShadowMatrix.value=N.state.directionalShadowMatrix,Dt.spotShadowMap.value=N.state.spotShadowMap,Dt.spotLightMatrix.value=N.state.spotLightMatrix,Dt.spotLightMap.value=N.state.spotLightMap,Dt.pointShadowMap.value=N.state.pointShadowMap,Dt.pointShadowMatrix.value=N.state.pointShadowMatrix),V.currentProgram=Ot,V.uniformsList=null,Ot}function Po(M){if(M.uniformsList===null){const U=M.currentProgram.getUniforms();M.uniformsList=Vr.seqWithValue(U.seq,M.uniforms)}return M.uniformsList}function Do(M,U){const k=Et.get(M);k.outputColorSpace=U.outputColorSpace,k.batching=U.batching,k.batchingColor=U.batchingColor,k.instancing=U.instancing,k.instancingColor=U.instancingColor,k.instancingMorph=U.instancingMorph,k.skinning=U.skinning,k.morphTargets=U.morphTargets,k.morphNormals=U.morphNormals,k.morphColors=U.morphColors,k.morphTargetsCount=U.morphTargetsCount,k.numClippingPlanes=U.numClippingPlanes,k.numIntersection=U.numClipIntersection,k.vertexAlphas=U.vertexAlphas,k.vertexTangents=U.vertexTangents,k.toneMapping=U.toneMapping}function Mu(M,U,k,V,N){U.isScene!==!0&&(U=lt),Pt.resetTextureUnits();const ot=U.fog,_t=V.isMeshStandardMaterial?U.environment:null,wt=L===null?y.outputColorSpace:L.isXRRenderTarget===!0?L.texture.colorSpace:bi,St=(V.isMeshStandardMaterial?T:Jt).get(V.envMap||_t),Ft=V.vertexColors===!0&&!!k.attributes.color&&k.attributes.color.itemSize===4,Ot=!!k.attributes.tangent&&(!!V.normalMap||V.anisotropy>0),Dt=!!k.morphAttributes.position,qt=!!k.morphAttributes.normal,Qt=!!k.morphAttributes.color;let oe=Rn;V.toneMapped&&(L===null||L.isXRRenderTarget===!0)&&(oe=y.toneMapping);const re=k.morphAttributes.position||k.morphAttributes.normal||k.morphAttributes.color,ne=re!==void 0?re.length:0,Lt=Et.get(V),ae=d.state.lights;if(tt===!0&&($===!0||M!==v)){const xe=M===v&&V.id===S;bt.setState(V,M,xe)}let Kt=!1;V.version===Lt.__version?(Lt.needsLights&&Lt.lightsStateVersion!==ae.state.version||Lt.outputColorSpace!==wt||N.isBatchedMesh&&Lt.batching===!1||!N.isBatchedMesh&&Lt.batching===!0||N.isBatchedMesh&&Lt.batchingColor===!0&&N.colorTexture===null||N.isBatchedMesh&&Lt.batchingColor===!1&&N.colorTexture!==null||N.isInstancedMesh&&Lt.instancing===!1||!N.isInstancedMesh&&Lt.instancing===!0||N.isSkinnedMesh&&Lt.skinning===!1||!N.isSkinnedMesh&&Lt.skinning===!0||N.isInstancedMesh&&Lt.instancingColor===!0&&N.instanceColor===null||N.isInstancedMesh&&Lt.instancingColor===!1&&N.instanceColor!==null||N.isInstancedMesh&&Lt.instancingMorph===!0&&N.morphTexture===null||N.isInstancedMesh&&Lt.instancingMorph===!1&&N.morphTexture!==null||Lt.envMap!==St||V.fog===!0&&Lt.fog!==ot||Lt.numClippingPlanes!==void 0&&(Lt.numClippingPlanes!==bt.numPlanes||Lt.numIntersection!==bt.numIntersection)||Lt.vertexAlphas!==Ft||Lt.vertexTangents!==Ot||Lt.morphTargets!==Dt||Lt.morphNormals!==qt||Lt.morphColors!==Qt||Lt.toneMapping!==oe||Lt.morphTargetsCount!==ne)&&(Kt=!0):(Kt=!0,Lt.__version=V.version);let Re=Lt.currentProgram;Kt===!0&&(Re=sr(V,U,N));let ti=!1,Ce=!1,Ii=!1;const se=Re.getUniforms(),Ue=Lt.uniforms;if(pt.useProgram(Re.program)&&(ti=!0,Ce=!0,Ii=!0),V.id!==S&&(S=V.id,Ce=!0),ti||v!==M){pt.buffers.depth.getReversed()?(Y.copy(M.projectionMatrix),gh(Y),vh(Y),se.setValue(A,"projectionMatrix",Y)):se.setValue(A,"projectionMatrix",M.projectionMatrix),se.setValue(A,"viewMatrix",M.matrixWorldInverse);const Se=se.map.cameraPosition;Se!==void 0&&Se.setValue(A,Q.setFromMatrixPosition(M.matrixWorld)),It.logarithmicDepthBuffer&&se.setValue(A,"logDepthBufFC",2/(Math.log(M.far+1)/Math.LN2)),(V.isMeshPhongMaterial||V.isMeshToonMaterial||V.isMeshLambertMaterial||V.isMeshBasicMaterial||V.isMeshStandardMaterial||V.isShaderMaterial)&&se.setValue(A,"isOrthographic",M.isOrthographicCamera===!0),v!==M&&(v=M,Ce=!0,Ii=!0)}if(N.isSkinnedMesh){se.setOptional(A,N,"bindMatrix"),se.setOptional(A,N,"bindMatrixInverse");const xe=N.skeleton;xe&&(xe.boneTexture===null&&xe.computeBoneTexture(),se.setValue(A,"boneTexture",xe.boneTexture,Pt))}N.isBatchedMesh&&(se.setOptional(A,N,"batchingTexture"),se.setValue(A,"batchingTexture",N._matricesTexture,Pt),se.setOptional(A,N,"batchingIdTexture"),se.setValue(A,"batchingIdTexture",N._indirectTexture,Pt),se.setOptional(A,N,"batchingColorTexture"),N._colorsTexture!==null&&se.setValue(A,"batchingColorTexture",N._colorsTexture,Pt));const Ne=k.morphAttributes;if((Ne.position!==void 0||Ne.normal!==void 0||Ne.color!==void 0)&&Mt.update(N,k,Re),(Ce||Lt.receiveShadow!==N.receiveShadow)&&(Lt.receiveShadow=N.receiveShadow,se.setValue(A,"receiveShadow",N.receiveShadow)),V.isMeshGouraudMaterial&&V.envMap!==null&&(Ue.envMap.value=St,Ue.flipEnvMap.value=St.isCubeTexture&&St.isRenderTargetTexture===!1?-1:1),V.isMeshStandardMaterial&&V.envMap===null&&U.environment!==null&&(Ue.envMapIntensity.value=U.environmentIntensity),Ce&&(se.setValue(A,"toneMappingExposure",y.toneMappingExposure),Lt.needsLights&&Su(Ue,Ii),ot&&V.fog===!0&&K.refreshFogUniforms(Ue,ot),K.refreshMaterialUniforms(Ue,V,z,j,d.state.transmissionRenderTarget[M.id]),Vr.upload(A,Po(Lt),Ue,Pt)),V.isShaderMaterial&&V.uniformsNeedUpdate===!0&&(Vr.upload(A,Po(Lt),Ue,Pt),V.uniformsNeedUpdate=!1),V.isSpriteMaterial&&se.setValue(A,"center",N.center),se.setValue(A,"modelViewMatrix",N.modelViewMatrix),se.setValue(A,"normalMatrix",N.normalMatrix),se.setValue(A,"modelMatrix",N.matrixWorld),V.isShaderMaterial||V.isRawShaderMaterial){const xe=V.uniformsGroups;for(let Se=0,vs=xe.length;Se<vs;Se++){const Ln=xe[Se];P.update(Ln,Re),P.bind(Ln,Re)}}return Re}function Su(M,U){M.ambientLightColor.needsUpdate=U,M.lightProbe.needsUpdate=U,M.directionalLights.needsUpdate=U,M.directionalLightShadows.needsUpdate=U,M.pointLights.needsUpdate=U,M.pointLightShadows.needsUpdate=U,M.spotLights.needsUpdate=U,M.spotLightShadows.needsUpdate=U,M.rectAreaLights.needsUpdate=U,M.hemisphereLights.needsUpdate=U}function yu(M){return M.isMeshLambertMaterial||M.isMeshToonMaterial||M.isMeshPhongMaterial||M.isMeshStandardMaterial||M.isShadowMaterial||M.isShaderMaterial&&M.lights===!0}this.getActiveCubeFace=function(){return C},this.getActiveMipmapLevel=function(){return R},this.getRenderTarget=function(){return L},this.setRenderTargetTextures=function(M,U,k){const V=Et.get(M);V.__autoAllocateDepthBuffer=M.resolveDepthBuffer===!1,V.__autoAllocateDepthBuffer===!1&&(V.__useRenderToTexture=!1),Et.get(M.texture).__webglTexture=U,Et.get(M.depthTexture).__webglTexture=V.__autoAllocateDepthBuffer?void 0:k,V.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(M,U){const k=Et.get(M);k.__webglFramebuffer=U,k.__useDefaultFramebuffer=U===void 0};const Eu=A.createFramebuffer();this.setRenderTarget=function(M,U=0,k=0){L=M,C=U,R=k;let V=!0,N=null,ot=!1,_t=!1;if(M){const St=Et.get(M);if(St.__useDefaultFramebuffer!==void 0)pt.bindFramebuffer(A.FRAMEBUFFER,null),V=!1;else if(St.__webglFramebuffer===void 0)Pt.setupRenderTarget(M);else if(St.__hasExternalTextures)Pt.rebindTextures(M,Et.get(M.texture).__webglTexture,Et.get(M.depthTexture).__webglTexture);else if(M.depthBuffer){const Dt=M.depthTexture;if(St.__boundDepthTexture!==Dt){if(Dt!==null&&Et.has(Dt)&&(M.width!==Dt.image.width||M.height!==Dt.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");Pt.setupDepthRenderbuffer(M)}}const Ft=M.texture;(Ft.isData3DTexture||Ft.isDataArrayTexture||Ft.isCompressedArrayTexture)&&(_t=!0);const Ot=Et.get(M).__webglFramebuffer;M.isWebGLCubeRenderTarget?(Array.isArray(Ot[U])?N=Ot[U][k]:N=Ot[U],ot=!0):M.samples>0&&Pt.useMultisampledRTT(M)===!1?N=Et.get(M).__webglMultisampledFramebuffer:Array.isArray(Ot)?N=Ot[k]:N=Ot,E.copy(M.viewport),O.copy(M.scissor),I=M.scissorTest}else E.copy(yt).multiplyScalar(z).floor(),O.copy(Ct).multiplyScalar(z).floor(),I=kt;if(k!==0&&(N=Eu),pt.bindFramebuffer(A.FRAMEBUFFER,N)&&V&&pt.drawBuffers(M,N),pt.viewport(E),pt.scissor(O),pt.setScissorTest(I),ot){const St=Et.get(M.texture);A.framebufferTexture2D(A.FRAMEBUFFER,A.COLOR_ATTACHMENT0,A.TEXTURE_CUBE_MAP_POSITIVE_X+U,St.__webglTexture,k)}else if(_t){const St=Et.get(M.texture),Ft=U;A.framebufferTextureLayer(A.FRAMEBUFFER,A.COLOR_ATTACHMENT0,St.__webglTexture,k,Ft)}else if(M!==null&&k!==0){const St=Et.get(M.texture);A.framebufferTexture2D(A.FRAMEBUFFER,A.COLOR_ATTACHMENT0,A.TEXTURE_2D,St.__webglTexture,k)}S=-1},this.readRenderTargetPixels=function(M,U,k,V,N,ot,_t,wt=0){if(!(M&&M.isWebGLRenderTarget)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let St=Et.get(M).__webglFramebuffer;if(M.isWebGLCubeRenderTarget&&_t!==void 0&&(St=St[_t]),St){pt.bindFramebuffer(A.FRAMEBUFFER,St);try{const Ft=M.textures[wt],Ot=Ft.format,Dt=Ft.type;if(!It.textureFormatReadable(Ot)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!It.textureTypeReadable(Dt)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}U>=0&&U<=M.width-V&&k>=0&&k<=M.height-N&&(M.textures.length>1&&A.readBuffer(A.COLOR_ATTACHMENT0+wt),A.readPixels(U,k,V,N,ft.convert(Ot),ft.convert(Dt),ot))}finally{const Ft=L!==null?Et.get(L).__webglFramebuffer:null;pt.bindFramebuffer(A.FRAMEBUFFER,Ft)}}},this.readRenderTargetPixelsAsync=async function(M,U,k,V,N,ot,_t,wt=0){if(!(M&&M.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let St=Et.get(M).__webglFramebuffer;if(M.isWebGLCubeRenderTarget&&_t!==void 0&&(St=St[_t]),St)if(U>=0&&U<=M.width-V&&k>=0&&k<=M.height-N){pt.bindFramebuffer(A.FRAMEBUFFER,St);const Ft=M.textures[wt],Ot=Ft.format,Dt=Ft.type;if(!It.textureFormatReadable(Ot))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!It.textureTypeReadable(Dt))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");const qt=A.createBuffer();A.bindBuffer(A.PIXEL_PACK_BUFFER,qt),A.bufferData(A.PIXEL_PACK_BUFFER,ot.byteLength,A.STREAM_READ),M.textures.length>1&&A.readBuffer(A.COLOR_ATTACHMENT0+wt),A.readPixels(U,k,V,N,ft.convert(Ot),ft.convert(Dt),0);const Qt=L!==null?Et.get(L).__webglFramebuffer:null;pt.bindFramebuffer(A.FRAMEBUFFER,Qt);const oe=A.fenceSync(A.SYNC_GPU_COMMANDS_COMPLETE,0);return A.flush(),await _h(A,oe,4),A.bindBuffer(A.PIXEL_PACK_BUFFER,qt),A.getBufferSubData(A.PIXEL_PACK_BUFFER,0,ot),A.deleteBuffer(qt),A.deleteSync(oe),ot}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(M,U=null,k=0){const V=Math.pow(2,-k),N=Math.floor(M.image.width*V),ot=Math.floor(M.image.height*V),_t=U!==null?U.x:0,wt=U!==null?U.y:0;Pt.setTexture2D(M,0),A.copyTexSubImage2D(A.TEXTURE_2D,k,0,0,_t,wt,N,ot),pt.unbindTexture()};const Tu=A.createFramebuffer(),bu=A.createFramebuffer();this.copyTextureToTexture=function(M,U,k=null,V=null,N=0,ot=null){ot===null&&(N!==0?(xi("WebGLRenderer: copyTextureToTexture function signature has changed to support src and dst mipmap levels."),ot=N,N=0):ot=0);let _t,wt,St,Ft,Ot,Dt,qt,Qt,oe;const re=M.isCompressedTexture?M.mipmaps[ot]:M.image;if(k!==null)_t=k.max.x-k.min.x,wt=k.max.y-k.min.y,St=k.isBox3?k.max.z-k.min.z:1,Ft=k.min.x,Ot=k.min.y,Dt=k.isBox3?k.min.z:0;else{const Ne=Math.pow(2,-N);_t=Math.floor(re.width*Ne),wt=Math.floor(re.height*Ne),M.isDataArrayTexture?St=re.depth:M.isData3DTexture?St=Math.floor(re.depth*Ne):St=1,Ft=0,Ot=0,Dt=0}V!==null?(qt=V.x,Qt=V.y,oe=V.z):(qt=0,Qt=0,oe=0);const ne=ft.convert(U.format),Lt=ft.convert(U.type);let ae;U.isData3DTexture?(Pt.setTexture3D(U,0),ae=A.TEXTURE_3D):U.isDataArrayTexture||U.isCompressedArrayTexture?(Pt.setTexture2DArray(U,0),ae=A.TEXTURE_2D_ARRAY):(Pt.setTexture2D(U,0),ae=A.TEXTURE_2D),A.pixelStorei(A.UNPACK_FLIP_Y_WEBGL,U.flipY),A.pixelStorei(A.UNPACK_PREMULTIPLY_ALPHA_WEBGL,U.premultiplyAlpha),A.pixelStorei(A.UNPACK_ALIGNMENT,U.unpackAlignment);const Kt=A.getParameter(A.UNPACK_ROW_LENGTH),Re=A.getParameter(A.UNPACK_IMAGE_HEIGHT),ti=A.getParameter(A.UNPACK_SKIP_PIXELS),Ce=A.getParameter(A.UNPACK_SKIP_ROWS),Ii=A.getParameter(A.UNPACK_SKIP_IMAGES);A.pixelStorei(A.UNPACK_ROW_LENGTH,re.width),A.pixelStorei(A.UNPACK_IMAGE_HEIGHT,re.height),A.pixelStorei(A.UNPACK_SKIP_PIXELS,Ft),A.pixelStorei(A.UNPACK_SKIP_ROWS,Ot),A.pixelStorei(A.UNPACK_SKIP_IMAGES,Dt);const se=M.isDataArrayTexture||M.isData3DTexture,Ue=U.isDataArrayTexture||U.isData3DTexture;if(M.isDepthTexture){const Ne=Et.get(M),xe=Et.get(U),Se=Et.get(Ne.__renderTarget),vs=Et.get(xe.__renderTarget);pt.bindFramebuffer(A.READ_FRAMEBUFFER,Se.__webglFramebuffer),pt.bindFramebuffer(A.DRAW_FRAMEBUFFER,vs.__webglFramebuffer);for(let Ln=0;Ln<St;Ln++)se&&(A.framebufferTextureLayer(A.READ_FRAMEBUFFER,A.COLOR_ATTACHMENT0,Et.get(M).__webglTexture,N,Dt+Ln),A.framebufferTextureLayer(A.DRAW_FRAMEBUFFER,A.COLOR_ATTACHMENT0,Et.get(U).__webglTexture,ot,oe+Ln)),A.blitFramebuffer(Ft,Ot,_t,wt,qt,Qt,_t,wt,A.DEPTH_BUFFER_BIT,A.NEAREST);pt.bindFramebuffer(A.READ_FRAMEBUFFER,null),pt.bindFramebuffer(A.DRAW_FRAMEBUFFER,null)}else if(N!==0||M.isRenderTargetTexture||Et.has(M)){const Ne=Et.get(M),xe=Et.get(U);pt.bindFramebuffer(A.READ_FRAMEBUFFER,Tu),pt.bindFramebuffer(A.DRAW_FRAMEBUFFER,bu);for(let Se=0;Se<St;Se++)se?A.framebufferTextureLayer(A.READ_FRAMEBUFFER,A.COLOR_ATTACHMENT0,Ne.__webglTexture,N,Dt+Se):A.framebufferTexture2D(A.READ_FRAMEBUFFER,A.COLOR_ATTACHMENT0,A.TEXTURE_2D,Ne.__webglTexture,N),Ue?A.framebufferTextureLayer(A.DRAW_FRAMEBUFFER,A.COLOR_ATTACHMENT0,xe.__webglTexture,ot,oe+Se):A.framebufferTexture2D(A.DRAW_FRAMEBUFFER,A.COLOR_ATTACHMENT0,A.TEXTURE_2D,xe.__webglTexture,ot),N!==0?A.blitFramebuffer(Ft,Ot,_t,wt,qt,Qt,_t,wt,A.COLOR_BUFFER_BIT,A.NEAREST):Ue?A.copyTexSubImage3D(ae,ot,qt,Qt,oe+Se,Ft,Ot,_t,wt):A.copyTexSubImage2D(ae,ot,qt,Qt,Ft,Ot,_t,wt);pt.bindFramebuffer(A.READ_FRAMEBUFFER,null),pt.bindFramebuffer(A.DRAW_FRAMEBUFFER,null)}else Ue?M.isDataTexture||M.isData3DTexture?A.texSubImage3D(ae,ot,qt,Qt,oe,_t,wt,St,ne,Lt,re.data):U.isCompressedArrayTexture?A.compressedTexSubImage3D(ae,ot,qt,Qt,oe,_t,wt,St,ne,re.data):A.texSubImage3D(ae,ot,qt,Qt,oe,_t,wt,St,ne,Lt,re):M.isDataTexture?A.texSubImage2D(A.TEXTURE_2D,ot,qt,Qt,_t,wt,ne,Lt,re.data):M.isCompressedTexture?A.compressedTexSubImage2D(A.TEXTURE_2D,ot,qt,Qt,re.width,re.height,ne,re.data):A.texSubImage2D(A.TEXTURE_2D,ot,qt,Qt,_t,wt,ne,Lt,re);A.pixelStorei(A.UNPACK_ROW_LENGTH,Kt),A.pixelStorei(A.UNPACK_IMAGE_HEIGHT,Re),A.pixelStorei(A.UNPACK_SKIP_PIXELS,ti),A.pixelStorei(A.UNPACK_SKIP_ROWS,Ce),A.pixelStorei(A.UNPACK_SKIP_IMAGES,Ii),ot===0&&U.generateMipmaps&&A.generateMipmap(ae),pt.unbindTexture()},this.copyTextureToTexture3D=function(M,U,k=null,V=null,N=0){return xi('WebGLRenderer: copyTextureToTexture3D function has been deprecated. Use "copyTextureToTexture" instead.'),this.copyTextureToTexture(M,U,k,V,N)},this.initRenderTarget=function(M){Et.get(M).__webglFramebuffer===void 0&&Pt.setupRenderTarget(M)},this.initTexture=function(M){M.isCubeTexture?Pt.setTextureCube(M,0):M.isData3DTexture?Pt.setTexture3D(M,0):M.isDataArrayTexture||M.isCompressedArrayTexture?Pt.setTexture2DArray(M,0):Pt.setTexture2D(M,0),pt.unbindTexture()},this.resetState=function(){C=0,R=0,L=null,pt.reset(),zt.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return pn}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(t){this._outputColorSpace=t;const e=this.getContext();e.drawingBufferColorSpace=jt._getDrawingBufferColorSpace(t),e.unpackColorSpace=jt._getUnpackColorSpace()}}const Dl={type:"change"},mo={type:"start"},zc={type:"end"},Cr=new uo,Ll=new bn,k_=Math.cos(70*ph.DEG2RAD),he=new F,Ee=2*Math.PI,ee={NONE:-1,ROTATE:0,DOLLY:1,PAN:2,TOUCH_ROTATE:3,TOUCH_PAN:4,TOUCH_DOLLY_PAN:5,TOUCH_DOLLY_ROTATE:6},js=1e-6;class H_ extends ef{constructor(t,e=null){super(t,e),this.state=ee.NONE,this.target=new F,this.cursor=new F,this.minDistance=0,this.maxDistance=1/0,this.minZoom=0,this.maxZoom=1/0,this.minTargetRadius=0,this.maxTargetRadius=1/0,this.minPolarAngle=0,this.maxPolarAngle=Math.PI,this.minAzimuthAngle=-1/0,this.maxAzimuthAngle=1/0,this.enableDamping=!1,this.dampingFactor=.05,this.enableZoom=!0,this.zoomSpeed=1,this.enableRotate=!0,this.rotateSpeed=1,this.keyRotateSpeed=1,this.enablePan=!0,this.panSpeed=1,this.screenSpacePanning=!0,this.keyPanSpeed=7,this.zoomToCursor=!1,this.autoRotate=!1,this.autoRotateSpeed=2,this.keys={LEFT:"ArrowLeft",UP:"ArrowUp",RIGHT:"ArrowRight",BOTTOM:"ArrowDown"},this.mouseButtons={LEFT:mn.ROTATE,MIDDLE:mn.DOLLY,RIGHT:mn.PAN},this.touches={ONE:mi.ROTATE,TWO:mi.DOLLY_PAN},this.target0=this.target.clone(),this.position0=this.object.position.clone(),this.zoom0=this.object.zoom,this._domElementKeyEvents=null,this._lastPosition=new F,this._lastQuaternion=new $n,this._lastTargetPosition=new F,this._quat=new $n().setFromUnitVectors(t.up,new F(0,1,0)),this._quatInverse=this._quat.clone().invert(),this._spherical=new sl,this._sphericalDelta=new sl,this._scale=1,this._panOffset=new F,this._rotateStart=new Vt,this._rotateEnd=new Vt,this._rotateDelta=new Vt,this._panStart=new Vt,this._panEnd=new Vt,this._panDelta=new Vt,this._dollyStart=new Vt,this._dollyEnd=new Vt,this._dollyDelta=new Vt,this._dollyDirection=new F,this._mouse=new Vt,this._performCursorZoom=!1,this._pointers=[],this._pointerPositions={},this._controlActive=!1,this._onPointerMove=G_.bind(this),this._onPointerDown=V_.bind(this),this._onPointerUp=W_.bind(this),this._onContextMenu=Z_.bind(this),this._onMouseWheel=Y_.bind(this),this._onKeyDown=$_.bind(this),this._onTouchStart=K_.bind(this),this._onTouchMove=j_.bind(this),this._onMouseDown=X_.bind(this),this._onMouseMove=q_.bind(this),this._interceptControlDown=J_.bind(this),this._interceptControlUp=Q_.bind(this),this.domElement!==null&&this.connect(this.domElement),this.update()}connect(t){super.connect(t),this.domElement.addEventListener("pointerdown",this._onPointerDown),this.domElement.addEventListener("pointercancel",this._onPointerUp),this.domElement.addEventListener("contextmenu",this._onContextMenu),this.domElement.addEventListener("wheel",this._onMouseWheel,{passive:!1}),this.domElement.getRootNode().addEventListener("keydown",this._interceptControlDown,{passive:!0,capture:!0}),this.domElement.style.touchAction="none"}disconnect(){this.domElement.removeEventListener("pointerdown",this._onPointerDown),this.domElement.removeEventListener("pointermove",this._onPointerMove),this.domElement.removeEventListener("pointerup",this._onPointerUp),this.domElement.removeEventListener("pointercancel",this._onPointerUp),this.domElement.removeEventListener("wheel",this._onMouseWheel),this.domElement.removeEventListener("contextmenu",this._onContextMenu),this.stopListenToKeyEvents(),this.domElement.getRootNode().removeEventListener("keydown",this._interceptControlDown,{capture:!0}),this.domElement.style.touchAction="auto"}dispose(){this.disconnect()}getPolarAngle(){return this._spherical.phi}getAzimuthalAngle(){return this._spherical.theta}getDistance(){return this.object.position.distanceTo(this.target)}listenToKeyEvents(t){t.addEventListener("keydown",this._onKeyDown),this._domElementKeyEvents=t}stopListenToKeyEvents(){this._domElementKeyEvents!==null&&(this._domElementKeyEvents.removeEventListener("keydown",this._onKeyDown),this._domElementKeyEvents=null)}saveState(){this.target0.copy(this.target),this.position0.copy(this.object.position),this.zoom0=this.object.zoom}reset(){this.target.copy(this.target0),this.object.position.copy(this.position0),this.object.zoom=this.zoom0,this.object.updateProjectionMatrix(),this.dispatchEvent(Dl),this.update(),this.state=ee.NONE}update(t=null){const e=this.object.position;he.copy(e).sub(this.target),he.applyQuaternion(this._quat),this._spherical.setFromVector3(he),this.autoRotate&&this.state===ee.NONE&&this._rotateLeft(this._getAutoRotationAngle(t)),this.enableDamping?(this._spherical.theta+=this._sphericalDelta.theta*this.dampingFactor,this._spherical.phi+=this._sphericalDelta.phi*this.dampingFactor):(this._spherical.theta+=this._sphericalDelta.theta,this._spherical.phi+=this._sphericalDelta.phi);let i=this.minAzimuthAngle,r=this.maxAzimuthAngle;isFinite(i)&&isFinite(r)&&(i<-Math.PI?i+=Ee:i>Math.PI&&(i-=Ee),r<-Math.PI?r+=Ee:r>Math.PI&&(r-=Ee),i<=r?this._spherical.theta=Math.max(i,Math.min(r,this._spherical.theta)):this._spherical.theta=this._spherical.theta>(i+r)/2?Math.max(i,this._spherical.theta):Math.min(r,this._spherical.theta)),this._spherical.phi=Math.max(this.minPolarAngle,Math.min(this.maxPolarAngle,this._spherical.phi)),this._spherical.makeSafe(),this.enableDamping===!0?this.target.addScaledVector(this._panOffset,this.dampingFactor):this.target.add(this._panOffset),this.target.sub(this.cursor),this.target.clampLength(this.minTargetRadius,this.maxTargetRadius),this.target.add(this.cursor);let s=!1;if(this.zoomToCursor&&this._performCursorZoom||this.object.isOrthographicCamera)this._spherical.radius=this._clampDistance(this._spherical.radius);else{const a=this._spherical.radius;this._spherical.radius=this._clampDistance(this._spherical.radius*this._scale),s=a!=this._spherical.radius}if(he.setFromSpherical(this._spherical),he.applyQuaternion(this._quatInverse),e.copy(this.target).add(he),this.object.lookAt(this.target),this.enableDamping===!0?(this._sphericalDelta.theta*=1-this.dampingFactor,this._sphericalDelta.phi*=1-this.dampingFactor,this._panOffset.multiplyScalar(1-this.dampingFactor)):(this._sphericalDelta.set(0,0,0),this._panOffset.set(0,0,0)),this.zoomToCursor&&this._performCursorZoom){let a=null;if(this.object.isPerspectiveCamera){const o=he.length();a=this._clampDistance(o*this._scale);const l=o-a;this.object.position.addScaledVector(this._dollyDirection,l),this.object.updateMatrixWorld(),s=!!l}else if(this.object.isOrthographicCamera){const o=new F(this._mouse.x,this._mouse.y,0);o.unproject(this.object);const l=this.object.zoom;this.object.zoom=Math.max(this.minZoom,Math.min(this.maxZoom,this.object.zoom/this._scale)),this.object.updateProjectionMatrix(),s=l!==this.object.zoom;const c=new F(this._mouse.x,this._mouse.y,0);c.unproject(this.object),this.object.position.sub(c).add(o),this.object.updateMatrixWorld(),a=he.length()}else console.warn("WARNING: OrbitControls.js encountered an unknown camera type - zoom to cursor disabled."),this.zoomToCursor=!1;a!==null&&(this.screenSpacePanning?this.target.set(0,0,-1).transformDirection(this.object.matrix).multiplyScalar(a).add(this.object.position):(Cr.origin.copy(this.object.position),Cr.direction.set(0,0,-1).transformDirection(this.object.matrix),Math.abs(this.object.up.dot(Cr.direction))<k_?this.object.lookAt(this.target):(Ll.setFromNormalAndCoplanarPoint(this.object.up,this.target),Cr.intersectPlane(Ll,this.target))))}else if(this.object.isOrthographicCamera){const a=this.object.zoom;this.object.zoom=Math.max(this.minZoom,Math.min(this.maxZoom,this.object.zoom/this._scale)),a!==this.object.zoom&&(this.object.updateProjectionMatrix(),s=!0)}return this._scale=1,this._performCursorZoom=!1,s||this._lastPosition.distanceToSquared(this.object.position)>js||8*(1-this._lastQuaternion.dot(this.object.quaternion))>js||this._lastTargetPosition.distanceToSquared(this.target)>js?(this.dispatchEvent(Dl),this._lastPosition.copy(this.object.position),this._lastQuaternion.copy(this.object.quaternion),this._lastTargetPosition.copy(this.target),!0):!1}_getAutoRotationAngle(t){return t!==null?Ee/60*this.autoRotateSpeed*t:Ee/60/60*this.autoRotateSpeed}_getZoomScale(t){const e=Math.abs(t*.01);return Math.pow(.95,this.zoomSpeed*e)}_rotateLeft(t){this._sphericalDelta.theta-=t}_rotateUp(t){this._sphericalDelta.phi-=t}_panLeft(t,e){he.setFromMatrixColumn(e,0),he.multiplyScalar(-t),this._panOffset.add(he)}_panUp(t,e){this.screenSpacePanning===!0?he.setFromMatrixColumn(e,1):(he.setFromMatrixColumn(e,0),he.crossVectors(this.object.up,he)),he.multiplyScalar(t),this._panOffset.add(he)}_pan(t,e){const i=this.domElement;if(this.object.isPerspectiveCamera){const r=this.object.position;he.copy(r).sub(this.target);let s=he.length();s*=Math.tan(this.object.fov/2*Math.PI/180),this._panLeft(2*t*s/i.clientHeight,this.object.matrix),this._panUp(2*e*s/i.clientHeight,this.object.matrix)}else this.object.isOrthographicCamera?(this._panLeft(t*(this.object.right-this.object.left)/this.object.zoom/i.clientWidth,this.object.matrix),this._panUp(e*(this.object.top-this.object.bottom)/this.object.zoom/i.clientHeight,this.object.matrix)):(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - pan disabled."),this.enablePan=!1)}_dollyOut(t){this.object.isPerspectiveCamera||this.object.isOrthographicCamera?this._scale/=t:(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled."),this.enableZoom=!1)}_dollyIn(t){this.object.isPerspectiveCamera||this.object.isOrthographicCamera?this._scale*=t:(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled."),this.enableZoom=!1)}_updateZoomParameters(t,e){if(!this.zoomToCursor)return;this._performCursorZoom=!0;const i=this.domElement.getBoundingClientRect(),r=t-i.left,s=e-i.top,a=i.width,o=i.height;this._mouse.x=r/a*2-1,this._mouse.y=-(s/o)*2+1,this._dollyDirection.set(this._mouse.x,this._mouse.y,1).unproject(this.object).sub(this.object.position).normalize()}_clampDistance(t){return Math.max(this.minDistance,Math.min(this.maxDistance,t))}_handleMouseDownRotate(t){this._rotateStart.set(t.clientX,t.clientY)}_handleMouseDownDolly(t){this._updateZoomParameters(t.clientX,t.clientX),this._dollyStart.set(t.clientX,t.clientY)}_handleMouseDownPan(t){this._panStart.set(t.clientX,t.clientY)}_handleMouseMoveRotate(t){this._rotateEnd.set(t.clientX,t.clientY),this._rotateDelta.subVectors(this._rotateEnd,this._rotateStart).multiplyScalar(this.rotateSpeed);const e=this.domElement;this._rotateLeft(Ee*this._rotateDelta.x/e.clientHeight),this._rotateUp(Ee*this._rotateDelta.y/e.clientHeight),this._rotateStart.copy(this._rotateEnd),this.update()}_handleMouseMoveDolly(t){this._dollyEnd.set(t.clientX,t.clientY),this._dollyDelta.subVectors(this._dollyEnd,this._dollyStart),this._dollyDelta.y>0?this._dollyOut(this._getZoomScale(this._dollyDelta.y)):this._dollyDelta.y<0&&this._dollyIn(this._getZoomScale(this._dollyDelta.y)),this._dollyStart.copy(this._dollyEnd),this.update()}_handleMouseMovePan(t){this._panEnd.set(t.clientX,t.clientY),this._panDelta.subVectors(this._panEnd,this._panStart).multiplyScalar(this.panSpeed),this._pan(this._panDelta.x,this._panDelta.y),this._panStart.copy(this._panEnd),this.update()}_handleMouseWheel(t){this._updateZoomParameters(t.clientX,t.clientY),t.deltaY<0?this._dollyIn(this._getZoomScale(t.deltaY)):t.deltaY>0&&this._dollyOut(this._getZoomScale(t.deltaY)),this.update()}_handleKeyDown(t){let e=!1;switch(t.code){case this.keys.UP:t.ctrlKey||t.metaKey||t.shiftKey?this.enableRotate&&this._rotateUp(Ee*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(0,this.keyPanSpeed),e=!0;break;case this.keys.BOTTOM:t.ctrlKey||t.metaKey||t.shiftKey?this.enableRotate&&this._rotateUp(-Ee*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(0,-this.keyPanSpeed),e=!0;break;case this.keys.LEFT:t.ctrlKey||t.metaKey||t.shiftKey?this.enableRotate&&this._rotateLeft(Ee*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(this.keyPanSpeed,0),e=!0;break;case this.keys.RIGHT:t.ctrlKey||t.metaKey||t.shiftKey?this.enableRotate&&this._rotateLeft(-Ee*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(-this.keyPanSpeed,0),e=!0;break}e&&(t.preventDefault(),this.update())}_handleTouchStartRotate(t){if(this._pointers.length===1)this._rotateStart.set(t.pageX,t.pageY);else{const e=this._getSecondPointerPosition(t),i=.5*(t.pageX+e.x),r=.5*(t.pageY+e.y);this._rotateStart.set(i,r)}}_handleTouchStartPan(t){if(this._pointers.length===1)this._panStart.set(t.pageX,t.pageY);else{const e=this._getSecondPointerPosition(t),i=.5*(t.pageX+e.x),r=.5*(t.pageY+e.y);this._panStart.set(i,r)}}_handleTouchStartDolly(t){const e=this._getSecondPointerPosition(t),i=t.pageX-e.x,r=t.pageY-e.y,s=Math.sqrt(i*i+r*r);this._dollyStart.set(0,s)}_handleTouchStartDollyPan(t){this.enableZoom&&this._handleTouchStartDolly(t),this.enablePan&&this._handleTouchStartPan(t)}_handleTouchStartDollyRotate(t){this.enableZoom&&this._handleTouchStartDolly(t),this.enableRotate&&this._handleTouchStartRotate(t)}_handleTouchMoveRotate(t){if(this._pointers.length==1)this._rotateEnd.set(t.pageX,t.pageY);else{const i=this._getSecondPointerPosition(t),r=.5*(t.pageX+i.x),s=.5*(t.pageY+i.y);this._rotateEnd.set(r,s)}this._rotateDelta.subVectors(this._rotateEnd,this._rotateStart).multiplyScalar(this.rotateSpeed);const e=this.domElement;this._rotateLeft(Ee*this._rotateDelta.x/e.clientHeight),this._rotateUp(Ee*this._rotateDelta.y/e.clientHeight),this._rotateStart.copy(this._rotateEnd)}_handleTouchMovePan(t){if(this._pointers.length===1)this._panEnd.set(t.pageX,t.pageY);else{const e=this._getSecondPointerPosition(t),i=.5*(t.pageX+e.x),r=.5*(t.pageY+e.y);this._panEnd.set(i,r)}this._panDelta.subVectors(this._panEnd,this._panStart).multiplyScalar(this.panSpeed),this._pan(this._panDelta.x,this._panDelta.y),this._panStart.copy(this._panEnd)}_handleTouchMoveDolly(t){const e=this._getSecondPointerPosition(t),i=t.pageX-e.x,r=t.pageY-e.y,s=Math.sqrt(i*i+r*r);this._dollyEnd.set(0,s),this._dollyDelta.set(0,Math.pow(this._dollyEnd.y/this._dollyStart.y,this.zoomSpeed)),this._dollyOut(this._dollyDelta.y),this._dollyStart.copy(this._dollyEnd);const a=(t.pageX+e.x)*.5,o=(t.pageY+e.y)*.5;this._updateZoomParameters(a,o)}_handleTouchMoveDollyPan(t){this.enableZoom&&this._handleTouchMoveDolly(t),this.enablePan&&this._handleTouchMovePan(t)}_handleTouchMoveDollyRotate(t){this.enableZoom&&this._handleTouchMoveDolly(t),this.enableRotate&&this._handleTouchMoveRotate(t)}_addPointer(t){this._pointers.push(t.pointerId)}_removePointer(t){delete this._pointerPositions[t.pointerId];for(let e=0;e<this._pointers.length;e++)if(this._pointers[e]==t.pointerId){this._pointers.splice(e,1);return}}_isTrackingPointer(t){for(let e=0;e<this._pointers.length;e++)if(this._pointers[e]==t.pointerId)return!0;return!1}_trackPointer(t){let e=this._pointerPositions[t.pointerId];e===void 0&&(e=new Vt,this._pointerPositions[t.pointerId]=e),e.set(t.pageX,t.pageY)}_getSecondPointerPosition(t){const e=t.pointerId===this._pointers[0]?this._pointers[1]:this._pointers[0];return this._pointerPositions[e]}_customWheelEvent(t){const e=t.deltaMode,i={clientX:t.clientX,clientY:t.clientY,deltaY:t.deltaY};switch(e){case 1:i.deltaY*=16;break;case 2:i.deltaY*=100;break}return t.ctrlKey&&!this._controlActive&&(i.deltaY*=10),i}}function V_(n){this.enabled!==!1&&(this._pointers.length===0&&(this.domElement.setPointerCapture(n.pointerId),this.domElement.addEventListener("pointermove",this._onPointerMove),this.domElement.addEventListener("pointerup",this._onPointerUp)),!this._isTrackingPointer(n)&&(this._addPointer(n),n.pointerType==="touch"?this._onTouchStart(n):this._onMouseDown(n)))}function G_(n){this.enabled!==!1&&(n.pointerType==="touch"?this._onTouchMove(n):this._onMouseMove(n))}function W_(n){switch(this._removePointer(n),this._pointers.length){case 0:this.domElement.releasePointerCapture(n.pointerId),this.domElement.removeEventListener("pointermove",this._onPointerMove),this.domElement.removeEventListener("pointerup",this._onPointerUp),this.dispatchEvent(zc),this.state=ee.NONE;break;case 1:const t=this._pointers[0],e=this._pointerPositions[t];this._onTouchStart({pointerId:t,pageX:e.x,pageY:e.y});break}}function X_(n){let t;switch(n.button){case 0:t=this.mouseButtons.LEFT;break;case 1:t=this.mouseButtons.MIDDLE;break;case 2:t=this.mouseButtons.RIGHT;break;default:t=-1}switch(t){case mn.DOLLY:if(this.enableZoom===!1)return;this._handleMouseDownDolly(n),this.state=ee.DOLLY;break;case mn.ROTATE:if(n.ctrlKey||n.metaKey||n.shiftKey){if(this.enablePan===!1)return;this._handleMouseDownPan(n),this.state=ee.PAN}else{if(this.enableRotate===!1)return;this._handleMouseDownRotate(n),this.state=ee.ROTATE}break;case mn.PAN:if(n.ctrlKey||n.metaKey||n.shiftKey){if(this.enableRotate===!1)return;this._handleMouseDownRotate(n),this.state=ee.ROTATE}else{if(this.enablePan===!1)return;this._handleMouseDownPan(n),this.state=ee.PAN}break;default:this.state=ee.NONE}this.state!==ee.NONE&&this.dispatchEvent(mo)}function q_(n){switch(this.state){case ee.ROTATE:if(this.enableRotate===!1)return;this._handleMouseMoveRotate(n);break;case ee.DOLLY:if(this.enableZoom===!1)return;this._handleMouseMoveDolly(n);break;case ee.PAN:if(this.enablePan===!1)return;this._handleMouseMovePan(n);break}}function Y_(n){this.enabled===!1||this.enableZoom===!1||this.state!==ee.NONE||(n.preventDefault(),this.dispatchEvent(mo),this._handleMouseWheel(this._customWheelEvent(n)),this.dispatchEvent(zc))}function $_(n){this.enabled!==!1&&this._handleKeyDown(n)}function K_(n){switch(this._trackPointer(n),this._pointers.length){case 1:switch(this.touches.ONE){case mi.ROTATE:if(this.enableRotate===!1)return;this._handleTouchStartRotate(n),this.state=ee.TOUCH_ROTATE;break;case mi.PAN:if(this.enablePan===!1)return;this._handleTouchStartPan(n),this.state=ee.TOUCH_PAN;break;default:this.state=ee.NONE}break;case 2:switch(this.touches.TWO){case mi.DOLLY_PAN:if(this.enableZoom===!1&&this.enablePan===!1)return;this._handleTouchStartDollyPan(n),this.state=ee.TOUCH_DOLLY_PAN;break;case mi.DOLLY_ROTATE:if(this.enableZoom===!1&&this.enableRotate===!1)return;this._handleTouchStartDollyRotate(n),this.state=ee.TOUCH_DOLLY_ROTATE;break;default:this.state=ee.NONE}break;default:this.state=ee.NONE}this.state!==ee.NONE&&this.dispatchEvent(mo)}function j_(n){switch(this._trackPointer(n),this.state){case ee.TOUCH_ROTATE:if(this.enableRotate===!1)return;this._handleTouchMoveRotate(n),this.update();break;case ee.TOUCH_PAN:if(this.enablePan===!1)return;this._handleTouchMovePan(n),this.update();break;case ee.TOUCH_DOLLY_PAN:if(this.enableZoom===!1&&this.enablePan===!1)return;this._handleTouchMoveDollyPan(n),this.update();break;case ee.TOUCH_DOLLY_ROTATE:if(this.enableZoom===!1&&this.enableRotate===!1)return;this._handleTouchMoveDollyRotate(n),this.update();break;default:this.state=ee.NONE}}function Z_(n){this.enabled!==!1&&n.preventDefault()}function J_(n){n.key==="Control"&&(this._controlActive=!0,this.domElement.getRootNode().addEventListener("keyup",this._interceptControlUp,{passive:!0,capture:!0}))}function Q_(n){n.key==="Control"&&(this._controlActive=!1,this.domElement.getRootNode().removeEventListener("keyup",this._interceptControlUp,{passive:!0,capture:!0}))}function Gr(n,t){return n==null||t==null?NaN:n<t?-1:n>t?1:n>=t?0:NaN}function tg(n,t){return n==null||t==null?NaN:t<n?-1:t>n?1:t>=n?0:NaN}function kc(n){let t,e,i;n.length!==2?(t=Gr,e=(o,l)=>Gr(n(o),l),i=(o,l)=>n(o)-l):(t=n===Gr||n===tg?n:eg,e=n,i=n);function r(o,l,c=0,u=o.length){if(c<u){if(t(l,l)!==0)return u;do{const h=c+u>>>1;e(o[h],l)<0?c=h+1:u=h}while(c<u)}return c}function s(o,l,c=0,u=o.length){if(c<u){if(t(l,l)!==0)return u;do{const h=c+u>>>1;e(o[h],l)<=0?c=h+1:u=h}while(c<u)}return c}function a(o,l,c=0,u=o.length){const h=r(o,l,c,u-1);return h>c&&i(o[h-1],l)>-i(o[h],l)?h-1:h}return{left:r,center:a,right:s}}function eg(){return 0}function ng(n){return n===null?NaN:+n}const ig=kc(Gr),rg=ig.right;kc(ng).center;class sg extends Map{constructor(t,e=lg){if(super(),Object.defineProperties(this,{_intern:{value:new Map},_key:{value:e}}),t!=null)for(const[i,r]of t)this.set(i,r)}get(t){return super.get(Il(this,t))}has(t){return super.has(Il(this,t))}set(t,e){return super.set(ag(this,t),e)}delete(t){return super.delete(og(this,t))}}function Il({_intern:n,_key:t},e){const i=t(e);return n.has(i)?n.get(i):e}function ag({_intern:n,_key:t},e){const i=t(e);return n.has(i)?n.get(i):(n.set(i,e),e)}function og({_intern:n,_key:t},e){const i=t(e);return n.has(i)&&(e=n.get(i),n.delete(i)),e}function lg(n){return n!==null&&typeof n=="object"?n.valueOf():n}function Ul(n){return n}function Nl(n,...t){return cg(n,Ul,Ul,t)}function cg(n,t,e,i){return function r(s,a){if(a>=i.length)return e(s);const o=new sg,l=i[a++];let c=-1;for(const u of s){const h=l(u,++c,s),f=o.get(h);f?f.push(u):o.set(h,[u])}for(const[u,h]of o)o.set(u,r(h,a));return t(o)}(n,0)}const ug=Math.sqrt(50),hg=Math.sqrt(10),fg=Math.sqrt(2);function Qr(n,t,e){const i=(t-n)/Math.max(0,e),r=Math.floor(Math.log10(i)),s=i/Math.pow(10,r),a=s>=ug?10:s>=hg?5:s>=fg?2:1;let o,l,c;return r<0?(c=Math.pow(10,-r)/a,o=Math.round(n*c),l=Math.round(t*c),o/c<n&&++o,l/c>t&&--l,c=-c):(c=Math.pow(10,r)*a,o=Math.round(n/c),l=Math.round(t/c),o*c<n&&++o,l*c>t&&--l),l<o&&.5<=e&&e<2?Qr(n,t,e*2):[o,l,c]}function dg(n,t,e){if(t=+t,n=+n,e=+e,!(e>0))return[];if(n===t)return[n];const i=t<n,[r,s,a]=i?Qr(t,n,e):Qr(n,t,e);if(!(s>=r))return[];const o=s-r+1,l=new Array(o);if(i)if(a<0)for(let c=0;c<o;++c)l[c]=(s-c)/-a;else for(let c=0;c<o;++c)l[c]=(s-c)*a;else if(a<0)for(let c=0;c<o;++c)l[c]=(r+c)/-a;else for(let c=0;c<o;++c)l[c]=(r+c)*a;return l}function Wa(n,t,e){return t=+t,n=+n,e=+e,Qr(n,t,e)[2]}function pg(n,t,e){t=+t,n=+n,e=+e;const i=t<n,r=i?Wa(t,n,e):Wa(n,t,e);return(i?-1:1)*(r<0?1/-r:r)}function mg(n,t){let e;if(t===void 0)for(const i of n)i!=null&&(e<i||e===void 0&&i>=i)&&(e=i);else{let i=-1;for(let r of n)(r=t(r,++i,n))!=null&&(e<r||e===void 0&&r>=r)&&(e=r)}return e}function Fl(n,t){let e=0,i=0;if(t===void 0)for(let r of n)r!=null&&(r=+r)>=r&&(++e,i+=r);else{let r=-1;for(let s of n)(s=t(s,++r,n))!=null&&(s=+s)>=s&&(++e,i+=s)}if(e)return i/e}var _g={value:()=>{}};function Hc(){for(var n=0,t=arguments.length,e={},i;n<t;++n){if(!(i=arguments[n]+"")||i in e||/[\s.]/.test(i))throw new Error("illegal type: "+i);e[i]=[]}return new Wr(e)}function Wr(n){this._=n}function gg(n,t){return n.trim().split(/^|\s+/).map(function(e){var i="",r=e.indexOf(".");if(r>=0&&(i=e.slice(r+1),e=e.slice(0,r)),e&&!t.hasOwnProperty(e))throw new Error("unknown type: "+e);return{type:e,name:i}})}Wr.prototype=Hc.prototype={constructor:Wr,on:function(n,t){var e=this._,i=gg(n+"",e),r,s=-1,a=i.length;if(arguments.length<2){for(;++s<a;)if((r=(n=i[s]).type)&&(r=vg(e[r],n.name)))return r;return}if(t!=null&&typeof t!="function")throw new Error("invalid callback: "+t);for(;++s<a;)if(r=(n=i[s]).type)e[r]=Ol(e[r],n.name,t);else if(t==null)for(r in e)e[r]=Ol(e[r],n.name,null);return this},copy:function(){var n={},t=this._;for(var e in t)n[e]=t[e].slice();return new Wr(n)},call:function(n,t){if((r=arguments.length-2)>0)for(var e=new Array(r),i=0,r,s;i<r;++i)e[i]=arguments[i+2];if(!this._.hasOwnProperty(n))throw new Error("unknown type: "+n);for(s=this._[n],i=0,r=s.length;i<r;++i)s[i].value.apply(t,e)},apply:function(n,t,e){if(!this._.hasOwnProperty(n))throw new Error("unknown type: "+n);for(var i=this._[n],r=0,s=i.length;r<s;++r)i[r].value.apply(t,e)}};function vg(n,t){for(var e=0,i=n.length,r;e<i;++e)if((r=n[e]).name===t)return r.value}function Ol(n,t,e){for(var i=0,r=n.length;i<r;++i)if(n[i].name===t){n[i]=_g,n=n.slice(0,i).concat(n.slice(i+1));break}return e!=null&&n.push({name:t,value:e}),n}var Xa="http://www.w3.org/1999/xhtml";const Bl={svg:"http://www.w3.org/2000/svg",xhtml:Xa,xlink:"http://www.w3.org/1999/xlink",xml:"http://www.w3.org/XML/1998/namespace",xmlns:"http://www.w3.org/2000/xmlns/"};function ps(n){var t=n+="",e=t.indexOf(":");return e>=0&&(t=n.slice(0,e))!=="xmlns"&&(n=n.slice(e+1)),Bl.hasOwnProperty(t)?{space:Bl[t],local:n}:n}function xg(n){return function(){var t=this.ownerDocument,e=this.namespaceURI;return e===Xa&&t.documentElement.namespaceURI===Xa?t.createElement(n):t.createElementNS(e,n)}}function Mg(n){return function(){return this.ownerDocument.createElementNS(n.space,n.local)}}function Vc(n){var t=ps(n);return(t.local?Mg:xg)(t)}function Sg(){}function _o(n){return n==null?Sg:function(){return this.querySelector(n)}}function yg(n){typeof n!="function"&&(n=_o(n));for(var t=this._groups,e=t.length,i=new Array(e),r=0;r<e;++r)for(var s=t[r],a=s.length,o=i[r]=new Array(a),l,c,u=0;u<a;++u)(l=s[u])&&(c=n.call(l,l.__data__,u,s))&&("__data__"in l&&(c.__data__=l.__data__),o[u]=c);return new Ie(i,this._parents)}function Eg(n){return n==null?[]:Array.isArray(n)?n:Array.from(n)}function Tg(){return[]}function Gc(n){return n==null?Tg:function(){return this.querySelectorAll(n)}}function bg(n){return function(){return Eg(n.apply(this,arguments))}}function Ag(n){typeof n=="function"?n=bg(n):n=Gc(n);for(var t=this._groups,e=t.length,i=[],r=[],s=0;s<e;++s)for(var a=t[s],o=a.length,l,c=0;c<o;++c)(l=a[c])&&(i.push(n.call(l,l.__data__,c,a)),r.push(l));return new Ie(i,r)}function Wc(n){return function(){return this.matches(n)}}function Xc(n){return function(t){return t.matches(n)}}var wg=Array.prototype.find;function Rg(n){return function(){return wg.call(this.children,n)}}function Cg(){return this.firstElementChild}function Pg(n){return this.select(n==null?Cg:Rg(typeof n=="function"?n:Xc(n)))}var Dg=Array.prototype.filter;function Lg(){return Array.from(this.children)}function Ig(n){return function(){return Dg.call(this.children,n)}}function Ug(n){return this.selectAll(n==null?Lg:Ig(typeof n=="function"?n:Xc(n)))}function Ng(n){typeof n!="function"&&(n=Wc(n));for(var t=this._groups,e=t.length,i=new Array(e),r=0;r<e;++r)for(var s=t[r],a=s.length,o=i[r]=[],l,c=0;c<a;++c)(l=s[c])&&n.call(l,l.__data__,c,s)&&o.push(l);return new Ie(i,this._parents)}function qc(n){return new Array(n.length)}function Fg(){return new Ie(this._enter||this._groups.map(qc),this._parents)}function ts(n,t){this.ownerDocument=n.ownerDocument,this.namespaceURI=n.namespaceURI,this._next=null,this._parent=n,this.__data__=t}ts.prototype={constructor:ts,appendChild:function(n){return this._parent.insertBefore(n,this._next)},insertBefore:function(n,t){return this._parent.insertBefore(n,t)},querySelector:function(n){return this._parent.querySelector(n)},querySelectorAll:function(n){return this._parent.querySelectorAll(n)}};function Og(n){return function(){return n}}function Bg(n,t,e,i,r,s){for(var a=0,o,l=t.length,c=s.length;a<c;++a)(o=t[a])?(o.__data__=s[a],i[a]=o):e[a]=new ts(n,s[a]);for(;a<l;++a)(o=t[a])&&(r[a]=o)}function zg(n,t,e,i,r,s,a){var o,l,c=new Map,u=t.length,h=s.length,f=new Array(u),p;for(o=0;o<u;++o)(l=t[o])&&(f[o]=p=a.call(l,l.__data__,o,t)+"",c.has(p)?r[o]=l:c.set(p,l));for(o=0;o<h;++o)p=a.call(n,s[o],o,s)+"",(l=c.get(p))?(i[o]=l,l.__data__=s[o],c.delete(p)):e[o]=new ts(n,s[o]);for(o=0;o<u;++o)(l=t[o])&&c.get(f[o])===l&&(r[o]=l)}function kg(n){return n.__data__}function Hg(n,t){if(!arguments.length)return Array.from(this,kg);var e=t?zg:Bg,i=this._parents,r=this._groups;typeof n!="function"&&(n=Og(n));for(var s=r.length,a=new Array(s),o=new Array(s),l=new Array(s),c=0;c<s;++c){var u=i[c],h=r[c],f=h.length,p=Vg(n.call(u,u&&u.__data__,c,i)),g=p.length,x=o[c]=new Array(g),m=a[c]=new Array(g),d=l[c]=new Array(f);e(u,h,x,m,d,p,t);for(var w=0,b=0,y,D;w<g;++w)if(y=x[w]){for(w>=b&&(b=w+1);!(D=m[b])&&++b<g;);y._next=D||null}}return a=new Ie(a,i),a._enter=o,a._exit=l,a}function Vg(n){return typeof n=="object"&&"length"in n?n:Array.from(n)}function Gg(){return new Ie(this._exit||this._groups.map(qc),this._parents)}function Wg(n,t,e){var i=this.enter(),r=this,s=this.exit();return typeof n=="function"?(i=n(i),i&&(i=i.selection())):i=i.append(n+""),t!=null&&(r=t(r),r&&(r=r.selection())),e==null?s.remove():e(s),i&&r?i.merge(r).order():r}function Xg(n){for(var t=n.selection?n.selection():n,e=this._groups,i=t._groups,r=e.length,s=i.length,a=Math.min(r,s),o=new Array(r),l=0;l<a;++l)for(var c=e[l],u=i[l],h=c.length,f=o[l]=new Array(h),p,g=0;g<h;++g)(p=c[g]||u[g])&&(f[g]=p);for(;l<r;++l)o[l]=e[l];return new Ie(o,this._parents)}function qg(){for(var n=this._groups,t=-1,e=n.length;++t<e;)for(var i=n[t],r=i.length-1,s=i[r],a;--r>=0;)(a=i[r])&&(s&&a.compareDocumentPosition(s)^4&&s.parentNode.insertBefore(a,s),s=a);return this}function Yg(n){n||(n=$g);function t(h,f){return h&&f?n(h.__data__,f.__data__):!h-!f}for(var e=this._groups,i=e.length,r=new Array(i),s=0;s<i;++s){for(var a=e[s],o=a.length,l=r[s]=new Array(o),c,u=0;u<o;++u)(c=a[u])&&(l[u]=c);l.sort(t)}return new Ie(r,this._parents).order()}function $g(n,t){return n<t?-1:n>t?1:n>=t?0:NaN}function Kg(){var n=arguments[0];return arguments[0]=this,n.apply(null,arguments),this}function jg(){return Array.from(this)}function Zg(){for(var n=this._groups,t=0,e=n.length;t<e;++t)for(var i=n[t],r=0,s=i.length;r<s;++r){var a=i[r];if(a)return a}return null}function Jg(){let n=0;for(const t of this)++n;return n}function Qg(){return!this.node()}function t0(n){for(var t=this._groups,e=0,i=t.length;e<i;++e)for(var r=t[e],s=0,a=r.length,o;s<a;++s)(o=r[s])&&n.call(o,o.__data__,s,r);return this}function e0(n){return function(){this.removeAttribute(n)}}function n0(n){return function(){this.removeAttributeNS(n.space,n.local)}}function i0(n,t){return function(){this.setAttribute(n,t)}}function r0(n,t){return function(){this.setAttributeNS(n.space,n.local,t)}}function s0(n,t){return function(){var e=t.apply(this,arguments);e==null?this.removeAttribute(n):this.setAttribute(n,e)}}function a0(n,t){return function(){var e=t.apply(this,arguments);e==null?this.removeAttributeNS(n.space,n.local):this.setAttributeNS(n.space,n.local,e)}}function o0(n,t){var e=ps(n);if(arguments.length<2){var i=this.node();return e.local?i.getAttributeNS(e.space,e.local):i.getAttribute(e)}return this.each((t==null?e.local?n0:e0:typeof t=="function"?e.local?a0:s0:e.local?r0:i0)(e,t))}function Yc(n){return n.ownerDocument&&n.ownerDocument.defaultView||n.document&&n||n.defaultView}function l0(n){return function(){this.style.removeProperty(n)}}function c0(n,t,e){return function(){this.style.setProperty(n,t,e)}}function u0(n,t,e){return function(){var i=t.apply(this,arguments);i==null?this.style.removeProperty(n):this.style.setProperty(n,i,e)}}function h0(n,t,e){return arguments.length>1?this.each((t==null?l0:typeof t=="function"?u0:c0)(n,t,e??"")):wi(this.node(),n)}function wi(n,t){return n.style.getPropertyValue(t)||Yc(n).getComputedStyle(n,null).getPropertyValue(t)}function f0(n){return function(){delete this[n]}}function d0(n,t){return function(){this[n]=t}}function p0(n,t){return function(){var e=t.apply(this,arguments);e==null?delete this[n]:this[n]=e}}function m0(n,t){return arguments.length>1?this.each((t==null?f0:typeof t=="function"?p0:d0)(n,t)):this.node()[n]}function $c(n){return n.trim().split(/^|\s+/)}function go(n){return n.classList||new Kc(n)}function Kc(n){this._node=n,this._names=$c(n.getAttribute("class")||"")}Kc.prototype={add:function(n){var t=this._names.indexOf(n);t<0&&(this._names.push(n),this._node.setAttribute("class",this._names.join(" ")))},remove:function(n){var t=this._names.indexOf(n);t>=0&&(this._names.splice(t,1),this._node.setAttribute("class",this._names.join(" ")))},contains:function(n){return this._names.indexOf(n)>=0}};function jc(n,t){for(var e=go(n),i=-1,r=t.length;++i<r;)e.add(t[i])}function Zc(n,t){for(var e=go(n),i=-1,r=t.length;++i<r;)e.remove(t[i])}function _0(n){return function(){jc(this,n)}}function g0(n){return function(){Zc(this,n)}}function v0(n,t){return function(){(t.apply(this,arguments)?jc:Zc)(this,n)}}function x0(n,t){var e=$c(n+"");if(arguments.length<2){for(var i=go(this.node()),r=-1,s=e.length;++r<s;)if(!i.contains(e[r]))return!1;return!0}return this.each((typeof t=="function"?v0:t?_0:g0)(e,t))}function M0(){this.textContent=""}function S0(n){return function(){this.textContent=n}}function y0(n){return function(){var t=n.apply(this,arguments);this.textContent=t??""}}function E0(n){return arguments.length?this.each(n==null?M0:(typeof n=="function"?y0:S0)(n)):this.node().textContent}function T0(){this.innerHTML=""}function b0(n){return function(){this.innerHTML=n}}function A0(n){return function(){var t=n.apply(this,arguments);this.innerHTML=t??""}}function w0(n){return arguments.length?this.each(n==null?T0:(typeof n=="function"?A0:b0)(n)):this.node().innerHTML}function R0(){this.nextSibling&&this.parentNode.appendChild(this)}function C0(){return this.each(R0)}function P0(){this.previousSibling&&this.parentNode.insertBefore(this,this.parentNode.firstChild)}function D0(){return this.each(P0)}function L0(n){var t=typeof n=="function"?n:Vc(n);return this.select(function(){return this.appendChild(t.apply(this,arguments))})}function I0(){return null}function U0(n,t){var e=typeof n=="function"?n:Vc(n),i=t==null?I0:typeof t=="function"?t:_o(t);return this.select(function(){return this.insertBefore(e.apply(this,arguments),i.apply(this,arguments)||null)})}function N0(){var n=this.parentNode;n&&n.removeChild(this)}function F0(){return this.each(N0)}function O0(){var n=this.cloneNode(!1),t=this.parentNode;return t?t.insertBefore(n,this.nextSibling):n}function B0(){var n=this.cloneNode(!0),t=this.parentNode;return t?t.insertBefore(n,this.nextSibling):n}function z0(n){return this.select(n?B0:O0)}function k0(n){return arguments.length?this.property("__data__",n):this.node().__data__}function H0(n){return function(t){n.call(this,t,this.__data__)}}function V0(n){return n.trim().split(/^|\s+/).map(function(t){var e="",i=t.indexOf(".");return i>=0&&(e=t.slice(i+1),t=t.slice(0,i)),{type:t,name:e}})}function G0(n){return function(){var t=this.__on;if(t){for(var e=0,i=-1,r=t.length,s;e<r;++e)s=t[e],(!n.type||s.type===n.type)&&s.name===n.name?this.removeEventListener(s.type,s.listener,s.options):t[++i]=s;++i?t.length=i:delete this.__on}}}function W0(n,t,e){return function(){var i=this.__on,r,s=H0(t);if(i){for(var a=0,o=i.length;a<o;++a)if((r=i[a]).type===n.type&&r.name===n.name){this.removeEventListener(r.type,r.listener,r.options),this.addEventListener(r.type,r.listener=s,r.options=e),r.value=t;return}}this.addEventListener(n.type,s,e),r={type:n.type,name:n.name,value:t,listener:s,options:e},i?i.push(r):this.__on=[r]}}function X0(n,t,e){var i=V0(n+""),r,s=i.length,a;if(arguments.length<2){var o=this.node().__on;if(o){for(var l=0,c=o.length,u;l<c;++l)for(r=0,u=o[l];r<s;++r)if((a=i[r]).type===u.type&&a.name===u.name)return u.value}return}for(o=t?W0:G0,r=0;r<s;++r)this.each(o(i[r],t,e));return this}function Jc(n,t,e){var i=Yc(n),r=i.CustomEvent;typeof r=="function"?r=new r(t,e):(r=i.document.createEvent("Event"),e?(r.initEvent(t,e.bubbles,e.cancelable),r.detail=e.detail):r.initEvent(t,!1,!1)),n.dispatchEvent(r)}function q0(n,t){return function(){return Jc(this,n,t)}}function Y0(n,t){return function(){return Jc(this,n,t.apply(this,arguments))}}function $0(n,t){return this.each((typeof t=="function"?Y0:q0)(n,t))}function*K0(){for(var n=this._groups,t=0,e=n.length;t<e;++t)for(var i=n[t],r=0,s=i.length,a;r<s;++r)(a=i[r])&&(yield a)}var Qc=[null];function Ie(n,t){this._groups=n,this._parents=t}function nr(){return new Ie([[document.documentElement]],Qc)}function j0(){return this}Ie.prototype=nr.prototype={constructor:Ie,select:yg,selectAll:Ag,selectChild:Pg,selectChildren:Ug,filter:Ng,data:Hg,enter:Fg,exit:Gg,join:Wg,merge:Xg,selection:j0,order:qg,sort:Yg,call:Kg,nodes:jg,node:Zg,size:Jg,empty:Qg,each:t0,attr:o0,style:h0,property:m0,classed:x0,text:E0,html:w0,raise:C0,lower:D0,append:L0,insert:U0,remove:F0,clone:z0,datum:k0,on:X0,dispatch:$0,[Symbol.iterator]:K0};function tu(n){return typeof n=="string"?new Ie([[document.querySelector(n)]],[document.documentElement]):new Ie([[n]],Qc)}function vo(n,t,e){n.prototype=t.prototype=e,e.constructor=n}function eu(n,t){var e=Object.create(n.prototype);for(var i in t)e[i]=t[i];return e}function ir(){}var Zi=.7,es=1/Zi,Si="\\s*([+-]?\\d+)\\s*",Ji="\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)\\s*",en="\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)%\\s*",Z0=/^#([0-9a-f]{3,8})$/,J0=new RegExp(`^rgb\\(${Si},${Si},${Si}\\)$`),Q0=new RegExp(`^rgb\\(${en},${en},${en}\\)$`),tv=new RegExp(`^rgba\\(${Si},${Si},${Si},${Ji}\\)$`),ev=new RegExp(`^rgba\\(${en},${en},${en},${Ji}\\)$`),nv=new RegExp(`^hsl\\(${Ji},${en},${en}\\)$`),iv=new RegExp(`^hsla\\(${Ji},${en},${en},${Ji}\\)$`),zl={aliceblue:15792383,antiquewhite:16444375,aqua:65535,aquamarine:8388564,azure:15794175,beige:16119260,bisque:16770244,black:0,blanchedalmond:16772045,blue:255,blueviolet:9055202,brown:10824234,burlywood:14596231,cadetblue:6266528,chartreuse:8388352,chocolate:13789470,coral:16744272,cornflowerblue:6591981,cornsilk:16775388,crimson:14423100,cyan:65535,darkblue:139,darkcyan:35723,darkgoldenrod:12092939,darkgray:11119017,darkgreen:25600,darkgrey:11119017,darkkhaki:12433259,darkmagenta:9109643,darkolivegreen:5597999,darkorange:16747520,darkorchid:10040012,darkred:9109504,darksalmon:15308410,darkseagreen:9419919,darkslateblue:4734347,darkslategray:3100495,darkslategrey:3100495,darkturquoise:52945,darkviolet:9699539,deeppink:16716947,deepskyblue:49151,dimgray:6908265,dimgrey:6908265,dodgerblue:2003199,firebrick:11674146,floralwhite:16775920,forestgreen:2263842,fuchsia:16711935,gainsboro:14474460,ghostwhite:16316671,gold:16766720,goldenrod:14329120,gray:8421504,green:32768,greenyellow:11403055,grey:8421504,honeydew:15794160,hotpink:16738740,indianred:13458524,indigo:4915330,ivory:16777200,khaki:15787660,lavender:15132410,lavenderblush:16773365,lawngreen:8190976,lemonchiffon:16775885,lightblue:11393254,lightcoral:15761536,lightcyan:14745599,lightgoldenrodyellow:16448210,lightgray:13882323,lightgreen:9498256,lightgrey:13882323,lightpink:16758465,lightsalmon:16752762,lightseagreen:2142890,lightskyblue:8900346,lightslategray:7833753,lightslategrey:7833753,lightsteelblue:11584734,lightyellow:16777184,lime:65280,limegreen:3329330,linen:16445670,magenta:16711935,maroon:8388608,mediumaquamarine:6737322,mediumblue:205,mediumorchid:12211667,mediumpurple:9662683,mediumseagreen:3978097,mediumslateblue:8087790,mediumspringgreen:64154,mediumturquoise:4772300,mediumvioletred:13047173,midnightblue:1644912,mintcream:16121850,mistyrose:16770273,moccasin:16770229,navajowhite:16768685,navy:128,oldlace:16643558,olive:8421376,olivedrab:7048739,orange:16753920,orangered:16729344,orchid:14315734,palegoldenrod:15657130,palegreen:10025880,paleturquoise:11529966,palevioletred:14381203,papayawhip:16773077,peachpuff:16767673,peru:13468991,pink:16761035,plum:14524637,powderblue:11591910,purple:8388736,rebeccapurple:6697881,red:16711680,rosybrown:12357519,royalblue:4286945,saddlebrown:9127187,salmon:16416882,sandybrown:16032864,seagreen:3050327,seashell:16774638,sienna:10506797,silver:12632256,skyblue:8900331,slateblue:6970061,slategray:7372944,slategrey:7372944,snow:16775930,springgreen:65407,steelblue:4620980,tan:13808780,teal:32896,thistle:14204888,tomato:16737095,turquoise:4251856,violet:15631086,wheat:16113331,white:16777215,whitesmoke:16119285,yellow:16776960,yellowgreen:10145074};vo(ir,jn,{copy(n){return Object.assign(new this.constructor,this,n)},displayable(){return this.rgb().displayable()},hex:kl,formatHex:kl,formatHex8:rv,formatHsl:sv,formatRgb:Hl,toString:Hl});function kl(){return this.rgb().formatHex()}function rv(){return this.rgb().formatHex8()}function sv(){return nu(this).formatHsl()}function Hl(){return this.rgb().formatRgb()}function jn(n){var t,e;return n=(n+"").trim().toLowerCase(),(t=Z0.exec(n))?(e=t[1].length,t=parseInt(t[1],16),e===6?Vl(t):e===3?new be(t>>8&15|t>>4&240,t>>4&15|t&240,(t&15)<<4|t&15,1):e===8?Pr(t>>24&255,t>>16&255,t>>8&255,(t&255)/255):e===4?Pr(t>>12&15|t>>8&240,t>>8&15|t>>4&240,t>>4&15|t&240,((t&15)<<4|t&15)/255):null):(t=J0.exec(n))?new be(t[1],t[2],t[3],1):(t=Q0.exec(n))?new be(t[1]*255/100,t[2]*255/100,t[3]*255/100,1):(t=tv.exec(n))?Pr(t[1],t[2],t[3],t[4]):(t=ev.exec(n))?Pr(t[1]*255/100,t[2]*255/100,t[3]*255/100,t[4]):(t=nv.exec(n))?Xl(t[1],t[2]/100,t[3]/100,1):(t=iv.exec(n))?Xl(t[1],t[2]/100,t[3]/100,t[4]):zl.hasOwnProperty(n)?Vl(zl[n]):n==="transparent"?new be(NaN,NaN,NaN,0):null}function Vl(n){return new be(n>>16&255,n>>8&255,n&255,1)}function Pr(n,t,e,i){return i<=0&&(n=t=e=NaN),new be(n,t,e,i)}function av(n){return n instanceof ir||(n=jn(n)),n?(n=n.rgb(),new be(n.r,n.g,n.b,n.opacity)):new be}function qa(n,t,e,i){return arguments.length===1?av(n):new be(n,t,e,i??1)}function be(n,t,e,i){this.r=+n,this.g=+t,this.b=+e,this.opacity=+i}vo(be,qa,eu(ir,{brighter(n){return n=n==null?es:Math.pow(es,n),new be(this.r*n,this.g*n,this.b*n,this.opacity)},darker(n){return n=n==null?Zi:Math.pow(Zi,n),new be(this.r*n,this.g*n,this.b*n,this.opacity)},rgb(){return this},clamp(){return new be(qn(this.r),qn(this.g),qn(this.b),ns(this.opacity))},displayable(){return-.5<=this.r&&this.r<255.5&&-.5<=this.g&&this.g<255.5&&-.5<=this.b&&this.b<255.5&&0<=this.opacity&&this.opacity<=1},hex:Gl,formatHex:Gl,formatHex8:ov,formatRgb:Wl,toString:Wl}));function Gl(){return`#${Xn(this.r)}${Xn(this.g)}${Xn(this.b)}`}function ov(){return`#${Xn(this.r)}${Xn(this.g)}${Xn(this.b)}${Xn((isNaN(this.opacity)?1:this.opacity)*255)}`}function Wl(){const n=ns(this.opacity);return`${n===1?"rgb(":"rgba("}${qn(this.r)}, ${qn(this.g)}, ${qn(this.b)}${n===1?")":`, ${n})`}`}function ns(n){return isNaN(n)?1:Math.max(0,Math.min(1,n))}function qn(n){return Math.max(0,Math.min(255,Math.round(n)||0))}function Xn(n){return n=qn(n),(n<16?"0":"")+n.toString(16)}function Xl(n,t,e,i){return i<=0?n=t=e=NaN:e<=0||e>=1?n=t=NaN:t<=0&&(n=NaN),new Ye(n,t,e,i)}function nu(n){if(n instanceof Ye)return new Ye(n.h,n.s,n.l,n.opacity);if(n instanceof ir||(n=jn(n)),!n)return new Ye;if(n instanceof Ye)return n;n=n.rgb();var t=n.r/255,e=n.g/255,i=n.b/255,r=Math.min(t,e,i),s=Math.max(t,e,i),a=NaN,o=s-r,l=(s+r)/2;return o?(t===s?a=(e-i)/o+(e<i)*6:e===s?a=(i-t)/o+2:a=(t-e)/o+4,o/=l<.5?s+r:2-s-r,a*=60):o=l>0&&l<1?0:a,new Ye(a,o,l,n.opacity)}function lv(n,t,e,i){return arguments.length===1?nu(n):new Ye(n,t,e,i??1)}function Ye(n,t,e,i){this.h=+n,this.s=+t,this.l=+e,this.opacity=+i}vo(Ye,lv,eu(ir,{brighter(n){return n=n==null?es:Math.pow(es,n),new Ye(this.h,this.s,this.l*n,this.opacity)},darker(n){return n=n==null?Zi:Math.pow(Zi,n),new Ye(this.h,this.s,this.l*n,this.opacity)},rgb(){var n=this.h%360+(this.h<0)*360,t=isNaN(n)||isNaN(this.s)?0:this.s,e=this.l,i=e+(e<.5?e:1-e)*t,r=2*e-i;return new be(Zs(n>=240?n-240:n+120,r,i),Zs(n,r,i),Zs(n<120?n+240:n-120,r,i),this.opacity)},clamp(){return new Ye(ql(this.h),Dr(this.s),Dr(this.l),ns(this.opacity))},displayable(){return(0<=this.s&&this.s<=1||isNaN(this.s))&&0<=this.l&&this.l<=1&&0<=this.opacity&&this.opacity<=1},formatHsl(){const n=ns(this.opacity);return`${n===1?"hsl(":"hsla("}${ql(this.h)}, ${Dr(this.s)*100}%, ${Dr(this.l)*100}%${n===1?")":`, ${n})`}`}}));function ql(n){return n=(n||0)%360,n<0?n+360:n}function Dr(n){return Math.max(0,Math.min(1,n||0))}function Zs(n,t,e){return(n<60?t+(e-t)*n/60:n<180?e:n<240?t+(e-t)*(240-n)/60:t)*255}const xo=n=>()=>n;function cv(n,t){return function(e){return n+e*t}}function uv(n,t,e){return n=Math.pow(n,e),t=Math.pow(t,e)-n,e=1/e,function(i){return Math.pow(n+i*t,e)}}function hv(n){return(n=+n)==1?iu:function(t,e){return e-t?uv(t,e,n):xo(isNaN(t)?e:t)}}function iu(n,t){var e=t-n;return e?cv(n,e):xo(isNaN(n)?t:n)}const is=function n(t){var e=hv(t);function i(r,s){var a=e((r=qa(r)).r,(s=qa(s)).r),o=e(r.g,s.g),l=e(r.b,s.b),c=iu(r.opacity,s.opacity);return function(u){return r.r=a(u),r.g=o(u),r.b=l(u),r.opacity=c(u),r+""}}return i.gamma=n,i}(1);function fv(n,t){t||(t=[]);var e=n?Math.min(t.length,n.length):0,i=t.slice(),r;return function(s){for(r=0;r<e;++r)i[r]=n[r]*(1-s)+t[r]*s;return i}}function dv(n){return ArrayBuffer.isView(n)&&!(n instanceof DataView)}function pv(n,t){var e=t?t.length:0,i=n?Math.min(e,n.length):0,r=new Array(i),s=new Array(e),a;for(a=0;a<i;++a)r[a]=Mo(n[a],t[a]);for(;a<e;++a)s[a]=t[a];return function(o){for(a=0;a<i;++a)s[a]=r[a](o);return s}}function mv(n,t){var e=new Date;return n=+n,t=+t,function(i){return e.setTime(n*(1-i)+t*i),e}}function Xe(n,t){return n=+n,t=+t,function(e){return n*(1-e)+t*e}}function _v(n,t){var e={},i={},r;(n===null||typeof n!="object")&&(n={}),(t===null||typeof t!="object")&&(t={});for(r in t)r in n?e[r]=Mo(n[r],t[r]):i[r]=t[r];return function(s){for(r in e)i[r]=e[r](s);return i}}var Ya=/[-+]?(?:\d+\.?\d*|\.?\d+)(?:[eE][-+]?\d+)?/g,Js=new RegExp(Ya.source,"g");function gv(n){return function(){return n}}function vv(n){return function(t){return n(t)+""}}function ru(n,t){var e=Ya.lastIndex=Js.lastIndex=0,i,r,s,a=-1,o=[],l=[];for(n=n+"",t=t+"";(i=Ya.exec(n))&&(r=Js.exec(t));)(s=r.index)>e&&(s=t.slice(e,s),o[a]?o[a]+=s:o[++a]=s),(i=i[0])===(r=r[0])?o[a]?o[a]+=r:o[++a]=r:(o[++a]=null,l.push({i:a,x:Xe(i,r)})),e=Js.lastIndex;return e<t.length&&(s=t.slice(e),o[a]?o[a]+=s:o[++a]=s),o.length<2?l[0]?vv(l[0].x):gv(t):(t=l.length,function(c){for(var u=0,h;u<t;++u)o[(h=l[u]).i]=h.x(c);return o.join("")})}function Mo(n,t){var e=typeof t,i;return t==null||e==="boolean"?xo(t):(e==="number"?Xe:e==="string"?(i=jn(t))?(t=i,is):ru:t instanceof jn?is:t instanceof Date?mv:dv(t)?fv:Array.isArray(t)?pv:typeof t.valueOf!="function"&&typeof t.toString!="function"||isNaN(t)?_v:Xe)(n,t)}function xv(n,t){return n=+n,t=+t,function(e){return Math.round(n*(1-e)+t*e)}}var Yl=180/Math.PI,$a={translateX:0,translateY:0,rotate:0,skewX:0,scaleX:1,scaleY:1};function su(n,t,e,i,r,s){var a,o,l;return(a=Math.sqrt(n*n+t*t))&&(n/=a,t/=a),(l=n*e+t*i)&&(e-=n*l,i-=t*l),(o=Math.sqrt(e*e+i*i))&&(e/=o,i/=o,l/=o),n*i<t*e&&(n=-n,t=-t,l=-l,a=-a),{translateX:r,translateY:s,rotate:Math.atan2(t,n)*Yl,skewX:Math.atan(l)*Yl,scaleX:a,scaleY:o}}var Lr;function Mv(n){const t=new(typeof DOMMatrix=="function"?DOMMatrix:WebKitCSSMatrix)(n+"");return t.isIdentity?$a:su(t.a,t.b,t.c,t.d,t.e,t.f)}function Sv(n){return n==null||(Lr||(Lr=document.createElementNS("http://www.w3.org/2000/svg","g")),Lr.setAttribute("transform",n),!(n=Lr.transform.baseVal.consolidate()))?$a:(n=n.matrix,su(n.a,n.b,n.c,n.d,n.e,n.f))}function au(n,t,e,i){function r(c){return c.length?c.pop()+" ":""}function s(c,u,h,f,p,g){if(c!==h||u!==f){var x=p.push("translate(",null,t,null,e);g.push({i:x-4,x:Xe(c,h)},{i:x-2,x:Xe(u,f)})}else(h||f)&&p.push("translate("+h+t+f+e)}function a(c,u,h,f){c!==u?(c-u>180?u+=360:u-c>180&&(c+=360),f.push({i:h.push(r(h)+"rotate(",null,i)-2,x:Xe(c,u)})):u&&h.push(r(h)+"rotate("+u+i)}function o(c,u,h,f){c!==u?f.push({i:h.push(r(h)+"skewX(",null,i)-2,x:Xe(c,u)}):u&&h.push(r(h)+"skewX("+u+i)}function l(c,u,h,f,p,g){if(c!==h||u!==f){var x=p.push(r(p)+"scale(",null,",",null,")");g.push({i:x-4,x:Xe(c,h)},{i:x-2,x:Xe(u,f)})}else(h!==1||f!==1)&&p.push(r(p)+"scale("+h+","+f+")")}return function(c,u){var h=[],f=[];return c=n(c),u=n(u),s(c.translateX,c.translateY,u.translateX,u.translateY,h,f),a(c.rotate,u.rotate,h,f),o(c.skewX,u.skewX,h,f),l(c.scaleX,c.scaleY,u.scaleX,u.scaleY,h,f),c=u=null,function(p){for(var g=-1,x=f.length,m;++g<x;)h[(m=f[g]).i]=m.x(p);return h.join("")}}}var yv=au(Mv,"px, ","px)","deg)"),Ev=au(Sv,", ",")",")"),Ri=0,Wi=0,ki=0,ou=1e3,rs,Xi,ss=0,Zn=0,ms=0,Qi=typeof performance=="object"&&performance.now?performance:Date,lu=typeof window=="object"&&window.requestAnimationFrame?window.requestAnimationFrame.bind(window):function(n){setTimeout(n,17)};function So(){return Zn||(lu(Tv),Zn=Qi.now()+ms)}function Tv(){Zn=0}function as(){this._call=this._time=this._next=null}as.prototype=cu.prototype={constructor:as,restart:function(n,t,e){if(typeof n!="function")throw new TypeError("callback is not a function");e=(e==null?So():+e)+(t==null?0:+t),!this._next&&Xi!==this&&(Xi?Xi._next=this:rs=this,Xi=this),this._call=n,this._time=e,Ka()},stop:function(){this._call&&(this._call=null,this._time=1/0,Ka())}};function cu(n,t,e){var i=new as;return i.restart(n,t,e),i}function bv(){So(),++Ri;for(var n=rs,t;n;)(t=Zn-n._time)>=0&&n._call.call(void 0,t),n=n._next;--Ri}function $l(){Zn=(ss=Qi.now())+ms,Ri=Wi=0;try{bv()}finally{Ri=0,wv(),Zn=0}}function Av(){var n=Qi.now(),t=n-ss;t>ou&&(ms-=t,ss=n)}function wv(){for(var n,t=rs,e,i=1/0;t;)t._call?(i>t._time&&(i=t._time),n=t,t=t._next):(e=t._next,t._next=null,t=n?n._next=e:rs=e);Xi=n,Ka(i)}function Ka(n){if(!Ri){Wi&&(Wi=clearTimeout(Wi));var t=n-Zn;t>24?(n<1/0&&(Wi=setTimeout($l,n-Qi.now()-ms)),ki&&(ki=clearInterval(ki))):(ki||(ss=Qi.now(),ki=setInterval(Av,ou)),Ri=1,lu($l))}}function Kl(n,t,e){var i=new as;return t=t==null?0:+t,i.restart(r=>{i.stop(),n(r+t)},t,e),i}var Rv=Hc("start","end","cancel","interrupt"),Cv=[],uu=0,jl=1,ja=2,Xr=3,Zl=4,Za=5,qr=6;function _s(n,t,e,i,r,s){var a=n.__transition;if(!a)n.__transition={};else if(e in a)return;Pv(n,e,{name:t,index:i,group:r,on:Rv,tween:Cv,time:s.time,delay:s.delay,duration:s.duration,ease:s.ease,timer:null,state:uu})}function yo(n,t){var e=Je(n,t);if(e.state>uu)throw new Error("too late; already scheduled");return e}function nn(n,t){var e=Je(n,t);if(e.state>Xr)throw new Error("too late; already running");return e}function Je(n,t){var e=n.__transition;if(!e||!(e=e[t]))throw new Error("transition not found");return e}function Pv(n,t,e){var i=n.__transition,r;i[t]=e,e.timer=cu(s,0,e.time);function s(c){e.state=jl,e.timer.restart(a,e.delay,e.time),e.delay<=c&&a(c-e.delay)}function a(c){var u,h,f,p;if(e.state!==jl)return l();for(u in i)if(p=i[u],p.name===e.name){if(p.state===Xr)return Kl(a);p.state===Zl?(p.state=qr,p.timer.stop(),p.on.call("interrupt",n,n.__data__,p.index,p.group),delete i[u]):+u<t&&(p.state=qr,p.timer.stop(),p.on.call("cancel",n,n.__data__,p.index,p.group),delete i[u])}if(Kl(function(){e.state===Xr&&(e.state=Zl,e.timer.restart(o,e.delay,e.time),o(c))}),e.state=ja,e.on.call("start",n,n.__data__,e.index,e.group),e.state===ja){for(e.state=Xr,r=new Array(f=e.tween.length),u=0,h=-1;u<f;++u)(p=e.tween[u].value.call(n,n.__data__,e.index,e.group))&&(r[++h]=p);r.length=h+1}}function o(c){for(var u=c<e.duration?e.ease.call(null,c/e.duration):(e.timer.restart(l),e.state=Za,1),h=-1,f=r.length;++h<f;)r[h].call(n,u);e.state===Za&&(e.on.call("end",n,n.__data__,e.index,e.group),l())}function l(){e.state=qr,e.timer.stop(),delete i[t];for(var c in i)return;delete n.__transition}}function Dv(n,t){var e=n.__transition,i,r,s=!0,a;if(e){t=t==null?null:t+"";for(a in e){if((i=e[a]).name!==t){s=!1;continue}r=i.state>ja&&i.state<Za,i.state=qr,i.timer.stop(),i.on.call(r?"interrupt":"cancel",n,n.__data__,i.index,i.group),delete e[a]}s&&delete n.__transition}}function Lv(n){return this.each(function(){Dv(this,n)})}function Iv(n,t){var e,i;return function(){var r=nn(this,n),s=r.tween;if(s!==e){i=e=s;for(var a=0,o=i.length;a<o;++a)if(i[a].name===t){i=i.slice(),i.splice(a,1);break}}r.tween=i}}function Uv(n,t,e){var i,r;if(typeof e!="function")throw new Error;return function(){var s=nn(this,n),a=s.tween;if(a!==i){r=(i=a).slice();for(var o={name:t,value:e},l=0,c=r.length;l<c;++l)if(r[l].name===t){r[l]=o;break}l===c&&r.push(o)}s.tween=r}}function Nv(n,t){var e=this._id;if(n+="",arguments.length<2){for(var i=Je(this.node(),e).tween,r=0,s=i.length,a;r<s;++r)if((a=i[r]).name===n)return a.value;return null}return this.each((t==null?Iv:Uv)(e,n,t))}function Eo(n,t,e){var i=n._id;return n.each(function(){var r=nn(this,i);(r.value||(r.value={}))[t]=e.apply(this,arguments)}),function(r){return Je(r,i).value[t]}}function hu(n,t){var e;return(typeof t=="number"?Xe:t instanceof jn?is:(e=jn(t))?(t=e,is):ru)(n,t)}function Fv(n){return function(){this.removeAttribute(n)}}function Ov(n){return function(){this.removeAttributeNS(n.space,n.local)}}function Bv(n,t,e){var i,r=e+"",s;return function(){var a=this.getAttribute(n);return a===r?null:a===i?s:s=t(i=a,e)}}function zv(n,t,e){var i,r=e+"",s;return function(){var a=this.getAttributeNS(n.space,n.local);return a===r?null:a===i?s:s=t(i=a,e)}}function kv(n,t,e){var i,r,s;return function(){var a,o=e(this),l;return o==null?void this.removeAttribute(n):(a=this.getAttribute(n),l=o+"",a===l?null:a===i&&l===r?s:(r=l,s=t(i=a,o)))}}function Hv(n,t,e){var i,r,s;return function(){var a,o=e(this),l;return o==null?void this.removeAttributeNS(n.space,n.local):(a=this.getAttributeNS(n.space,n.local),l=o+"",a===l?null:a===i&&l===r?s:(r=l,s=t(i=a,o)))}}function Vv(n,t){var e=ps(n),i=e==="transform"?Ev:hu;return this.attrTween(n,typeof t=="function"?(e.local?Hv:kv)(e,i,Eo(this,"attr."+n,t)):t==null?(e.local?Ov:Fv)(e):(e.local?zv:Bv)(e,i,t))}function Gv(n,t){return function(e){this.setAttribute(n,t.call(this,e))}}function Wv(n,t){return function(e){this.setAttributeNS(n.space,n.local,t.call(this,e))}}function Xv(n,t){var e,i;function r(){var s=t.apply(this,arguments);return s!==i&&(e=(i=s)&&Wv(n,s)),e}return r._value=t,r}function qv(n,t){var e,i;function r(){var s=t.apply(this,arguments);return s!==i&&(e=(i=s)&&Gv(n,s)),e}return r._value=t,r}function Yv(n,t){var e="attr."+n;if(arguments.length<2)return(e=this.tween(e))&&e._value;if(t==null)return this.tween(e,null);if(typeof t!="function")throw new Error;var i=ps(n);return this.tween(e,(i.local?Xv:qv)(i,t))}function $v(n,t){return function(){yo(this,n).delay=+t.apply(this,arguments)}}function Kv(n,t){return t=+t,function(){yo(this,n).delay=t}}function jv(n){var t=this._id;return arguments.length?this.each((typeof n=="function"?$v:Kv)(t,n)):Je(this.node(),t).delay}function Zv(n,t){return function(){nn(this,n).duration=+t.apply(this,arguments)}}function Jv(n,t){return t=+t,function(){nn(this,n).duration=t}}function Qv(n){var t=this._id;return arguments.length?this.each((typeof n=="function"?Zv:Jv)(t,n)):Je(this.node(),t).duration}function tx(n,t){if(typeof t!="function")throw new Error;return function(){nn(this,n).ease=t}}function ex(n){var t=this._id;return arguments.length?this.each(tx(t,n)):Je(this.node(),t).ease}function nx(n,t){return function(){var e=t.apply(this,arguments);if(typeof e!="function")throw new Error;nn(this,n).ease=e}}function ix(n){if(typeof n!="function")throw new Error;return this.each(nx(this._id,n))}function rx(n){typeof n!="function"&&(n=Wc(n));for(var t=this._groups,e=t.length,i=new Array(e),r=0;r<e;++r)for(var s=t[r],a=s.length,o=i[r]=[],l,c=0;c<a;++c)(l=s[c])&&n.call(l,l.__data__,c,s)&&o.push(l);return new vn(i,this._parents,this._name,this._id)}function sx(n){if(n._id!==this._id)throw new Error;for(var t=this._groups,e=n._groups,i=t.length,r=e.length,s=Math.min(i,r),a=new Array(i),o=0;o<s;++o)for(var l=t[o],c=e[o],u=l.length,h=a[o]=new Array(u),f,p=0;p<u;++p)(f=l[p]||c[p])&&(h[p]=f);for(;o<i;++o)a[o]=t[o];return new vn(a,this._parents,this._name,this._id)}function ax(n){return(n+"").trim().split(/^|\s+/).every(function(t){var e=t.indexOf(".");return e>=0&&(t=t.slice(0,e)),!t||t==="start"})}function ox(n,t,e){var i,r,s=ax(t)?yo:nn;return function(){var a=s(this,n),o=a.on;o!==i&&(r=(i=o).copy()).on(t,e),a.on=r}}function lx(n,t){var e=this._id;return arguments.length<2?Je(this.node(),e).on.on(n):this.each(ox(e,n,t))}function cx(n){return function(){var t=this.parentNode;for(var e in this.__transition)if(+e!==n)return;t&&t.removeChild(this)}}function ux(){return this.on("end.remove",cx(this._id))}function hx(n){var t=this._name,e=this._id;typeof n!="function"&&(n=_o(n));for(var i=this._groups,r=i.length,s=new Array(r),a=0;a<r;++a)for(var o=i[a],l=o.length,c=s[a]=new Array(l),u,h,f=0;f<l;++f)(u=o[f])&&(h=n.call(u,u.__data__,f,o))&&("__data__"in u&&(h.__data__=u.__data__),c[f]=h,_s(c[f],t,e,f,c,Je(u,e)));return new vn(s,this._parents,t,e)}function fx(n){var t=this._name,e=this._id;typeof n!="function"&&(n=Gc(n));for(var i=this._groups,r=i.length,s=[],a=[],o=0;o<r;++o)for(var l=i[o],c=l.length,u,h=0;h<c;++h)if(u=l[h]){for(var f=n.call(u,u.__data__,h,l),p,g=Je(u,e),x=0,m=f.length;x<m;++x)(p=f[x])&&_s(p,t,e,x,f,g);s.push(f),a.push(u)}return new vn(s,a,t,e)}var dx=nr.prototype.constructor;function px(){return new dx(this._groups,this._parents)}function mx(n,t){var e,i,r;return function(){var s=wi(this,n),a=(this.style.removeProperty(n),wi(this,n));return s===a?null:s===e&&a===i?r:r=t(e=s,i=a)}}function fu(n){return function(){this.style.removeProperty(n)}}function _x(n,t,e){var i,r=e+"",s;return function(){var a=wi(this,n);return a===r?null:a===i?s:s=t(i=a,e)}}function gx(n,t,e){var i,r,s;return function(){var a=wi(this,n),o=e(this),l=o+"";return o==null&&(l=o=(this.style.removeProperty(n),wi(this,n))),a===l?null:a===i&&l===r?s:(r=l,s=t(i=a,o))}}function vx(n,t){var e,i,r,s="style."+t,a="end."+s,o;return function(){var l=nn(this,n),c=l.on,u=l.value[s]==null?o||(o=fu(t)):void 0;(c!==e||r!==u)&&(i=(e=c).copy()).on(a,r=u),l.on=i}}function xx(n,t,e){var i=(n+="")=="transform"?yv:hu;return t==null?this.styleTween(n,mx(n,i)).on("end.style."+n,fu(n)):typeof t=="function"?this.styleTween(n,gx(n,i,Eo(this,"style."+n,t))).each(vx(this._id,n)):this.styleTween(n,_x(n,i,t),e).on("end.style."+n,null)}function Mx(n,t,e){return function(i){this.style.setProperty(n,t.call(this,i),e)}}function Sx(n,t,e){var i,r;function s(){var a=t.apply(this,arguments);return a!==r&&(i=(r=a)&&Mx(n,a,e)),i}return s._value=t,s}function yx(n,t,e){var i="style."+(n+="");if(arguments.length<2)return(i=this.tween(i))&&i._value;if(t==null)return this.tween(i,null);if(typeof t!="function")throw new Error;return this.tween(i,Sx(n,t,e??""))}function Ex(n){return function(){this.textContent=n}}function Tx(n){return function(){var t=n(this);this.textContent=t??""}}function bx(n){return this.tween("text",typeof n=="function"?Tx(Eo(this,"text",n)):Ex(n==null?"":n+""))}function Ax(n){return function(t){this.textContent=n.call(this,t)}}function wx(n){var t,e;function i(){var r=n.apply(this,arguments);return r!==e&&(t=(e=r)&&Ax(r)),t}return i._value=n,i}function Rx(n){var t="text";if(arguments.length<1)return(t=this.tween(t))&&t._value;if(n==null)return this.tween(t,null);if(typeof n!="function")throw new Error;return this.tween(t,wx(n))}function Cx(){for(var n=this._name,t=this._id,e=du(),i=this._groups,r=i.length,s=0;s<r;++s)for(var a=i[s],o=a.length,l,c=0;c<o;++c)if(l=a[c]){var u=Je(l,t);_s(l,n,e,c,a,{time:u.time+u.delay+u.duration,delay:0,duration:u.duration,ease:u.ease})}return new vn(i,this._parents,n,e)}function Px(){var n,t,e=this,i=e._id,r=e.size();return new Promise(function(s,a){var o={value:a},l={value:function(){--r===0&&s()}};e.each(function(){var c=nn(this,i),u=c.on;u!==n&&(t=(n=u).copy(),t._.cancel.push(o),t._.interrupt.push(o),t._.end.push(l)),c.on=t}),r===0&&s()})}var Dx=0;function vn(n,t,e,i){this._groups=n,this._parents=t,this._name=e,this._id=i}function du(){return++Dx}var un=nr.prototype;vn.prototype={constructor:vn,select:hx,selectAll:fx,selectChild:un.selectChild,selectChildren:un.selectChildren,filter:rx,merge:sx,selection:px,transition:Cx,call:un.call,nodes:un.nodes,node:un.node,size:un.size,empty:un.empty,each:un.each,on:lx,attr:Vv,attrTween:Yv,style:xx,styleTween:yx,text:bx,textTween:Rx,remove:ux,tween:Nv,delay:jv,duration:Qv,ease:ex,easeVarying:ix,end:Px,[Symbol.iterator]:un[Symbol.iterator]};function Lx(n){return((n*=2)<=1?n*n*n:(n-=2)*n*n+2)/2}var Ix={time:null,delay:0,duration:250,ease:Lx};function Ux(n,t){for(var e;!(e=n.__transition)||!(e=e[t]);)if(!(n=n.parentNode))throw new Error(`transition ${t} not found`);return e}function Nx(n){var t,e;n instanceof vn?(t=n._id,n=n._name):(t=du(),(e=Ix).time=So(),n=n==null?null:n+"");for(var i=this._groups,r=i.length,s=0;s<r;++s)for(var a=i[s],o=a.length,l,c=0;c<o;++c)(l=a[c])&&_s(l,n,t,c,a,e||Ux(l,t));return new vn(i,this._parents,n,t)}nr.prototype.interrupt=Lv;nr.prototype.transition=Nx;var Jl={},Qs={},ta=34,Hi=10,ea=13;function pu(n){return new Function("d","return {"+n.map(function(t,e){return JSON.stringify(t)+": d["+e+'] || ""'}).join(",")+"}")}function Fx(n,t){var e=pu(n);return function(i,r){return t(e(i),r,n)}}function Ql(n){var t=Object.create(null),e=[];return n.forEach(function(i){for(var r in i)r in t||e.push(t[r]=r)}),e}function Te(n,t){var e=n+"",i=e.length;return i<t?new Array(t-i+1).join(0)+e:e}function Ox(n){return n<0?"-"+Te(-n,6):n>9999?"+"+Te(n,6):Te(n,4)}function Bx(n){var t=n.getUTCHours(),e=n.getUTCMinutes(),i=n.getUTCSeconds(),r=n.getUTCMilliseconds();return isNaN(n)?"Invalid Date":Ox(n.getUTCFullYear())+"-"+Te(n.getUTCMonth()+1,2)+"-"+Te(n.getUTCDate(),2)+(r?"T"+Te(t,2)+":"+Te(e,2)+":"+Te(i,2)+"."+Te(r,3)+"Z":i?"T"+Te(t,2)+":"+Te(e,2)+":"+Te(i,2)+"Z":e||t?"T"+Te(t,2)+":"+Te(e,2)+"Z":"")}function zx(n){var t=new RegExp('["'+n+`
\r]`),e=n.charCodeAt(0);function i(h,f){var p,g,x=r(h,function(m,d){if(p)return p(m,d-1);g=m,p=f?Fx(m,f):pu(m)});return x.columns=g||[],x}function r(h,f){var p=[],g=h.length,x=0,m=0,d,w=g<=0,b=!1;h.charCodeAt(g-1)===Hi&&--g,h.charCodeAt(g-1)===ea&&--g;function y(){if(w)return Qs;if(b)return b=!1,Jl;var C,R=x,L;if(h.charCodeAt(R)===ta){for(;x++<g&&h.charCodeAt(x)!==ta||h.charCodeAt(++x)===ta;);return(C=x)>=g?w=!0:(L=h.charCodeAt(x++))===Hi?b=!0:L===ea&&(b=!0,h.charCodeAt(x)===Hi&&++x),h.slice(R+1,C-1).replace(/""/g,'"')}for(;x<g;){if((L=h.charCodeAt(C=x++))===Hi)b=!0;else if(L===ea)b=!0,h.charCodeAt(x)===Hi&&++x;else if(L!==e)continue;return h.slice(R,C)}return w=!0,h.slice(R,g)}for(;(d=y())!==Qs;){for(var D=[];d!==Jl&&d!==Qs;)D.push(d),d=y();f&&(D=f(D,m++))==null||p.push(D)}return p}function s(h,f){return h.map(function(p){return f.map(function(g){return u(p[g])}).join(n)})}function a(h,f){return f==null&&(f=Ql(h)),[f.map(u).join(n)].concat(s(h,f)).join(`
`)}function o(h,f){return f==null&&(f=Ql(h)),s(h,f).join(`
`)}function l(h){return h.map(c).join(`
`)}function c(h){return h.map(u).join(n)}function u(h){return h==null?"":h instanceof Date?Bx(h):t.test(h+="")?'"'+h.replace(/"/g,'""')+'"':h}return{parse:i,parseRows:r,format:a,formatBody:o,formatRows:l,formatRow:c,formatValue:u}}var kx=zx(","),Hx=kx.parse;function Vx(n){if(!n.ok)throw new Error(n.status+" "+n.statusText);return n.text()}function Gx(n,t){return fetch(n,t).then(Vx)}function Wx(n){return function(t,e,i){return arguments.length===2&&typeof e=="function"&&(i=e,e=void 0),Gx(t,e).then(function(r){return n(r,i)})}}var Ir=Wx(Hx);function Xx(n){if(!n.ok)throw new Error(n.status+" "+n.statusText);if(!(n.status===204||n.status===205))return n.json()}function qx(n,t){return fetch(n,t).then(Xx)}function Yx(n){return Math.abs(n=Math.round(n))>=1e21?n.toLocaleString("en").replace(/,/g,""):n.toString(10)}function os(n,t){if((e=(n=t?n.toExponential(t-1):n.toExponential()).indexOf("e"))<0)return null;var e,i=n.slice(0,e);return[i.length>1?i[0]+i.slice(2):i,+n.slice(e+1)]}function Ci(n){return n=os(Math.abs(n)),n?n[1]:NaN}function $x(n,t){return function(e,i){for(var r=e.length,s=[],a=0,o=n[0],l=0;r>0&&o>0&&(l+o+1>i&&(o=Math.max(1,i-l)),s.push(e.substring(r-=o,r+o)),!((l+=o+1)>i));)o=n[a=(a+1)%n.length];return s.reverse().join(t)}}function Kx(n){return function(t){return t.replace(/[0-9]/g,function(e){return n[+e]})}}var jx=/^(?:(.)?([<>=^]))?([+\-( ])?([$#])?(0)?(\d+)?(,)?(\.\d+)?(~)?([a-z%])?$/i;function ls(n){if(!(t=jx.exec(n)))throw new Error("invalid format: "+n);var t;return new To({fill:t[1],align:t[2],sign:t[3],symbol:t[4],zero:t[5],width:t[6],comma:t[7],precision:t[8]&&t[8].slice(1),trim:t[9],type:t[10]})}ls.prototype=To.prototype;function To(n){this.fill=n.fill===void 0?" ":n.fill+"",this.align=n.align===void 0?">":n.align+"",this.sign=n.sign===void 0?"-":n.sign+"",this.symbol=n.symbol===void 0?"":n.symbol+"",this.zero=!!n.zero,this.width=n.width===void 0?void 0:+n.width,this.comma=!!n.comma,this.precision=n.precision===void 0?void 0:+n.precision,this.trim=!!n.trim,this.type=n.type===void 0?"":n.type+""}To.prototype.toString=function(){return this.fill+this.align+this.sign+this.symbol+(this.zero?"0":"")+(this.width===void 0?"":Math.max(1,this.width|0))+(this.comma?",":"")+(this.precision===void 0?"":"."+Math.max(0,this.precision|0))+(this.trim?"~":"")+this.type};function Zx(n){t:for(var t=n.length,e=1,i=-1,r;e<t;++e)switch(n[e]){case".":i=r=e;break;case"0":i===0&&(i=e),r=e;break;default:if(!+n[e])break t;i>0&&(i=0);break}return i>0?n.slice(0,i)+n.slice(r+1):n}var mu;function Jx(n,t){var e=os(n,t);if(!e)return n+"";var i=e[0],r=e[1],s=r-(mu=Math.max(-8,Math.min(8,Math.floor(r/3)))*3)+1,a=i.length;return s===a?i:s>a?i+new Array(s-a+1).join("0"):s>0?i.slice(0,s)+"."+i.slice(s):"0."+new Array(1-s).join("0")+os(n,Math.max(0,t+s-1))[0]}function tc(n,t){var e=os(n,t);if(!e)return n+"";var i=e[0],r=e[1];return r<0?"0."+new Array(-r).join("0")+i:i.length>r+1?i.slice(0,r+1)+"."+i.slice(r+1):i+new Array(r-i.length+2).join("0")}const ec={"%":(n,t)=>(n*100).toFixed(t),b:n=>Math.round(n).toString(2),c:n=>n+"",d:Yx,e:(n,t)=>n.toExponential(t),f:(n,t)=>n.toFixed(t),g:(n,t)=>n.toPrecision(t),o:n=>Math.round(n).toString(8),p:(n,t)=>tc(n*100,t),r:tc,s:Jx,X:n=>Math.round(n).toString(16).toUpperCase(),x:n=>Math.round(n).toString(16)};function nc(n){return n}var ic=Array.prototype.map,rc=["y","z","a","f","p","n","µ","m","","k","M","G","T","P","E","Z","Y"];function Qx(n){var t=n.grouping===void 0||n.thousands===void 0?nc:$x(ic.call(n.grouping,Number),n.thousands+""),e=n.currency===void 0?"":n.currency[0]+"",i=n.currency===void 0?"":n.currency[1]+"",r=n.decimal===void 0?".":n.decimal+"",s=n.numerals===void 0?nc:Kx(ic.call(n.numerals,String)),a=n.percent===void 0?"%":n.percent+"",o=n.minus===void 0?"−":n.minus+"",l=n.nan===void 0?"NaN":n.nan+"";function c(h){h=ls(h);var f=h.fill,p=h.align,g=h.sign,x=h.symbol,m=h.zero,d=h.width,w=h.comma,b=h.precision,y=h.trim,D=h.type;D==="n"?(w=!0,D="g"):ec[D]||(b===void 0&&(b=12),y=!0,D="g"),(m||f==="0"&&p==="=")&&(m=!0,f="0",p="=");var C=x==="$"?e:x==="#"&&/[boxX]/.test(D)?"0"+D.toLowerCase():"",R=x==="$"?i:/[%p]/.test(D)?a:"",L=ec[D],S=/[defgprs%]/.test(D);b=b===void 0?6:/[gprs]/.test(D)?Math.max(1,Math.min(21,b)):Math.max(0,Math.min(20,b));function v(E){var O=C,I=R,H,q,W;if(D==="c")I=L(E)+I,E="";else{E=+E;var j=E<0||1/E<0;if(E=isNaN(E)?l:L(Math.abs(E),b),y&&(E=Zx(E)),j&&+E==0&&g!=="+"&&(j=!1),O=(j?g==="("?g:o:g==="-"||g==="("?"":g)+O,I=(D==="s"?rc[8+mu/3]:"")+I+(j&&g==="("?")":""),S){for(H=-1,q=E.length;++H<q;)if(W=E.charCodeAt(H),48>W||W>57){I=(W===46?r+E.slice(H+1):E.slice(H))+I,E=E.slice(0,H);break}}}w&&!m&&(E=t(E,1/0));var z=O.length+E.length+I.length,nt=z<d?new Array(d-z+1).join(f):"";switch(w&&m&&(E=t(nt+E,nt.length?d-I.length:1/0),nt=""),p){case"<":E=O+E+I+nt;break;case"=":E=O+nt+E+I;break;case"^":E=nt.slice(0,z=nt.length>>1)+O+E+I+nt.slice(z);break;default:E=nt+O+E+I;break}return s(E)}return v.toString=function(){return h+""},v}function u(h,f){var p=c((h=ls(h),h.type="f",h)),g=Math.max(-8,Math.min(8,Math.floor(Ci(f)/3)))*3,x=Math.pow(10,-g),m=rc[8+g/3];return function(d){return p(x*d)+m}}return{format:c,formatPrefix:u}}var Ur,_u,gu;tM({thousands:",",grouping:[3],currency:["$",""]});function tM(n){return Ur=Qx(n),_u=Ur.format,gu=Ur.formatPrefix,Ur}function eM(n){return Math.max(0,-Ci(Math.abs(n)))}function nM(n,t){return Math.max(0,Math.max(-8,Math.min(8,Math.floor(Ci(t)/3)))*3-Ci(Math.abs(n)))}function iM(n,t){return n=Math.abs(n),t=Math.abs(t)-n,Math.max(0,Ci(t)-Ci(n))+1}function rM(n,t,e){return(t[0]-n[0])*(e[1]-n[1])-(t[1]-n[1])*(e[0]-n[0])}function sM(n,t){return n[0]-t[0]||n[1]-t[1]}function sc(n){const t=n.length,e=[0,1];let i=2,r;for(r=2;r<t;++r){for(;i>1&&rM(n[e[i-2]],n[e[i-1]],n[r])<=0;)--i;e[i++]=r}return e.slice(0,i)}function ac(n){if((e=n.length)<3)return null;var t,e,i=new Array(e),r=new Array(e);for(t=0;t<e;++t)i[t]=[+n[t][0],+n[t][1],t];for(i.sort(sM),t=0;t<e;++t)r[t]=[i[t][0],-i[t][1]];var s=sc(i),a=sc(r),o=a[0]===s[0],l=a[a.length-1]===s[s.length-1],c=[];for(t=s.length-1;t>=0;--t)c.push(n[i[s[t]][2]]);for(t=+o;t<a.length-l;++t)c.push(n[i[a[t]][2]]);return c}function aM(n,t){switch(arguments.length){case 0:break;case 1:this.range(n);break;default:this.range(t).domain(n);break}return this}function oM(n){return function(){return n}}function lM(n){return+n}var oc=[0,1];function gi(n){return n}function Ja(n,t){return(t-=n=+n)?function(e){return(e-n)/t}:oM(isNaN(t)?NaN:.5)}function cM(n,t){var e;return n>t&&(e=n,n=t,t=e),function(i){return Math.max(n,Math.min(t,i))}}function uM(n,t,e){var i=n[0],r=n[1],s=t[0],a=t[1];return r<i?(i=Ja(r,i),s=e(a,s)):(i=Ja(i,r),s=e(s,a)),function(o){return s(i(o))}}function hM(n,t,e){var i=Math.min(n.length,t.length)-1,r=new Array(i),s=new Array(i),a=-1;for(n[i]<n[0]&&(n=n.slice().reverse(),t=t.slice().reverse());++a<i;)r[a]=Ja(n[a],n[a+1]),s[a]=e(t[a],t[a+1]);return function(o){var l=rg(n,o,1,i)-1;return s[l](r[l](o))}}function fM(n,t){return t.domain(n.domain()).range(n.range()).interpolate(n.interpolate()).clamp(n.clamp()).unknown(n.unknown())}function dM(){var n=oc,t=oc,e=Mo,i,r,s,a=gi,o,l,c;function u(){var f=Math.min(n.length,t.length);return a!==gi&&(a=cM(n[0],n[f-1])),o=f>2?hM:uM,l=c=null,h}function h(f){return f==null||isNaN(f=+f)?s:(l||(l=o(n.map(i),t,e)))(i(a(f)))}return h.invert=function(f){return a(r((c||(c=o(t,n.map(i),Xe)))(f)))},h.domain=function(f){return arguments.length?(n=Array.from(f,lM),u()):n.slice()},h.range=function(f){return arguments.length?(t=Array.from(f),u()):t.slice()},h.rangeRound=function(f){return t=Array.from(f),e=xv,u()},h.clamp=function(f){return arguments.length?(a=f?!0:gi,u()):a!==gi},h.interpolate=function(f){return arguments.length?(e=f,u()):e},h.unknown=function(f){return arguments.length?(s=f,h):s},function(f,p){return i=f,r=p,u()}}function pM(){return dM()(gi,gi)}function mM(n,t,e,i){var r=pg(n,t,e),s;switch(i=ls(i??",f"),i.type){case"s":{var a=Math.max(Math.abs(n),Math.abs(t));return i.precision==null&&!isNaN(s=nM(r,a))&&(i.precision=s),gu(i,a)}case"":case"e":case"g":case"p":case"r":{i.precision==null&&!isNaN(s=iM(r,Math.max(Math.abs(n),Math.abs(t))))&&(i.precision=s-(i.type==="e"));break}case"f":case"%":{i.precision==null&&!isNaN(s=eM(r))&&(i.precision=s-(i.type==="%")*2);break}}return _u(i)}function _M(n){var t=n.domain;return n.ticks=function(e){var i=t();return dg(i[0],i[i.length-1],e??10)},n.tickFormat=function(e,i){var r=t();return mM(r[0],r[r.length-1],e??10,i)},n.nice=function(e){e==null&&(e=10);var i=t(),r=0,s=i.length-1,a=i[r],o=i[s],l,c,u=10;for(o<a&&(c=a,a=o,o=c,c=r,r=s,s=c);u-- >0;){if(c=Wa(a,o,e),c===l)return i[r]=a,i[s]=o,t(i);if(c>0)a=Math.floor(a/c)*c,o=Math.ceil(o/c)*c;else if(c<0)a=Math.ceil(a*c)/c,o=Math.floor(o*c)/c;else break;l=c}return n},n}function vu(){var n=pM();return n.copy=function(){return fM(n,vu())},aM.apply(n,arguments),_M(n)}function qi(n,t,e){this.k=n,this.x=t,this.y=e}qi.prototype={constructor:qi,scale:function(n){return n===1?this:new qi(this.k*n,this.x,this.y)},translate:function(n,t){return n===0&t===0?this:new qi(this.k,this.x+this.k*n,this.y+this.k*t)},apply:function(n){return[n[0]*this.k+this.x,n[1]*this.k+this.y]},applyX:function(n){return n*this.k+this.x},applyY:function(n){return n*this.k+this.y},invert:function(n){return[(n[0]-this.x)/this.k,(n[1]-this.y)/this.k]},invertX:function(n){return(n-this.x)/this.k},invertY:function(n){return(n-this.y)/this.k},rescaleX:function(n){return n.copy().domain(n.range().map(this.invertX,this).map(n.invert,n))},rescaleY:function(n){return n.copy().domain(n.range().map(this.invertY,this).map(n.invert,n))},toString:function(){return"translate("+this.x+","+this.y+") scale("+this.k+")"}};qi.prototype;const Vn="/EleVis/",lc="mesh_frames_",gM=.034,Nr=[["elephant_Trunk4_bone","elephant_Snout_bone"],["elephant_Trunk2_bone","elephant_Trunk4_bone"],["elephant_Snout_bone","elephant_Head_bone"],["elephant_Head_bone","elephant_Neck_bone"],["elephant_Neck_bone","elephant_Spine3_bone"],["elephant_Spine3_bone","elephant_Spine2_bone"],["elephant_Spine2_bone","elephant_Pelvis_bone"],["elephant_Pelvis_bone","elephant_Tail2_bone"],["elephant_Head_bone","elephant_r_Ear1_bone"],["elephant_r_Ear1_bone","elephant_r_Ear4_bone"],["elephant_Head_bone","elephant_l_Ear1_bone"],["elephant_l_Ear1_bone","elephant_l_Ear4_bone"],["elephant_Neck_bone","elephant_r_Humerus_bone"],["elephant_Neck_bone","elephant_l_Humerus_bone"],["elephant_Pelvis_bone","elephant_r_Femur_bone"],["elephant_Pelvis_bone","elephant_l_Femur_bone"]];let ge=null,cc=0,xu=10,cs=()=>{},Qa=null,Yr=[];document.addEventListener("DOMContentLoaded",()=>{let n=document.getElementById("overlay-line-layer");n||(n=document.createElementNS("http://www.w3.org/2000/svg","svg"),n.id="overlay-line-layer",n.setAttribute("width","100%"),n.setAttribute("height","100%"),Object.assign(n.style,{position:"absolute",inset:0,pointerEvents:"none",overflow:"visible",background:"transparent",zIndex:9998}),document.body.appendChild(n));const t=document.createElement("input");t.type="text",t.placeholder="Enter timestamp (e.g. 20250626_094312)",t.style="margin:10px 0;padding:6px;font-size:14px;width:300px",document.body.insertBefore(t,document.getElementById("viz"));const e=document.createElement("button");e.textContent="Load Dataset",e.style="margin-left:8px;padding:6px 12px",t.after(e);const r=1/.1,s=document.createElement("label");s.innerHTML='Dwell Threshold (s): <span id="dwellValue">1.0</span>',s.style="margin-left:20px;margin-right:5px;font-size:14px;",t.after(s);const a=document.createElement("input");a.type="range",a.min=.5,a.max=10,a.value=1,a.step=.1,a.style="vertical-align:middle",a.disabled=!0,s.appendChild(a),a.oninput=()=>{const o=+a.value;if(document.getElementById("dwellValue").textContent=o.toFixed(1),xu=Math.round(o*r),typeof cs=="function"){const l=+document.getElementById("stepSlider").value||0,c=+document.getElementById("skeletonSlider").value||1;cs(l,c)}},e.onclick=()=>{const o=t.value.trim();if(!/^\d{8}_\d{6}$/.test(o))return alert("Invalid timestamp format");uc(o)},uc("20250626_094312")});function uc(n){ge=null,tu("#viz").selectAll("*").remove(),Promise.all([Ir(`${Vn}skeleton_tracking_${n}.csv`),Ir(`${Vn}centroid_data_${n}_tracking.csv`),Ir(`${Vn}centroid_data_${n}_collisions.csv`),qx(`${Vn}skeleton_hierarchy_${n}.json`),Ir(`${Vn}behaviours.csv`)]).then(([t,e,i,r,s])=>{Qa=e,Yr=s.map(a=>({name:a[Object.keys(a)[1]],description:a[Object.keys(a)[2]]})),xM(t,e,i,r,n)}).catch(t=>{alert("Failed to load data (see console)"),console.error(t)})}function vM(n,t,e,i,r,s){const a=r-e,o=s-i;if(a===0&&o===0)return Math.hypot(n-e,t-i);const l=((n-e)*a+(t-i)*o)/(a*a+o*o),c=Math.max(0,Math.min(1,l)),u=e+c*a,h=i+c*o;return Math.hypot(n-u,t-h)}function xM(n,t,e,i,r){document.querySelector("input[type=range][disabled]")?.removeAttribute("disabled");const s=i.keys.map((v,E)=>[i.values[E],v]).filter(([v])=>v&&v!=="null"),a=1e3,o=1e3,l=vu().domain([-10,10]).range([0,a]),c=tu("#viz").attr("width",a).attr("height",o);c.append("g").attr("id","layer-static-boxes"),c.append("g").attr("id","layer-gray-skeletons"),c.append("g").attr("id","layer-blue-skeletons"),c.append("g").attr("id","layer-dwell-circles"),c.append("g").attr("id","layer-mesh"),c.append("g").attr("id","layer-hull-lines");const h=Nl(t,v=>v.time).get(t[0].time).map(v=>({x0:+v.boundsB_min_world_x,x1:+v.boundsB_max_world_x,z0:+v.boundsB_min_world_z,z1:+v.boundsB_max_world_z,height:+v.boundsB_max_world_y||.01})),f=c.select("#layer-static-boxes");f.selectAll("*").remove(),h.forEach(({x0:v,x1:E,z0:O,z1:I})=>{f.append("rect").attr("x",l(v)).attr("y",l(O)).attr("width",l(E)-l(v)).attr("height",l(I)-l(O)).attr("fill","pink")});const p=Nl(n,v=>v.time),g=[...p.keys()].sort((v,E)=>+v-+E),x=[...new Set(e.map(v=>v.collision_time))].filter(v=>{const E=p.get(v)?.[0];if(!E)return!1;const O=i.keys.map(I=>{const H=E[`${I}_x`],q=E[`${I}_z`];return H&&q?[+H,+q]:null}).filter(Boolean);return O.length>=3&&ac(O)}),m=document.getElementById("stepSlider"),d=document.getElementById("skeletonSlider"),w=document.getElementById("stepValue"),b=document.getElementById("skeletonValue");m.max=x.length-1,m.oninput=d.oninput=()=>{w.textContent=m.value,b.textContent=d.value,cs(+m.value,+d.value)};function y(v,E){c.selectAll("path,line,circle").remove();const O=(()=>{const $=[],Y=t.map(Q=>({x:+Q.centroidA_x,z:+Q.centroidA_z,t:Q.time})).filter(Q=>isFinite(Q.x)&&isFinite(Q.z)),G=new Set;for(let Q=0;Q<Y.length;Q++){const{x:it,z:lt,t:vt}=Y[Q];if(G.has(vt))continue;const ct=Y.filter(({x:It,z:pt,t:gt})=>Math.hypot(It-it,pt-lt)<=gM&&!G.has(gt));if(ct.length<xu)continue;ct.forEach(({t:It})=>G.add(It));const A=[];for(const{t:It}of ct){const pt=n.find(gt=>gt.time===It);pt&&i.keys.forEach(gt=>{const Et=+pt[`${gt}_x`],Pt=+pt[`${gt}_z`];isFinite(Et)&&isFinite(Pt)&&A.push([Et,Pt])})}const Yt=[Fl(A,It=>It[0]),Fl(A,It=>It[1])],Bt=mg(A,([It,pt])=>Math.hypot(It-Yt[0],pt-Yt[1]));$.push({centroid:Yt,radius:Bt})}return $})();for(let $=0;$<g.length;$+=E){const Y=p.get(g[$])?.[0];if(!Y)continue;const G={};Nr.flat().forEach(lt=>{Y[`${lt}_x`]&&(G[lt]=[+Y[`${lt}_x`],+Y[`${lt}_z`]])}),!(Object.values(G).filter(([lt,vt])=>O.some(({centroid:[ct,A],radius:Yt})=>Math.hypot(lt-ct,vt-A)<=Yt)).length>=15)&&Nr.forEach(([lt,vt])=>{G[lt]&&G[vt]&&c.select("#layer-gray-skeletons").append("line").attr("x1",l(G[lt][0])).attr("y1",l(G[lt][1])).attr("x2",l(G[vt][0])).attr("y2",l(G[vt][1])).attr("stroke","lightpink").attr("stroke-width",1).lower()})}for(let $=0;$<g.length;$+=E){const Y=p.get(g[$])?.[0];if(!Y)continue;const G={};Nr.flat().forEach(lt=>{Y[`${lt}_x`]&&(G[lt]=[+Y[`${lt}_x`],+Y[`${lt}_z`]])}),Object.values(G).filter(([lt,vt])=>O.some(({centroid:[ct,A],radius:Yt})=>Math.hypot(lt-ct,vt-A)<=Yt)).length>=10&&Nr.forEach(([lt,vt])=>{G[lt]&&G[vt]&&c.select("#layer-blue-skeletons").append("line").attr("x1",l(G[lt][0])).attr("y1",l(G[lt][1])).attr("x2",l(G[vt][0])).attr("y2",l(G[vt][1])).attr("stroke","purple").attr("stroke-width",1)})}const I=[];function H($,Y){return!($.right<Y.left||$.left>Y.right||$.bottom<Y.top||$.top>Y.bottom)}function q($,Y=10){let G=0;for(;G++<100;){const Q=$.getBoundingClientRect();if(!I.find(lt=>H(Q,lt.div.getBoundingClientRect())))return;$.style.left=`${Q.left+40}px`,$.style.top=`${Q.top+40}px`}}function W($){const Y=document.getElementById("viz").getBoundingClientRect(),G=$.getBoundingClientRect(),Q=Y.left,it=Y.right-G.width,lt=Y.top,vt=Y.bottom-G.height;let ct=Math.min(Math.max(G.left,Q),it),A=Math.min(Math.max(G.top,lt),vt);$.style.left=`${ct}px`,$.style.top=`${A}px`}function j($,Y=10){let G=0,Q=!0;for(;Q&&G++<100;){Q=!1;const it=$.getBoundingClientRect();for(const lt of I){if(lt.div===$)continue;const vt=lt.div.getBoundingClientRect();if(!H(it,vt))continue;const ct=it.left-vt.right-Y,A=it.right-vt.left+Y,Yt=it.top-vt.bottom-Y,Bt=it.bottom-vt.top+Y,It=Math.abs(ct)<Math.abs(A)?ct:A,pt=Math.abs(Yt)<Math.abs(Bt)?Yt:Bt;Math.abs(It)<Math.abs(pt)?lt.div.style.left=`${lt.div.offsetLeft+It}px`:lt.div.style.top=`${lt.div.offsetTop+pt}px`,Q=!0,requestAnimationFrame(lt.updateLine)}}}O.forEach(({centroid:[$,Y],radius:G})=>{const Q=Yr.length?Yr[Math.floor(Math.random()*Yr.length)]:{name:"Unknown",description:"No behavior data loaded."};c.select("#layer-dwell-circles").append("circle").attr("cx",l($)).attr("cy",l(Y)).attr("r",l($+G)-l($)).attr("fill","orange").attr("fill-opacity",.12).style("cursor","pointer").on("click",function(){const it=this.getBoundingClientRect(),lt=it.x+it.width*.5,vt=it.y+it.height*.5,ct=document.createElement("div");ct.className="dwell-popup",ct.innerHTML=`<b>${Q.name}</b><br>${Q.description}`,document.body.appendChild(ct);let A=260,Yt=80,Bt=lt+80,It=vt-Yt/2;const pt=Bt+A/2,gt=It+Yt/2,Et=pt-lt,Pt=gt-vt;Math.hypot(Et,Pt)<90&&(Bt=lt-80-A),Object.assign(ct.style,{position:"absolute",left:`${Bt}px`,top:`${It}px`,maxWidth:"300px",padding:"10px",background:"#fff",border:"1px solid #ccc",borderRadius:"6px",fontSize:"13px",color:"#333",boxShadow:"0 2px 8px rgba(0,0,0,0.25)",cursor:"move",zIndex:9999});const T=document.getElementById("overlay-line-layer"),_=document.createElementNS("http://www.w3.org/2000/svg","line");_.setAttribute("stroke","#333"),_.setAttribute("stroke-width","1.5"),_.setAttribute("stroke-dasharray","4 2"),T.appendChild(_);function B(){_.setAttribute("x1",lt),_.setAttribute("y1",vt),_.setAttribute("x2",ct.offsetLeft),_.setAttribute("y2",ct.offsetTop+ct.offsetHeight*.5)}requestAnimationFrame(()=>{q(ct),W(ct),j(ct),W(ct),B(),I.push({div:ct,line:_,updateLine:B})});let Z=!1,et=0,K=0;ct.addEventListener("mousedown",xt=>{Z=!0,et=xt.clientX-ct.offsetLeft,K=xt.clientY-ct.offsetTop,xt.preventDefault()}),document.addEventListener("mousemove",xt=>{Z&&(ct.style.left=`${xt.clientX-et}px`,ct.style.top=`${xt.clientY-K}px`,requestAnimationFrame(B))}),document.addEventListener("mouseup",()=>{Z&&(Z=!1,j(ct),W(ct))}),document.addEventListener("keydown",xt=>{xt.key==="Escape"&&(I.forEach(({div:ut,line:bt})=>{ut.remove(),bt.remove()}),I.length=0)})})});const z=p.get(x[v])?.[0];if(!z)return;const nt=S(z.time),ht=`${Vn}${lc}${r}/${nt}`;fetch(ht).then($=>$.ok?$.json():Promise.reject("mesh missing")).then($=>D(c,l,$,1.5,z,r,h,O)).catch($=>console.warn("2D mesh load error:",$));const yt=i.keys.map($=>{const Y=z[`${$}_x`],G=z[`${$}_z`];return Y&&G?[+Y,+G]:null}).filter(Boolean),Ct=ac(yt);if(!Ct)return;Ct.push(Ct[0]);const kt=[];for(let $=0;$<Ct.length-1;$++)kt.push([Ct[$],Ct[$+1]]);const X=[];c.selectAll("rect").each(function(){const $=this.getBBox(),Y=l.invert($.x+$.width/2),G=l.invert($.y+$.height/2);for(const[Q,it]of kt){const lt=vM(Y,G,Q[0],Q[1],it[0],it[1]);X.push({edge:[Q,it],dist:lt,rect:$})}}),X.sort(($,Y)=>$.dist-Y.dist).slice(0,2).forEach(({edge:$,rect:Y})=>{$.forEach(([G,Q])=>{const it=[l.invert(Math.max(Y.x,Math.min(l(G),Y.x+Y.width))),l.invert(Math.max(Y.y,Math.min(l(Q),Y.y+Y.height)))],lt=Math.hypot(G-it[0],Q-it[1]),vt=[(G+it[0])/2,(Q+it[1])/2];c.append("circle").attr("cx",l(it[0])).attr("cy",l(it[1])).attr("r",5).attr("fill","black").raise(),c.select("#layer-hull-lines").append("circle").attr("cx",l(vt[0])).attr("cy",l(vt[1])).attr("r",0).attr("fill","none").attr("stroke","red").attr("stroke-width",1.5).transition().duration(1e3).attr("r",l(lt/2)-l(0)).selection().raise()}),c.select("#layer-hull-lines").append("line").attr("x1",l($[0][0])).attr("y1",l($[0][1])).attr("x2",l($[1][0])).attr("y2",l($[1][1])).attr("stroke","black").attr("stroke-width",3).raise()}),ge&&R(z,h,i,s,r,O)}cs=y,y(0,+document.getElementById("skeletonSlider").value||1);function D(v,E,O,I=1.5,H,q,W,j){const z=v.select("#layer-mesh");z.selectAll("*").remove();const nt=O.vertices,ht=O.triangles,yt=W.map(X=>({x:(X.x0+X.x1)/2,z:(X.z0+X.z1)/2})),Ct=[];let kt=0;for(let X=0;X<nt.length;X+=3){const tt=nt[X],$=nt[X+2];let Y=1/0;for(const G of yt){const Q=Math.hypot(tt-G.x,$-G.z);Q<Y&&(Y=Q)}Ct.push(Y),Y>kt&&(kt=Y)}for(let X=0;X<ht.length;X+=3){const tt=ht[X],$=ht[X+1],Y=ht[X+2],G=nt[tt*3+1],Q=nt[$*3+1],it=nt[Y*3+1];if(Math.min(G,Q,it)<I)continue;const vt=E(nt[tt*3]),ct=E(nt[tt*3+2]),A=E(nt[$*3]),Yt=E(nt[$*3+2]),Bt=E(nt[Y*3]),It=E(nt[Y*3+2]),pt=Ct[tt],gt=Ct[$],Et=Ct[Y],Pt=1-(pt+gt+Et)/(3*kt),Jt=`rgb(255,${Math.pow(1-Pt,3.5)*255},0)`;z.append("path").attr("d",`M${vt},${ct} L${A},${Yt} L${Bt},${It} Z`).attr("fill",Jt).attr("fill-opacity",.75).style("cursor","pointer").on("click",()=>C(H,q,j))}}function C(v,E,O=[]){if(ge)return R(v,h,i,s,E,O);const I=document.createElement("div");Object.assign(I.style,{position:"fixed",inset:0,background:"transparent",zIndex:9999,pointerEvents:"none"}),document.body.appendChild(I);const H=document.createElement("div");Object.assign(H.style,{width:"800px",height:"800px",background:"#222",borderRadius:"8px",boxShadow:"0 4px 16px #000",position:"absolute",left:"100px",top:"100px",pointerEvents:"auto",overflow:"hidden"}),I.appendChild(H);const q=document.createElement("div");Object.assign(q.style,{height:"28px",background:"#000",color:"#000",display:"flex",alignItems:"center",padding:"0 8px",cursor:"grab",fontSize:"13px",borderTopLeftRadius:"8px",borderTopRightRadius:"8px",userSelect:"none"}),q.textContent="3‑D Skeleton + Mesh View",H.appendChild(q),document.addEventListener("keydown",function tt($){$.key==="Escape"&&(ge=null,I.remove(),document.removeEventListener("keydown",tt))});let W=!1,j=0,z=0;q.addEventListener("pointerdown",tt=>{tt.button||(W=!0,j=tt.clientX-H.offsetLeft,z=tt.clientY-H.offsetTop,q.setPointerCapture(tt.pointerId),q.style.cursor="grabbing")}),q.addEventListener("pointermove",tt=>{W&&(H.style.left=`${tt.clientX-j}px`,H.style.top=`${tt.clientY-z}px`)}),q.addEventListener("pointerup",tt=>{W=!1,q.style.cursor="grab",q.releasePointerCapture&&q.releasePointerCapture(tt.pointerId)});const nt=new Gh,ht=new tf,yt=new z_({antialias:!0});yt.setSize(800,800),H.appendChild(yt.domElement);const Ct=new Ic,kt=new H_(Ct,yt.domElement);kt.enableDamping=!0,kt.dampingFactor=.05,kt.enablePan=!0,kt.enableZoom=!0,kt.mouseButtons={LEFT:mn.NONE,MIDDLE:mn.PAN,RIGHT:mn.ROTATE},nt.add(new Jh(16777215,3355443,1));const X=new Vi;nt.add(X),ge={overlay:I,box:H,scene:nt,group:X,cam:Ct,ctl:kt,renderer:yt,clock:ht,dwellAnims:[]},L(),R(v,h,i,s,E,O)}function R(v,E,O,I,H,q=[]){const{group:W,cam:j,ctl:z,renderer:nt}=ge;W.clear();const ht=new ho({color:16753920,transparent:!0,opacity:.75});ge.dwellAnims.length=0,q.forEach(({centroid:[G,Q],radius:it})=>{const vt=new fo(it,it,.1,32),ct=new Be(vt,ht);ct.position.set(G,.1/2,Q),ct.scale.set(.001,1,.001),ge.dwellAnims.push({mesh:ct,t:0,duration:1.2}),W.add(ct)});const yt=++cc,Ct=S(v.time),kt=`${Vn}${lc}${H}/${Ct}`;fetch(kt).then(G=>G.ok?G.json():Promise.reject(`404 ${Ct}`)).then(G=>{if(yt!==cc)return;const Q=new Float32Array(G.vertices),it=new ze;it.setAttribute("position",new Le(Q,3)),it.setIndex(new Le(new Uint32Array(G.triangles),1)),it.computeVertexNormals();const lt=new F;for(let gt=0;gt<Q.length;gt+=3)lt.x+=Q[gt],lt.y+=Q[gt+1],lt.z+=Q[gt+2];lt.divideScalar(Q.length/3);let vt=null,ct=1/0;E.forEach(gt=>{const Et=(gt.x0+gt.x1)/2,Pt=gt.height/2,Jt=(gt.z0+gt.z1)/2,T=lt.distanceTo(new F(Et,Pt,Jt));T<ct&&(ct=T,vt=gt)});const A=new Float32Array(Q.length);let Yt=0;const Bt=new F((vt.x0+vt.x1)/2,vt.height/2,(vt.z0+vt.z1)/2),It=[];for(let gt=0;gt<Q.length;gt+=3){const Et=Q[gt],Pt=Q[gt+1],Jt=Q[gt+2],_=new F(Et,Pt,Jt).distanceTo(Bt);It.push(_),_>Yt&&(Yt=_)}for(let gt=0;gt<It.length;gt++){const Et=1-It[gt]/Yt,Pt=1,Jt=Math.pow(1-Et,3.5),T=0;A[gt*3]=Pt,A[gt*3+1]=Jt,A[gt*3+2]=T}it.setAttribute("color",new Le(A,3));const pt=new Be(it,new Yh({vertexColors:!0,metalness:.1,roughness:.75,transparent:!0,opacity:.9}));W.add(pt),Y()}).catch(G=>console.warn("Mesh load error:",G));const X=new $h({color:8947848,transparent:!0,opacity:.5,depthWrite:!1});E.forEach(G=>{const Q=new Di(G.x1-G.x0,G.height,G.z1-G.z0),it=new Be(Q,X);it.position.set(G.x0+(G.x1-G.x0)/2,G.height/2,G.z0+(G.z1-G.z0)/2),W.add(it)});const tt={};O.keys.forEach(G=>{const Q=+v[`${G}_x`],it=+v[`${G}_y`],lt=+v[`${G}_z`];!isNaN(Q)&&!isNaN(it)&&!isNaN(lt)&&(tt[G]=new F(Q,it,lt))});const $=new Va({color:16777215});if(I.forEach(([G,Q])=>{tt[G]&&tt[Q]&&W.add(new rl(new ze().setFromPoints([tt[G],tt[Q]]),$))}),Qa){const G=Qa.map(Q=>{const it=+Q.centroidA_x,lt=+Q.centroidA_z;return new F(it,.01,lt)}).filter(Q=>isFinite(Q.x)&&isFinite(Q.z));if(G.length>1){const Q=G.map(ct=>new F(ct.x,.1,ct.z)),it=new ze().setFromPoints(Q),lt=new Va({color:"red",linewidth:10,transparent:!0,opacity:.9,depthTest:!1}),vt=new rl(it,lt);W.add(vt)}}function Y(){const G=new Pi().setFromObject(W),Q=G.getCenter(new F),it=G.getSize(new F),lt=Math.max(it.x,it.y,it.z)*.6,vt=600/600;j.left=-lt*vt,j.right=lt*vt,j.top=lt,j.bottom=-lt,j.near=.1,j.far=1e3,j.updateProjectionMatrix();const ct=lt*2.5;j.position.set(Q.x+ct,Q.y+ct,Q.z+ct),j.lookAt(Q),z.target.copy(Q),z.update(),nt.render(ge.scene,j)}}function L(){if(!ge)return;const v=ge.clock.getDelta();ge.dwellAnims.forEach(E=>{E.t=Math.min(E.t+v,E.duration);const O=E.t/E.duration;E.mesh.scale.set(O,1,O)}),ge.ctl.update(),ge.renderer.render(ge.scene,ge.cam),requestAnimationFrame(L)}function S(v){const[E,O="0"]=v.split("."),I=parseInt(E,10).toString(),H=O.padEnd(2,"0").slice(0,2);return`mesh_${I}_${H}.json`}}

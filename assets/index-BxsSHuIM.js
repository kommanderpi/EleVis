...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Un,depthTest:!1,depthWrite:!1})}function oc(){return new On({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:ll(),fragmentShader:`
		...
		`,blending:Un,depthTest:!1,depthWrite:!1})}function ac(){return new On({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:ll(),fragmentShader:`
	...
	`}function p_(n){let t=new WeakMap,e=null;function i(a){if(a&&a.isTexture){const c=a.mapping,l=c===Jo||c===Qo,u=c===Hi||c===Vi;if(l||u){let h=t.get(a);const f=h!==void 0?h.texture.pmremVersion:0;if(a.isRenderTargetTexture&&a.pmremVersion!==f)return e===null&&(e=new rc(n)),h=l?e.fromEquirectangular(a,h):e.fromCubemap(a,h),h.texture.pmremVersion=a.pmremVersion,t.set(a,h),h.texture;if(h!==void 0)return h.texture;{const p=a.image;return l&&p&&p.height>0||u&&p&&r(p)?(e===null&&(e=new rc(n)),h=l?e.fromEquirectangular(a):e.fromCubemap(a),h.texture.pmremVersion=a.pmremVersion,t.set(a,h),a.addEventListener("dispose",s),h.texture):null}}}return a}function r(a){let c=0;const l=6;for(let u=0;u<l;u++)a[u]!==void 0&&c++;return c===l}function s(a){const c=a.target;c.removeEventListener("dispose",s);const l=t.get(c);l!==void 0&&(t.delete(c),l.dispose())}function o(){t=new WeakMap,e!==null&&(e.dispose(),e=null)}return{get:i,dispose:o}}function m_(n){const t={};function e(i){if(t[i]!==void 0)return t[i];let r;switch(i){case"WEBGL_depth_texture":r=n.getExtension("WEBGL_depth_texture")||n.getExtension("MOZ_WEBGL_depth_texture")||n.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":r=n.getExtension("EXT_texture_filter_anisotropic")||n.getExtension("MOZ_EXT_texture_filter_anisotropic")||n.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":r=n.getExtension("WEBGL_compressed_texture_s3tc")||n.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||n.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":r=n.getExtension("WEBGL_compressed_texture_pvrtc")||n.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:r=n.getExtension(i)}return t[i]=r,r}return{has:function(i){return e(i)!==null},init:function(){e("EXT_color_buffer_float"),e("WEBGL_clip_cull_distance"),e("OES_texture_float_linear"),e("EXT_color_buffer_half_float"),e("WEBGL_multisampled_render_to_texture"),e("WEBGL_render_shared_exponent")},get:function(i){const r=e(i);return r===null&&Fi("THREE.WebGLRenderer: "+i+" extension not supported."),r}}}function __(n,t,e,i){const r={},s=new WeakMap;function o(h){const f=h.target;f.index!==null&&t.remove(f.index);for(const _ in f.attributes)t.remove(f.attributes[_]);f.removeEventListener("dispose",o),delete r[f.id];const p=s.get(f);p&&(t.remove(p),s.delete(f)),i.releaseStatesOfGeometry(f),f.isInstancedBufferGeometry===!0&&delete f._maxInstanceCount,e.memory.geometries--}function a(h,f){return r[f.id]===!0||(f.addEventListener("dispose",o),r[f.id]=!0,e.memory.geometries++),f}function c(h){const f=h.attributes;for(const p in f)t.update(f[p],n.ARRAY_BUFFER)}function l(h){const f=[],p=h.index,_=h.attributes.position;let v=0;if(p!==null){const T=p.array;v=p.version;for(let w=0,S=T.length;w<S;w+=3){const D=T[w+0],P=T[w+1],A=T[w+2];f.push(D,P,P,A,A,D)}}else if(_!==void 0){const T=_.array;v=_.version;for(let w=0,S=T.length/3-1;w<S;w+=3){const D=w+0,P=w+1,A=w+2;f.push(D,P,P,A,A,D)}}else return;const m=new(Pu(f)?Nu:Uu)(f,1);m.version=v;const d=s.get(h);d&&t.remove(d),s.set(h,m)}function u(h){const f=s.get(h);if(f){const p=h.index;p!==null&&f.version<p.version&&l(h)}else l(h);return s.get(h)}return{get:a,update:c,getWireframeAttribute:u}}function g_(n,t,e){let i;function r(f){i=f}let s,o;function a(f){s=f.type,o=f.bytesPerElement}function c(f,p){n.drawElements(i,p,s,f*o),e.update(p,i,1)}function l(f,p,_){_!==0&&(n.drawElementsInstanced(i,p,s,f*o,_),e.update(p,i,_))}function u(f,p,_){if(_===0)return;t.get("WEBGL_multi_draw").multiDrawElementsWEBGL(i,p,0,s,f,0,_);let m=0;for(let d=0;d<_;d++)m+=p[d];e.update(m,i,1)}function h(f,p,_,v){if(_===0)return;const m=t.get("WEBGL_multi_draw");if(m===null)for(let d=0;d<f.length;d++)l(f[d]/o,p[d],v[d]);else{m.multiDrawElementsInstancedWEBGL(i,p,0,s,f,0,v,0,_);let d=0;for(let T=0;T<_;T++)d+=p[T]*v[T];e.update(d,i,1)}}this.setMode=r,this.setIndex=a,this.render=c,this.renderInstances=l,this.renderMultiDraw=u,this.renderMultiDrawInstances=h}function v_(n){const t={geometries:0,textures:0},e={frame:0,calls:0,triangles:0,points:0,lines:0};function i(s,o,a){switch(e.calls++,o){case n.TRIANGLES:e.triangles+=a*(s/3);break;case n.LINES:e.lines+=a*(s/2);break;case n.LINE_STRIP:e.lines+=a*(s-1);break;case n.LINE_LOOP:e.lines+=a*s;break;case n.POINTS:e.points+=a*s;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",o);break}}function r(){e.calls=0,e.triangles=0,e.points=0,e.lines=0}return{memory:t,render:e,programs:null,autoReset:!0,reset:r,update:i}}function x_(n,t,e){const i=new WeakMap,r=new ce;function s(o,a,c){const l=o.morphTargetInfluences,u=a.morphAttributes.position||a.morphAttributes.normal||a.morphAttributes.color,h=u!==void 0?u.length:0;let f=i.get(a);if(f===void 0||f.count!==h){let x=function(){C.dispose(),i.delete(a),a.removeEventListener("dispose",x)};var p=x;f!==void 0&&f.texture.dispose();const _=a.morphAttributes.position!==void 0,v=a.morphAttributes.normal!==void 0,m=a.morphAttributes.color!==void 0,d=a.morphAttributes.position||[],T=a.morphAttributes.normal||[],w=a.morphAttributes.color||[];let S=0;_===!0&&(S=1),v===!0&&(S=2),m===!0&&(S=3);let D=a.attributes.position.count*S,P=1;D>t.maxTextureSize&&(P=Math.ceil(D/t.maxTextureSize),D=t.maxTextureSize);const A=new Float32Array(D*P*4*h),C=new Du(A,D,P,h);C.type=Mn,C.needsUpdate=!0;const y=S*4;for(let b=0;b<h;b++){const z=d[b],O=T[b],$=w[b],j=D*P*4*b;for(let Z=0;Z<z.count;Z++){const et=Z*y;_===!0&&(r.fromBufferAttribute(z,Z),A[j+et+0]=r.x,A[j+et+1]=r.y,A[j+et+2]=r.z,A[j+et+3]=0),v===!0&&(r.fromBufferAttribute(O,Z),A[j+et+4]=r.x,A[j+et+5]=r.y,A[j+et+6]=r.z,A[j+et+7]=0),m===!0&&(r.fromBufferAttribute($,Z),A[j+et+8]=r.x,A[j+et+9]=r.y,A[j+et+10]=r.z,A[j+et+11]=$.itemSize===4?r.w:1)}}f={count:h,texture:C,size:new kt(D,P)},i.set(a,f),a.addEventListener("dispose",x)}if(o.isInstancedMesh===!0&&o.morphTexture!==null)c.getUniforms().setValue(n,"morphTexture",o.morphTexture,e);else{let _=0;for(let m=0;m<l.length;m++)_+=l[m];const v=a.morphTargetsRelative?1:1-_;c.getUniforms().setValue(n,"morphTargetBaseInfluence",v),c.getUniforms().setValue(n,"morphTargetInfluences",l)}c.getUniforms().setValue(n,"morphTargetsTexture",f.texture,e),c.getUniforms().setValue(n,"morphTargetsTextureSize",f.size)}return{update:s}}function M_(n,t,e,i){let r=new WeakMap;function s(c){const l=i.render.frame,u=c.geometry,h=t.get(c,u);if(r.get(h)!==l&&(t.update(h),r.set(h,l)),c.isInstancedMesh&&(c.hasEventListener("dispose",a)===!1&&c.addEventListener("dispose",a),r.get(c)!==l&&(e.update(c.instanceMatrix,n.ARRAY_BUFFER),c.instanceColor!==null&&e.update(c.instanceColor,n.ARRAY_BUFFER),r.set(c,l))),c.isSkinnedMesh){const f=c.skeleton;r.get(f)!==l&&(f.update(),r.set(f,l))}return h}function o(){r=new WeakMap}function a(c){const l=c.target;l.removeEventListener("dispose",a),e.remove(l.instanceMatrix),l.instanceColor!==null&&e.remove(l.instanceColor)}return{update:s,dispose:o}}const Gu=new Re,lc=new ku(1,1),Wu=new Du,Xu=new qf,qu=new Bu,cc=[],uc=[],hc=new Float32Array(16),fc=new Float32Array(9),dc=new Float32Array(4);function Ji(n,t,e){const i=n[0];if(i<=0||i>0)return n;const r=t*e;let s=cc[r];if(s===void 0&&(s=new Float32Array(r),cc[r]=s),t!==0){i.toArray(s,0);for(let o=1,a=0;o!==t;++o)a+=e,n[o].toArray(s,a)}return s}function de(n,t){if(n.length!==t.length)return!1;for(let e=0,i=n.length;e<i;e++)if(n[e]!==t[e])return!1;return!0}function pe(n,t){for(let e=0,i=t.length;e<i;e++)n[e]=t[e]}function js(n,t){let e=uc[t];e===void 0&&(e=new Int32Array(t),uc[t]=e);for(let i=0;i!==t;++i)e[i]=n.allocateTextureUnit();return e}function y_(n,t){const e=this.cache;e[0]!==t&&(n.uniform1f(this.addr,t),e[0]=t)}function S_(n,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(n.uniform2f(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(de(e,t))return;n.uniform2fv(this.addr,t),pe(e,t)}}function E_(n,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(n.uniform3f(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else if(t.r!==void 0)(e[0]!==t.r||e[1]!==t.g||e[2]!==t.b)&&(n.uniform3f(this.addr,t.r,t.g,t.b),e[0]=t.r,e[1]=t.g,e[2]=t.b);else{if(de(e,t))return;n.uniform3fv(this.addr,t),pe(e,t)}}function T_(n,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(n.uniform4f(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(de(e,t))return;n.uniform4fv(this.addr,t),pe(e,t)}}function w_(n,t){const e=this.cache,i=t.elements;if(i===void 0){if(de(e,t))return;n.uniformMatrix2fv(this.addr,!1,t),pe(e,t)}else{if(de(e,i))return;dc.set(i),n.uniformMatrix2fv(this.addr,!1,dc),pe(e,i)}}function b_(n,t){const e=this.cache,i=t.elements;if(i===void 0){if(de(e,t))return;n.uniformMatrix3fv(this.addr,!1,t),pe(e,t)}else{if(de(e,i))return;fc.set(i),n.uniformMatrix3fv(this.addr,!1,fc),pe(e,i)}}function A_(n,t){const e=this.cache,i=t.elements;if(i===void 0){if(de(e,t))return;n.uniformMatrix4fv(this.addr,!1,t),pe(e,t)}else{if(de(e,i))return;hc.set(i),n.uniformMatrix4fv(this.addr,!1,hc),pe(e,i)}}function R_(n,t){const e=this.cache;e[0]!==t&&(n.uniform1i(this.addr,t),e[0]=t)}function C_(n,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(n.uniform2i(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(de(e,t))return;n.uniform2iv(this.addr,t),pe(e,t)}}function P_(n,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(n.uniform3i(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else{if(de(e,t))return;n.uniform3iv(this.addr,t),pe(e,t)}}function D_(n,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(n.uniform4i(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(de(e,t))return;n.uniform4iv(this.addr,t),pe(e,t)}}function L_(n,t){const e=this.cache;e[0]!==t&&(n.uniform1ui(this.addr,t),e[0]=t)}function I_(n,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(n.uniform2ui(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(de(e,t))return;n.uniform2uiv(this.addr,t),pe(e,t)}}function U_(n,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(n.uniform3ui(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else{if(de(e,t))return;n.uniform3uiv(this.addr,t),pe(e,t)}}function N_(n,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(n.uniform4ui(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(de(e,t))return;n.uniform4uiv(this.addr,t),pe(e,t)}}function F_(n,t,e){const i=this.cache,r=e.allocateTextureUnit();i[0]!==r&&(n.uniform1i(this.addr,r),i[0]=r);let s;this.type===n.SAMPLER_2D_SHADOW?(lc.compareFunction=Cu,s=lc):s=Gu,e.setTexture2D(t||s,r)}function O_(n,t,e){const i=this.cache,r=e.allocateTextureUnit();i[0]!==r&&(n.uniform1i(this.addr,r),i[0]=r),e.setTexture3D(t||Xu,r)}function B_(n,t,e){const i=this.cache,r=e.allocateTextureUnit();i[0]!==r&&(n.uniform1i(this.addr,r),i[0]=r),e.setTextureCube(t||qu,r)}function z_(n,t,e){const i=this.cache,r=e.allocateTextureUnit();i[0]!==r&&(n.uniform1i(this.addr,r),i[0]=r),e.setTexture2DArray(t||Wu,r)}function k_(n){switch(n){case 5126:return y_;case 35664:return S_;case 35665:return E_;case 35666:return T_;case 35674:return w_;case 35675:return b_;case 35676:return A_;case 5124:case 35670:return R_;case 35667:case 35671:return C_;case 35668:case 35672:return P_;case 35669:case 35673:return D_;case 5125:return L_;case 36294:return I_;case 36295:return U_;case 36296:return N_;case 35678:case 36198:case 36298:case 36306:case 35682:return F_;case 35679:case 36299:case 36307:return O_;case 35680:case 36300:case 36308:case 36293:return B_;case 36289:case 36303:case 36311:case 36292:return z_}}function H_(n,t){n.uniform1fv(this.addr,t)}function V_(n,t){const e=Ji(t,this.size,2);n.uniform2fv(this.addr,e)}function G_(n,t){const e=Ji(t,this.size,3);n.uniform3fv(this.addr,e)}function W_(n,t){const e=Ji(t,this.size,4);n.uniform4fv(this.addr,e)}function X_(n,t){const e=Ji(t,this.size,4);n.uniformMatrix2fv(this.addr,!1,e)}function q_(n,t){const e=Ji(t,this.size,9);n.uniformMatrix3fv(this.addr,!1,e)}function Y_(n,t){const e=Ji(t,this.size,16);n.uniformMatrix4fv(this.addr,!1,e)}function $_(n,t){n.uniform1iv(this.addr,t)}function Z_(n,t){n.uniform2iv(this.addr,t)}function K_(n,t){n.uniform3iv(this.addr,t)}function j_(n,t){n.uniform4iv(this.addr,t)}function J_(n,t){n.uniform1uiv(this.addr,t)}function Q_(n,t){n.uniform2uiv(this.addr,t)}function tg(n,t){n.uniform3uiv(this.addr,t)}function eg(n,t){n.uniform4uiv(this.addr,t)}function ng(n,t,e){const i=this.cache,r=t.length,s=js(e,r);de(i,s)||(n.uniform1iv(this.addr,s),pe(i,s));for(let o=0;o!==r;++o)e.setTexture2D(t[o]||Gu,s[o])}function ig(n,t,e){const i=this.cache,r=t.length,s=js(e,r);de(i,s)||(n.uniform1iv(this.addr,s),pe(i,s));for(let o=0;o!==r;++o)e.setTexture3D(t[o]||Xu,s[o])}function rg(n,t,e){const i=this.cache,r=t.length,s=js(e,r);de(i,s)||(n.uniform1iv(this.addr,s),pe(i,s));for(let o=0;o!==r;++o)e.setTextureCube(t[o]||qu,s[o])}function sg(n,t,e){const i=this.cache,r=t.length,s=js(e,r);de(i,s)||(n.uniform1iv(this.addr,s),pe(i,s));for(let o=0;o!==r;++o)e.setTexture2DArray(t[o]||Wu,s[o])}function og(n){switch(n){case 5126:return H_;case 35664:return V_;case 35665:return G_;case 35666:return W_;case 35674:return X_;case 35675:return q_;case 35676:return Y_;case 5124:case 35670:return $_;case 35667:case 35671:return Z_;case 35668:case 35672:return K_;case 35669:case 35673:return j_;case 5125:return J_;case 36294:return Q_;case 36295:return tg;case 36296:return eg;case 35678:case 36198:case 36298:case 36306:case 35682:return ng;case 35679:case 36299:case 36307:return ig;case 35680:case 36300:case 36308:case 36293:return rg;case 36289:case 36303:case 36311:case 36292:return sg}}class ag{constructor(t,e,i){this.id=t,this.addr=i,this.cache=[],this.type=e.type,this.setValue=k_(e.type)}}class lg{constructor(t,e,i){this.id=t,this.addr=i,this.cache=[],this.type=e.type,this.size=e.size,this.setValue=og(e.type)}}class cg{constructor(t){this.id=t,this.seq=[],this.map={}}setValue(t,e,i){const r=this.seq;for(let s=0,o=r.length;s!==o;++s){const a=r[s];a.setValue(t,e[a.id],i)}}}const Io=/(\w+)(\])?(\[|\.)?/g;function pc(n,t){n.seq.push(t),n.map[t.id]=t}function ug(n,t,e){const i=n.name,r=i.length;for(Io.lastIndex=0;;){const s=Io.exec(i),o=Io.lastIndex;let a=s[1];const c=s[2]==="]",l=s[3];if(c&&(a=a|0),l===void 0||l==="["&&o+2===r){pc(e,l===void 0?new ag(a,n,t):new lg(a,n,t));break}else{let h=e.map[a];h===void 0&&(h=new cg(a),pc(e,h)),e=h}}}class gs{constructor(t,e){this.seq=[],this.map={};const i=t.getProgramParameter(e,t.ACTIVE_UNIFORMS);for(let r=0;r<i;++r){const s=t.getActiveUniform(e,r),o=t.getUniformLocation(e,s.name);ug(s,o,this)}}setValue(t,e,i,r){const s=this.map[e];s!==void 0&&s.setValue(t,i,r)}setOptional(t,e,i){const r=e[i];r!==void 0&&this.setValue(t,i,r)}static upload(t,e,i,r){for(let s=0,o=e.length;s!==o;++s){const a=e[s],c=i[a.id];c.needsUpdate!==!1&&a.setValue(t,c.value,r)}}static seqWithValue(t,e){const i=[];for(let r=0,s=t.length;r!==s;++r){const o=t[r];o.id in e&&i.push(o)}return i}}function mc(n,t,e){const i=n.createShader(t);return n.shaderSource(i,e),n.compileShader(i),i}const hg=37297;let fg=0;function dg(n,t){const e=n.split(`
`),i=[],r=Math.max(t-6,0),s=Math.min(t+6,e.length);for(let o=r;o<s;o++){const a=o+1;i.push(`${a===t?">":" "} ${a}: ${e[o]}`)}return i.join(`
`)}const _c=new Ht;function pg(n){jt._getMatrix(_c,jt.workingColorSpace,n);const t=`mat3( ${_c.elements.map(e=>e.toFixed(4))} )`;switch(jt.getTransfer(n)){case ws:return[t,"LinearTransferOETF"];case te:return[t,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space: ",n),[t,"LinearTransferOETF"]}}function gc(n,t,e){const i=n.getShaderParameter(t,n.COMPILE_STATUS),r=n.getShaderInfoLog(t).trim();if(i&&r==="")return"";const s=/ERROR: 0:(\d+)/.exec(r);if(s){const o=parseInt(s[1]);return e.toUpperCase()+`

`+r+`

`+dg(n.getShaderSource(t),o)}else return r}function mg(n,t){const e=pg(t);return[`vec4 ${n}( vec4 value ) {`,`	return ${e[1]}( vec4( value.rgb * ${e[0]}, value.a ) );`,"}"].join(`
`)}function _g(n,t){let e;switch(t){case gf:e="Linear";break;case vf:e="Reinhard";break;case xf:e="Cineon";break;case Mf:e="ACESFilmic";break;case Sf:e="AgX";break;case Ef:e="Neutral";break;case yf:e="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",t),e="Linear"}return"vec3 "+n+"( vec3 color ) { return "+e+"ToneMapping( color ); }"}const rs=new F;function gg(){jt.getLuminanceCoefficients(rs);const n=rs.x.toFixed(4),t=rs.y.toFixed(4),e=rs.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${n}, ${t}, ${e} );`,"	return dot( weights, rgb );","}"].join(`
`)}function vg(n){return[n.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",n.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(fr).join(`
`)}function xg(n){const t=[];for(const e in n){const i=n[e];i!==!1&&t.push("#define "+e+" "+i)}return t.join(`
`)}function Mg(n,t){const e={},i=n.getProgramParameter(t,n.ACTIVE_ATTRIBUTES);for(let r=0;r<i;r++){const s=n.getActiveAttrib(t,r),o=s.name;let a=1;s.type===n.FLOAT_MAT2&&(a=2),s.type===n.FLOAT_MAT3&&(a=3),s.type===n.FLOAT_MAT4&&(a=4),e[o]={type:s.type,location:n.getAttribLocation(t,o),locationSize:a}}return e}function fr(n){return n!==""}function vc(n,t){const e=t.numSpotLightShadows+t.numSpotLightMaps-t.numSpotLightShadowsWithMaps;return n.replace(/NUM_DIR_LIGHTS/g,t.numDirLights).replace(/NUM_SPOT_LIGHTS/g,t.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,t.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,e).replace(/NUM_RECT_AREA_LIGHTS/g,t.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,t.numPointLights).replace(/NUM_HEMI_LIGHTS/g,t.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,t.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,t.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,t.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,t.numPointLightShadows)}function xc(n,t){return n.replace(/NUM_CLIPPING_PLANES/g,t.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,t.numClippingPlanes-t.numClipIntersection)}const yg=/^[ \t]*#include +<([\w\d./]+)>/gm;function Pa(n){return n.replace(yg,Eg)}const Sg=new Map;function Eg(n,t){let e=Vt[t];if(e===void 0){const i=Sg.get(t);if(i!==void 0)e=Vt[i],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',t,i);else throw new Error("Can not resolve #include <"+t+">")}return Pa(e)}const Tg=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function Mc(n){return n.replace(Tg,wg)}function wg(n,t,e,i){let r="";for(let s=parseInt(t);s<parseInt(e);s++)r+=i.replace(/\[\s*i\s*\]/g,"[ "+s+" ]").replace(/UNROLLED_LOOP_INDEX/g,s);return r}function yc(n){let t=`precision ${n.precision} float;
...
#define LOW_PRECISION`),t}function bg(n){let t="SHADOWMAP_TYPE_BASIC";return n.shadowMapType===xu?t="SHADOWMAP_TYPE_PCF":n.shadowMapType===Zh?t="SHADOWMAP_TYPE_PCF_SOFT":n.shadowMapType===vn&&(t="SHADOWMAP_TYPE_VSM"),t}function Ag(n){let t="ENVMAP_TYPE_CUBE";if(n.envMap)switch(n.envMapMode){case Hi:case Vi:t="ENVMAP_TYPE_CUBE";break;case $s:t="ENVMAP_TYPE_CUBE_UV";break}return t}function Rg(n){let t="ENVMAP_MODE_REFLECTION";if(n.envMap)switch(n.envMapMode){case Vi:t="ENVMAP_MODE_REFRACTION";break}return t}function Cg(n){let t="ENVMAP_BLENDING_NONE";if(n.envMap)switch(n.combine){case Ka:t="ENVMAP_BLENDING_MULTIPLY";break;case mf:t="ENVMAP_BLENDING_MIX";break;case _f:t="ENVMAP_BLENDING_ADD";break}return t}function Pg(n){const t=n.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,i=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),7*16)),texelHeight:i,maxMip:e}}function Dg(n,t,e,i){const r=n.getContext(),s=e.defines;let o=e.vertexShader,a=e.fragmentShader;const c=bg(e),l=Ag(e),u=Rg(e),h=Cg(e),f=Pg(e),p=vg(e),_=xg(s),v=r.createProgram();let m,d,T=e.glslVersion?"#version "+e.glslVersion+`
...
`)}function l(h){return h.map(u).join(n)}function u(h){return h==null?"":h instanceof Date?wy(h):t.test(h+="")?'"'+h.replace(/"/g,'""')+'"':h}return{parse:i,parseRows:r,format:o,formatBody:a,formatRows:c,formatRow:l,formatValue:u}}var Ay=by(","),Ry=Ay.parse;function Cy(n){if(!n.ok)throw new Error(n.status+" "+n.statusText);return n.text()}function Py(n,t){return fetch(n,t).then(Cy)}function Dy(n){return function(t,e,i){return arguments.length===2&&typeof e=="function"&&(i=e,e=void 0),Py(t,e).then(function(r){return n(r,i)})}}var cs=Dy(Ry);function Ly(n){if(!n.ok)throw new Error(n.status+" "+n.statusText);if(!(n.status===204||n.status===205))return n.json()}function Iy(n,t){return fetch(n,t).then(Ly)}function Uy(n){return Math.abs(n=Math.round(n))>=1e21?n.toLocaleString("en").replace(/,/g,""):n.toString(10)}function zs(n,t){if((e=(n=t?n.toExponential(t-1):n.toExponential()).indexOf("e"))<0)return null;var e,i=n.slice(0,e);return[i.length>1?i[0]+i.slice(2):i,+n.slice(e+1)]}function $i(n){return n=zs(Math.abs(n)),n?n[1]:NaN}function Ny(n,t){return function(e,i){for(var r=e.length,s=[],o=0,a=n[0],c=0;r>0&&a>0&&(c+a+1>i&&(a=Math.max(1,i-c)),s.push(e.substring(r-=a,r+a)),!((c+=a+1)>i));)a=n[o=(o+1)%n.length];return s.reverse().join(t)}}function Fy(n){return function(t){return t.replace(/[0-9]/g,function(e){return n[+e]})}}var Oy=/^(?:(.)?([<>=^]))?([+\-( ])?([$#])?(0)?(\d+)?(,)?(\.\d+)?(~)?([a-z%])?$/i;function ks(n){if(!(t=Oy.exec(n)))throw new Error("invalid format: "+n);var t;return new xl({fill:t[1],align:t[2],sign:t[3],symbol:t[4],zero:t[5],width:t[6],comma:t[7],precision:t[8]&&t[8].slice(1),trim:t[9],type:t[10]})}ks.prototype=xl.prototype;function xl(n){this.fill=n.fill===void 0?" ":n.fill+"",this.align=n.align===void 0?">":n.align+"",this.sign=n.sign===void 0?"-":n.sign+"",this.symbol=n.symbol===void 0?"":n.symbol+"",this.zero=!!n.zero,this.width=n.width===void 0?void 0:+n.width,this.comma=!!n.comma,this.precision=n.precision===void 0?void 0:+n.precision,this.trim=!!n.trim,this.type=n.type===void 0?"":n.type+""}xl.prototype.toString=function(){return this.fill+this.align+this.sign+this.symbol+(this.zero?"0":"")+(this.width===void 0?"":Math.max(1,this.width|0))+(this.comma?",":"")+(this.precision===void 0?"":"."+Math.max(0,this.precision|0))+(this.trim?"~":"")+this.type};function By(n){t:for(var t=n.length,e=1,i=-1,r;e<t;++e)switch(n[e]){case".":i=r=e;break;case"0":i===0&&(i=e),r=e;break;default:if(!+n[e])break t;i>0&&(i=0);break}return i>0?n.slice(0,i)+n.slice(r+1):n}var Th;function zy(n,t){var e=zs(n,t);if(!e)return n+"";var i=e[0],r=e[1],s=r-(Th=Math.max(-8,Math.min(8,Math.floor(r/3)))*3)+1,o=i.length;return s===o?i:s>o?i+new Array(s-o+1).join("0"):s>0?i.slice(0,s)+"."+i.slice(s):"0."+new Array(1-s).join("0")+zs(n,Math.max(0,t+s-1))[0]}function jc(n,t){var e=zs(n,t);if(!e)return n+"";var i=e[0],r=e[1];return r<0?"0."+new Array(-r).join("0")+i:i.length>r+1?i.slice(0,r+1)+"."+i.slice(r+1):i+new Array(r-i.length+2).join("0")}const Jc={"%":(n,t)=>(n*100).toFixed(t),b:n=>Math.round(n).toString(2),c:n=>n+"",d:Uy,e:(n,t)=>n.toExponential(t),f:(n,t)=>n.toFixed(t),g:(n,t)=>n.toPrecision(t),o:n=>Math.round(n).toString(8),p:(n,t)=>jc(n*100,t),r:jc,s:zy,X:n=>Math.round(n).toString(16).toUpperCase(),x:n=>Math.round(n).toString(16)};function Qc(n){return n}var tu=Array.prototype.map,eu=["y","z","a","f","p","n","µ","m","","k","M","G","T","P","E","Z","Y"];function ky(n){var t=n.grouping===void 0||n.thousands===void 0?Qc:Ny(tu.call(n.grouping,Number),n.thousands+""),e=n.currency===void 0?"":n.currency[0]+"",i=n.currency===void 0?"":n.currency[1]+"",r=n.decimal===void 0?".":n.decimal+"",s=n.numerals===void 0?Qc:Fy(tu.call(n.numerals,String)),o=n.percent===void 0?"%":n.percent+"",a=n.minus===void 0?"−":n.minus+"",c=n.nan===void 0?"NaN":n.nan+"";function l(h){h=ks(h);var f=h.fill,p=h.align,_=h.sign,v=h.symbol,m=h.zero,d=h.width,T=h.comma,w=h.precision,S=h.trim,D=h.type;D==="n"?(T=!0,D="g"):Jc[D]||(w===void 0&&(w=12),S=!0,D="g"),(m||f==="0"&&p==="=")&&(m=!0,f="0",p="=");var P=v==="$"?e:v==="#"&&/[boxX]/.test(D)?"0"+D.toLowerCase():"",A=v==="$"?i:/[%p]/.test(D)?o:"",C=Jc[D],y=/[defgprs%]/.test(D);w=w===void 0?6:/[gprs]/.test(D)?Math.max(1,Math.min(21,w)):Math.max(0,Math.min(20,w));function x(b){var z=P,O=A,$,j,Z;if(D==="c")O=C(b)+O,b="";else{b=+b;var et=b<0||1/b<0;if(b=isNaN(b)?c:C(Math.abs(b),w),S&&(b=By(b)),et&&+b==0&&_!=="+"&&(et=!1),z=(et?_==="("?_:a:_==="-"||_==="("?"":_)+z,O=(D==="s"?eu[8+Th/3]:"")+O+(et&&_==="("?")":""),y){for($=-1,j=b.length;++$<j;)if(Z=b.charCodeAt($),48>Z||Z>57){O=(Z===46?r+b.slice($+1):b.slice($))+O,b=b.slice(0,$);break}}}T&&!m&&(b=t(b,1/0));var X=z.length+b.length+O.length,W=X<d?new Array(d-X+1).join(f):"";switch(T&&m&&(b=t(W+b,W.length?d-O.length:1/0),W=""),p){case"<":b=z+b+O+W;break;case"=":b=z+W+b+O;break;case"^":b=W.slice(0,X=W.length>>1)+z+b+O+W.slice(X);break;default:b=W+z+b+O;break}return s(b)}return x.toString=function(){return h+""},x}function u(h,f){var p=l((h=ks(h),h.type="f",h)),_=Math.max(-8,Math.min(8,Math.floor($i(f)/3)))*3,v=Math.pow(10,-_),m=eu[8+_/3];return function(d){return p(v*d)+m}}return{format:l,formatPrefix:u}}var us,wh,bh;Hy({thousands:",",grouping:[3],currency:["$",""]});function Hy(n){return us=ky(n),wh=us.format,bh=us.formatPrefix,us}function Vy(n){return Math.max(0,-$i(Math.abs(n)))}function Gy(n,t){return Math.max(0,Math.max(-8,Math.min(8,Math.floor($i(t)/3)))*3-$i(Math.abs(n)))}function Wy(n,t){return n=Math.abs(n),t=Math.abs(t)-n,Math.max(0,$i(t)-$i(n))+1}var Xy=Math.PI,qy=Xy*2,Yy=Math.abs,Ml=Math.sqrt;function je(){}function Hs(n,t){n&&iu.hasOwnProperty(n.type)&&iu[n.type](n,t)}var nu={Feature:function(n,t){Hs(n.geometry,t)},FeatureCollection:function(n,t){for(var e=n.features,i=-1,r=e.length;++i<r;)Hs(e[i].geometry,t)}},iu={Sphere:function(n,t){t.sphere()},Point:function(n,t){n=n.coordinates,t.point(n[0],n[1],n[2])},MultiPoint:function(n,t){for(var e=n.coordinates,i=-1,r=e.length;++i<r;)n=e[i],t.point(n[0],n[1],n[2])},LineString:function(n,t){Ba(n.coordinates,t,0)},MultiLineString:function(n,t){for(var e=n.coordinates,i=-1,r=e.length;++i<r;)Ba(e[i],t,0)},Polygon:function(n,t){ru(n.coordinates,t)},MultiPolygon:function(n,t){for(var e=n.coordinates,i=-1,r=e.length;++i<r;)ru(e[i],t)},GeometryCollection:function(n,t){for(var e=n.geometries,i=-1,r=e.length;++i<r;)Hs(e[i],t)}};function Ba(n,t,e){var i=-1,r=n.length-e,s;for(t.lineStart();++i<r;)s=n[i],t.point(s[0],s[1],s[2]);t.lineEnd()}function ru(n,t){var e=-1,i=n.length;for(t.polygonStart();++e<i;)Ba(n[e],t,1);t.polygonEnd()}function cr(n,t){n&&nu.hasOwnProperty(n.type)?nu[n.type](n,t):Hs(n,t)}const $y=n=>n;var Ho=new Xi,za=new Xi,Ah,Rh,ka,Ha,xn={point:je,lineStart:je,lineEnd:je,polygonStart:function(){xn.lineStart=Zy,xn.lineEnd=jy},polygonEnd:function(){xn.lineStart=xn.lineEnd=xn.point=je,Ho.add(Yy(za)),za=new Xi},result:function(){var n=Ho/2;return Ho=new Xi,n}};function Zy(){xn.point=Ky}function Ky(n,t){xn.point=Ch,Ah=ka=n,Rh=Ha=t}function Ch(n,t){za.add(Ha*n-ka*t),ka=n,Ha=t}function jy(){Ch(Ah,Rh)}var Zi=1/0,Vs=Zi,Rr=-Zi,Gs=Rr,su={point:Jy,lineStart:je,lineEnd:je,polygonStart:je,polygonEnd:je,result:function(){var n=[[Zi,Vs],[Rr,Gs]];return Rr=Gs=-(Vs=Zi=1/0),n}};function Jy(n,t){n<Zi&&(Zi=n),n>Rr&&(Rr=n),t<Vs&&(Vs=t),t>Gs&&(Gs=t)}var Va=0,Ga=0,mr=0,Ws=0,Xs=0,Li=0,Wa=0,Xa=0,_r=0,Ph,Dh,on,an,ze={point:li,lineStart:ou,lineEnd:au,polygonStart:function(){ze.lineStart=eS,ze.lineEnd=nS},polygonEnd:function(){ze.point=li,ze.lineStart=ou,ze.lineEnd=au},result:function(){var n=_r?[Wa/_r,Xa/_r]:Li?[Ws/Li,Xs/Li]:mr?[Va/mr,Ga/mr]:[NaN,NaN];return Va=Ga=mr=Ws=Xs=Li=Wa=Xa=_r=0,n}};function li(n,t){Va+=n,Ga+=t,++mr}function ou(){ze.point=Qy}function Qy(n,t){ze.point=tS,li(on=n,an=t)}function tS(n,t){var e=n-on,i=t-an,r=Ml(e*e+i*i);Ws+=r*(on+n)/2,Xs+=r*(an+t)/2,Li+=r,li(on=n,an=t)}function au(){ze.point=li}function eS(){ze.point=iS}function nS(){Lh(Ph,Dh)}function iS(n,t){ze.point=Lh,li(Ph=on=n,Dh=an=t)}function Lh(n,t){var e=n-on,i=t-an,r=Ml(e*e+i*i);Ws+=r*(on+n)/2,Xs+=r*(an+t)/2,Li+=r,r=an*n-on*t,Wa+=r*(on+n),Xa+=r*(an+t),_r+=r*3,li(on=n,an=t)}function Ih(n){this._context=n}Ih.prototype={_radius:4.5,pointRadius:function(n){return this._radius=n,this},polygonStart:function(){this._line=0},polygonEnd:function(){this._line=NaN},lineStart:function(){this._point=0},lineEnd:function(){this._line===0&&this._context.closePath(),this._point=NaN},point:function(n,t){switch(this._point){case 0:{this._context.moveTo(n,t),this._point=1;break}case 1:{this._context.lineTo(n,t);break}default:{this._context.moveTo(n+this._radius,t),this._context.arc(n,t,this._radius,0,qy);break}}},result:je};var qa=new Xi,Vo,Uh,Nh,gr,vr,Cr={point:je,lineStart:function(){Cr.point=rS},lineEnd:function(){Vo&&Fh(Uh,Nh),Cr.point=je},polygonStart:function(){Vo=!0},polygonEnd:function(){Vo=null},result:function(){var n=+qa;return qa=new Xi,n}};function rS(n,t){Cr.point=Fh,Uh=gr=n,Nh=vr=t}function Fh(n,t){gr-=n,vr-=t,qa.add(Ml(gr*gr+vr*vr)),gr=n,vr=t}let lu,qs,cu,uu;class hu{constructor(t){this._append=t==null?Oh:sS(t),this._radius=4.5,this._=""}pointRadius(t){return this._radius=+t,this}polygonStart(){this._line=0}polygonEnd(){this._line=NaN}lineStart(){this._point=0}lineEnd(){this._line===0&&(this._+="Z"),this._point=NaN}point(t,e){switch(this._point){case 0:{this._append`M${t},${e}`,this._point=1;break}case 1:{this._append`L${t},${e}`;break}default:{if(this._append`M${t},${e}`,this._radius!==cu||this._append!==qs){const i=this._radius,r=this._;this._="",this._append`m0,${i}a${i},${i} 0 1,1 0,${-2*i}a${i},${i} 0 1,1 0,${2*i}z`,cu=i,qs=this._append,uu=this._,this._=r}this._+=uu;break}}}result(){const t=this._;return this._="",t.length?t:null}}function Oh(n){let t=1;this._+=n[0];for(const e=n.length;t<e;++t)this._+=arguments[t]+n[t]}function sS(n){const t=Math.floor(n);if(!(t>=0))throw new RangeError(`invalid digits: ${n}`);if(t>15)return Oh;if(t!==lu){const e=10**t;lu=t,qs=function(r){let s=1;this._+=r[0];for(const o=r.length;s<o;++s)this._+=Math.round(arguments[s]*e)/e+r[s]}}return qs}function Bh(n,t){let e=3,i=4.5,r,s;function o(a){return a&&(typeof i=="function"&&s.pointRadius(+i.apply(this,arguments)),cr(a,r(s))),s.result()}return o.area=function(a){return cr(a,r(xn)),xn.result()},o.measure=function(a){return cr(a,r(Cr)),Cr.result()},o.bounds=function(a){return cr(a,r(su)),su.result()},o.centroid=function(a){return cr(a,r(ze)),ze.result()},o.projection=function(a){return arguments.length?(r=a==null?(n=null,$y):(n=a).stream,o):n},o.context=function(a){return arguments.length?(s=a==null?(t=null,new hu(e)):new Ih(t=a),typeof i!="function"&&s.pointRadius(i),o):t},o.pointRadius=function(a){return arguments.length?(i=typeof a=="function"?a:(s.pointRadius(+a),+a),o):i},o.digits=function(a){if(!arguments.length)return e;if(a==null)e=null;else{const c=Math.floor(a);if(!(c>=0))throw new RangeError(`invalid digits: ${a}`);e=c}return t===null&&(s=new hu(e)),o},o.projection(n).digits(e).context(t)}function oS(n,t,e){return(t[0]-n[0])*(e[1]-n[1])-(t[1]-n[1])*(e[0]-n[0])}function aS(n,t){return n[0]-t[0]||n[1]-t[1]}function fu(n){const t=n.length,e=[0,1];let i=2,r;for(r=2;r<t;++r){for(;i>1&&oS(n[e[i-2]],n[e[i-1]],n[r])<=0;)--i;e[i++]=r}return e.slice(0,i)}function du(n){if((e=n.length)<3)return null;var t,e,i=new Array(e),r=new Array(e);for(t=0;t<e;++t)i[t]=[+n[t][0],+n[t][1],t];for(i.sort(aS),t=0;t<e;++t)r[t]=[i[t][0],-i[t][1]];var s=fu(i),o=fu(r),a=o[0]===s[0],c=o[o.length-1]===s[s.length-1],l=[];for(t=s.length-1;t>=0;--t)l.push(n[i[s[t]][2]]);for(t=+a;t<o.length-c;++t)l.push(n[i[o[t]][2]]);return l}function lS(n,t){switch(arguments.length){case 0:break;case 1:this.range(n);break;default:this.range(t).domain(n);break}return this}function cS(n){return function(){return n}}function uS(n){return+n}var pu=[0,1];function Ii(n){return n}function Ya(n,t){return(t-=n=+n)?function(e){return(e-n)/t}:cS(isNaN(t)?NaN:.5)}function hS(n,t){var e;return n>t&&(e=n,n=t,t=e),function(i){return Math.max(n,Math.min(t,i))}}function fS(n,t,e){var i=n[0],r=n[1],s=t[0],o=t[1];return r<i?(i=Ya(r,i),s=e(o,s)):(i=Ya(i,r),s=e(s,o)),function(a){return s(i(a))}}function dS(n,t,e){var i=Math.min(n.length,t.length)-1,r=new Array(i),s=new Array(i),o=-1;for(n[i]<n[0]&&(n=n.slice().reverse(),t=t.slice().reverse());++o<i;)r[o]=Ya(n[o],n[o+1]),s[o]=e(t[o],t[o+1]);return function(a){var c=T0(n,a,1,i)-1;return s[c](r[c](a))}}function pS(n,t){return t.domain(n.domain()).range(n.range()).interpolate(n.interpolate()).clamp(n.clamp()).unknown(n.unknown())}function mS(){var n=pu,t=pu,e=ml,i,r,s,o=Ii,a,c,l;function u(){var f=Math.min(n.length,t.length);return o!==Ii&&(o=hS(n[0],n[f-1])),a=f>2?dS:fS,c=l=null,h}function h(f){return f==null||isNaN(f=+f)?s:(c||(c=a(n.map(i),t,e)))(i(o(f)))}return h.invert=function(f){return o(r((l||(l=a(t,n.map(i),Ye)))(f)))},h.domain=function(f){return arguments.length?(n=Array.from(f,uS),u()):n.slice()},h.range=function(f){return arguments.length?(t=Array.from(f),u()):t.slice()},h.rangeRound=function(f){return t=Array.from(f),e=Xx,u()},h.clamp=function(f){return arguments.length?(o=f?!0:Ii,u()):o!==Ii},h.interpolate=function(f){return arguments.length?(e=f,u()):e},h.unknown=function(f){return arguments.length?(s=f,h):s},function(f,p){return i=f,r=p,u()}}function _S(){return mS()(Ii,Ii)}function gS(n,t,e,i){var r=z0(n,t,e),s;switch(i=ks(i??",f"),i.type){case"s":{var o=Math.max(Math.abs(n),Math.abs(t));return i.precision==null&&!isNaN(s=Gy(r,o))&&(i.precision=s),bh(i,o)}case"":case"e":case"g":case"p":case"r":{i.precision==null&&!isNaN(s=Wy(r,Math.max(Math.abs(n),Math.abs(t))))&&(i.precision=s-(i.type==="e"));break}case"f":case"%":{i.precision==null&&!isNaN(s=Vy(r))&&(i.precision=s-(i.type==="%")*2);break}}return wh(i)}function vS(n){var t=n.domain;return n.ticks=function(e){var i=t();return ul(i[0],i[i.length-1],e??10)},n.tickFormat=function(e,i){var r=t();return gS(r[0],r[r.length-1],e??10,i)},n.nice=function(e){e==null&&(e=10);var i=t(),r=0,s=i.length-1,o=i[r],a=i[s],c,l,u=10;for(a<o&&(l=o,o=a,a=l,l=r,r=s,s=l);u-- >0;){if(l=Ds(o,a,e),l===c)return i[r]=o,i[s]=a,t(i);if(l>0)o=Math.floor(o/l)*l,a=Math.ceil(a/l)*l;else if(l<0)o=Math.ceil(o*l)/l,a=Math.floor(a*l)/l;else break;c=l}return n},n}function $a(){var n=_S();return n.copy=function(){return pS(n,$a())},lS.apply(n,arguments),vS(n)}function xr(n,t,e){this.k=n,this.x=t,this.y=e}xr.prototype={constructor:xr,scale:function(n){return n===1?this:new xr(this.k*n,this.x,this.y)},translate:function(n,t){return n===0&t===0?this:new xr(this.k,this.x+this.k*n,this.y+this.k*t)},apply:function(n){return[n[0]*this.k+this.x,n[1]*this.k+this.y]},applyX:function(n){return n*this.k+this.x},applyY:function(n){return n*this.k+this.y},invert:function(n){return[(n[0]-this.x)/this.k,(n[1]-this.y)/this.k]},invertX:function(n){return(n-this.x)/this.k},invertY:function(n){return(n-this.y)/this.k},rescaleX:function(n){return n.copy().domain(n.range().map(this.invertX,this).map(n.invert,n))},rescaleY:function(n){return n.copy().domain(n.range().map(this.invertY,this).map(n.invert,n))},toString:function(){return"translate("+this.x+","+this.y+") scale("+this.k+")"}};xr.prototype;const Kn="/EleVis/",mu="mesh_frames_",Ss=.034,ur=[["elephant_Trunk4_bone","elephant_Snout_bone"],["elephant_Trunk2_bone","elephant_Trunk4_bone"],["elephant_Snout_bone","elephant_Head_bone"],["elephant_Head_bone","elephant_Neck_bone"],["elephant_Neck_bone","elephant_Spine3_bone"],["elephant_Spine3_bone","elephant_Spine2_bone"],["elephant_Spine2_bone","elephant_Pelvis_bone"],["elephant_Pelvis_bone","elephant_Tail2_bone"],["elephant_Head_bone","elephant_r_Ear1_bone"],["elephant_r_Ear1_bone","elephant_r_Ear4_bone"],["elephant_Head_bone","elephant_l_Ear1_bone"],["elephant_l_Ear1_bone","elephant_l_Ear4_bone"],["elephant_Neck_bone","elephant_r_Humerus_bone"],["elephant_Neck_bone","elephant_l_Humerus_bone"],["elephant_Pelvis_bone","elephant_r_Femur_bone"],["elephant_Pelvis_bone","elephant_l_Femur_bone"]];let ti=null,_u=0,Mr=10,Ys=()=>{},Es=null,Ts=[];function xS(){if(document.getElementById("dashboard"))return;const n=document.createElement("div");n.id="dashboard",n.style.cssText=`
  ...
  `,i.appendChild(r);const s=document.body;n.appendChild(e),n.appendChild(i),s.appendChild(n)}function MS(n,t,e,i,r,s){const o=r-e,a=s-i;if(o===0&&a===0)return Math.hypot(n-e,t-i);const c=((n-e)*o+(t-i)*a)/(o*o+a*a),l=Math.max(0,Math.min(1,c)),u=e+l*o,h=i+l*a;return Math.hypot(n-u,t-h)}function yS(n,t=.3,e=1){const i=new Map;return n.forEach(s=>{const o=+s.centroidA_x,a=+s.centroidA_z;if(!isFinite(o)||!isFinite(a))return;const c=`${o/t|0},${a/t|0}`;i.has(c)||i.set(c,[]),i.get(c).push({cx:o,cz:a})}),Array.from(i.values()).filter(s=>s.length>=e).map(s=>{const o=s.reduce((a,c)=>({cx:a.cx+c.cx,cz:a.cz+c.cz}),{cx:0,cz:0});return{cx:o.cx/s.length,cz:o.cz/s.length}})}function SS(n,t,e,i,r=1e3,s=1e3){const o=Bi("#viz").selectAll("g#layer-heatmap").data([null]).join("g").attr("id","layer-heatmap").lower();o.selectAll("*").remove();const a=n.map(u=>({x:+u.contact_x,z:+u.contact_z||+u.contact_y})).filter(u=>isFinite(u.x)&&isFinite(u.z));if(!a.length){console.warn("No collision coords");return}const c=Sh().x(u=>e(u.x)).y(u=>i(u.z)).size([r,s]).bandwidth(30)(a),l=ei(c,u=>u.value);o.selectAll("path").data(c).enter().append("path").attr("d",Bh()).attr("fill","red").attr("fill-opacity",u=>u.value/l).attr("stroke","none")}function ES(n,t,e,i=1e3,r=1e3){const s=Bi("#viz").selectAll("g#layer-dwell-heatmap").data([null]).join("g").attr("id","layer-dwell-heatmap").lower();if(s.selectAll("*").remove(),!n?.length){console.warn("No dwell zones provided.");return}const o=n.map(({cx:l,cz:u})=>({x:+l,z:+u})).filter(l=>isFinite(l.x)&&isFinite(l.z));if(!o.length)return;const a=Sh().x(l=>t(l.x)).y(l=>e(l.z)).size([i,r]).bandwidth(30)(o),c=ei(a,l=>l.value);s.selectAll("path").data(a).enter().append("path").attr("d",Bh()).attr("fill","purple").attr("fill-opacity",l=>l.value/c).attr("stroke","none")}document.addEventListener("DOMContentLoaded",()=>{xS();let n=document.getElementById("overlay-line-layer");n||(n=document.createElementNS("http://www.w3.org/2000/svg","svg"),n.id="overlay-line-layer",n.setAttribute("width","100%"),n.setAttribute("height","100%"),Object.assign(n.style,{position:"absolute",inset:0,pointerEvents:"none",overflow:"visible",background:"transparent",zIndex:9998}),document.body.appendChild(n));const t=Object.assign({"/public/skeleton_tracking_20250626_094312.csv":()=>wl(()=>import("./skeleton_tracking_20250626_094312-mk7Ol7QD.js"),[]).then(u=>u.default),"/public/skeleton_tracking_20250701_113425.csv":()=>wl(()=>import("./skeleton_tracking_20250701_113425-CZfE7OGE.js"),[]).then(u=>u.default)}),e=Object.keys(t).map(u=>{const h=u.match(/skeleton_tracking_(\d{8}_\d{6})\.csv$/);return h?h[1]:null}).filter(Boolean).sort().reverse();e.length||(alert("No datasets found in /public"),console.warn("datasetUrls",t));const i=document.createElement("select");i.id="datasetSelect",i.style="margin:10px 0;padding:6px;font-size:14px;",e.forEach(u=>{const h=document.createElement("option");h.value=u,h.textContent=u,i.appendChild(h)}),document.body.insertBefore(i,document.getElementById("dashboard")),i.addEventListener("change",()=>gu(i.value)),e.length&&gu(e[0]);const s=1/.1,o=document.createElement("label");o.innerHTML='Dwell Threshold (s): <span id="dwellValue">1.0</span>',o.style="margin-left:20px;margin-right:5px;font-size:14px;",i.after(o);const a=document.createElement("input");a.type="range",a.min=.5,a.max=10,a.value=3.5,a.step=.1,a.style="vertical-align:middle",a.disabled=!0,o.appendChild(a),a.oninput=()=>{const u=+a.value;if(document.getElementById("dwellValue").textContent=u.toFixed(1),Mr=Math.round(u*s),typeof Ys=="function"){const h=+document.getElementById("stepSlider").value||0,f=+document.getElementById("skeletonSlider").value||1;Ys(h,f)}typeof window.refreshSliderTicks=="function"&&window.refreshSliderTicks()},a.oninput();const c=document.createElement("button");c.textContent="Toggle Heat-map",c.style="margin-left:8px;padding:6px 12px",c.disabled=!0,c.id="toggleHeatmap",i.after(c);const l=document.createElement("button");l.id="toggleDwellHeatmap",l.textContent="Toggle Dwell Heat-map",l.style="margin-left:8px;padding:6px 12px",l.disabled=!0,c.after(l)});function gu(n){ti=null,Bi("#viz").selectAll("*").remove(),document.getElementById("viewer3DContainer").innerHTML="",Promise.all([cs(`${Kn}skeleton_tracking_${n}.csv`),cs(`${Kn}centroid_data_${n}_tracking.csv`),cs(`${Kn}centroid_data_${n}_collisions.csv`),Iy(`${Kn}skeleton_hierarchy_${n}.json`),cs(`${Kn}behaviours.csv`)]).then(([t,e,i,r,s])=>{Es=e,Ts=s.map(l=>({name:l[Object.keys(l)[1]],description:l[Object.keys(l)[2]]})),TS(t,e,i,r,n);const o=yS(e,Ss,Mr);window._dwellZones=o;const a=document.getElementById("toggleHeatmap");if(a){a.disabled=!1;let l=!1;a.onclick=()=>{l=!l,a.textContent=l?"Hide Collision Heat-map":"Show Collision Heat-map",l?SS(i,window._rects3D,window._scaleX,window._scaleZ):Bi("#layer-heatmap").remove()}}const c=document.getElementById("toggleDwellHeatmap");if(c){c.disabled=!1;let l=!1;c.onclick=()=>{l=!l,c.textContent=l?"Hide Dwell Heat-map":"Show Dwell Heat-map",l?ES(window._dwellZones,window._scaleX,window._scaleZ):Bi("#layer-dwell-heatmap").remove()}}}).catch(t=>{alert("Failed to load data (see console)"),console.error(t)})}function vu(){if(ti)return ti;const n=document.getElementById("viewer3DContainer");if(!n){console.warn("viewer3DContainer missing");return}const t=new hd,e=new s0({antialias:!0});e.setSize(n.clientWidth,n.clientHeight),n.appendChild(e.domElement),t.background=new $t(16777215);const i=new Hu,r=new a0(i,e.domElement);r.enablePan=!0,r.enableZoom=!0,r.enableRotate=!0,t.add(new Md(16777215,3355443,1));const s=new hr;return t.add(s),ti={scene:t,group:s,cam:i,renderer:e,controls:r,dwellAnims:[]},function o(){requestAnimationFrame(o),r.update(),e.render(t,i)}(),ti}function TS(n,t,e,i,r){document.querySelector("input[type=range][disabled]")?.removeAttribute("disabled");const s=document.getElementById("stepSlider"),o=document.getElementById("skeletonSlider");document.getElementById("stepValue"),document.getElementById("skeletonValue");function a(W,nt){window.refreshSliderTicks=()=>{const st=(()=>{const ut=new Set,at=Es.map(Rt=>({x:+Rt.centroidA_x,z:+Rt.centroidA_z,t:Rt.time})).filter(Rt=>isFinite(Rt.x)&&isFinite(Rt.z)),dt=new Set;for(let Rt=0;Rt<at.length;Rt++){const{x:Et,z:Zt,t:qt}=at[Rt];if(dt.has(qt))continue;const zt=at.filter(R=>Math.hypot(R.x-Et,R.z-Zt)<=Ss&&!dt.has(R.t));zt.length<Mr||zt.forEach(R=>{ut.add(R.t),dt.add(R.t)})}return ut})();document.querySelectorAll("#collisionTicks, #dwellTicks").forEach(ut=>ut.remove()),a(W,st)};const ct=document.createElement("div");ct.id="hullSliderWrapper",ct.style.cssText=`
      position:relative;
      width:1000px;
      height:60px;
      margin-top:6px;
